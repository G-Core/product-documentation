...
<Frame>![Subscription methods](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/subscribe-sp-10.png)</Frame>
...
<Frame>![Status Page of Gcore](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/email-sp-20.png)</Frame>
...
<Frame>![Click more in Slack](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/slack-30.png)</Frame>

3. Enter **Incoming WebHooks** in the search bar. 

4. Click the app to open its settings.

<Frame>![Incoming WebHooks](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/open-old-app-40.png)</Frame>

5. Go to the **Configuration** section. 

<Frame>![Configuration section.](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/configuration-50.png)</Frame>
...
<Frame>![Disable and Remove](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/remove-integration-60.png)</Frame>
...
<Frame>![Subscribe via Slack](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/slack-70.png)</Frame>

2. Enter the Slack workspace URL.

3. Click **Continue**.

<Frame>![Slack sign in](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/slack-continue-80.png)</Frame>
...
<Frame>![Sign in](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/private-slack-90.png)</Frame>

6. Enter **Status page** and click **Add** next to the app. 

<Frame>![Add apps](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/add-private-100.png)</Frame>
...
<Frame>![Enter Status page](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/allow-110.png)</Frame>
