...
ai-navigation: Subscribe to Gcore Status Page via email, Slack, or webhook to receive notifications about service incidents, scheduled maintenance, and outages; configure component-specific alerts and manage Slack workspace integrations.
---
...
<Frame>![Subscription methods](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/be-aware-of-the-service-status-scheduled-and-emergency-maintenance-image1.png)</Frame>
...
<Frame>![Status Page of Gcore](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/be-aware-of-the-service-status-scheduled-and-emergency-maintenance-image2.png)</Frame>
...
<Frame>![Click more in Slack](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/be-aware-of-the-service-status-scheduled-and-emergency-maintenance-image3.png)</Frame>
...
<Frame>![Incoming WebHooks](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/be-aware-of-the-service-status-scheduled-and-emergency-maintenance-image4.png)</Frame>
...
<Frame>![Configuration section.](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/be-aware-of-the-service-status-scheduled-and-emergency-maintenance-image5.png)</Frame>
...
<Frame>![Disable and Remove](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/be-aware-of-the-service-status-scheduled-and-emergency-maintenance-image6.png)</Frame>
...
<Frame>![Subscribe via Slack](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/be-aware-of-the-service-status-scheduled-and-emergency-maintenance-image7.png)</Frame>
...
<Frame>![Slack sign in](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/be-aware-of-the-service-status-scheduled-and-emergency-maintenance-image8.png)</Frame>
...
<Frame>![Sign in](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/be-aware-of-the-service-status-scheduled-and-emergency-maintenance-image9.png)</Frame>
...
<Frame>![Add apps](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/be-aware-of-the-service-status-scheduled-and-emergency-maintenance-image10.png)</Frame>
...
<Frame>![Enter Status page](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/be-aware-of-the-service-status-scheduled-and-emergency-maintenance-image11.png)</Frame>
...
<Frame>![Permission to access](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/be-aware-of-the-service-status-scheduled-and-emergency-maintenance-image12.png)</Frame>
...
<Frame>![Email management ](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/be-aware-of-the-service-status-scheduled-and-emergency-maintenance-image13.png)</Frame>
...
<Frame>![Components statuses ](/images/docs/account-settings/be-aware-of-the-service-status-scheduled-and-emergency-maintenance/be-aware-of-the-service-status-scheduled-and-emergency-maintenance-image14.png)</Frame>
