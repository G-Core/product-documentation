...
ai-navigation: Subscribe to Gcore Status Page via email, Slack, or webhook to receive notifications about service outages, scheduled maintenance, and incident updates.
ai-navigation: Subscribe to Gcore Status Page via email, Slack, or webhook for service status, incident, and maintenance notifications.
---
...
<Frame>![Components statuses ](/images/docs/account-settings/status-page/components-140.png)</Frame>
