...
<Warning>
Setting `GCORE_TOOLS=*` exposes all 780 tools. Use this configuration with Claude Code where deferred loading prevents context overflow. Other clients may fail or become unresponsive with this setting.
</Warning>
