...
description: Configure GCORE_TOOLS environment variable with predefined toolsets, wildcard patterns, or exact tool names to filter MCP Server's ~720 tools and reduce cont...
---
