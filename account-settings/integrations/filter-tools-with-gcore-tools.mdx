...
ai-navigation: Configure GCORE_TOOLS environment variable with predefined toolsets, wildcard patterns, or exact tool names to filter MCP Server tool exposure and
---
