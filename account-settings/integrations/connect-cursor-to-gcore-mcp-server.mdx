...
description: Configure Cursor IDE 0.40+ to connect Gcore MCP Server with product-specific tool patterns (dns.*, storage.*, cdn.*) under 50-tool limit using API token auth...
---
