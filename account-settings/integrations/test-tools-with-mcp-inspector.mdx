...
ai-navigation: Configure MCP Inspector to connect to Gcore MCP Server via stdio or HTTP transport, explore available tools filtered by product type (DNS, CDN, Cloud), and manually execute tools with parameters to test behavior before integration with Claude Code.
---
...
<Frame>![MCP Inspector showing connection error: McpError MCP error -32001 Request timed out](/images/docs/account-settings/integrations/test-tools-with-mcp-inspector/test-tools-with-mcp-inspector-image1.png)</Frame>
...
<Frame>![MCP Inspector Tools tab showing available Gcore DNS tools with descriptions](/images/docs/account-settings/integrations/test-tools-with-mcp-inspector/test-tools-with-mcp-inspector-image2.png)</Frame>
...
<Frame>![MCP Inspector showing dns_zones_ls tool execution with JSON response containing zone details](/images/docs/account-settings/integrations/test-tools-with-mcp-inspector/test-tools-with-mcp-inspector-image3.png)</Frame>
...
<Frame>![MCP Inspector server log showing Connected status and INFO logs with HTTP requests to Gcore API](/images/docs/account-settings/integrations/test-tools-with-mcp-inspector/test-tools-with-mcp-inspector-image4.png)</Frame>
