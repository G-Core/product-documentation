...
<Frame>![CDN traffic consumption level](/images/docs/account-settings/my-profile/overview/notifications-cdn.png)</Frame>
...
<Frame>![Configure notifications for Storage](/images/docs/account-settings/my-profile/overview/notifications-object-storage.png)</Frame>