...
<Frame>![Profile section in the Customer Portal](/images/docs/account-settings/profile-menu.png)</Frame>
...
<Frame>![Notifications page in account settings](/images/docs/account-settings/notifications-page.png)</Frame>
...
<Frame>![CDN traffic consumption level](/images/docs/account-settings/notifications-cdn.png)</Frame>
...
<Frame>![Configure notifications for Storage](/images/docs/account-settings/notifications-object-storage.png)</Frame>