...
ai-navigation: Configure product notifications, technical notifications, and promotional emails per user in Gcore Customer Portal via the Notifications page, with shared general notification settings across all account users and CDN traffic consumption level alerts checked hourly.
---
...
<Frame>![Profile section in the Customer Portal](/images/docs/account-settings/notifications/notifications-image1.png)</Frame>
...
<Frame>![Notifications page in account settings](/images/docs/account-settings/notifications/notifications-image2.png)</Frame>
...
<Frame>![CDN traffic consumption level](/images/docs/account-settings/notifications/notifications-image3.png)</Frame>
...
<Frame>![Configure notifications for Storage](/images/docs/account-settings/notifications/notifications-image4.png)</Frame>