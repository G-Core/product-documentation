...
<img src="/images/docs/account-settings/my-profile-overview.png" alt="My profile page in the Customer Portal" width="80%"/>
...
[Two-factor authentication](/account-settings/your-profile-settings/set-up-two-factor-authentication) (2FA) adds an extra layer of security by requiring a verification code in addition to the password during login.
...
<img src="/images/docs/account-settings/my-profile-security-section.png" alt="Two-factor authentication and Password sections in My profile" width="80%"/>
...
<img src="/images/docs/account-settings/change-password-dialog.png" alt="Change password dialog with fields for current password, new password, and confirmation" width="60%"/>

[Password changes](/account-settings/password/change-the-current-password) apply immediately. All active sessions remain valid until a manual logout.
...
<img src="/images/docs/account-settings/my-presets-dialog.png" alt="My Presets dropdown with Save current set as a preset option" width="60%"/>
...
<img src="/images/docs/account-settings/my-profile-logins-section.png" alt="Last logins section showing filters, toolbar, and login history table" width="90%"/>
