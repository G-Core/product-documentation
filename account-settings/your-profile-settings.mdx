...
<Frame>![Account General information page](/images/docs/account-settings/account-general-information.png)</Frame>
...
<Frame>![Switch to company account button on the General information page](/images/docs/account-settings/switch-to-company-button.png)</Frame>
...
<Frame>![Switch to company account dialog with required fields](/images/docs/account-settings/switch-to-company-dialog.png)</Frame>
...
<Info>
Your billing address is separate from the address specified in your payment method. Changes made on one page won't affect the other.
</Info>
...
<Frame>![Billing address and Tax and currency sections](/images/docs/account-settings/billing-address-tax.png)</Frame>
...
<Frame>![Account deletion status section showing cancellation option](/images/docs/account-settings/account-deletion-status.png)</Frame>
