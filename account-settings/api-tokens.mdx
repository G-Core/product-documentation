...
ai-navigation: Create, configure, and manage permanent API tokens with role-based access control, expiration settings, and APIKey authorization headers for automated CDN op
ai-navigation: Create permanent API tokens with name, role, expiration date for automated API requests; delete tokens via Profile > API tokens section.
---
...
To manage services, add your permanent API token after APIKey in the authorization header: `Authorization: APIKey 7711$eyJ0eXAiOiJKV`. The header name is case-insensitive, so `authorization` and `AUTHORIZATION` work identically.
...
<Frame>![Create a permanent API token](/images/docs/account-settings/api-tokens.png)</Frame>
...
<Frame>![API token creation](/images/docs/account-settings/api-tokens-create-dialog.png)</Frame>
...
<Frame>![New API token](/images/docs/account-settings/api-tokens/creation-notification-30.png)</Frame>
...
<Frame>![Delete an API token](/images/docs/account-settings/api-tokens-delete-menu.png)</Frame>
...
<Frame>![API tokens section](/images/docs/account-settings/api-tokens.png)</Frame>
...
You [can configure](/account-settings/notifications) notifications in the Notifications section of the Profile tab. 


<Frame>![API token expiration notifications](/images/docs/account-settings/api-tokens/expiration-notification-60.png)</Frame>
