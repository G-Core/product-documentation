...
To manage services, add your permanent API token after APIKey in the authorization header: `Authorization: APIKey 7711_eyJ0eXAiOiJKV`. The header name is case-insensitive, so `authorization` and `AUTHORIZATION` work identically.

## Create a permanent API token

**Note:** There is currently a limit of 100 API tokens per account


<Frame>![Create a permanent API token](/images/docs/account-settings/my-profile/overview/api-tokens.png)</Frame>
...
<Frame>![API token creation](/images/docs/account-settings/my-profile/overview/api-tokens-create-dialog.png)</Frame>
...
<Frame>![Delete an API token](/images/docs/account-settings/my-profile/overview/api-tokens-delete-menu.png)</Frame>
...
<Frame>![API tokens section](/images/docs/account-settings/my-profile/overview/api-tokens.png)</Frame>
