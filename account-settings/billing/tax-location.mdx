---
title: TAX location
ai-navigation: Configure tax location in billing profile based on address, payment method, and IP address to apply correct VAT rates and tax regulations; update VAT number and tax jurisdiction via billing profile or support contact.
---
...
You can update your address and view your account's VAT rate at any time in your billing profile. As we also consider the default payment method added to your account, please proceed to the [payment methods page](https://portal.gcore.com/accounts/billing/payment-methods) to make changes.
