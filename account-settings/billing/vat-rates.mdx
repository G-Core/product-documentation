...
description: Reference VAT rates by country and user type (individual or organization), with conditional rates for EU organizations based on VAT number provision.
---
