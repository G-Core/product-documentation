...
ai-navigation: Reference VAT rates by country and user type (individual or organization), with conditional rates for EU organizations based on VAT number provision.
ai-navigation: Determine VAT rates by user type (individual/organization), country, and VAT number provision status.
---
