---
title: Expenses
description: View consumed Gcore product costs by service, feature, usage, and pricing rule status (commitment/overcommitment) with tax and discount breakdowns.
---
