---
title: Expenses
ai-navigation: View consumed Gcore product costs by service, feature, usage, and pricing rule status (commitment/overcommitment) with tax and discount breakdowns.
ai-navigation: View billed Gcore product expenses by date, service, feature, usage, pricing rule status, and tax breakdown in account billing.
---
...
<Frame>![Expenses page in the account settings](/images/docs/account-settings/billing/expenses/expenses-page.png)</Frame>
...
If you click the info icon next to the Sum column, you can view a detailed breakdown of the expense, including the collected taxes and applied discounts: 
  ...
  * **Tax rate (%)**: The percentage of tax applied to your expense. This rate is based on local tax laws or regulations. [Check VAT rates in different countries](/account-settings/billing/vat-rates)
  * **Tax amount (€)**: The total amount of tax you'll pay.


<Frame>![Tax calculation dialog](/images/docs/account-settings/billing/expenses/tax-calculation.png)</Frame>
