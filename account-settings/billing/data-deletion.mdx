...
Gcore deletes a suspended service, its settings, and associated customer data after a retention period that depends on the product; full retention periods by product appear below.
