...
ai-navigation: Submit documentation edits via GitHub pull requests using the Edit on GitHub button, fork repository, commit changes, and create pull requests for review by
ai-navigation: Propose documentation changes via GitHub pull request: edit content, fix links, report screenshot errors.
---

1\. Open any article in the [Product Documentation](/) section and scroll down to the footer. Click **Edit on GitHub**. In the example below we open the [What to do if you forget your password?](/account-settings/my-profile/change-password) guide.
