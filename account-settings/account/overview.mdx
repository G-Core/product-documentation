...
ai-navigation: Configure account identification, billing address, tax location, and currency settings in Gcore Customer Portal; switch individual accounts to company status via KYC verification and business documentation submission.
---
...
<Frame>![Account General information page](/images/docs/account-settings/my-profile/overview/account-general-information.png)</Frame>
...
<Frame>![Switch to company account button on the General information page](/images/docs/account-settings/my-profile/overview/switch-to-company-button.png)</Frame>
...
<Frame>![Switch to company account dialog with required fields](/images/docs/account-settings/my-profile/overview/switch-to-company-dialog.png)</Frame>
...
<Frame>![Billing address and Tax and currency sections](/images/docs/account-settings/my-profile/overview/billing-address-tax.png)</Frame>
