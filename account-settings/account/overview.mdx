...
ai-navigation: Configure account identification, billing address, tax location, currency, and initiate KYC verification to switch from individual to company account status.
ai-navigation: Configure account identification, billing address, tax location, currency, and switch individual accounts to company status via KYC verification.
---
