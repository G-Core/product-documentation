...
<Frame>![Account General information page](/images/docs/account-settings/account/overview/overview-image1.png)</Frame>
...
<Frame>![Switch to company account button on the General information page](/images/docs/account-settings/account/overview/overview-image2.png)</Frame>
...
<Frame>![Switch to company account dialog with required fields](/images/docs/account-settings/account/overview/overview-image3.png)</Frame>
...
<Frame>![Billing address and Tax and currency sections](/images/docs/account-settings/account/overview/overview-image4.png)</Frame>
