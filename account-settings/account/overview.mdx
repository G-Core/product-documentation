...
Expanding a service row reveals additional details including plan specifics, credit limits, and billing information. [Service status](/account-settings/account/services) can be changed from this page.

## Account deletion

If [account deletion](/account-settings/account/account-deletion) has been requested, the General information page displays an **Account deletion status** section showing:
