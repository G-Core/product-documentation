...
description: Configure account identification, billing address, tax location, currency, and initiate KYC verification to switch from individual to company account status.
---
