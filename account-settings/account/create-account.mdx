...
ai-navigation: Register individual or legal entity accounts via Google, GitHub, or email; confirm registration and access Gcore Customer Portal dashboard.
ai-navigation: Create Gcore account for individuals via Google, GitHub, or email with billing information setup.
---
...
<Frame>![Gcore website](/images/docs/account-settings/account/get-started-gcore-website-10.png)</Frame>
...
<Frame>![Select the Gcore platform](/images/docs/account-settings/account/select-gcore-platform-20.png)</Frame>
...
<Frame>![Create an account](/images/docs/account-settings/account/create-gcore-account-30.jpg)</Frame>
...
<Frame>![Confirm email](/images/docs/account-settings/account/confirm-email-40.jpg)</Frame>
...
<Frame>![Gcore dashboard](/images/docs/account-settings/account/gcore-dashboard-50.png)</Frame>
...
<Frame>![billing information details](/images/docs/account-settings/account/check-billing-info-60.jpg)</Frame>
