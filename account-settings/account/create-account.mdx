...
<Frame>![Gcore website](/images/docs/account-settings/account/create-account/get-started-gcore-website-10.png)</Frame>
...
<Frame>![Select the Gcore platform](/images/docs/account-settings/account/create-account/select-gcore-platform-20.png)</Frame>
...
<Frame>![Create an account](/images/docs/account-settings/account/create-account/create-gcore-account-30.jpg)</Frame>
...
<Frame>![Confirm email](/images/docs/account-settings/account/create-account/confirm-email-40.jpg)</Frame>
...
<Frame>![Gcore dashboard](/images/docs/account-settings/account/create-account/gcore-dashboard-50.png)</Frame>
...
<Frame>![billing information details](/images/docs/account-settings/account/create-account/check-billing-info-60.jpg)</Frame>
