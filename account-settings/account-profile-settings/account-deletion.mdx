...
Go to the [Delete account](https://portal.gcore.com/accounts/settings/account/general-information) page and click **Delete my account**.
...
To check whether your account has a debt or not, open the [Billing](https://portal.gcore.com/billing/services) section and check the top right corner of the page.
