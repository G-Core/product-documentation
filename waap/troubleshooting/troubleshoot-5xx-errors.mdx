...
ai-navigation: Diagnose WAAP 5xx server errors including 543 errors caused by origin server downtime, firewall blocks, connection timeouts, and incorrect configuration settings.
---
...
<Frame>![543 error message in the Customer Portal](/images/docs/waap/troubleshooting/troubleshoot-5xx-errors-image1.png)</Frame>