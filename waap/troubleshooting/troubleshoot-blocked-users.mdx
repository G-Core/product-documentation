...
ai-navigation: Troubleshoot WAAP blocked users by searching Events requests table with Reference ID, IP address, and date-time metadata to inspect triggered policies, custom rules, HTTP method, client IP, country of origin, and user agent details in the Customer Portal.
---
...
<Frame>![Domains page in the Customer Portal](/images/docs/waap/troubleshooting/troubleshoot-blocked-users/domains-waap-page.png)</Frame>



2. Find the domain where you want to check analytics and click the domain name to open it. 

3. In the sidebar menu, click **Events**.


<Frame>![Analytics page in the Customer Portal](/images/docs/waap/troubleshooting/troubleshoot-blocked-users/waap-analytics-page.png)</Frame>
...
<Frame>![Requests table with search by Reference ID](/images/docs/waap/troubleshooting/troubleshoot-blocked-users/search-requests-by-reference-id.png)</Frame>
