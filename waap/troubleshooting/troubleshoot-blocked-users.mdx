...
ai-navigation: Diagnose blocked users by searching Reference IDs in WAAP Events, inspecting request details including IP, timestamp, HTTP method, and triggered security rules.
ai-navigation: Diagnose WAAP blocked users using Reference ID, IP address, and request details in Events analytics.
---
