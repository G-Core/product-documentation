...
description: Diagnose blocked users by searching Reference IDs in WAAP Events, inspecting request details including IP, timestamp, HTTP method, and triggered security rules.
---
