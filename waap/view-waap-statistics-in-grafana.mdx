...
1. [Download](https://github.com/G-Core/waap-stats-datasource-plugin/releases) the latest plugin ZIP archive from the GitHub releases page.

2. Unzip the archive into the Grafana plugins folder. The default location is:
