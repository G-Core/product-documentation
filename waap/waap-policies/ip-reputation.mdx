...
ai-navigation: Configure IP Reputation rules in Gcore WAAP to block, challenge, or allow traffic from malicious IPs, TOR networks, proxy networks, hosting services, VPNs, bot traffic, suspicious NAT ranges, and external reputation blocklists using JavaScript validation policies.
---
