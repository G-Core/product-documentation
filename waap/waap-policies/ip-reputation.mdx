...
ai-navigation: Configure IP Reputation policy rules in Gcore WAAP to block, challenge, or allow traffic from TOR, proxies, VPNs, hosting services, bots, suspicious NAT rang
ai-navigation: Configure IP Reputation rules in WAAP Firewall to block, challenge, or allow traffic from TOR, proxies, VPNs, hosting services, bots, and suspicious
---
...
You can review and configure IP Reputation rules in the [Gcore Customer Portal](https://accounts.gcore.com/reports/dashboard): 
