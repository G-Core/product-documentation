...
ai-navigation: Configure Advanced API protection policies including auth token protection, sensitive data exposure blocking, invalid JSON traffic filtering, and API-level a
ai-navigation: Configure Advanced API protection policies: auth token, sensitive data exposure, invalid traffic, authorization levels, non-baselined requests.
---
...
You can review and configure API Protection rules in the [Gcore Customer Portal](https://accounts.gcore.com/reports/dashboard): 
