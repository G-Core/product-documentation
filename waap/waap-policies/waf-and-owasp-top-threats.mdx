...
ai-navigation: Configure WAF & OWASP Top 10 policies including SQL injection, XSS, shellshock, open redirect, and PII detection rules in Gcore Customer Portal.
ai-navigation: Configure OWASP Threats rules in WAF policy group to enable SQL injection, XSS, Shellshock, and PII detection policies.
---
