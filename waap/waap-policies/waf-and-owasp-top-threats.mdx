...
You can review the OWASP Threats rules and enable or disable them in the [Gcore Customer Portal](https://portal.gcore.com/accounts/reports/dashboard):
...
Manage the WAF & OWASP Threats policy group for a domain: retrieve the current state of each security rule and toggle individual policies on or off.
