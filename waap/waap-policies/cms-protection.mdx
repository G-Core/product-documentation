...
description: Configure WAAP CMS protection policies to allowlist authenticated WordPress, MODX, and Drupal admin sessions while blocking known CMS exploits.
---
