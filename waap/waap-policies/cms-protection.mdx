...
ai-navigation: Configure CMS Protection policy group in WAAP to allowlist logged-in administrators for WordPress, MODX, and Drupal while blocking WordPress exploits and SQL injection attacks via the Gcore Customer Portal.
---
...
<Frame>![Firewall page with the Allowed IPs tab](/images/docs/waap/waap-policies/cms-protection/cms-protection-image1.png)</Frame>
