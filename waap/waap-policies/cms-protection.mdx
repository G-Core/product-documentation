...
ai-navigation: Configure WAAP CMS protection policies to allowlist authenticated WordPress, MODX, and Drupal admin sessions while blocking known CMS exploits.
ai-navigation: Configure CMS Protection policy group to allowlist logged-in admin sessions and block WordPress exploits in WAAP.
---
