...
| Policy | Purpose | ID | Action | Default |
|---|---|---|---|---|
| WordPress WAF ruleset | Blocks requests that match known WordPress exploit patterns. | `S3008875` | Block | Enabled |
| Logged-in WordPress admins | Allows requests from logged-in WordPress admin sessions. | `S3008908` | Allow | Disabled |
| Logged-in MODX admins | Allows requests from logged-in MODX admin sessions. | `S3008909` | Allow | Disabled |
| Logged-in Drupal admins | Allows requests from logged-in Drupal admin sessions. | `S3008910` | Allow | Disabled |
| Logged-in Joomla admins | Allows requests from logged-in Joomla admin sessions. | `S3008911` | Allow | Disabled |
| Logged-in allowlist Magento admins | Allows requests from logged-in Magento admin sessions. | `S3008914` | Allow | Disabled |
| Logged-in Umbraco admins | Allows requests from logged-in Umbraco admin sessions. | `S3008927` | Allow | Disabled |
| Logged-in PimCore admins | Allows requests from logged-in PimCore admin sessions. | `S3008949` | Allow | Disabled |
