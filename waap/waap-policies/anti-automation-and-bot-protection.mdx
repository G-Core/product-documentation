...
|---|---|---|---|
| Invalid user agent | `S3008869` | Block | Enabled |
| Unknown user agent | `S3008870` | Handshake | Enabled |
| Anti-spam | `S3008900` | Captcha | Disabled |
| Traffic anomaly | `S3008905` | Captcha | Disabled |
| Automated clients | `S3008906` | Block | Disabled |
| Headless browsers | `S3008907` | Captcha | Disabled |
| Anti-scraping | `S3008912` | Captcha | Disabled |
| Vulnerability scanner | `S3008995` | Block | Disabled |
