...
<p>For a verified known bot set to Policy-based, Bot Attacks checks are automatically excluded to avoid false positives. The [Known Bots](/waap/waap-policies/known-bots) article explains which checks are skipped and covers [Policy-based mode behavior](/waap/waap-policies/known-bots#policy-based-mode-and-other-protections) in detail.</p>
