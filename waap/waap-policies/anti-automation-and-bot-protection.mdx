...
The **Invalid user agent** and **Unknown user agent** policies are enabled by default. Other policies are disabled. To change a policy mode, click the dropdown near that policy.
</Info>
