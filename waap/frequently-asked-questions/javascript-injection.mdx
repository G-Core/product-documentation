...
description: Explain WAAP JavaScript injection mechanism for client fingerprinting, browser signatures, and GUI interaction detection via cookies and /sbbi/ endpoint.
---
