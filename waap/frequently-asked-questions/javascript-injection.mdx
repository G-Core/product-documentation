...
ai-navigation: Configure WAAP JavaScript injection to collect client fingerprint, browser-type signature, and GUI interaction data via cookie-based tracking and /sbbi/ endpoint requests for bot detection and malicious traffic filtering.
---
