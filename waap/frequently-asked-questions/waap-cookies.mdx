...
ai-navigation: Document WAAP cookies with Set-Cookie response headers, sessionID, usertag, CSRF protection, CAPTCHA validation, DDoS protection, and load balancing attributes.
ai-navigation: Configure WAAP required cookies for session tracking, CSRF protection, CAPTCHA validation, and DDoS protection with Set-Cookie headers.
---
