...
description: Document WAAP cookies with Set-Cookie response headers, sessionID, usertag, CSRF protection, CAPTCHA validation, DDoS protection, and load balancing attributes.
---
