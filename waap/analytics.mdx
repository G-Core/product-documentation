...
The rules to block or allow requests will appear on the [Firewall](/waap/ip-security/allow-and-block-ip-addresses) page. The rules to challenge requests with JavaScript or CAPTCHA validation will appear on the [WAAP rules](/waap/waap-rules) page. 
