...
<Frame>![Events page in the Customer Portal](/images/docs/waap/analytics/waap-analytics-page.png)</Frame>
...
<Frame>![Auto-refresh toggle on the Events page](/images/docs/waap/analytics/auto-refresh.png)</Frame>
...
<Frame>![WAAP graph on the Overview page in the Customer Portal](/images/docs/waap/analytics/waap-overview.png)</Frame>
...
<Frame>![Status codes graph on the Overview page in the Customer Portal](/images/docs/waap/analytics/overview-status-codes.png)</Frame>
...
<Frame>![Web Application Firewall Requests graph on the Events page](/images/docs/waap/analytics/waap-requests-chart.png)</Frame>
...
<Frame>![Requests table on the Events page](/images/docs/waap/analytics/waap-requests-table.png)</Frame>
...
<Frame>![Threats section on the Events page](/images/docs/waap/analytics/waf-threats.png)</Frame>
...
<Frame>![Top threat origins map on the Events page](/images/docs/waap/analytics/waf-threat-origins.png)</Frame>
...
<Frame>![DDoS attacks graph on the L7 DDoS page](/images/docs/waap/analytics/ddos-over-time.png)</Frame>
...
<Frame>![IPs participated section on the L7 DDoS page](/images/docs/waap/analytics/ips-participated.png)</Frame>
...
<Frame>![URLs targeted section on the L7 DDoS page](/images/docs/waap/analytics/urls-targeted.png)</Frame>
...
<Frame>![User agents section on the L7 DDoS page](/images/docs/waap/analytics/user-agents.png)</Frame>
