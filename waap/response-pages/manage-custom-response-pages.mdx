...
ai-navigation: Configure custom response pages at account and domain levels in WAAP, including switching page sets, modifying pages, managing statuses, and applying changes
ai-navigation: Manage custom response pages at account and domain levels; switch page sets, modify pages, update statuses, apply to domains.
---
...
1\. In the [Gcore Customer Portal](https://accounts.gcore.com/reports/dashboard), navigate to **WAAP** > **Response Pages**. Here you'll see all default and custom response pages. 
...
1\. In the [Gcore Customer Portal](https://accounts.gcore.com/reports/dashboard), navigate to **WAAP** > **Response Pages**. 
