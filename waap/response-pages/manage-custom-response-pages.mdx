...
ai-navigation: Manage custom response pages at account and domain levels in Gcore WAAP, including switching active page sets, modifying page statuses (Active/Inactive), and updating page set assignments to domains via the Customer Portal.
---
...
To view page sets, open the **WAAP** page and navigate to **Response Pages**. You'll be directed to the page with all relevant settings. 


<Frame>![Response pages functionality in the Customer Portal](/images/docs/waap/response-pages/manage-custom-response-pages-image1.png)</Frame>
...
3\. In the sidebar, click **Response Pages**. On this page, you'll see all response pages that are currently applied to your domain. 
...
<Frame>![Update page set on the account level](/images/docs/waap/response-pages/manage-custom-response-pages-image2.png)</Frame>
...
1\. In the [Gcore Customer Portal](https://portal.gcore.com/accounts/reports/dashboard), navigate to **WAAP** > **Response Pages**. Here you'll see all default and custom response pages. 
...
<Frame>![Add domains to a page set on the account level](/images/docs/waap/response-pages/manage-custom-response-pages-image3.png)</Frame>
...
<Frame>![Edit page button in the page set settings](/images/docs/waap/response-pages/manage-custom-response-pages-image4.png)</Frame>
...
<Frame>![Delete page button in the page set settings](/images/docs/waap/response-pages/manage-custom-response-pages-image5.png)</Frame>
