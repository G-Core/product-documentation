...
ai-navigation: Create custom WAAP response pages with personalized content for Block, Block CSRF, Captcha, Enable cookies, Browser validation, and Enable javascript page types, configurable at account level with browser title, page title, and custom messaging up to 6 page sets per account.
---
...
1\. In the [Gcore Customer Portal](https://portal.gcore.com/accounts/reports/dashboard), navigate to **WAAP** > **Response Pages**. 

2\. In the upper-right corner of the screen, click **Response Page Set**.


<Frame>![Highlighted button for creating response page in the Customer Portal](/images/docs/waap/response-pages/create-custom-response-pages-image1.png)</Frame>
...
<Frame>![Create response page set dialog](/images/docs/waap/response-pages/create-custom-response-pages-image2.png)</Frame>
...
<Frame>![Crete response page dialog](/images/docs/waap/response-pages/create-custom-response-pages-image3.png)</Frame>
...
<Frame>![Block response page](/images/docs/waap/response-pages/create-custom-response-pages-image4.png)</Frame>
...
<Frame>![Enable JavaScript response page](/images/docs/waap/response-pages/create-custom-response-pages-image5.png)</Frame>
...
<Frame>![Block CSRF response page](/images/docs/waap/response-pages/create-custom-response-pages-image6.png)</Frame>
...
<Frame>![Set page to active toggle enabled](/images/docs/waap/response-pages/create-custom-response-pages-image7.png)</Frame>
...
<Frame>![Preview page button](/images/docs/waap/response-pages/create-custom-response-pages-image8.png)</Frame>
...
<Frame>![List of domains to select](/images/docs/waap/response-pages/create-custom-response-pages-image9.png)</Frame>
