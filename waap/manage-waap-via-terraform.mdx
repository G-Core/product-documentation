...
<Warning>
If `terraform apply` reports an error, the WAAP API may already have created the silence. Confirm the rule in the Customer Portal or the [Security insights](/api-reference/waap#security-insights) API.
</Warning>
