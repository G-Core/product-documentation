...
The **IP Reputation** policy group is available in the **Pro** and **Enterprise** plans. More details on the [Security pricing page](https://gcore.com/pricing/security#waap).
</Info>
