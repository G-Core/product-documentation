...
For example, you can create a rule that restricts access to admin endpoints. Only users with a valid bearer token in the authorization header will be able to interact with admin APIs. 
...
<Frame>![Domains page in the Customer Portal](/images/docs/waap/getting-started/configure-api-access-with-reserved-tags-image1.png)</Frame>
...
<Frame>![A custom rule to set up privileged API access](/images/docs/waap/api-discovery-and-protection/api-access-with-reserved-tags/configure-api-access-with-reserved-tags-image2.png)</Frame>
...
<Frame>![A custom rule to create privileged users](/images/docs/waap/api-discovery-and-protection/api-access-with-reserved-tags/configure-api-access-with-reserved-tags-image3.png)</Frame>
...
Additionally, you can configure the following security settings for your APIs. 
...
<Frame>![A custom rule to protect Auth endpoint](/images/docs/waap/api-discovery-and-protection/api-access-with-reserved-tags/configure-api-access-with-reserved-tags-image4.png)</Frame>
...
<Frame>![A custom rule to ignore SDE detection](/images/docs/waap/api-discovery-and-protection/api-access-with-reserved-tags/configure-api-access-with-reserved-tags-image5.png)</Frame>
...
<Frame>![WAAP policies page with the highlighted advanced AIP protection policy](/images/docs/waap/waap-policies/advanced-api-protection/configure-api-access-with-reserved-tags-image6.png)</Frame>
