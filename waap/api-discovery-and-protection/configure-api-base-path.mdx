...
3. In the sidebar, click **Domain Settings** \> **API Base Path**.
...
4. Either enable the **Set as API Domain toggle** to treat the whole domain as an API or enter a specific API endpoint path into the **Host** input field.
