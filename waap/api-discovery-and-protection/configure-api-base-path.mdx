...
description: Manually add API endpoint paths to WAAP domain base path via Customer Portal Settings to define communication paths and protect APIs without API Discovery en...
---
