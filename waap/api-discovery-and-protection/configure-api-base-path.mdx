...
ai-navigation: Manually add API endpoint paths to WAAP domain base path via Customer Portal Settings to define communication paths and protect APIs without API Discovery en
ai-navigation: Configure API Base Path endpoints in WAAP domains to define communication paths for API request protection without API Discovery.
---
...
<Frame>
  <img
    src="/images/waap-base-path-2.png"
    alt="API base path form"
    style={{ width:"61%" }}
  />
</Frame>
