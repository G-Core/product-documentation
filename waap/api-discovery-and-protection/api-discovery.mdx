...
ai-navigation: Scan domain traffic to discover, validate, and manage REST API endpoints including legacy and shadow APIs for WAAP protection via API Baseline, Potential API
ai-navigation: Manage REST API endpoints with API Discovery: scan traffic, validate APIs, import Swagger files, protect legacy and shadow APIs in WAAP domains.
---
