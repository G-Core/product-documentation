---
title: "IP Spotlight"
ai-navigation: "Analyze IP addresses using IP Spotlight threat analytics to retrieve risk assessment scores, global and domain activity, WHOIS data, botnet involvement, and threat tags (SQL injection, DDoS, headless browsers) for WAAP policy configuration and WAF rule creation."
---
...
IP Spotlight provides [IP details](/api-reference/waap#ip-spotlight) as its source, total number of requests, destinations, whois data, and whether it has been involved in any malicious activity against other domains within our network.

To check an IP address, follow these steps:

1. In the [Gcore Customer Portal](https://portal.gcore.com/), navigate to **WAAP** \> **IP Spotlight**.
...
<Frame>
  ![IP Spotlight](/images/docs/waap/ip-security/ip-spotlight/ip-spotlight-3.png)
</Frame>
...
<Frame>
  ![IP Spotlight](/images/docs/waap/ip-security/ip-spotlight/ip-spotlight-4.png)
</Frame>
...
<Frame>
  ![IP Spotlight](/images/docs/waap/ip-security/ip-spotlight/ip-spotlight-5.png)
</Frame>
...
<Frame>
  ![IP Spotlight](/images/docs/waap/ip-security/ip-spotlight/ip-spotlight-6.png)
</Frame>
...
<Frame>
  ![IP Spotlight](/images/docs/waap/ip-security/ip-spotlight/ip-spotlight-7.png)
</Frame>
...
<Frame>
  ![IP Spotlight](/images/docs/waap/ip-security/ip-spotlight/ip-spotlight-8.png)
</Frame>
...
<Frame>
  ![IP Spotlight](/images/docs/waap/ip-security/ip-spotlight/ip-spotlight-9.png)
</Frame>
