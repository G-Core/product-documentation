---
title: "IP Spotlight"
ai-navigation: Query threat analytics for specific IP addresses to assess risk levels, view global/domain activity, request counts, and malicious behavior across Gcore netw
ai-navigation: Analyze IP addresses for threat risk assessment, global activity, domain activity, and malicious behavior using IP Spotlight.
---
...
<Frame>
  ![IP Spotlight](/images/docs/waap/ip-security/ip-spotlight/ip-spotlight-2.png)
</Frame>
