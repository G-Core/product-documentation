...
description: Detect and mitigate Layer 7 DDoS attacks on web applications using WAAP Monitoring and Protection modes with configurable global thresholds.
---
