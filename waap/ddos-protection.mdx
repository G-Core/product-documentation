...
DDoS protection is always enabled, even if WAAP is in [Monitoring mode](/waap/getting-started/waap-modes#monitoring-mode). Once a DDoS attack is identified, the system activates a DDoS mode.
