...
ai-navigation: Detect and mitigate Layer 7 DDoS attacks on web applications using WAAP Monitoring and Protection modes with configurable global thresholds.
ai-navigation: Enable L7 DDoS protection in WAAP Protection mode to block application-layer attacks; detection always active in Monitoring mode.
---
