...
<Frame>
  ![Events page in the Customer Portal](/images/docs/waap/analytics/waap-events.png)
</Frame>
...
<Frame>
  ![Add filter button in Events](/images/docs/waap/analytics/waap-events-add-filter.png)
</Frame>
...
<Frame>
  ![WAAP Events export](/images/docs/waap/analytics/waap-events-export-csv.png)
</Frame>
