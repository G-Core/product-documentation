...
title: "Events"
sidebarTitle: Events
ai-navigation: Investigate HTTP requests and security events in WAAP using Events filters by time range, event type, action (Blocked, Monitored, Allowed, Passed, CAPTCHA, Challenge), country, IP address, path, HTTP method, response code, request ID, reference ID, and session ID with 30-day retention.
---
...
- **Actions** — filter requests based on the mitigation decision applied by WAAP. Available values include:
