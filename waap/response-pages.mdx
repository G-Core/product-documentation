...
ai-navigation: Configure WAAP response pages including Browser validation, Enable cookies, Enable JavaScript, Captcha, Block, and Block CSRF pages triggered by WAAP policies and custom rules, with customizable priority order and corporate branding options.
---
...
When a request is subject to browser validation, a user will be presented with the browser validation page. They don't need to perform any action, and the page will be displayed for less than a second. 
...
<Frame>![Enable cookies response page](/images/docs/waap/response-pages/response-pages-image1.png)</Frame>
...
<Frame>![Enable JavaScript response page](/images/docs/waap/response-pages/response-pages-image2.png)</Frame>
...
<Frame>![Captcha response page](/images/docs/waap/response-pages/response-pages-image3.png)</Frame>
...
<Frame>![Block response page](/images/docs/waap/response-pages/response-pages-image4.png)</Frame>
...
<Frame>![Block CSRF response page](/images/docs/waap/response-pages/response-pages-image5.png)</Frame>
