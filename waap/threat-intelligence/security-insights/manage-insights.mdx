...
<p>The API exposes two operations for managing insights: updating the status of an existing insight and creating a silence rule to suppress notifications.</p>
...
<Tabs>
  ...
  <Tab title="curl">
    ...
    ```json
    {
      ...
      "status": "ACKED",
      "description": "A request originated from a high-risk IP 198.51.100.42 but it was allowed by rule block-internal(12345)",
      "recommendation": "Validate rule block-internal is not too permissive",
      ...
      "last_status_change": "2026-06-25T13:00:00Z"
    }
    ```
