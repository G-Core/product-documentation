...
<p>Silence rules [created](/waap/threat-intelligence/security-insights/manage-insights#silence-an-insight) for a domain can be listed by ID, updated to change their expiry or comment, or deleted to re-enable notifications.</p>

<Info>
  A permanent [API token](/account-settings/api-tokens) and a domain ID are required. To find silence rule IDs, use the List operation below.
</Info>
      ...
      "results": [
        {
          ...
          "comment": "Trusted internal scanner",
