---
title: "IP Spotlight"
ai-navigation: Analyze IP addresses for threat intelligence using risk scores, global/domain activity, request metrics, and malicious behavior detection in WAAP.
ai-navigation: Analyze IP addresses for threat risk assessment, global activity, domain activity, and malicious behavior using IP Spotlight in WAAP.
---
