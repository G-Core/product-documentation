---
title: "IP Spotlight"
description: Analyze IP addresses for threat intelligence using risk scores, global/domain activity, request metrics, and malicious behavior detection in WAAP.
---
