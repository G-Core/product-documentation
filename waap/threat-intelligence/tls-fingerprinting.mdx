...
2. In the filter bar, click **Add filter** and select **JA3** or **JA4**.
3. Enter the fingerprint value and click **Apply**:
   - JA3: a 32-character hex string, for example `e2925c27149b0d0dc34373d55040dde1`.
   - JA4: a three-part string in `prefix_hex12_hex12` format, for example `t13d1516h2_8daaf6152771_b1ff8ab2d16f`.

<Frame>![Events page with a TLS fingerprint filter applied in the filter bar](/images/docs/waap/threat-intelligence/tls-fingerprinting/ja3-events-filter.png)</Frame>
