...
- [API docs](/api-reference/waap): Learn how to construct and manage advanced rules.
...
You can also retrieve and manage advanced rules programmatically using the [Advanced Rules retrieval endpoint](/api-reference/waap/advanced-rules/retrieve-advanced-rules).

<Frame>
  ![Custom Rules page listing rate limit, basic, and advanced rules, with the Advanced Rule tooltip shown on the type icon](/images/docs/waap/waap-rules/advanced-rules/advanced-rule.png)
</Frame>
