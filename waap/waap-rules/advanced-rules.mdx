...
ai-navigation: Create and manage advanced WAAP custom rules using Common Expression Language (CEL) syntax via API with complex conditional logic and single-action enforcement.
ai-navigation: Create advanced WAAP rules with Common Expression Language (CEL) syntax via API for complex conditional logic.
---
