...
5. In the **Define rule** section, configure the rule logic:
   ...
   - **Then**: Select the action (for example, **Block**, **Allow**, **Captcha**, or **Tag**) and configure action-specific settings such as status code and duration.
...
The following sections provide examples of advanced rules you can create in the Customer Portal or via our API. Use the visual rule builder and **Quick Templates** for common scenarios, or adapt the API examples below when you need programmatic control.
