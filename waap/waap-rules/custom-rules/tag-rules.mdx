...
<Frame>![Example of a tag-based rule](/images/docs/waap/waap-rules/tag-rules/tag-rules-image1.png)</Frame>
...
<Frame>![Example of a tag-based rule](/images/docs/waap/waap-rules/tag-rules/tag-rules-image2.png)</Frame>
...
<Frame>![Example of a tag-based rule](/images/docs/waap/waap-rules/tag-rules/tag-rules-image3.png)</Frame>
