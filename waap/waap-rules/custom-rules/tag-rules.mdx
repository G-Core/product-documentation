...
description: Create tag-based and tag-generating rules in WAAP custom rules to filter traffic using predefined tags, user-defined tags, and conditional logic.
---
