...
After the rule is active, WAAP applies LLM Attack inspection to tagged requests and blocks matches for prompt injection (OWASP LLM01) and supply chain attacks (OWASP LLM05).
