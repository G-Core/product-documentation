...
description: Configure reserved tags in WAAP custom rules to trigger specific actions: Registered, Logged In, Paid, Monitor, API Privileged Access, Auth Endpoint, and oth...
---
