...
<Frame>![A custom rule for tagging a registered client](/images/docs/waap/waap-rules/tag-rules/reserved-tags-image1.png)</Frame>
...
<Frame>![A custom rule for tagging a logged-in client](/images/docs/waap/waap-rules/tag-rules/reserved-tags-image2.png)</Frame>
...
<Frame>![WAAP requests graph on the Analytics page](/images/docs/waap/waap-rules/tag-rules/reserved-tags-image3.png)</Frame>
...
<Frame>![A custom rule for tagging requests from certain countries](/images/docs/waap/waap-rules/tag-rules/reserved-tags-image4.png)</Frame>
...
<Frame>![A custom rule for tagging requests with ignored bot activity](/images/docs/waap/waap-rules/tag-rules/reserved-tags-image5.png)</Frame>
...
<Frame>![A custom rule for tagging requests to login pages](/images/docs/waap/waap-rules/tag-rules/reserved-tags-image6.png)</Frame>
...
<Frame>![A custom rule for tagging requests from paid users](/images/docs/waap/waap-rules/tag-rules/reserved-tags-image7.png)</Frame>
...
<Frame>![A custom rule to detect denial of inventory attacks](/images/docs/waap/waap-rules/tag-rules/reserved-tags-image8.png)</Frame>
...
<Frame>![A custom rule to detect item added to cart](/images/docs/waap/waap-rules/tag-rules/reserved-tags-image9.png)</Frame>
