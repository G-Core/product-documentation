...
ai-navigation: Configure request.limit_rate method with threshold, time window, filters, and aggregation scope to enforce rate limiting rules via WAAP API.
ai-navigation: Configure request.limit_rate method with threshold, time window, IP filters, URL patterns, methods, status codes, and aggregation scope in WAAP
---
