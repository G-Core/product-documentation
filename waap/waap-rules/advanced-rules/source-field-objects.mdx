...
ai-navigation: Configure advanced rule expressions using source field objects (request.headers, request.ip, request.uri, request.path, request.method, request.origin_ip, request.ja3) with single-quoted string values in WAAP rule conditions.
---
