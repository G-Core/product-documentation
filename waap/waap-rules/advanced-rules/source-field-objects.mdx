...
ai-navigation: Reference source field objects (request, headers, ip, uri, path, method, origin_ip, ja3) and syntax for advanced rule expressions in WAF/security policies.
ai-navigation: Configure source field objects (request, headers, ip, uri, path, method, origin_ip, ja3) in advanced rule expressions with single-quote syntax.
---
