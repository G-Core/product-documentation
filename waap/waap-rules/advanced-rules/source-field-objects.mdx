...
description: Reference source field objects (request, headers, ip, uri, path, method, origin_ip, ja3) and syntax for advanced rule expressions in WAF/security policies.
---
