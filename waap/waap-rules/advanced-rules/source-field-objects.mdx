...
ai-navigation: Configure advanced rule expressions using source field objects (request.headers, request.ip, request.uri, request.path, request.method, request.origin_ip, request.ja3, request.ja4) with single-quoted string values in WAAP rule conditions.
---
...
| ja4          | string  | JA4 TLS client [fingerprint](/waap/threat-intelligence/tls-fingerprinting).                                                      | request.ja4<br/>request.ja4 == 't13d1516h2_8daaf6152771_b1ff8ab2d16f'                                                                                                        |
