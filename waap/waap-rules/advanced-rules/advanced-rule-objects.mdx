...
description: Reference advanced rule objects and attributes including client_data, request, response containers with fingerprint, headers, status, rate_limit, and ip_in_r...
---
