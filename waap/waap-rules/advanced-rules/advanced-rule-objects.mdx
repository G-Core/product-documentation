...
ai-navigation: Reference advanced rule objects and attributes including client_data, request, response containers with fingerprint, headers, status, rate_limit, and ip_in_r
ai-navigation: Configure advanced rule objects and attributes: client_data, request, response containers with fingerprint, headers, status, rate_limit, ip_in_range
---
