...
You can create the following types of custom rules: 
  ...
  * [Tag rules](/waap/waap-rules/advanced-rules) contain tags, which are added to existing rules and function as identifiers for monitoring and analytics purposes. You can also create custom rules based on tags.
