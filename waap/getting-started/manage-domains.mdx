...
ai-navigation: Disable or delete WAAP-protected domains in CDN resources; manage domain statuses (Monitoring, Protection, Disabled) and toggle WAAP protection in Security s
ai-navigation: Manage WAAP-protected domains: enable, disable, delete; configure Monitoring, Protection, Disabled statuses in CDN resource settings.
---
