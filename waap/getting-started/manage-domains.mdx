...
description: Disable or delete WAAP-protected domains in CDN resources; manage domain statuses (Monitoring, Protection, Disabled) and toggle WAAP protection in Security s...
---
