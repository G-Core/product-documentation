...
<Tabs>
  ...
  <Tab title="Create a resource with your DNS provider">
    ...
    <Frame>
      ![Create CDN resource form](/images/docs/waap/getting-started/create-resource.png)
    </Frame>
    ...
    <Frame>
      ![Host header configuration](/images/docs/waap/getting-started/host-header-forward.png)
    </Frame>
    <Info>
      **Info**
      ...
      <Frame>
       ![Always online disabled](/images/docs/waap/getting-started/always-online-disabled.png)
      </Frame>
...
<Frame>
  ![Firewall page in the Customer Portal](/images/docs/waap/getting-started/waap-firewall.png)
</Frame>
...
<Frame>
  ![Default Rules page with CMS Protection tab](/images/docs/waap/getting-started/default-rules-cms-protection.png)
</Frame>
...
<Frame>
  ![Bot Management page with Known Bots tab](/images/docs/waap/getting-started/bot-management-known-bots.png)
</Frame>
...
<Frame>
  ![WAAP modes dropdown on Domains page](/images/docs/waap/getting-started/domains-waap-protection.png)
</Frame>
