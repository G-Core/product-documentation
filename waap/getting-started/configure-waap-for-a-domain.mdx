...
ai-navigation: Create CDN resource with WAAP enabled, configure origin server details, update DNS records, and verify traffic routing through Gcore network.
ai-navigation: Create CDN resource with WAAP enabled, configure origin server, update DNS records to route traffic through Gcore network.
---
