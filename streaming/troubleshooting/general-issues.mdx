...
4. Screenshot of the information shown in https://gcore.com/.well-known/cdn-debug.
5. Screenshot of the response to this command:

   ```
   curl https://gcore.com/.well-known/cdn-debug/json
   ```
6. Screenshot of the speed test result using https://gcore.com/.well-known/cdn-debug.
