...
ai-navigation: "List of output parameters after transcoding"
ai-navigation: Configure transcoding output codecs (H.264, H.265, AV1), bitrate, frame rate, and ABR quality levels for HLS MPEG-TS, HLS CMAF, MPEG-DASH.
---
