...
1. Decoding of the original video ([list of accepted parameters](/streaming/live-streams-and-videos-protocols-and-codecs/what-initial-parameters-of-your-live-streams-and-videos-we-can-accept) for input video)
...
Gcore ensures consistent audio track indexing automatically in streaming manifests and segments. It maintains static audio track indices at position zero, enabling smooth playback across all video quality renditions.
