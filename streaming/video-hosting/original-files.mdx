...
ai-navigation: Download transcoded video files in multiple codecs and resolutions from Gcore Video Streaming via Customer Portal after original files are deleted post-transcoding.
---
...
When you upload an original video file to Gcore Video Streaming, it transcodes the file for [multiple codecs and resolutions](/streaming/video-hosting/hls-and-mp4) to ensure viewers can watch it regardless of device performance, display resolution, or connection speed.
...
![All Videos list in Gcore Video Hosting portal](/images/docs/streaming-platform/video-hosting/original-files/original-files-vod-1.png)
...
![Video Settings page showing Download video section](/images/docs/streaming-platform/video-hosting/original-files/original-files-vod-2.png)
