...
This request will allow your keyserver to retrieve the decryption key, which should then pass to the viewer in its original format. An AES-128 key is a 16-byte binary value. In hexadecimal notation it looks like:
