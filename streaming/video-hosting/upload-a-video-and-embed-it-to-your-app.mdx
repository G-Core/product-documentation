...
ai-navigation: Configure Gcore Video Hosting to upload videos via direct upload, Google Drive import, TUS protocol resumable uploads, or remote URL fetch, then deliver adaptive bitrate HLS MPEG-TS, HLS CMAF, MPEG-DASH CMAF, MP4, HEVC, AV1, VP9, and 8K resolution renditions with multi-audio tracks, subtitles, custom thumbnails, and analytics.
---

Upload a video to Gcore Video Hosting, update its playback settings, and embed it into your app or website with the Gcore player, iframe code, or direct playback links.

## Step 1. Upload a video to the customer portal

Navigate to the [Video Hosting](https://portal.gcore.com/streaming/video/list) tab and upload a video using one of the following actions: 
...
|--------|---------------|
| `empty` | The video entity was created, but the source file is still being received by upload, import, or download from your source. |
...
For more details, see [Video Lifecycle and Statuses](/streaming/video-hosting/vod-status).
