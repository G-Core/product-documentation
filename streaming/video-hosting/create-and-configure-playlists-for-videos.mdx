...
ai-navigation: Create and configure video playlists in Gcore Streaming Platform by enabling the feature, adding up to 512 videos to a playlist via the portal Editor, reordering videos by drag-and-drop, and exporting embed code for website integration.
---
...
You can [view statistics](/streaming) for your playlist. To do this, open the settings of the playlist needed in the control panel and go to the **Statistics** tab.
