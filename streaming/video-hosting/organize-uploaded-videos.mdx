...
ai-navigation: Organize videos in Gcore Streaming using directories and tags for filtering and grouping by metadata; create directories, upload videos, move videos between directories, add tags to videos, and filter videos by tag names in the Customer Portal.
---
