...
ai-navigation: Configure Live imitation to broadcast uploaded videos at scheduled times with iframe player embedding and playlist sequencing.
ai-navigation: Create Live imitation to broadcast uploaded videos at scheduled date and time with iframe player embed.
---
...
1\. Upload videos that you want to broadcast in live mode as a live stream according to 1–4 steps in the [Upload a video and embed it to your app](/streaming/video-hosting/upload-a-video-and-embed-it-to-your-app) guide. You can upload up to 512 videos to a playlist.
