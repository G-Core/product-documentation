...
ai-navigation: Delete uploaded videos via Gcore Customer Portal or DELETE /videos API endpoint; permanently removes video data, transcoded versions, subtitles, and screensh
ai-navigation: Delete uploaded videos from Video Hosting via Customer Portal or API; permanently removes transcoded versions, subtitles, screenshots.
---
