...
description: Delete uploaded videos via Gcore Customer Portal or DELETE /videos API endpoint; permanently removes video data, transcoded versions, subtitles, and screensh...
---
