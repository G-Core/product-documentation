...
ai-navigation: Delete uploaded videos from Gcore Video Hosting via Customer Portal or DELETE /videos API endpoint; permanently removes all transcoded versions, subtitles, screenshots, and associated data from cloud storage.
---
...
1\. In the [Gcore Customer Portal](https://portal.gcore.com/accounts/reports/dashboard), navigate to **Streaming** > **Video Hosting**. You'll be directed to the **All videos** page.
