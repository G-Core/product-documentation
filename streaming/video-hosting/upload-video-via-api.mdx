...
ai-navigation: Upload videos to Gcore VOD storage via API using copy from external storage, local device upload, or batch migration methods with HLS/MP4 transcoding.
ai-navigation: Upload videos to VOD storage via API using copy from external storage, local device upload, or batch migration methods.
---
...
Read more on the page [Generate and translate AI captions for a new VOD](/streaming/ai-video-service/generate-ai-subtitles-and-add-them-to-video/generate-captions-via-api).
