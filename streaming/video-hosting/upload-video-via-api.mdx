...
description: Upload videos to Gcore VOD storage via API using copy from external storage, local device upload, or batch migration methods with HLS/MP4 transcoding.
---
