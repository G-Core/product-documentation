...
ai-navigation: Generate video captions and translate subtitles using Whisper ASR and AI models via Gcore API or Customer Portal for 100+ languages.
ai-navigation: Generate and translate video captions using AI ASR with Whisper models; transcribe audio in 100+ languages or translate to multilingual audiences.
---

## Introduction

Gcore [AI automated speech recognition (ASR)](https://gcore.com/streaming-platform/ai-for-video) functionality allows you to automatically generate [video captions](/streaming/video-hosting/subtitles-and-closed-captions-for-vod#what-are-subtitles-and-closed-captions) (also referred to as subtitles) using AI models. This serves two use cases: 
...
You can transcribe and translate subtitles in two ways: via API or in the Customer Portal. For step-by-step instructions, check out the relevant guide: 
  ...
  * [Transcribe and translate captions in the Customer Portal](/streaming/ai-video-service/generate-ai-subtitles-and-add-them-to-video/generate-captions-in-customer-portal)
  * [Transcribe and translate captions via API](/streaming/ai-video-service/generate-ai-subtitles-and-add-them-to-video/generate-captions-via-api)