...
You can transcribe and translate subtitles in two ways: via API or in the Customer Portal. For step-by-step instructions, check out the relevant guide: 
  ...
  * [Create AI tasks](/streaming/ai-video-service/generate-ai-subtitles-and-add-them-to-video/generate-captions-in-customer-portal)
  * [Using video upload parameters](/streaming/ai-video-service/generate-ai-subtitles-and-add-them-to-video/generate-captions-in-customer-portal)