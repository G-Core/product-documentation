...
ai-navigation: Configure subtitles and closed captions for VOD videos using SRT and WebVTT timed text track formats in Gcore Player, with support for AI-generated subtitles, automatic translation, and third-party caption file attachment.
---
...
1\. Go to the [Video Hosting](https://portal.gcore.com/streaming/video/list) section and open the video where you want to add subtitles or captions.
