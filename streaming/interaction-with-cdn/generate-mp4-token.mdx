...
An [MP4&nbsp;speed&nbsp;limit](/streaming/video-hosting/download-mp4-files#limit-mp4-download-speed) must be configured on the CDN resource for `speed` and `buffer` to take effect.
