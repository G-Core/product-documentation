...
description: Configure auto-refresh for short-lived video secure tokens (HLS/DASH) with IP-bound or plain modes to prevent link sharing during live streams and pay-per-vi...
---
