...
ai-navigation: Configure video secure tokens to restrict content access by user authentication, expiration time, and per-user token generation for paid subscriptions, private videos, time-limited previews, and anti-hotlinking protection.
---
...
![Custom CDN resources](/images/docs/streaming-platform/interaction-with-cdn/token-auto-refresh/cdn-resources.png)
