...
ai-navigation: Configure dedicated custom CDN resources with geo-blocking, IP restrictions, referrer validation, secure tokens, and per-GB billing for Video Streaming deliv
ai-navigation: Create custom CDN resources for Video Streaming with geo-blocking, custom domains, IP policies, and per-GB billing separate from default streaming.
---
...
1. **Active CDN subscription** – Activate the [CDN product](/cdn/getting-started/create-a-cdn-resource)
