...
ai-navigation: Embed HTML widgets as overlays into live streams using Gcore API with support for multiple overlays, transparent areas, and automatic scaling across adaptive
ai-navigation: Embed HTML overlays into live streams via API with transparent areas, multiple overlays per stream, and automatic scaling.
---
