...
Gcore overlays differ from OBS overlays in scalability and deployment:
...
Set the overlay ID from the response to use it in subsequent requests:

```bash
export OVERLAY_ID="{YOUR_OVERLAY_ID}"
```
