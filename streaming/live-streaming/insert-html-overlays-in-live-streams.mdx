...
description: Embed HTML widgets as overlays into live streams using Gcore API with support for multiple overlays, transparent areas, and automatic scaling across adaptive...
---
