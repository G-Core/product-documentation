...
When [creating or editing](/api-reference/streaming) the stream via API, to enable auto recording, change the parameter in the API request in the following way:
