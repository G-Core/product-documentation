...
sidebarTitle: Record
ai-navigation: Enable manual or automatic recording of live streams via Gcore Streaming portal or API using the record feature to save stream fragments or entire sessions to Streaming Storage, with automatic splitting for interruptions over one minute and recordings exceeding four hours.
---
