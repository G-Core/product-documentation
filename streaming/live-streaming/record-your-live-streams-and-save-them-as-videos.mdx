...
sidebarTitle: Record
ai-navigation: Record live streams manually or automatically via Gcore Customer Portal or API, storing video fragments in Streaming Storage with automatic splitting for int
ai-navigation: Record live streams manually or automatically to Streaming Storage via portal Start/Stop Record button or API auto_record parameter.
---
