...
<Tip>
  You can see the stream's [output parameters here](/streaming/live-streaming/broadcasting-software/obs#output-parameters). If you need to increase the FPS to 60, make sure to also increase the bitrate accordingly for optimal stream quality.
</Tip>
