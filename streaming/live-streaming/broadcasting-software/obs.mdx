...
sidebarTitle: "OBS"
ai-navigation: Configure OBS encoder settings (Server URL, Stream Key, Video Bitrate, Audio Bitrate) to push RTMP live streams to Gcore Video Streaming platform.
ai-navigation: Configure OBS encoder Server URL, Stream Key, Video Bitrate, Audio Bitrate, and Encoder for Gcore Video Streaming RTMP push.
---
