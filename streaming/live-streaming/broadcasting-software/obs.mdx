...
sidebarTitle: "OBS"
description: Configure OBS encoder settings (Server URL, Stream Key, Video Bitrate, Audio Bitrate) to push RTMP live streams to Gcore Video Streaming platform.
---
