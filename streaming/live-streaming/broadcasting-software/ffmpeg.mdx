...
title: "FFmpeg"
sidebarTitle: "FFmpeg"
description: Configure FFmpeg command-line parameters (bitrate, encoder, keyframe interval, resolution, audio sample rate) to stream video to Gcore Video Streaming via RTMP.
---
