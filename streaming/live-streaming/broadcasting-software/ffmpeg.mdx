...
title: "FFmpeg"
sidebarTitle: "FFmpeg"
ai-navigation: Configure FFmpeg command-line parameters (bitrate, encoder, keyframe interval, resolution, audio sample rate) to stream video to Gcore Video Streaming via RTMP.
ai-navigation: Configure FFmpeg RTMP stream parameters: video bitrate, audio bitrate, encoder, keyframe interval, CPU preset, resolution, and frame rate.
---
