...
ai-navigation: Configure GStreamer pipelines with videotestsrc, audiotestsrc, x264enc, and container multiplexers (FLV, MPEG-TS) to encode and push live streams to Gcore RTMP or SRT ingest endpoints using H.264 video, AAC audio, and protocol-specific sink elements (rtmpsink, srtsink).
---
