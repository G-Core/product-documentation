...
ai-navigation: Build GStreamer pipelines with videotestsrc, x264enc, and srtsink/rtmpsink to encode and push H.264/AAC streams to Gcore RTMP or SRT ingest endpoints.
ai-navigation: Configure GStreamer pipelines to encode and push live streams to Gcore RTMP/SRT ingest endpoints with H.264 video and AAC audio codecs.
---
