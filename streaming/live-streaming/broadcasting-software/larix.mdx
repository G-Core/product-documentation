...
title: "Larix"
sidebarTitle: "Larix"
ai-navigation: Configure Larix mobile encoder with RTMP URL, Larix Grove QR code, and stream parameters (bitrate, resolution, FPS, keyframe interval) for Gcore Video Stream
ai-navigation: Configure Larix mobile encoder with RTMP URL, bitrate, resolution, frame rate, and keyframe interval for Gcore Video Streaming.
---
