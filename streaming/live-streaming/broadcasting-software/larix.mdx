...
title: "Larix"
sidebarTitle: "Larix"
description: Configure Larix mobile encoder with RTMP URL, Larix Grove QR code, and stream parameters (bitrate, resolution, FPS, keyframe interval) for Gcore Video Stream...
---
