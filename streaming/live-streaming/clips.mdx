...
title: "Instant clips"
sidebarTitle: "Clips"
ai-navigation: Create instant clips from ongoing live streams in HLS (.m3u8) or MP4 formats with configurable expiration (1 minute to 4 hours), stored in server memory until expiration or conversion to permanent VOD.
---
...
You can generate a clip from any part of DVR window by specifying the start time and duration. Read more about DVR window on the page [DVR, Pause and rewind the live streams](/streaming/live-streaming/pause-and-rewind-the-live-streams).
