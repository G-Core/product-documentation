...
sidebarTitle: DVR
ai-navigation: Enable DVR feature to cache live streams for 1-4 hours, allowing viewers to pause and rewind broadcasts using PATCH /streaming/streams/{id} API or UI toggle.
ai-navigation: Enable DVR feature to cache live streams for 1 hour default, allowing viewers to pause and rewind broadcasts via player scroll bar.
---
