...
SRT implements reliability using UDP plus selective retransmissions. Unlike TCP, SRT enforces a strict latency window (e.g., 500–2000 ms). Packets must arrive within this time, otherwise they are dropped. 
...
Read more about [encoder buffering, frame reordering, and zerolatency tuning using SRT](srt)
