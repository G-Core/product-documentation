...
title: "RTMP"
sidebarTitle: "RTMP"
ai-navigation: Ingesting original streams via RTMP, RTMPS protocols
ai-navigation: Configure RTMP/RTMPS encoder with ingest URL, stream key, H.264 video codec, AAC audio, keyframe interval, and bitrate for live stream ingestion.
---
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Follow <a href="/docs/streaming/live-streaming/create-a-live-stream#step-3-configure-your-stream-for-push-pull-or-webrtc-to-hls" target="_blank">step 3 of the guide</a>.
      </td>
    </tr>
    <tr>
