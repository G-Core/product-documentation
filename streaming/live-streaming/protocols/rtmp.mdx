...
<Info>
  RTMP only supports H.264 video + AAC audio; for other codecs (e.g. H.265/HEVC), use [use SRT](/streaming/live-streaming/protocols/srt) ingest.
...
## Demo RTMP Streaming: How LowLatency Encoder Tuning Impact Delivery
