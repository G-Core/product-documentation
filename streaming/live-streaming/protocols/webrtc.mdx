...
ai-navigation: Ingest via WebRTC WHIP and transcoding to LL-HLS/LL-DASH
ai-navigation: Configure WebRTC WHIP ingest with H.264 video and OPUS audio, transcode to HLS/DASH with adaptive bitrate streaming via CDN.
---
