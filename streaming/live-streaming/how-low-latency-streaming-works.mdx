...
<Frame>
  ![Example of how low-latency streaming works](/images/docs/streaming-platform/live-streaming/how-low-latency-streaming-works/low-latency-football.gif)
</Frame>
...
<Frame>
![Low-latency streaming links for live streams](/images/docs/streaming-platform/live-streaming/how-low-latency-streaming-works/low-latency-links.png)
</Frame>
...
<Frame>
  ![HLS non-low-latency link example](/images/docs/streaming-platform/live-streaming/how-low-latency-streaming-works/export-non-low-latency-link.png)
</Frame>
