...
ai-navigation: "Achieve ~2–5s latency with unified LL-HLS and LL-DASH support"
ai-navigation: Configure LL-HLS and LL-DASH protocols with CMAF for live streaming latency of 2–5 seconds via Gcore Video Streaming CDN.
---
