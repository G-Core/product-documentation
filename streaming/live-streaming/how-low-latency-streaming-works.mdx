...
ai-navigation: Configure low-latency live streaming with LL-HLS and LL-DASH protocols using CMAF and fMP4 containers to achieve 2–5 seconds latency; ingest RTMP or SRT streams, transcode to adaptive bitrate, and deliver via CDN with manifest blocking and chunked downloads.
---
