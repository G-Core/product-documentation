...
ai-navigation: Configure Multicamera to combine multiple live streams into a single player with stream status selection, custom player assignment, stream ordering, and screensaver upload for multi-angle or multi-language broadcasts.
---
