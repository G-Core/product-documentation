...
ai-navigation: Learn what Gcore Live Streaming provides for live video workflows - RTMP, SRT, and WebRTC WHIP ingest, adaptive bitrate HLS/DASH delivery, low-latency modes, overlays, playlists, live clipping, restreams, recording, and DVR features.
---
...
<Info>
  **Active by default**: Low-latency streaming (LL-HLS and LL-DASH) is available from the start for all accounts. It works automatically across all service tiers—including the trial period and free tier—without requiring any plan upgrades or additional activation steps.
</Info>
