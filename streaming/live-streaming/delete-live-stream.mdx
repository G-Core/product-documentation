...
<Frame>![Turn off enable live stream toggle](/images/docs/streaming/live-streaming/create-a-live-stream/live-stream-disable.png)</Frame>
...
<Frame>![Live stream settings UI](/images/docs/streaming/live-streaming/create-a-live-stream/live-stream-delete.png)</Frame>
