...
sidebarTitle: Manage live streams
...
We only support [usage reports](/streaming/billing/usage-and-billing-reports) collection for Gcore players. If you use your own, non-Gcore player, the statistics page will be empty. Independent of the player, you can view [monitoring metrics](/streaming/live-streaming/view-your-live-stream-metrics) for performance analysis and troubleshooting.
</Warning> */}
