...
Use RTMP or RTMPS for social platforms and short, stable network paths where the destination requires RTMP ingest. It's common, useful, and well known protocol for sending master-streams, if it satisfies your requirements then use it.
