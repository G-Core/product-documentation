...
Example:
```
<iframe width="560" height="315" src="https://player.gvideo.co/videos/2675_mvsPGvDVx0Hzbog" frameborder="0" allow="fullscreen; autoplay; encrypted-media" allowfullscreen></iframe>
```
