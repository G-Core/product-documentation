...
description: Detect explicit and partial nudity including faces and uncovered body parts in videos using soft nudity content moderation task with frame-level confidence s...
---
