...
ai-navigation: Configure soft nudity detection in Gcore Streaming AI to identify explicit and partial nudity including male and female faces and uncovered body parts in MP4 videos via the portal, with detection results including object type, frame number, and confidence probability threshold of 30%.
---
