...
<Steps>
  <Step title="Open AI tasks">
    ...
    <Frame><img src="/images/docs/streaming/ai-video-service/content-moderation/nsfw-detection/ai-tasks-page.png" width="70%" alt="AI tasks page" /></Frame>
  </Step>
  ...
  <Step title="Review the result">
    ...
    * If sensitive content is found, the result identifies the flagged frame and the confidence score — _"nsfw: detected at frame №2 with score 41%"._
    <Frame><img src="/images/docs/streaming/ai-video-service/content-moderation/nsfw-detection/nsfw-detection.png" width="70%" alt="NSFW detection task details" /></Frame>
  </Step>
</Steps>
</MethodSection>
