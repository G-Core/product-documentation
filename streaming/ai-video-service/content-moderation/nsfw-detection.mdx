...
description: Detect and flag inappropriate video content using NSFW detection task in Gcore Streaming AI with confidence scoring and frame-level analysis.
---
