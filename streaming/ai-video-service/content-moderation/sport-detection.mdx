...
For a full list of activities that can be detected with the sport detection check, read our [API documentation](/api-reference/streaming/ai/create-ai-task).
