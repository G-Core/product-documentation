...
description: Detect sporting activities, actions, and events in videos using content moderation API with confidence scores and frame-level identification.
---
