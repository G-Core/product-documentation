...
ai-navigation: Detect sporting activities, actions, and events in videos using content moderation API with confidence scores and frame-level identification.
ai-navigation: Detect sporting activities in video using Content Moderation task with frame number and confidence probability.
---
