...
ai-navigation: Generate AI captions and translate subtitles for VOD videos using Video Streaming API or AI API with transcription and multi-language translation parameters.
ai-navigation: Generate AI captions for VOD videos via transcription and multi-language translation using Video Streaming or Subtitles API.
---
