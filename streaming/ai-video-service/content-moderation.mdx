...
ai-navigation: Detect NSFW materials, hard nudity, soft nudity, and sport activities in video and image content using Gcore AI content moderation with real-time keyframe analysis and configurable probability thresholds for age-appropriate filtering.
---
