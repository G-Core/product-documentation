...
ai-navigation: Detect NSFW, nudity, and sports activities in video/image content using AI models with configurable probability thresholds for content filtering and personal
ai-navigation: Detect NSFW, nudity, and sports activities in video and image content using AI models analyzing keyframes for content moderation.
---
...
Content types we detect in videos and images: 
  ...
  * [Not safe for work (NSFW) materials](/streaming/ai-video-service/content-moderation/nsfw-detection)
