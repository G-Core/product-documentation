...
description: Detect explicit nudity involving genitals in videos using Gcore Streaming AI content moderation with confidence scoring and frame-level results.
---
