...
<Steps>
  <Step title="Open AI tasks">
    ...
    <Frame><img src="/images/docs/streaming/ai-video-service/ai-nudity-detection/ai-tasks-page.png" width="70%" alt="AI tasks page" /></Frame>
  </Step>
  ...
  <Step title="Review the result">
    ...
    * If explicit content is detected, the result identifies the detected element, the relevant frame, and the confidence score.
    <Frame><img src="/images/docs/streaming/ai-video-service/ai-nudity-detection/hard-nudity-detection.png" width="70%" alt="Hard nudity detection task details" /></Frame>
  </Step>
</Steps>
