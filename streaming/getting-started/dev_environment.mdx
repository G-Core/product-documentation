...
ai-navigation: Use one account, separate accounts, or custom plans to set up Streaming development and production environments for small, medium, and enterprise projects.
---
...
Use one account when the same team manages development and production assets. This model is appropriate when accidental access between environments is acceptable and keeps billing and operations in one place.
