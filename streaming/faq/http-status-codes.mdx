...
ai-navigation: Reference HTTP status codes (200, 403, 404, 422, 500, 502, 503, 504) returned by video streaming manifest and chunk requests, including CMAF X-Err-Code heade
ai-navigation: Diagnose video streaming HTTP status codes (200, 403, 404, 422, 500, 502, 503, 504) for manifests and chunks.
---
