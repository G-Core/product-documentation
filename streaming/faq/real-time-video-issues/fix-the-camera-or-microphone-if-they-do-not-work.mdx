...
<Frame>![Camera or Microphone switchers are disabled](/images/docs/streaming/faq/real-time-video-issues/fix-the-camera-or-microphone-if-they-do-not-work/13080497186449.png)</Frame>
...
<Frame>![Privacy and Security](/images/docs/streaming/faq/real-time-video-issues/fix-the-camera-or-microphone-if-they-do-not-work/13080561876625.png)</Frame>
...
<Frame>![Allowed to use your microphone](/images/docs/streaming/faq/real-time-video-issues/fix-the-camera-or-microphone-if-they-do-not-work/13080685472401.png)</Frame>
...
<Frame>![the icons on the left side of the browser's address bar](/images/docs/streaming/faq/real-time-video-issues/fix-the-camera-or-microphone-if-they-do-not-work/13080971968273.png)</Frame>
...
<Frame>![browser Settings](/images/docs/streaming/faq/real-time-video-issues/fix-the-camera-or-microphone-if-they-do-not-work/13081090317969.png)</Frame>
...
<Frame>![padlock icon in the browser's address bar ](/images/docs/streaming/faq/real-time-video-issues/fix-the-camera-or-microphone-if-they-do-not-work/13081119381265.png)</Frame>
...
<Frame>![Opera browser settings](/images/docs/streaming/faq/real-time-video-issues/fix-the-camera-or-microphone-if-they-do-not-work/13081222474513.png)</Frame>
...
<Frame>![Permissions section](/images/docs/streaming/faq/real-time-video-issues/fix-the-camera-or-microphone-if-they-do-not-work/13080991315601.png)</Frame>
...
<Frame>![Safari broswer settings](/images/docs/streaming/faq/real-time-video-issues/fix-the-camera-or-microphone-if-they-do-not-work/13081307372817.png)</Frame>
...
<Frame>![System Preferences iOS](/images/docs/streaming/faq/real-time-video-issues/fix-the-camera-or-microphone-if-they-do-not-work/13081820659857.png)</Frame>
...
<Frame>![Privacy iOS section](/images/docs/streaming/faq/real-time-video-issues/fix-the-camera-or-microphone-if-they-do-not-work/13081892456593.png)</Frame>
...
<Frame>![Sound section Windows](/images/docs/streaming/faq/real-time-video-issues/fix-the-camera-or-microphone-if-they-do-not-work/13081899519505.png)</Frame>
...
<Frame>![ Camera or Microphone Windows sections](/images/docs/streaming/faq/real-time-video-issues/fix-the-camera-or-microphone-if-they-do-not-work/13081924169617.png)</Frame>