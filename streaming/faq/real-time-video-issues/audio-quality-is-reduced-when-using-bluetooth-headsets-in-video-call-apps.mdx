...
ai-navigation: Bluetooth audio quality degrades in video calls because A2DP high-quality profile switches to low-quality HSP/HFP profile when microphone is needed.
ai-navigation: Diagnose Bluetooth audio quality reduction when switching from A2DP to HSP/HFP profile during video calls.
---
