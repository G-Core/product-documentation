...
description: Bluetooth audio quality degrades in video calls because A2DP high-quality profile switches to low-quality HSP/HFP profile when microphone is needed.
---
