...
ai-navigation: Troubleshoot Bluetooth audio quality degradation in video call applications caused by profile switching from A2DP (Advanced Audio Distribution Profile) to HSP/HFP (Headset Profile/Hands-Free Profile) when microphone input is required.
---
