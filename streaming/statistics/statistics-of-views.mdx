...
ai-navigation: Monitor video views and delivered minutes through Gcore Video Hosting Statistics tab in the Customer Portal, tracking unique viewers counted once per session and total CDN delivery minutes by time period filters.
---

Gcore Video Hosting provides you with statistics on the views of your videos and the delivery minutes through Gcore CDN. This information helps you monitor the popularity of your content and the efficiency of your video delivery.
...
To prevent this, adjust your player settings to optimize downloading to the buffer. For example, the [Gcore built-in player](/streaming/extra-features/customize-appearance-of-the-built-in-player) downloads only the first few video fragments.
</Info>
