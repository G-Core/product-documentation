...
To prevent this, adjust your player settings to optimize downloading to the buffer. For example, the [Gcore built-in player](/streaming/player/customize-appearance-of-the-built-in-player) downloads only the first few video fragments.
</Info>
