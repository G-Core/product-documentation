...
description: Access viewer analytics for VOD and live streams via Reports page with metrics on browsers, geography, OS, hosts, and unique viewers updated every five minutes.
---
