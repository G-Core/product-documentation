...
ai-navigation: Access viewer analytics for VOD and live streams via Reports page with metrics on browsers, geography, OS, hosts, and unique viewers updated every five minutes.
ai-navigation: View video and live stream statistics: viewers, browsers, OS, geography, hosts, popular videos via Reports page or resource Statistics tab.
---
