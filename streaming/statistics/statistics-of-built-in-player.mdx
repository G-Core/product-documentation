...
ai-navigation: Monitor Video Hosting player metrics including average view duration, viewer geography, browsers, operating systems, hosts, and viewer count via the Player metrics tab in Gcore Customer Portal with UTC or local timezone filtering and auto-refresh intervals.
---
