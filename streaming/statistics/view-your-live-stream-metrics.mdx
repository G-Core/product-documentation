...
description: Monitor live stream performance metrics including video bitrate, FPS, and key frame interval via Live Stream Monitoring dashboard in Gcore Customer Portal.
---
