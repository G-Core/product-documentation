...
ai-navigation: Monitor live stream performance metrics including video bitrate, FPS, and key frame interval via Live Stream Monitoring dashboard in Gcore Customer Portal.
ai-navigation: View live stream metrics: video bitrate, FPS, key frame interval by date and time range in Gcore Streaming portal.
---
