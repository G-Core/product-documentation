...
ai-navigation: Monitor live stream performance metrics including video bitrate, FPS, and key frame interval via Live Stream Monitoring in Gcore Streaming platform, with 1-minute resolution data stored for one year.
---
