...
ai-navigation: Configure Telegram bot integration with Gclaw AI assistant by creating a bot via BotFather, adding the bot token to OpenClaw configuration, and pairing Telegram accounts using pairing codes in the Gclaw chat interface.
...
<Frame>
<img src="/images/docs/gclaw/connect-telegram/connect-telegram-image1.png" alt="Gclaw confirming Telegram bot token has been added" />
</Frame>
