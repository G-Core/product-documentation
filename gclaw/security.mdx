...
ai-navigation: Security architecture, shared responsibility, and security considerations for Gclaw.
sidebarTitle: Security
ai-navigation: Configure OpenClaw agent security model with dedicated VM isolation, unique API keys per account, and shared responsibility for prompt safety and
---
