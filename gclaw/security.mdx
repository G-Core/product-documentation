...
ai-navigation: Configure OpenClaw account isolation with dedicated VMs, unique API keys per account, and network isolation from Gcore backend; manage shared security responsibilities including prompt safety, credential protection, third-party bot token security, and agent activity monitoring.
...
| Gcore infrastructure availability and updates | Yes | No |
...
Security hardening recommendations for OpenClaw installations are in the [OpenClaw security documentation](https://docs.openclaw.ai/).
