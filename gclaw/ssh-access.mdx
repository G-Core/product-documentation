...
ai-navigation: Obtain SSH access to a Gclaw dedicated VM by generating an SSH key pair, asking the Gclaw assistant to authorize the public key, and connecting as the ubuntu user via the VM IP address.
