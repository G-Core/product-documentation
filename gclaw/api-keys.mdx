...
ai-navigation: Add external API keys and configure integrations for Gclaw skills.
sidebarTitle: API keys
ai-navigation: Configure API keys for Gclaw OpenClaw skills: OpenAI, Spotify, Brave Search, GitHub, Notion via chat interface.
---
