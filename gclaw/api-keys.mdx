...
ai-navigation: Configure API keys for Gclaw OpenClaw skills including OpenAI, Spotify, Brave Search, GitHub, and Notion by providing credentials directly in the chat interface for secure storage in instance configuration.
...
<Frame>
<img src="/images/docs/gclaw/api-keys/api-keys-config.png" alt="Gclaw showing API key configuration options" />
</Frame>
...
<Frame>
<img src="/images/docs/gclaw/api-keys/skills-list.png" alt="Gclaw listing available skills by category" />
</Frame>
