...
ai-navigation: Configure Gclaw Discord integration by creating a Discord bot application in the Developer Portal, enabling Message Content Intent, copying the bot token, adding it to OpenClaw configuration, and authorizing the bot to Discord servers with Read Messages/View Channels, Send Messages, and Read Message History permissions.
...
<Frame>
<img src="/images/docs/gclaw/connect-discord/connect-discord-image1.png" alt="Gclaw providing Discord connection instructions" />
</Frame>
