...
ai-navigation: Create a Discord bot and connect it to a Gclaw instance.
sidebarTitle: Connect Discord
ai-navigation: Create Discord bot application, enable Message Content Intent, add bot token to Gclaw configuration, invite bot to Discord server.
---
