...
ai-navigation: Restart, back up, restore, and recreate a Gclaw instance.
sidebarTitle: Manage instance
ai-navigation: Backup and restore Gclaw instance configuration, workspace files, and API keys via Settings panel or JSON export.
---
