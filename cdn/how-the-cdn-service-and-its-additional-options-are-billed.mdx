...
Click the profile icon in the top-right of the page, select **Profile**, go to **Account** and select **Services**. Expand **CDN** and click **Change plan** to change to the plan you need.

<Frame>
  ![Cdn Plan](/images/docs/cdn/how-the-cdn-service-and-its-additional-options-are-billed/cdn-plan.png)
</Frame>
