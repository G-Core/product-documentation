...
ai-navigation: Calculate CDN service billing based on monthly traffic limits, overage charges, and request limits with per-unit pricing for exceeded thresholds.
ai-navigation: Understand CDN billing: monthly traffic limits, traffic overage charges, request overage rates, and plan renewal cycles.
---
...
<Frame>
  ![Change CDN plan](/images/docs/cdn/how-the-cdn-service-and-its-additional-options-are-billed/cdn-plan.png)
</Frame>
