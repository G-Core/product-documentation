...
ai-navigation: Configure CDN billing plans with monthly traffic limits, traffic overage charges, and request overage fees; traffic renews monthly and includes origin-to-CDN and CDN-to-end-user traffic.
---
...
Log in to your account, click the profile icon, select **Profile**, and go to **Billing**. Find the following sections:
...
<Frame>
  ![View your charges and payment history](/images/docs/cdn/how-the-cdn-service-and-its-additional-options-are-billed/how-the-cdn-service-and-its-additional-options-are-billed-image1.png)
</Frame>

## Change your billing plan

Click the profile icon in the top-right corner of the page, select **Profile**, go to **Account**, and select **Services**. Expand **CDN** and click **Change plan** to switch to the plan you need.

<Frame>
  ![Change CDN plan](/images/docs/cdn/how-the-cdn-service-and-its-additional-options-are-billed/how-the-cdn-service-and-its-additional-options-are-billed-image2.png)
</Frame>

A new plan will be activated only on the 1st day of a following month.

If you have any questions, please contact [Gcore Support](mailto:support@gcore.com). If you are interested in the **Enterprise** plan, please contact [Gcore Sales](https://gcore.com/contact-sales).