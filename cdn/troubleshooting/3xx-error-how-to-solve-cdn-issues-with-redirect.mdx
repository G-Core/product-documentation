...
ai-navigation: Resolve CDN 3xx redirect errors by configuring origin pull protocol, Host Header, and origin domain settings to match redirect behavior.
ai-navigation: Diagnose CDN 3xx redirects by configuring origin pull protocol, Host Header, and origin domain settings.
---
---
