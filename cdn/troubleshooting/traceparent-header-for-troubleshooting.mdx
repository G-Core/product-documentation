...
ai-navigation: Implement W3C traceparent HTTP header for distributed tracing across Gcore Edge Network with trace-id and parent-id fields in requests and raw logs.
ai-navigation: Enable traceparent HTTP header tracing via W3C Trace Context specification for request tracking and CDN troubleshooting.
---
