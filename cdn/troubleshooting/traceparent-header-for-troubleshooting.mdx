...
description: Implement W3C traceparent HTTP header for distributed tracing across Gcore Edge Network with trace-id and parent-id fields in requests and raw logs.
---
