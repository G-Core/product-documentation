...
ai-navigation: Diagnose and resolve CDN content delivery failures by verifying origin HTTP responses, validating CNAME DNS configuration, and checking Host Header settings.
ai-navigation: Diagnose CDN content unavailability by verifying origin HTTP 200 response, checking CNAME record configuration, and validating DNS setup status.
---
