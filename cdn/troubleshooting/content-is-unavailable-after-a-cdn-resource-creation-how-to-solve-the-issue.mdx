...
ai-navigation: Troubleshoot CDN resource content unavailability by verifying origin HTTP 200 response codes, checking CNAME record configuration in DNS settings, and validating Host Header options in CDN resource settings.
---
...
<Frame>![How to open setup CDN guide](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image1.png)</Frame>


2\. Click the **Check DNS setup status** button.


<Frame>![Check DNS setup status](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image2.png)</Frame>


If the CNAME record doesn't set up, this notification will appear:


<Frame>![DNS record hasn't been set up error](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image3.png)</Frame>
...
<Frame>![Host header option in the Gcore Customer Portal](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image4.png)</Frame>
...
<Frame>![The browser icon which shows that domain of the site is secured with the SSL](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image5.png)</Frame>
...
<Frame>![Not secure label](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image6.png)</Frame>
...
<Frame>![Check origin pull protocol](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image7.png)</Frame>
...
<Frame>![Check the SSL option](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image8.png)</Frame>
...
<Frame>![SSL configuration](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image9.png)</Frame>
...
<Frame>![Rules section](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image10.png)</Frame>
...
<Frame>![Certificate information in the browser](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image11.png)</Frame>
...
<Frame>![SSL server test via SSL labs](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image12.png)</Frame>
...
<Frame>![Rating A+ for SSL labs testing](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image13.png)</Frame>
...
<Frame>![SSL report for the domain with B grade](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image14.png)</Frame>



the chain of the SSL certificate is incomplete or added in the wrong way. Go to the [SSL certificates](https://portal.gcore.com/cdn/ssl/list) section in the Gcore Customer Portal. Delete the wrong certificate and add it again according to the [How to add a personal SSL certificate in the SSL certificates section](/cdn/ssl-certificates/add-an-ssl-certificate-to-deliver-content-over-https#add-an-ssl-certificate-to-deliver-content-over-https) guide. 
...
1\. Go to the [Dashboard](https://portal.gcore.com/accounts/reports/dashboard) section and click **Total traffic**.


<Frame>![Total traffic in the Gcore Dashboard](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image15.png)</Frame>
...
<Frame>![Cache hit ratio report in the Statistics section](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image16.png)</Frame>
...
<Frame>![CDN caching option](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image17.png)</Frame>
...
<Frame>![Set-Cookie and Query string options](/images/docs/cdn/troubleshooting/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue/content-is-unavailable-after-a-cdn-resource-creation-how-to-solve-the-issue-image18.png)</Frame>
...
If the problem persists after performing troubleshooting according to this guide, contact support via chat or email at [Gcore Support](mailto:support@gcore.com). You may have an atypical problem that requires assistance from technical specialists. We'll be happy to help!
