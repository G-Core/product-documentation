...
ai-navigation: Diagnose and resolve low CDN content delivery speed by comparing origin and CDN performance, checking cache hit ratio, enabling large file optimization, and
ai-navigation: Diagnose CDN content delivery speed issues via Cache Hit Ratio, Large files optimization, compression settings, and origin server comparison.
---
...
If you revised your CDN resource's settings but are still unsatisfied with the download speed, contact [technical support](mailto:support@gcore.com) and provide the following information:
  ...
  * File URL
  * Follow the link `https://gcore.com/.well-known/cdn-debug`, copy all information from the page or save a screenshot. 
