...
ai-navigation: Diagnose and resolve 4xx CDN errors by validating origin accessibility, allowlisting CDN edge IPs, configuring Origin Pull Protocol, and verifying Host Heade
ai-navigation: Diagnose CDN 4xx errors: verify origin HTTP 200 response, allowlist CDN edge IPs, check resource activation and Origin Pull Protocol settings.
---
...
To receive more details about users' requests to resources, use the Raw logs option. It is a paid feature The Raw log receiving setup flow and the description of logs' fields are located [here](/cdn/logs/raw-logs-export-cdn-resource-logs-to-your-storage). If you want to activate this feature, contact your account manager or send a request to [Gcore Support](mailto:support@gcore.com).
