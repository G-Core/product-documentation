...
ai-navigation: Troubleshoot SSL certificate attachment and Let's Encrypt issuance failures by verifying certificate chain formatting, checking CDN rules don't block /.well-known/acme-challenge/ path, and confirming CNAME record configuration in DNS.
---
...
<Frame>![Can't attach a personal certificate to a resource](/images/docs/cdn/troubleshooting/an-ssl-certificate-isn-t-working-how-to-solve-to-issue/an-ssl-certificate-isn-t-working-how-to-solve-to-issue-image1.png)</Frame>
...
<Frame>![Can't get Let's Encrypt certificate](/images/docs/cdn/troubleshooting/an-ssl-certificate-isn-t-working-how-to-solve-to-issue/an-ssl-certificate-isn-t-working-how-to-solve-to-issue-image2.png)</Frame>
