...
<Tabs>
  ...
  <Tab title="Purge by pattern">
    ...
    | **2. Purge the group of files from one folder**<br /><br />Use the `*` operator: `/statiс/*`                                                                                                                                                                                                                                                       | `cdn.site/static`           | `/statiс/*`         |
...
b. Enter the resource URL in the request URL field. Replace `{{resource}}` with the actual value.
