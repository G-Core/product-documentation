...
There are two ways to clear the cache: via API (use the [API documentation](/api-reference/cdn/tools/purge-cache) to get more information about the request) and in the [Gcore Customer Portal](https://portal.gcore.com/cdn/resources/list).
