...
<Frame>
  ![Purge section overview](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/purge-section-overview.png)
</Frame>
...
<Tabs>
  <Tab title="Purge by URL">
    ...
    <Frame>
      ![Purge by URL](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/14339546960145.png)
    </Frame>
  ...
  <Tab title="Purge all">
    ...
    <Frame>
      ![Purge all](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/14339549617041.png)
    </Frame>
  </Tab>
  <Tab title="Purge by pattern">
    ...
    <Frame>
      ![Purge by pattern](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/14339551969425.png)
    </Frame>
...
<Frame>
  ![New request tab in Postman](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/14339834314641.png)
</Frame>
...
<Frame>
  ![Authorization](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/14339852303249.png)
</Frame>
...
<Frame>
  ![Body tab](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/14339837932177.png)
</Frame>
...
<Frame>
  ![purge is successful](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/14339892700945.png)
</Frame>
...
<Frame>
  ![error occurs](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/14339878706961.png)
</Frame>
...
<Frame>
  ![Purge history section](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/purge-history.png)
</Frame>
...
<Frame>
  ![Purge history section explanation](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/purge-history-overview.png)
</Frame>