...
sidebarTitle: "Purge"
ai-navigation: Clear CDN resource cache by URL, pattern, or all using Gcore CDN Purge API or Customer Portal, with purge history tracking and rate limits of two requests per resource per minute.
---

[Purge](https://portal.gcore.com/cdn/purge/purge-request) is an option that allows clearing the CDN resource cache. Using Purge is helpful if you update the content on your origin and don't want to wait until the content is updated on CDN servers naturally because it takes time. After Purge is applied, the outdated CDN server's cache will disappear. Additionally, the option assists if your end-users receive incorrect content of your website data from CDN servers.
...
There are two ways to clear the cache: via API (use the [API documentation](/api-reference/cdn/tools/purge-cache) to get more information about the request) and in the [Gcore Customer Portal](https://portal.gcore.com/accounts/reports/dashboard).

## Configure purge in the Gcore Customer Portal

1. Go to the [Purge request](https://portal.gcore.com/cdn/purge/purge-request) section.
...
<Frame>
  ![Purge section overview](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/clear-cdn-resource-cache-by-url-pattern-or-all-image1.png)
</Frame>
...
<Tabs>
  <Tab title="Purge by URL">
    ...
    <Frame>
      ![Purge by URL](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/clear-cdn-resource-cache-by-url-pattern-or-all-image2.png)
    </Frame>
  ...
  <Tab title="Purge all">
    ...
    <Frame>
      ![Purge all](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/clear-cdn-resource-cache-by-url-pattern-or-all-image3.png)
    </Frame>
  </Tab>
  <Tab title="Purge by pattern">
    ...
    <Frame>
      ![Purge by pattern](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/clear-cdn-resource-cache-by-url-pattern-or-all-image4.png)
    </Frame>
...
We will explain in detail how to do Purge by URL via API calls. Examples of other Purge types (all and by pattern) can be found in the [API documentation](/api-reference/cdn/tools/purge-cache).
...
b. Enter the resource URL in the request URL field. Replace `{{resource}}` with your actual value.

<Frame>
  ![New request tab in Postman](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/clear-cdn-resource-cache-by-url-pattern-or-all-image5.png)
</Frame>
...
<Frame>
  ![Authorization](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/clear-cdn-resource-cache-by-url-pattern-or-all-image6.png)
</Frame>
...
<Frame>
  ![Body tab](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/clear-cdn-resource-cache-by-url-pattern-or-all-image7.png)
</Frame>
...
<Frame>
  ![purge is successful](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/clear-cdn-resource-cache-by-url-pattern-or-all-image8.png)
</Frame>
...
<Frame>
  ![error occurs](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/clear-cdn-resource-cache-by-url-pattern-or-all-image9.png)
</Frame>
...
To view the history, navigate to the [Purge history](https://portal.gcore.com/cdn/purge/purge-history) page. The page will display all existing requests.

<Frame>
  ![Purge history section](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/clear-cdn-resource-cache-by-url-pattern-or-all-image10.png)
</Frame>
...
<Frame>
  ![Purge history section explanation](/images/docs/cdn/clear-cdn-resource-cache-by-url-pattern-or-all/clear-cdn-resource-cache-by-url-pattern-or-all-image11.png)
</Frame>