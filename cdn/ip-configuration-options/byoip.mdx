...
When using Gcore CDN, requests normally reach shared Gcore anycast addresses. Bring Your Own IP (BYOIP) lets a CDN resource use customer-owned public IP prefixes instead, preserving their IP reputation, allowlists, and network identity.
