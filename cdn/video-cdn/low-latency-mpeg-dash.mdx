...
ai-navigation: Deliver ultra-low latency MPEG-DASH live streams with 2-4 second glass-to-glass latency using Gcore CDN
ai-navigation: Configure LL-DASH streaming with Chunked-Proxy on Gcore CDN for 2-4 second glass-to-glass latency using MPEG-DASH CMAF segments.
---
...
| **Chunked-Proxy activation** | **Required** - Contact [Gcore Support](mailto:support@gcore.com) |
