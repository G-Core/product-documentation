...
ai-navigation: Protect HLS and MPEG-DASH video delivery with CDN secure tokens and query string forwarding
ai-navigation: Enable Secure Token and Query String Forwarding in Video CDN to protect HLS and MPEG-DASH streams with temporary access tokens.
---
