...
ai-navigation: Enable Secure Token and Query String Forwarding in Video CDN to protect HLS and MPEG-DASH streams with temporary access tokens, forwarding token parameters from master manifests to nested manifests, segments, and subtitles via directory-path token rules.
---
...
<Frame>![Query string parameters are inserted into manifest body links automatically](/images/docs/cdn/video-cdn/improve-video-delivery-speed/cdn-token-forwarding-body.png)</Frame>
...
<Frame>![Query string parameters are forwarded from the master manifest to nested manifests and segments](/images/docs/cdn/video-cdn/improve-video-delivery-speed/cdn-token-forwarding-query.png)</Frame>
...
<Frame>![Protected MPEG-DASH stream opened in dash.js player](/images/docs/cdn/video-cdn/improve-video-delivery-speed/cdn-token-dashjs.png)</Frame>
