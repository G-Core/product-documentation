...
<Frame>![Expired secure token returns 410 for a video segment](/images/docs/cdn/video-cdn/secure-token-image1.png)</Frame>
...
<Frame>![Query string parameters are inserted into manifest body links automatically](/images/docs/cdn/video-cdn/secure-token-image2.png)</Frame>
...
<Frame>![Query string parameters are forwarded from the master manifest to nested manifests and segments](/images/docs/cdn/video-cdn/secure-token-image3.png)</Frame>
...
<Frame>![Protected MPEG-DASH stream opened in dash.js player](/images/docs/cdn/video-cdn/secure-token-image4.png)</Frame>
