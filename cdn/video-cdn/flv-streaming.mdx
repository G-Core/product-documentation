...
ai-navigation: "Technical guide for implementing FLV Live streaming and VOD delivery on Gcore CDN with configuration, authentication, failover, and observability"
ai-navigation: Deploy HTTP-FLV Live streaming with ultra-low latency and high concurrency via Gcore CDN; requires sales agreement and origin FLV stream with
---
...
![FLV via CDN](/images/docs/cdn/video-cdn/flv-cdn.png)
...
![flv-player-demo](/images/docs/cdn/video-cdn/flv-demo.png)
...
- **[Live Streaming Overview](/cdn/video-cdn/hls-streaming)**: HLS live streaming setup
