...
sidebarTitle: "Zero-delay FLV Live & VOD"
ai-navigation: Deploy HTTP-FLV Live streaming with ultra-low latency (1-3 seconds) and high concurrency (100K+ simultaneous viewers) using Gcore CDN's dedicated FLV Live profile; configure origin to deliver FLV container with proper headers, monotonic PTS/DTS timestamps, H.264/H.265/AAC codecs, and HTTP 200 responses cached via sliding window RAM buffer.
---
...
![FLV via CDN](/images/docs/cdn/video-cdn/improve-video-delivery-speed/flv-cdn.png)
...
1. **Secure Token:**
   ...
   - More information in [About Secure Token](/cdn/cdn-resource-options/security/use-a-secure-token/about-secure-token)

2. **Referer-based Access Control**
3. **User-Agent Filtering**
4. **Geo Filtering**

Get more information in [About Security](/cdn/cdn-resource-options/security/control-access-to-the-content-with-country-referrer-ip-and-user-agents-policies)
...
Standard CDN resource creation process: /cdn/about-cdn-resources-interface-how-it-is-arranged 
...
3. Full instructions: [Optimize large file delivery](/cdn/cdn-resource-options/optimize-large-file-delivery)
...
Full instructions: [Load content to the CDN before users request it](/cdn/load-the-content-to-cdn-before-users-request-it)
...
![flv-player-demo](/images/docs/cdn/video-cdn/improve-video-delivery-speed/flv-demo.png)
...
- **[CDN Resource Configuration](/cdn/getting-started/create-a-cdn-resource/overview)**: General CDN setup guide
...
- **[HLS and LL-HLS](/cdn/video-cdn/hls)**: HLS live streaming setup
