...
## Getting Started with Video CDN

<Steps>
  <Step title="Choose your format">
    Determine which streaming format you're using:
    - [HLS Streaming](/cdn/video-cdn/hls-streaming) - Most common format
    - [FLV Streaming](/cdn/video-cdn/flv-streaming) - Ultra-low latency option
  </Step>

  <Step title="Request activation">
    Contact [support@gcore.com](mailto:support@gcore.com) to activate video streaming for your CDN account. Provide:
