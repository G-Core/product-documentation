...
description: Configure CDN Secure Token auto-refresh with 60-second expiry and query string parameters or path-based tokens to prevent URL sharing during live streams and...
---
