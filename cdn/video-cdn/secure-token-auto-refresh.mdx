...
ai-navigation: Configure CDN Secure Token auto-refresh with 60-second expiration and query string parameters or path-based tokens to prevent link sharing during live streams and pay-per-view events, supporting plain or IP-bound token validation modes.
---
...
![Secure token protection](/images/docs/cdn/video-cdn/improve-video-delivery-speed/cdn-token-410.png)
...
![Token auto-refresh demo app](/images/docs/streaming-platform/interaction-with-cdn/token-auto-refresh/cdn-token-demo.png)
