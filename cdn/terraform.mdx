---
title: Terraform
ai-navigation: Manage Gcore CDN resources, SSL certificates, and rules using Terraform declarative configuration files and API integration.
ai-navigation: Deploy CDN resources, SSL certificates, and rules using Terraform configuration files and Gcore provider.
---
