...
ai-navigation: Install Terraform and configure the Gcore provider version 0.3.44 with API token authentication to manage CDN resources via terraform init and main.tf configuration.
---
