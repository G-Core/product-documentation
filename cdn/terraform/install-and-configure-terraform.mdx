...
ai-navigation: Install Terraform, configure Gcore provider with API token, and initialize Terraform modules for CDN resource management.
ai-navigation: Install Terraform provider for Gcore CDN and configure main.tf with API token for resource management.
---
