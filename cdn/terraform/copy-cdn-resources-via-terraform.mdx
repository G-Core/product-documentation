...
ai-navigation: Duplicate CDN resources across environments using Terraform variables, workspaces, and .tfvars files with API token authentication.
ai-navigation: Copy CDN resources across environments using Terraform variables, workspaces, and API tokens.
---
...
To proceed with the following steps, you need to have [API keys](/account-settings/api-tokens#create-a-permanent-api-token) configured.
</Tip>
