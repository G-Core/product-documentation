...
<Note>
Provider v2 is currently in alpha (`2.0.0-alpha`). Breaking changes may occur between releases. For production workloads, use the [v0 provider](/cdn/terraform/manage-cdn-via-terraform) until v2 reaches general availability.
</Note>
