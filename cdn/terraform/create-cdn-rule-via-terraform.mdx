...
ai-navigation: Create CDN rules via Terraform using gcore_cdn_rule resource with path patterns, rule names, and options like WebP Compression configured in main.tf and applied with terraform plan and terraform apply commands.
---
