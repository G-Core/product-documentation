...
ai-navigation: Add CDN rules to Terraform-managed resources using gcore_cdn_resource with rule blocks, path patterns, and optional compression settings.
ai-navigation: Create CDN rule via Terraform using gcore_cdn_rule resource with path patterns, options, and resource references.
---
