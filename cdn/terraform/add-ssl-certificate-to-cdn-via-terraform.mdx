...
ai-navigation: Configure SSL certificate for CDN resource in Terraform using main.tf with certificate name, public key, and private key parameters.
ai-navigation: Add SSL certificate to CDN resource via Terraform using ssl_certificate block with public and private keys in main.tf.
---
