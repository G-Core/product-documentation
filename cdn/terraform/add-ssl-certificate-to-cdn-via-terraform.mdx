...
ai-navigation: Add SSL certificates to Gcore CDN resources via Terraform by configuring certificate name, public key, and private key in main.tf, then execute terraform plan and terraform apply commands.
---
