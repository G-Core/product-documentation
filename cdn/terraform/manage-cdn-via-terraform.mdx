...
<Note>
Origin shielding requires a separate subscription. Contact [Gcore support](https://support.gcore.com/hc/en-us/requests/new) to enable it. Applying `gcore_cdn_originshielding` without the subscription returns a `403` error.
</Note>
