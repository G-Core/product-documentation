...
ai-navigation: Configure Gcore CDN resources using Terraform provider with origin groups, active/backup origins, and upstream failover options via main.tf.
ai-navigation: Create CDN origin groups with Terraform using gcore_cdn_resource with active/backup origins and use_next_upstream option.
---
