...
ai-navigation: Create and manage CDN resources including origin groups with Terraform using gcore provider, configuring active and backup origins, upstream failover behavior, and resource options via main.tf and terraform plan/apply commands.
---
