...
**First-time setup — required order:**
...
<Steps>
  ...
  <Step title="Create a target">
    Go to the **Targets** tab and click **Add target**. Select the destination type (S3, SFTP, or HTTP(S)) and enter the connection details. A green `Authentication complete` status confirms the target is reachable.
  </Step>
...
<AccordionGroup>
  <Accordion title="Log format example">
    The format below is a template showing all available fields. The actual log output depends on which fields are selected, their order, and the delimiter and separator configured in the policy.
...
| `$timestamp`<br />(Internal variable)  | `-`                                                                                                                                               | Internal variable; always produces an empty value                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `$ip`<br />(Internal variable)         | `-`                                                                                                                                               | Internal variable; always produces an empty value                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `$country`<br />(Internal variable)    | `-`                                                                                                                                               | Internal variable; always produces an empty value                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `$media_type`<br />(Internal variable) | `-`                                                                                                                                               | Internal variable; always produces an empty value                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `$size`<br />(Internal variable)       | `-`                                                                                                                                               | Internal variable; always produces an empty value                                                                                                                                                                                                                                                                                                                                                                                                       |
| `$duration`<br />(Internal variable)   | `-`                                                                                                                                               | Internal variable; always produces an empty value                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `$session_id`<br />(Internal variable) | `-`                                                                                                                                               | Internal variable; always produces an empty value                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `$domain`<br />(Internal variable)     | `-`                                                                                                                                               | Internal variable; always produces an empty value                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `$name`<br />(Internal variable)       | `-`                                                                                                                                               | Internal variable; always produces an empty value                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `$edge`<br />(Internal variable)       | `-`                                                                                                                                               | Internal variable; always produces an empty value                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `$code`<br />(Internal variable)       | `-`                                                                                                                                               | Internal variable; always produces an empty value                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `$region`<br />(Internal variable)     | `-`                                                                                                                                               | Internal variable; always produces an empty value                                                                                                                                                                                                                                                                                                                                                                                                                                               |
