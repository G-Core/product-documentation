---
title: "Logs uploader"
ai-navigation: Export CDN resource logs to Object Storage, S3, FTP, SFTP, or HTTP endpoints; configure policies, targets, and delivery schedules via Logs uploader.
ai-navigation: Configure CDN Logs uploader to export request and cache data to Object Storage, S3, FTP, SFTP, or HTTP endpoints with custom field selection and
---
