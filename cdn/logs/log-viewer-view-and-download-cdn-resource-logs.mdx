...
ai-navigation: View and download CDN resource logs using Log viewer with filters for time interval, client IP, HTTP method, status code, data center, and cache status; export up to 10,000 log entries per 24-hour period.
---
...
<Frame>![Log viewer](/images/docs/cdn/logs/log-viewer-view-and-download-cdn-resource-logs/log-viewer-view-and-download-cdn-resource-logs-image1.png)</Frame>
...
<Frame>![logs in the Gcore Customer Portal](/images/docs/cdn/logs/log-viewer-view-and-download-cdn-resource-logs/log-viewer-view-and-download-cdn-resource-logs-image2.png)</Frame>



You can customize a log report:

  * To see logs of a specific CDN resource, enter its [CNAME](/cdn/cdn-resource-options/general/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn) or ID.
...
<Frame>![customize a log report](/images/docs/cdn/logs/log-viewer-view-and-download-cdn-resource-logs/log-viewer-view-and-download-cdn-resource-logs-image3.png)</Frame>
...
<Frame>![more details about a log](/images/docs/cdn/logs/log-viewer-view-and-download-cdn-resource-logs/log-viewer-view-and-download-cdn-resource-logs-image4.png)</Frame>
...
Logs are exported based on the filters that you have applied. 
To download logs to your PC:
...
<Frame>![Export](/images/docs/cdn/logs/log-viewer-view-and-download-cdn-resource-logs/log-viewer-view-and-download-cdn-resource-logs-image5.png)</Frame>



## Manage Log viewer via the API

You can also view and download logs via the API using requests from our [API documentation](/api-reference/cdn/log-viewer/get-cdn-logs). Below we explain how to create a request.
...
1\. In a tool for working with an API, add an authorization header. Choose one of the two headers below, copy it, replace the expression in brackets with your data and remove the brackets.
  ...
  * Authorization: Bearer (your [standard authorization token](https://api.gcore.com/docs/iam#tag/Account/paths/~1auth~1jwt~1login/post) that is valid for 1 hour; its lifetime can be extended up to 24 hours).
  * Authorization: APIKey (your [permanent authorization token](/account-settings/api-tokens) generated in your personal account; it never expires).
