...
<Frame>![Log Viewer](/images/docs/cdn/logs/log-viewer-view-and-download-cdn-resource-logs/image_1330-2.png)</Frame>
...
<Frame>![logs in the Gcore Customer Portal](/images/docs/cdn/logs/log-viewer-view-and-download-cdn-resource-logs/image_1331.png)</Frame>
...
<Frame>![customize a log report](/images/docs/cdn/logs/log-viewer-view-and-download-cdn-resource-logs/image_1332.png)</Frame>
...
<Frame>![more details about a log](/images/docs/cdn/logs/log-viewer-view-and-download-cdn-resource-logs/image_1333-2.png)</Frame>
...
1\. Click the "Export" button on the right side of the page. 2\. Select the time range of logs you want to download: you can keep the current period (selected in filters when viewing), or set a new value. 3\. Choose the export format: CSV or TSV. 4\. Click **Export**.

The file will be downloaded to your browser download location.


<Frame>![Export](/images/docs/cdn/logs/log-viewer-view-and-download-cdn-resource-logs/image_1334.png)</Frame>



## Manage Log Viewer via the API

You can also view and download logs via the API using requests from our [API documentation](https://api.gcore.com/docs/cdn#tag/CDN-Logs). Below we explain how to create a request.
...
1\. In a tool for working with an API, add an authorization header. Choose one of the two headers below, copy it, replace the expression in brackets with your data and remove the brackets.
  ...
  * Authorization: APIKey **(your** [permanent authorization token](/account-settings/create-use-or-delete-a-permanent-api-token) **generated in your personal account; it never expires)**
...
3\. We add the "Authorization" header and its value. We want to log in with a [permanent token](/account-settings/create-use-or-delete-a-permanent-api-token), so we specify our token "APIKey 7711$eyJ0eXAiOiJKV".
