...
<Frame>![Raw Logs page in the Customer Portal](/images/docs/cdn/logs/raw-logs-export-cdn-resource-logs-to-your-storage/raw-logs-page.png)</Frame>
...
<Steps>
  ...
  <Step title="Save the change">
    ...
    <Frame>![Raw Logs page with Receive Raw Logs turned off](/images/docs/cdn/logs/raw-logs-export-cdn-resource-logs-to-your-storage/raw-logs-page.png)</Frame>
  </Step>
</Steps>
