...
description: Export CDN resource logs hourly to S3, FTP, or SFTP storage with Raw Logs feature; includes Origin Shielding logs and status tracking (Pending, OK, Failed, P...
---
