...
ai-navigation: Export CDN resource logs hourly to S3, FTP, or SFTP storage with Raw Logs feature; includes Origin Shielding logs and status tracking (Pending, OK, Failed, P
ai-navigation: Enable Raw Logs to export CDN resource logs to S3, FTP, or SFTP storage with Origin Shielding option.
---
