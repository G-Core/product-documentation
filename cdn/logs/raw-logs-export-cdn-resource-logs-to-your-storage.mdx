  ...
  <Tab title="Amazon S3">
    <Steps>
      ...
      <Step title="Select Amazon S3">
        ...
        <Frame>![Amazon S3 export form in Raw Logs settings](/images/docs/cdn/logs/raw-logs-export-cdn-resource-logs-to-your-storage/amazon-s3-form.png)</Frame>
      </Step>
  ...
  <Tab title="Other S3-compatible storage">
    <Steps>
      ...
      <Step title="Select other S3 storage">
        ...
        <Frame>![Other S3 export form in Raw Logs settings](/images/docs/cdn/logs/raw-logs-export-cdn-resource-logs-to-your-storage/other-s3-form.png)</Frame>
      </Step>
  ...
  <Tab title="SFTP">
    <Steps>
      ...
      <Step title="Select SFTP">
        ...
        <Frame>![SFTP export form in Raw Logs settings](/images/docs/cdn/logs/raw-logs-export-cdn-resource-logs-to-your-storage/sftp-form.png)</Frame>
      </Step>
  ...
  <Tab title="FTP">
    ...
    <Steps>
      ...
      <Step title="Select FTP">
        ...
        <Frame>![FTP export form in Raw Logs settings](/images/docs/cdn/logs/raw-logs-export-cdn-resource-logs-to-your-storage/ftp-form.png)</Frame>
      </Step>
      <Step title="Enter the hostname and port">
