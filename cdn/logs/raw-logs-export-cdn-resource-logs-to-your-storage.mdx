...
<Frame>![Raw Logs page in the Customer Portal](/images/docs/cdn/logs/raw-logs-export-cdn-resource-logs-to-your-storage/raw-logs-page-off.png)</Frame>
...
<Frame>![Add logs from Origin Shielding checkbox](/images/docs/cdn/logs/raw-logs-export-cdn-resource-logs-to-your-storage/origin-shielding-logs.png)</Frame>
  ...
  <Tab title="Amazon S3">
    <Steps>
      <Step title="Open Raw Logs">
        In the [Gcore Customer Portal](https://portal.gcore.com), navigate to **CDN** > **Logs** > **Raw Logs**.
      </Step>
      ...
      <Step title="Select Amazon S3">
        ...
        <Frame>![Amazon S3 selected in Raw Logs settings](/images/docs/cdn/logs/raw-logs-export-cdn-resource-logs-to-your-storage/amazon-s3-export-1.png)</Frame>
      </Step>
      ...
      <Step title="Set region and buckets">
        ...
        <Frame>![Amazon S3 bucket and folder fields](/images/docs/cdn/logs/raw-logs-export-cdn-resource-logs-to-your-storage/amazon-s3-export-2.png)</Frame>
      </Step>
  ...
  <Tab title="Other S3-compatible storage">
    <Steps>
      ...
      <Step title="Select other S3 storage">
        Under **Receive logs using**, select **S3**. Under **Choose S3 storage**, select **Other**.

        <Frame>![Other S3 selected in Raw Logs settings](/images/docs/cdn/logs/raw-logs-export-cdn-resource-logs-to-your-storage/other-s3-export-1.png)</Frame>
      </Step>
      ...
      <Step title="Set buckets">
        ...
        <Frame>![Other S3 bucket and folder fields](/images/docs/cdn/logs/raw-logs-export-cdn-resource-logs-to-your-storage/other-s3-export-2.png)</Frame>
      </Step>
      <Step title="Save the configuration">
        Click **Save changes**.
      </Step>
  ...
  <Tab title="SFTP">
    <Steps>
      ...
      <Step title="Select SFTP">
        ...
        <Frame>![SFTP selected in Raw Logs settings](/images/docs/cdn/logs/raw-logs-export-cdn-resource-logs-to-your-storage/sftp-export-1.png)</Frame>
      </Step>
      ...
      <Step title="Enter credentials">
        Enter the **Login** and **Password**. For Gcore SFTP Storage, the login is **Storage/User name** in [Details](/storage/create-an-s3-or-sftp-storage#sftp).
      </Step>
      ...
      <Step title="Organize folders">
        ...
        <Frame>![SFTP folder organization in Raw Logs settings](/images/docs/cdn/logs/raw-logs-export-cdn-resource-logs-to-your-storage/sftp-export-2.png)</Frame>
      </Step>
      <Step title="Save the configuration">
        Click **Save changes**.
      </Step>
  ...
  <Tab title="FTP">
    ...
    <Steps>
      ...
      <Step title="Select FTP">
        Under **Receive logs using**, select **FTP**.

        <Frame>![FTP selected in Raw Logs settings](/images/docs/cdn/logs/raw-logs-export-cdn-resource-logs-to-your-storage/ftp-export.png)</Frame>
      </Step>
      <Step title="Enter the hostname and port">
      ...
      <Step title="Enter the destination folder">
        Optionally enter a **Prepend folder**. Then enter the **Folder**, or leave it empty if the FTP account starts in that folder.
      </Step>
      <Step title="Organize folders">
        Choose one folder for all CDN resources or a separate folder per resource. A missing folder name sends files to the root folder.
      </Step>
...
<Steps>
  <Step title="Turn off the export">
    In the [Gcore Customer Portal](https://portal.gcore.com), navigate to **CDN** > **Logs** > **Raw Logs** and turn off **Receive Raw Logs**.
  </Step>
  <Step title="Save the change">
    ...
    <Frame>![Raw Logs page with Receive Raw Logs turned off](/images/docs/cdn/logs/raw-logs-export-cdn-resource-logs-to-your-storage/raw-logs-page-off.png)</Frame>
  </Step>
</Steps>
