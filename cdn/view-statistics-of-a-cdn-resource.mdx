...
ai-navigation: Access CDN resource statistics including traffic, bandwidth, response codes, cache hit ratio, and advanced analytics with filtering by countries, directories
ai-navigation: View CDN resource statistics: traffic, bandwidth, response codes, cache hit ratio, requests, regional/country distribution, image optimization
---
