...
description: Configure X-Forwarded-Proto header on CDN servers to identify client protocol (HTTP/HTTPS) for conditional redirects and content delivery logic.
---
