...
ai-navigation: Configure X-Forwarded-Proto header on CDN servers to identify client protocol (HTTP/HTTPS) for conditional redirects and content delivery logic.
ai-navigation: Configure X-Forwarded-Proto header in CDN to identify client protocol (HTTP/HTTPS) for redirects and content delivery logic.
---
