...
ai-navigation: Configure the Host header in Gcore CDN resources using Custom Host header or Forward Host header options in HTTP headers settings to specify origin domain/IP address, and verify header values with curl or diagnostic tools to prevent 4xx/5xx errors.
---
...
<Frame>![What is the Host header](/images/docs/cdn/cdn-resource-options/http-headers/configure-and-check-the-host-header/configure-and-check-the-host-header-image1.png)</Frame>
...
<Frame>![Change Host heade](/images/docs/cdn/cdn-resource-options/http-headers/configure-and-check-the-host-header/configure-and-check-the-host-header-image2.png)</Frame>
...
<Frame>![Resource settings in the control panel](/images/docs/cdn/cdn-resource-options/http-headers/configure-and-check-the-host-header/configure-and-check-the-host-header-image3.png)</Frame>
...
If you are [using a default CDN resource (*.gvideo.io) for streaming](/streaming/how-the-streaming-platform-interact-with-the-cdn), the Host header will take the value of the CNAME of the CDN resource. This is the value that the option will take as soon as it is disabled.


<Frame>![How to disable the Change Host header option](/images/docs/cdn/cdn-resource-options/http-headers/configure-and-check-the-host-header/configure-and-check-the-host-header-image4.png)</Frame>
