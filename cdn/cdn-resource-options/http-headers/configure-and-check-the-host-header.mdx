...
If you are [using a default CDN resource (*.gvideo.io) for streaming](/streaming/interaction-with-cdn/get-started-streaming-cdn), the Host header will take the value of the CNAME of the CDN resource. This is the value that the option will take as soon as it is disabled.
