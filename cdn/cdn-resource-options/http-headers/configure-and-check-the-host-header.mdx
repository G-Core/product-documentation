...
ai-navigation: Configure and check the Host header in CDN resources using Custom Host header or Forward Host header options to ensure correct origin requests.
ai-navigation: Configure CDN resource Host header to custom domain or forward origin Host header value in HTTP headers settings.
---
