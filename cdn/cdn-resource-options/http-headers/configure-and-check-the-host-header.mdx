...
description: Configure and check the Host header in CDN resources using Custom Host header or Forward Host header options to ensure correct origin requests.
---
