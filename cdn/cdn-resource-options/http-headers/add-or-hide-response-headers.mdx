...
ai-navigation: Configure custom HTTP response headers in CDN resource settings with header name, value, status code filtering, and support for multiple values per header.
ai-navigation: Add custom HTTP response headers to CDN resource with header name, value, status codes, and up to 50 headers per resource.
---
