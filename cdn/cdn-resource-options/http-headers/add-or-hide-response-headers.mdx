...
description: Configure custom HTTP response headers in CDN resource settings with header name, value, status code filtering, and support for multiple values per header.
---
