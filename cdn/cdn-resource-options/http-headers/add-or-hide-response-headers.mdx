...
<Frame>![Go to the CDN resource settings](/images/docs/cdn/cdn-resource-options/http-headers/add-or-hide-response-headers/add-or-hide-response-headers-image1.png)</Frame>
...
<Frame>![Add multiple header values](/images/docs/cdn/cdn-resource-options/http-headers/add-or-hide-response-headers/add-or-hide-response-headers-image2.png)</Frame>
...
<Frame>![header values ](/images/docs/cdn/cdn-resource-options/http-headers/add-or-hide-response-headers/add-or-hide-response-headers-image3.png)</Frame>
...
<Frame>![header values ](/images/docs/cdn/cdn-resource-options/http-headers/add-or-hide-response-headers/add-or-hide-response-headers-image4.png)</Frame>
...
<Frame>![Hide response headers option ](/images/docs/cdn/cdn-resource-options/http-headers/add-or-hide-response-headers/add-or-hide-response-headers-image5.png)</Frame>
...
<Frame>![Hide all except](/images/docs/cdn/cdn-resource-options/http-headers/add-or-hide-response-headers/add-or-hide-response-headers-image6.png)</Frame>
...
<Frame>![Hide only](/images/docs/cdn/cdn-resource-options/http-headers/add-or-hide-response-headers/add-or-hide-response-headers-image7.png)</Frame>
