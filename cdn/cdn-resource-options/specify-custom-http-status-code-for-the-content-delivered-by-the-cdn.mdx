...
ai-navigation: Configure custom HTTP status codes for CDN resources via Resource settings or Rules, with optional scheduling and redirect URLs.
ai-navigation: Configure HTTP status codes for CDN resources via Resource settings or Rules with optional schedule and redirect URL.
---
