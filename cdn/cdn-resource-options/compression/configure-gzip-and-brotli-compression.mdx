...
ai-navigation: Enable Gzip and Brotli edge compression on Gcore CDN with configurable MIME types; requires Origin Shielding for Brotli and Accept-Encoding header support.
ai-navigation: Enable Gzip and Brotli edge compression for CDN resources by MIME type; requires Origin Shielding for Brotli.
---
