...
description: Enable Gzip and Brotli edge compression on Gcore CDN with configurable MIME types; requires Origin Shielding for Brotli and Accept-Encoding header support.
---
