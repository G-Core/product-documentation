...
sidebarTitle: Fetch
description: Enable Fetch compressed option in CDN resource Content settings to pull pre-compressed content from origin servers supporting GZip compression.
---
