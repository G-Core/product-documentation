...
sidebarTitle: Fetch
ai-navigation: Enable Fetch compressed in CDN resource Content settings to pull already-compressed content from origin servers supporting GZip compression, reducing bandwidth and delivery time between origin and CDN edge servers.
---
...
<Frame>![Fetch compressed](/images/docs/cdn/cdn-resource-options/compression/configure-fetch-compression/configure-fetch-compression-image1.png)</Frame>
