...
sidebarTitle: Fetch
ai-navigation: Enable Fetch compressed option in CDN resource Content settings to pull pre-compressed content from origin servers supporting GZip compression.
ai-navigation: Enable Fetch compressed option in CDN resource Content settings to pull pre-compressed content from origin supporting GZip.
---
...
<Frame>![Fetch compressed](/images/docs/cdn/cdn-resource-options/compression/configure-fetch-compression/fetch_compressed.png)</Frame>
...
## Option features
  ...
  * The Fetch compressed option and [GZip Compression](/cdn/cdn-resource-options/compression/configure-gzip-and-brotli-compression#gzip) exclude each other and don't work together.
