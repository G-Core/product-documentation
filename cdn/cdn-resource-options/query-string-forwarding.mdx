...
description: Forward query string parameters from HLS/MPEG-DASH master manifests to nested rendition manifests and segments via CDN resource configuration or API.
---
