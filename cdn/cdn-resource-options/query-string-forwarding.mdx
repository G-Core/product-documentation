...
<Frame>![Example of query string forwarding settings](/images/docs/cdn/cdn-resource-options/query-string-forwarding/query-string-forwarding-image1.png)</Frame>
...
<Frame>![Query string parameters are inserted into manifest body links automatically](/images/docs/cdn/video-cdn/query-string-forwarding-image2.png)</Frame>
...
<Frame>![Query string parameters are forwarded from the master manifest to nested manifests and segments](/images/docs/cdn/video-cdn/query-string-forwarding-image3.png)</Frame>
...
<Frame>
  <img src="/images/docs/cdn/cdn-resource-options/query-string-forwarding/query-string-forwarding-image4.png" alt="CDN Query String Forwarding settings" style={{ maxHeight: '300px' }} />
</Frame>
