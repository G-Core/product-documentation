...
<Frame><img src="/images/docs/cdn/cdn-resource-options/network-limits-set-the-content-delivery-speed-to-end-users/network-limits-image2.png" alt="Download speed limit option in the Network limits sidebar section" width="70%"/></Frame>



3\. Enable the **Download speed limit** toggle.

<Frame><img src="/images/docs/cdn/cdn-resource-options/network-limits-set-the-content-delivery-speed-to-end-users/network-limits-image3.png" alt="Download speed limit toggle enabled with Static and Dynamic mode selector" width="70%"/></Frame>
