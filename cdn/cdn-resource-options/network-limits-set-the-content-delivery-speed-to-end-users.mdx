...
ai-navigation: Configure CDN Download Speed Limit with Static mode (Connection Speed, Limit After parameters) or Dynamic mode (speed, buffer query arguments) to throttle co
ai-navigation: Configure CDN Download Speed Limit in Static or Dynamic mode with Connection Speed (KB/s) and Limit After parameters.
---
