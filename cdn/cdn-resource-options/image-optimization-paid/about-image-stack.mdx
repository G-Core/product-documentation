...
ai-navigation: Configure Image Stack to optimize JPG and PNG images on the fly using quality adjustment, WebP/AVIF compression, resize, and crop operations; optimized versions cache on CDN while original images remain unchanged and X-Img-Operations headers track transformations.
---
...
<Frame>![Image Stack](/images/docs/cdn/cdn-resource-options/image-optimization-paid/about-image-stack/about-image-stack-image1.png)</Frame>
...
<Tabs>
  <Tab title="Original image">
    <Frame>![original.jpg](/images/docs/cdn/cdn-resource-options/image-optimization-paid/about-image-stack/about-image-stack-image2.png)</Frame>
  ...
  <Tab title="Compression">
    <Frame>![compression.jpg](/images/docs/cdn/cdn-resource-options/image-optimization-paid/about-image-stack/about-image-stack-image3.png)</Frame>
  ...
  <Tab title="Quality">
    <Frame>![quality.jpg](/images/docs/cdn/cdn-resource-options/image-optimization-paid/about-image-stack/about-image-stack-image4.png)</Frame>
  ...
  <Tab title="Resize">
    <Frame>![resize.jpg](/images/docs/cdn/cdn-resource-options/image-optimization-paid/about-image-stack/about-image-stack-image5.png)</Frame>


    - W×H: 333×500 px
  </Tab>
  <Tab title="Crop">
    <Frame>![crop.jpg](/images/docs/cdn/cdn-resource-options/image-optimization-paid/about-image-stack/about-image-stack-image6.png)</Frame>
...
<Frame>![How Image Stack works](/images/docs/cdn/cdn-resource-options/image-optimization-paid/about-image-stack/about-image-stack-image7.png)</Frame>
...
<Frame>![Img-Skip-Reason HTTP header](/images/docs/cdn/cdn-resource-options/image-optimization-paid/about-image-stack/about-image-stack-image8.png)</Frame>
