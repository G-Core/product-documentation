...
description: Optimize JPG and PNG images on-the-fly using Image Stack with quality adjustment, WebP/AVIF compression, resize, and crop operations cached in CDN.
---
