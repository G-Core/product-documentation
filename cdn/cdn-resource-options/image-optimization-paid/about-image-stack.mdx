...
ai-navigation: Optimize JPG and PNG images on-the-fly using Image Stack with quality adjustment, WebP/AVIF compression, resize, and crop operations cached in CDN.
ai-navigation: Configure Image Stack to optimize JPG and PNG images via quality, compression to WebP/AVIF, resize, and crop.
---
