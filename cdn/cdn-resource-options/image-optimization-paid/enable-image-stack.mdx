...
More information can be found in the [?onfigure image compression to WebP and AVIF](/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/configure-image-compression-to-webp-and-avif) guide.
