...
title: Crop images
sidebarTitle: Crop
ai-navigation: Configure CDN image cropping with query string parameters to automatically crop JPG/PNG images before delivery using aspect ratio, dimensions, or gravity set
ai-navigation: Configure CDN image crop with query parameters: aspect ratio, width/height, or gravity positioning.
---
