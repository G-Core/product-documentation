...
title: Crop images
sidebarTitle: Crop
description: Configure CDN image cropping with query string parameters to automatically crop JPG/PNG images before delivery using aspect ratio, dimensions, or gravity set...
---
