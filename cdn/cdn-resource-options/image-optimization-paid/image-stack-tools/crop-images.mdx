...
title: Crop images
sidebarTitle: Crop
ai-navigation: Configure image cropping in Gcore CDN using query string parameters to specify aspect ratio, dimensions, and crop location before image delivery via the Image Stack paid feature.
---
...
<Tabs>
  <Tab title="Original image">
    <Frame>![Original image](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image1.png)</Frame>
  </Tab>
  <Tab title="Cropped image">
    <Frame>![Cropped image](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image2.png)</Frame>
  </Tab>
</Tabs>
...
<Frame>![Crop an image by customizing its aspect ratio](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image3.png)</Frame>
...
<Frame>![Crop an image by customizing its aspect ratio](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image4.png)</Frame>
...
<Frame>![Crop an image by customizing its aspect ratio](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image5.png)</Frame>
...
<Frame>![Crop an image at its center](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image6.png)</Frame>
...
<Frame>![Crop an image at its center](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image7.png)</Frame>
...
<Frame>![Crop a section of an original image from a specific location](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image8.png)</Frame>
...
<Frame>![Crop a section of an original image from a specific location](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image9.png)</Frame>
...
<Frame>![Crop a section of an original image from a specific location](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image10.png)</Frame>
...
<Frame>![Crop a section of an original image from a specific location](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image11.png)</Frame>
...
<Frame>![Crop a section of an original image from a specific location](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image12.png)</Frame>
...
<Frame>![Crop a section of an original image from a specific location](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image13.png)</Frame>
...
<Frame>![Crop a section of an original image from a specific location](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image14.png)</Frame>
...
<Frame>![Crop a section of an original image from a specific location](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image15.png)</Frame>
...
<Frame>![Crop a section of an original image from a specific location](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image16.png)</Frame>
...
<Frame>![Crop a section of an original image from a specific location](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image17.png)</Frame>
...
<Frame>![Crop a section of an original image from a specific location](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image18.png)</Frame>
...
<Frame>![Crop a section of an original image from a specific location](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image19.png)</Frame>
...
<Frame>![Check HTTP headers](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image20.png)</Frame>
...
<Frame>![Check HTTP headers](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/crop-images/crop-images-image21.png)</Frame>