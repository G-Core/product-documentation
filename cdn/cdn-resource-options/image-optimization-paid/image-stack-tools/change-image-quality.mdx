...
ai-navigation: Reduce image quality via Image Stack option using portal settings or query string parameters with preset or custom quality values.
ai-navigation: Configure Image Stack Quality parameter to reduce image quality in conjunction with format conversion or Crop/Resize features via portal or query
---
