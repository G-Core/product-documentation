...
ai-navigation: Configure image quality reduction in Gcore CDN Image Stack via portal settings or query string parameters (quality values - High, Medium, Low, or custom percentage) applied alongside format conversion (WebP, AVIF) or other transformations (Crop, Resize).
---
...
<Tabs>
  <Tab title=" High (90%)">
    <Frame>![Example of high image quality](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/change-image-quality/change-image-quality-image1.png)</Frame>
  </Tab>
  <Tab title="Medium (80%)">
    <Frame>![Example of medium image quality](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/change-image-quality/change-image-quality-image2.png)</Frame>
  </Tab>
  <Tab title="Low (65%)">
    <Frame>![Example of low image quality](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/change-image-quality/change-image-quality-image3.png)</Frame>
  </Tab>
  <Tab title="Custom value (50%)">
    <Frame>![Example of custom value of image quality](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/change-image-quality/change-image-quality-image4.png)</Frame>
  </Tab>
</Tabs>
...
<Frame>![Gcore Customer Portal](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/change-image-quality/change-image-quality-image5.png)</Frame>
...
<Frame>![Selection of the built-in presets](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/change-image-quality/change-image-quality-image6.png)</Frame>
...
<Tabs>
  <Tab title="Before">
    ...
    <Frame>![Before webp compression](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/change-image-quality/change-image-quality-image7.png)</Frame>
  </Tab>
  <Tab title="After webp compression">
    ...
    <Frame>![After webp compression](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/change-image-quality/change-image-quality-image8.png)</Frame>
  </Tab>
  <Tab title="After avif compression 50%">
    ...
    <Frame>![After avif compression 50%](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/change-image-quality/change-image-quality-image9.png)</Frame>
  </Tab>
  <Tab title="After avif compression 10%">
    ...
    <Frame>![After avif compression 10%](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/change-image-quality/change-image-quality-image10.png)</Frame>
  </Tab>
</Tabs>
...
<Frame>![Check HTTP headers](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/change-image-quality/change-image-quality-image11.png)</Frame>
...
<Frame>![Check HTTP headers](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/change-image-quality/change-image-quality-image12.png)</Frame>