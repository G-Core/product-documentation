...
sidebarTitle: Resize
ai-navigation: Configure CDN image resize using query parameters to reduce JPG/PNG dimensions via compression or cropping before delivery.
ai-navigation: Configure Resize query parameters (width, height) to reduce JPG/PNG images in CDN cache before delivery.
---
