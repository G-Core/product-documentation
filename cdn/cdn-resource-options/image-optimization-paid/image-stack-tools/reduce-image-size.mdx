...
sidebarTitle: Resize
ai-navigation: Configure Resize query parameters (width, height) in image URLs to reduce JPG and PNG dimensions on Gcore CDN with automatic aspect ratio preservation or cropping via Image Stack feature.
---
...
<Tabs>
  <Tab title="Original image">
    <Frame>![Original image](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/reduce-image-size/reduce-image-size-image1.png)</Frame>
  </Tab>
  <Tab title="Resized image">
    <Frame>![Resized image](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/reduce-image-size/reduce-image-size-image2.png)</Frame>
  </Tab>
</Tabs>
...
<AccordionGroup>
  <Accordion title="Width">
    ...
    <Tabs>
      <Tab title="Before: image.jpg">
        <Frame>![Before](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/reduce-image-size/reduce-image-size-image3.png)</Frame>
        500×333
      </Tab>
      <Tab title="After: image.jpg?width=300">
        <Frame>![Width After](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/reduce-image-size/reduce-image-size-image4.png)</Frame>
        300×200
      </Tab>
    </Tabs>
  </Accordion>
  <Accordion title="Height">
    ...
    <Tabs>
      ...
      <Tab title="After: image.jpg?height=300">
        <Frame>![Height after](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/reduce-image-size/reduce-image-size-image4.png)</Frame>
        450×300  
      </Tab>
    </Tabs>
  </Accordion>
  <Accordion title="Fit">
    ...
    <Tabs>
      <Tab title="Before: image.jpg">
        <Frame>![Fit](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/reduce-image-size/reduce-image-size-image3.png)</Frame>
        500×333
      </Tab>
      <Tab title="After">
        ...
        <AccordionGroup>
          <Accordion title="1. fit=fit">
            ...
            <Frame>![fit=fit](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/reduce-image-size/reduce-image-size-image5.png)</Frame>
            200×100
          </Accordion>
          <Accordion title="2. fit=bounds">
            ...
            <Frame>![fit=bounds](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/reduce-image-size/reduce-image-size-image3.png)</Frame>
            200×133 
          </Accordion>
          <Accordion title="3. fit=cover">
            ...
            <Frame>![fit=cover](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/reduce-image-size/reduce-image-size-image3.png)</Frame>
            150×100 
          </Accordion>
          <Accordion title="4. fit=force">
            ...
            <Frame>![fit=force](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/reduce-image-size/reduce-image-size-image6.png)</Frame>
            200х50  
          </Accordion>
        </AccordionGroup>
      </Tab>
...
<Frame>![Check HTTP headers](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/reduce-image-size/reduce-image-size-image7.png)</Frame>
