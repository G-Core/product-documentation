...
ai-navigation: Enable automatic WebP and AVIF compression for JPG and PNG images via CDN Image Stack rules or query string parameters.
ai-navigation: Enable WebP and AVIF compression for JPG and PNG images in CDN Image Stack via portal or query strings.
---
