...
ai-navigation: Enable WebP and AVIF image compression in Gcore CDN to automatically convert JPG and PNG images to modern optimized formats via Customer Portal Image optimization rules or query string parameters.
---
...
<Tabs>
  <Tab title="PNG (1860 KB)">
    <Frame>![PNG example](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/configure-image-compression-to-webp-and-avif/configure-image-compression-to-webp-and-avif-image1.png)</Frame>
  </Tab>
  <Tab title="JPG (169 KB)">
    <Frame>![JPG example](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/configure-image-compression-to-webp-and-avif/configure-image-compression-to-webp-and-avif-image2.png)</Frame>
  </Tab>
  <Tab title="WebP (136 KB)">
    <Frame>![WebP example](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/configure-image-compression-to-webp-and-avif/configure-image-compression-to-webp-and-avif-image3.png)</Frame>
  </Tab>
  <Tab title="AVIF (113 KB)">
    <Frame>![AVIF example](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/configure-image-compression-to-webp-and-avif/configure-image-compression-to-webp-and-avif-image4.png)</Frame>
  </Tab>
</Tabs>
...
<Frame>![Rules](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/configure-image-compression-to-webp-and-avif/configure-image-compression-to-webp-and-avif-image5.png)</Frame>
...
<Frame>![Enable WebP compression](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/configure-image-compression-to-webp-and-avif/configure-image-compression-to-webp-and-avif-image6.png)</Frame>
...
<Frame>![Check HTTP headers](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/configure-image-compression-to-webp-and-avif/configure-image-compression-to-webp-and-avif-image7.png)</Frame>
...
<Frame>![Check HTTP headers](/images/docs/cdn/cdn-resource-options/image-optimization-paid/image-stack-tools/configure-image-compression-to-webp-and-avif/configure-image-compression-to-webp-and-avif-image8.png)</Frame>