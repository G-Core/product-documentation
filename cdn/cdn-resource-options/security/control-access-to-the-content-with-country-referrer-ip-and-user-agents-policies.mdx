...
<Frame>![Allow referrer policy](/images/docs/cdn/cdn-resource-options/security/control-access-to-the-content-with-country-referrer-ip-and-user-agents-policies/cdn-referrer-access-policy.png)</Frame>
...
<Frame>![Block referrer policy](/images/docs/cdn/cdn-resource-options/security/control-access-to-the-content-with-country-referrer-ip-and-user-agents-policies/cdn-referrer-access-policy-block.png)</Frame>
...
<Frame>![Allow country access policy](/images/docs/cdn/cdn-resource-options/security/control-access-to-the-content-with-country-referrer-ip-and-user-agents-policies/cdn-country-access.png)</Frame>
...
<Frame>![Block country access policy](/images/docs/cdn/cdn-resource-options/security/control-access-to-the-content-with-country-referrer-ip-and-user-agents-policies/cdn-country-access-block.png)</Frame>
...
<Frame>![Allow IP policy](/images/docs/cdn/cdn-resource-options/security/control-access-to-the-content-with-country-referrer-ip-and-user-agents-policies/cdn-ip-access-policy.png)</Frame>
...
<Frame>![Block IP policy](/images/docs/cdn/cdn-resource-options/security/control-access-to-the-content-with-country-referrer-ip-and-user-agents-policies/cdn-ip-access-policy-block.png)</Frame>
...
<Frame>![Set via the Gcore Customer Portal](/images/docs/cdn/cdn-resource-options/security/control-access-to-the-content-with-country-referrer-ip-and-user-agents-policies/cdn-resources.png)</Frame>
...
<Frame>![Access](/images/docs/cdn/cdn-resource-options/security/control-access-to-the-content-with-country-referrer-ip-and-user-agents-policies/cdn-access-menu.png)</Frame>
...
<Frame>![Enable user agents policy](/images/docs/cdn/cdn-resource-options/security/control-access-to-the-content-with-country-referrer-ip-and-user-agents-policies/cdn-user-agents-policy.png)</Frame>
...
<Frame>![Empty value](/images/docs/cdn/cdn-resource-options/security/control-access-to-the-content-with-country-referrer-ip-and-user-agents-policies/cdn-user-agents-policy-empty.png)</Frame>
...
_excepted_values_ | This property is an array of user agents to allow or block. The array must contain at least 1 item.<br/>Possible values:<br/>- two double quotation marks without a space in-between ("") represents the _empty value_, used to match requests that do not send a User-Agent header<br/>- a string that represents the exact user agent, with a maximum length of 255 characters; if you need to increase this limit, you can contact our [Gcore Support](mailto:support@gcore.com)<br/>- a regular expression prefixed with `~` for case-sensitive matching (for example, `~Mozilla.*`) or `~*` for case-insensitive matching (for example, `~*mozilla.*`)
