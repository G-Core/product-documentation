...
Referrer access policy is a restriction to publish the links to content on your site on other sites. To enable the option open the [CDN resource](https://portal.preprod.world/cdn/resources/list), in the **Resource settings**, select **Access**, and then open **eferrer access policy**. 
...
In CDN Resource settings, select **Access**, and open **IP access policy**.
