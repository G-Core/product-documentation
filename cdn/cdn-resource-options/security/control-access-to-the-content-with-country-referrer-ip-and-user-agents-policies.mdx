...
**Note** : You can specify countries only one by one via the Gcore Customer Portal. To add the list of the countries, use [API](/api-reference/cdn/cdn-resources/change-cdn-resource-1). 
