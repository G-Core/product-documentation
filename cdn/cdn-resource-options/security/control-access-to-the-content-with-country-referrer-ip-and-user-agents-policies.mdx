...
Referrer access policy is a restriction to publish the links to content on your site on other sites. To enable the option navigate to CDN resources, in the **Resource settings**, select **Access**, and then open **eferrer access policy**. 
