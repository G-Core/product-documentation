...
ai-navigation: Enable secure token authentication with MD5 hash validation, IP allowlisting, and path-based access control for CDN content delivery.
ai-navigation: Configure Secure Token with MD5 hash, UNIX timestamp expiration, and optional client IP allowlisting for CDN content protection.
---
