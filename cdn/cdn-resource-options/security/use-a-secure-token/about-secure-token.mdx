...
description: Protect CDN content from unauthorized access using Secure Token with IP allowlisting and URL expiration to restrict downloads by time or source IP address.
---
