...
ai-navigation: Protect CDN content from unauthorized access using Secure Token with IP allowlisting and URL expiration to restrict downloads by time or source IP address.
ai-navigation: Configure Secure Token to restrict CDN content access by expiration time and IP address whitelist.
---
