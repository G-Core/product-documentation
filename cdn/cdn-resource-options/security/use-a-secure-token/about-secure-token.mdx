...
ai-navigation: Configure Gcore CDN Secure Token to protect content with time-based expiration and IP address restrictions, returning 410 Gone responses for expired tokens and unauthorized IP requests.
---
...
<Frame>![Expired secure token returns 410 for a video segment](/images/docs/cdn/video-cdn/about-secure-token-image1.png)</Frame>
...
<Frame>![How a secured URL looks ](/images/docs/cdn/cdn-resource-options/security/use-a-secure-token/about-secure-token/about-secure-token-image2.png)</Frame>
...
<Frame>![How content is requested via a secured link ](/images/docs/cdn/cdn-resource-options/security/use-a-secure-token/about-secure-token/about-secure-token-image3.png)</Frame>
