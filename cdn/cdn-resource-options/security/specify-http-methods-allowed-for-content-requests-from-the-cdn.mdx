...
ai-navigation: Configure allowed HTTP methods (GET, HEAD, POST, PUT, PATCH, DELETE, OPTIONS) for CDN resources via the Enable HTTP methods toggle to block unauthorized requests and return 405 Method Not Allowed responses.
---
...
<Frame>![CDN resources page with a resource CNAME highlighted](/images/docs/cdn/cdn-resource-options/security/specify-http-methods-allowed-for-content-requests-from-the-cdn/specify-http-methods-allowed-for-content-requests-from-the-cdn-image1.png)</Frame>
...
<Frame>![HTTP methods section in resource settings](/images/docs/cdn/cdn-resource-options/security/specify-http-methods-allowed-for-content-requests-from-the-cdn/specify-http-methods-allowed-for-content-requests-from-the-cdn-image2.png)</Frame>
