...
description: Configure allowed HTTP methods (GET, HEAD, POST, PUT, PATCH, DELETE, OPTIONS) for CDN resources to block unsupported requests and return 405/501 responses.
---
