...
ai-navigation: Configure SNI hostname in HTTPS origin requests using dynamic or custom hostname modes in CDN resource security settings.
ai-navigation: Configure SNI hostname in CDN HTTPS origin requests using Dynamic or Custom mode.
---
