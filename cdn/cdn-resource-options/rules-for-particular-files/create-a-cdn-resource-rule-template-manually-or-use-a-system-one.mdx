...
ai-navigation: Create custom CDN resource rule templates with file paths, origin pull protocols, and caching options, or apply pre-built System templates for video streamin
ai-navigation: Create CDN resource rule templates manually with file paths, origin pull protocol, and options, or apply system templates for video streaming and
---
