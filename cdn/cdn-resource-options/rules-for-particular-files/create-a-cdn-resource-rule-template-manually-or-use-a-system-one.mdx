...
<Frame>![Create a template](/images/docs/cdn/cdn-resource-options/rules-for-particular-files/create-a-cdn-resource-rule-template-manually-or-use-a-system-one/image_1506.png)</Frame>
...
<Frame>![Create a template](/images/docs/cdn/cdn-resource-options/rules-for-particular-files/create-a-cdn-resource-rule-template-manually-or-use-a-system-one/image_1507.png)</Frame>
...
<Frame>![Use a system template](/images/docs/cdn/cdn-resource-options/rules-for-particular-files/create-a-cdn-resource-rule-template-manually-or-use-a-system-one/image_1510.png)</Frame>



**Video segments template (.ts)** is a rule template for caching chunks ([streaming via CDN](/cdn/cdn-resource-options/configure-live-streams-and-video-delivery-via-cdn-only-for-paid-tariffs)).

**Playlists template (.m3u8)** is a rule template for caching playlists ([streaming via CDN](/cdn/cdn-resource-options/configure-live-streams-and-video-delivery-via-cdn-only-for-paid-tariffs)).
...
<Frame>![Create a rule from a template ](/images/docs/cdn/cdn-resource-options/rules-for-particular-files/create-a-cdn-resource-rule-template-manually-or-use-a-system-one/image_1508.png)</Frame>
...
<Frame>![Create a rule from a template ](/images/docs/cdn/cdn-resource-options/rules-for-particular-files/create-a-cdn-resource-rule-template-manually-or-use-a-system-one/image_1509.png)</Frame>
