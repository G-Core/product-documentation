...
description: Create custom CDN resource rule templates with file paths, origin pull protocols, and caching options, or apply pre-built System templates for video streamin...
---
