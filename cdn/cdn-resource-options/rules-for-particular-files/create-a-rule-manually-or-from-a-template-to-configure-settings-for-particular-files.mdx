...
ai-navigation: Create CDN rules to override resource-level settings for specific file paths using URI patterns or regex, configuring cache lifetime, origin protocol, and other CDN options per rule with a maximum of five custom rules per resource.
---
...
<Frame>![What is the Rules section](/images/docs/cdn/cdn-resource-options/rules-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files-image1.png)</Frame>
...
<Frame>![Add option ](/images/docs/cdn/cdn-resource-options/rules-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files-image4.png)</Frame>
...
<Frame>![CDN resource](/images/docs/cdn/cdn-resource-options/rules-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files-image5.png)</Frame>
...
<Frame>![Create rule](/images/docs/cdn/cdn-resource-options/rules-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files-image6.png)</Frame>
...
<Frame>![Prohibit image caching in CDN](/images/docs/cdn/cdn-resource-options/rules-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files-image7.png)</Frame>
...
<Frame>![Set Access-Control-Allow-Origin for .ttf files](/images/docs/cdn/cdn-resource-options/rules-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files-image8.png)</Frame>
...
<Frame>![Rules section ](/images/docs/cdn/cdn-resource-options/rules-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files-image9.png)</Frame>
...
<Frame>![Disable rule](/images/docs/cdn/cdn-resource-options/rules-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files-image10.png)</Frame>
...
<Frame>![Suspended status and](/images/docs/cdn/cdn-resource-options/rules-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files/create-a-rule-manually-or-from-a-template-to-configure-settings-for-particular-files-image11.png)</Frame>