...
ai-navigation: Create CDN rules for specific file paths with custom caching, origin protocol, and delivery options using manual creation or predefined templates.
ai-navigation: Create CDN rules for file paths with custom caching, origin protocol, and options; limit five rules per resource.
---
