...
description: Create CDN rules for specific file paths with custom caching, origin protocol, and delivery options using manual creation or predefined templates.
---
