...
ai-navigation: Enable Large File Delivery Optimization in CDN Resource Settings to serve 10 MB+ content via chunked range requests with origin caching.
ai-navigation: Enable Large File Delivery Optimization in CDN Resource Settings to cache 10 MB chunks via HTTP Range Requests for files >10 MB.
---
