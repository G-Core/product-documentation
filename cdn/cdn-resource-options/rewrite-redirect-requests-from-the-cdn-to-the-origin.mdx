...
ai-navigation: Configure CDN Rewrite option with nginx-compatible regular expressions to redirect request paths from CDN to origin, using space-separated directives with capture groups ($1, $2) and optional flags like break, last, redirect, permanent.
---
