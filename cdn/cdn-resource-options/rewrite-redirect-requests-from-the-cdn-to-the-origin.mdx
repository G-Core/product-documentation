...
description: Configure CDN Rewrite option with nginx regex directives to redirect origin requests from one path to another using capture groups and flags.
---
