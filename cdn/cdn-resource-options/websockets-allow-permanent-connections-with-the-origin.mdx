...
ai-navigation: Enable or disable WebSocket protocol support on CDN resources to allow persistent bidirectional TCP connections between clients and origin servers for real-time data exchange.
---
...
<Frame>![How is WebSocket different from HTTP](/images/docs/cdn/cdn-resource-options/websockets-allow-permanent-connections-with-the-origin/websockets-allow-permanent-connections-with-the-origin-image1.png)</Frame>
...
1\. Go to the [CDN](https://portal.gcore.com/cdn/resources/list) section in the Gcore Customer Portal and open the settings of the resource for which you want to manage WebSockets by clicking its custom domain.


<Frame>![Manage the WebSockets feature](/images/docs/cdn/cdn-resource-options/websockets-allow-permanent-connections-with-the-origin/websockets-allow-permanent-connections-with-the-origin-image2.png)</Frame>
...
<Frame>![Manage the WebSockets feature](/images/docs/cdn/cdn-resource-options/websockets-allow-permanent-connections-with-the-origin/websockets-allow-permanent-connections-with-the-origin-image3.png)</Frame>
