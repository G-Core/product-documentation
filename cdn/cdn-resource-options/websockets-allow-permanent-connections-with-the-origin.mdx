...
By default, the WebSocket feature is enabled for CDN resources using DNS delegation and disabled for CNAME-based CDN resources. You can manage this feature depending on your setup: disable it for resources with DNS delegation or enable it for CNAME-based resources. See the [CDN resource guide](/cdn/getting-started/create-a-cdn-resource/create-a-cdn-resource-for-only-static-files) for details on each setup type.
