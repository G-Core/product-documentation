...
ai-navigation: Configure custom connection and read timeouts for CDN resources to control edge node wait duration when connecting to origin servers and receiving responses.
ai-navigation: Configure CDN resource custom connection and read timeouts for origin server communication delays.
---
