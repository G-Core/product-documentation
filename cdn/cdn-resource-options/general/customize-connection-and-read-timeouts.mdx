...
description: Configure custom connection and read timeouts for CDN resources to control edge node wait duration when connecting to origin servers and receiving responses.
---
