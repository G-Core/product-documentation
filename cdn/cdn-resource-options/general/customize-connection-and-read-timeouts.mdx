...
ai-navigation: Configure custom connection timeout and read timeout for CDN resources to specify how long edge nodes wait when connecting to origin servers and receiving responses before returning 504 Gateway Timeout errors.
---
...
<Frame>![CDN page with a list of CDN resources](/images/docs/cdn/getting-started/timeouts/customize-connection-and-read-timeouts-image1.png)</Frame>
...
<Frame>![Resource settings with custom timeouts section open](/images/docs/cdn/getting-started/timeouts/customize-connection-and-read-timeouts-image2.png)</Frame>
...
<Frame>![A dialog with enabled custom read and connection timeouts](/images/docs/cdn/getting-started/timeouts/customize-connection-and-read-timeouts-image3.png)</Frame>