...
ai-navigation: Configure CDN origin SSL validation by uploading X.509 certificates via API and enabling proxy_ssl_enabled, proxy_ssl_ca, proxy_ssl_data parameters for certi
ai-navigation: Enable Origin SSL Validation via CDN API using proxy_ssl_enabled, proxy_ssl_ca, proxy_ssl_data keys with X.509 certificates.
---
