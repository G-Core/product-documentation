...
description: Configure CDN origin SSL validation by uploading X.509 certificates via API and enabling proxy_ssl_enabled, proxy_ssl_ca, proxy_ssl_data parameters for certi...
---
