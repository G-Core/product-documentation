...
ai-navigation: Configure origin server address and select HTTP, HTTPS, or HTTP/HTTPS protocol for CDN content retrieval from origin servers.
ai-navigation: Configure CDN origin pull protocol (HTTP, HTTPS, or HTTP and HTTPS) and specify origin server IP address or domain.
---
