...
ai-navigation: Configure custom domains and CNAME records for CDN static content delivery; set up DNS aliases pointing to Gcore's gcdn.co endpoint.
ai-navigation: Create custom domain for CDN static content delivery with CNAME record pointing to gcdn.co alias.
---
