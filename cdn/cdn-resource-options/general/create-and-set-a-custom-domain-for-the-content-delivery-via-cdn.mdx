...
ai-navigation: Create custom domains and additional domains for CDN static content delivery by specifying domain names in the CDN resource configuration and adding CNAME records pointing to the account-specific gcdn.co endpoint.
---
...
<Frame>![Custom domain](/images/docs/cdn/cdn-resource-options/general/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn-image1.png)</Frame>
...
<Frame>![Copy the value](/images/docs/cdn/cdn-resource-options/general/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn-image2.png)</Frame>
...
<Frame>![Complete the CDN resource creation](/images/docs/cdn/cdn-resource-options/general/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn-image3.png)</Frame>
...
<Frame>![Setup guide](/images/docs/cdn/cdn-resource-options/general/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn-image4.png)</Frame>
...
<Frame>![Setup Status](/images/docs/cdn/cdn-resource-options/general/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn-image5.png)</Frame>
...
<Frame>![check the DNS](/images/docs/cdn/cdn-resource-options/general/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn-image6.png)</Frame>
...
<Frame>![completed correctly](/images/docs/cdn/cdn-resource-options/general/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn-image7.png)</Frame>
...
1\. Go to the [CDN resource list](https://portal.gcore.com/cdn/resources/list) and click on the custom domain of the resource you want to configure.


<Frame>![CDN resource list ](/images/docs/cdn/cdn-resource-options/general/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn-image8.png)</Frame>
...
<Frame>![Custom domain](/images/docs/cdn/cdn-resource-options/general/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn-image9.png)</Frame>
