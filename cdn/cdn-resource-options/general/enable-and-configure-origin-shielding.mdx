...
ai-navigation: Enable origin shielding in Gcore CDN by toggling the feature in Resource settings and selecting a precache server location to reduce origin server load from multiple CDN edge servers.
---
...
<Frame>![What is Origin shielding](/images/docs/cdn/cdn-resource-options/general/enable-and-configure-origin-shielding/enable-and-configure-origin-shielding-image1.jpeg)</Frame>
...
<Frame>![Enable Origin shielding](/images/docs/cdn/cdn-resource-options/general/enable-and-configure-origin-shielding/enable-and-configure-origin-shielding-image2.png)</Frame>
...
<Frame>![Save changes](/images/docs/cdn/cdn-resource-options/general/enable-and-configure-origin-shielding/enable-and-configure-origin-shielding-image3.png)</Frame>