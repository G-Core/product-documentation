...
<Tabs>
  <Tab title="Customer Portal">
    Go to **CDN** > **Origin groups** and open the group. Saved **Access Key ID** and **Secret access key** values are masked. Click the pencil icon next to each field, enter the new values, and click **Save changes**.
  </Tab>
  <Tab title="API">
