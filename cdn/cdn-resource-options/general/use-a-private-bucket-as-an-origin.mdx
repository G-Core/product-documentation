...
Gcore allows private buckets in S3-compatible storage services, including Amazon and Gcore, as a [CDN resource origin](/cdn/getting-started/create-a-cdn-resource/create-a-cdn-resource#origin). However, to allow CDN servers to access the content stored in these private buckets, you must provide authentication data, including Access Key ID, Secret Access Key, Hostname, and Region. Without this information, the servers cannot access the content.
...
<Tabs>
  <Tab title="Customer Portal">
    ...
    **Tip**
    ...
    7\. Continue the CDN resource creation according to the [Create CDN resource for static assets only](/cdn/getting-started/create-a-cdn-resource/create-a-cdn-resource) guide.
  ...
  <Tab title="API">
    ...
    | Request parameter | For more information, see Gcore's [API documentation](/api-reference/cdn?_gl=1*1vtlv8c*_ga*ODE2MjQ4NzgwLjE2NjY2MDkxMzk.*_ga_Y79HRL8RPR*MTY4NDI0MDAyMC43MjYuMS4xNjg0MjQzNDMyLjYwLjAuMA..#tag/Origins/operation/create_origin_group)  |
