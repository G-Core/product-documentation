...
<Tabs>
  <Tab title="Customer Portal">
    1\. Go to **CDN** > **Origin groups** and open the group.

    2\. Click the pencil icon next to **Access Key ID** and **Secret access key**. Saved values are masked.

    3\. Enter the new values and click **Save changes**.
  </Tab>
  <Tab title="API">
