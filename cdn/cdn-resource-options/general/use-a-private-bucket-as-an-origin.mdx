...
ai-navigation: Configure private S3-compatible buckets as CDN origins using AWS Signature V4 authentication with Access Key ID, Secret Access Key, Hostname, and Region parameters for Amazon or Gcore Object Storage.
---
...
<Tabs>
  ...
  <Tab title="Gcore">
    You can find the Hostname and Region in the **Details** section under the [Storages](https://portal.gcore.com/storage/storages/list) tab.
    
    <Frame>![Gcore S3 storage](/images/docs/cdn/cdn-resource-options/general/use-a-private-bucket-as-an-origin/use-a-private-bucket-as-an-origin-image1.png)</Frame>
...
<Tabs>
  <Tab title="Customer Portal">
    ...
    1\. Go to the [CDN resource creation page](https://portal.gcore.com/cdn/resources/create/wizard), select **Accelerate and protect static assets only**, and click **Confirm**.


    <Frame>![CDN resource creation page](/images/docs/cdn/cdn-resource-options/general/use-a-private-bucket-as-an-origin/use-a-private-bucket-as-an-origin-image2.png)</Frame>
    ...
    **Tip**
    ...
    <Frame>![Origin section](/images/docs/cdn/cdn-resource-options/general/use-a-private-bucket-as-an-origin/use-a-private-bucket-as-an-origin-image3.png)</Frame>
    ...
    **Note** : The bucket in the "Host header" is very important to specify for the security of the storage data outside the bucket.
    ...
    <Frame>![Save changes](/images/docs/cdn/cdn-resource-options/general/use-a-private-bucket-as-an-origin/use-a-private-bucket-as-an-origin-image4.png)</Frame>
  </Tab>
  <Tab title="API">
    ...
    To access the API and make authenticated requests, [generate an access token](/account-settings/api-tokens). You can use a REST tool like cURL or Postman to send the requests. For this guide, we used Postman.
    ...
    <Frame>![ API URL ](/images/docs/cdn/cdn-resource-options/general/use-a-private-bucket-as-an-origin/use-a-private-bucket-as-an-origin-image5.png)</Frame>
    ...
    <Frame>![Token](/images/docs/cdn/cdn-resource-options/general/use-a-private-bucket-as-an-origin/use-a-private-bucket-as-an-origin-image6.png)</Frame>
    ...
    <Frame>![Send](/images/docs/cdn/cdn-resource-options/general/use-a-private-bucket-as-an-origin/use-a-private-bucket-as-an-origin-image7.png)</Frame>
  </Tab>
</Tabs>
