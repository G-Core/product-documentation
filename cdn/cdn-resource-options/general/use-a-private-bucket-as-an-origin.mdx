...
ai-navigation: Configure private S3 buckets as CDN origins using AWS Signature V4 authentication with Access Key ID, Secret Access Key, Hostname, and Region credentials.
ai-navigation: Configure private S3 bucket origin with AWS Signature V4 authentication using Access Key ID, Secret Access Key, Hostname, and Region.
---
