...
2\. Go to the [CDN](https://portal.gcore.com/cdn/resources/list) section in the Gcore Customer Portal and click the custom domain of the resource on which origin you configured the `Cache-Control` header.


<Frame>![CDN section](/images/docs/cdn/cdn-resource-options/cache/specify-cache-lifetime-on-a-cdn-resource-or-origin/specify-cache-lifetime-on-a-cdn-resource-or-origin-image1.png)</Frame>
...
<Frame>![The new page opens](/images/docs/cdn/cdn-resource-options/cache/specify-cache-lifetime-on-a-cdn-resource-or-origin/specify-cache-lifetime-on-a-cdn-resource-or-origin-image2.png)</Frame>
...
<Tabs>
  <Tab title="Enable CDN caching for the whole resource">
    ...
    <Frame>![CDN resources page](/images/docs/cdn/cdn-resource-options/cache/specify-cache-lifetime-on-a-cdn-resource-or-origin/specify-cache-lifetime-on-a-cdn-resource-or-origin-image3.png)</Frame>
    ...
    <Frame>![CDN cache settings](/images/docs/cdn/cdn-resource-options/cache/specify-cache-lifetime-on-a-cdn-resource-or-origin/specify-cache-lifetime-on-a-cdn-resource-or-origin-image4.png)</Frame>
  ...
  <Tab title="Enable CDN caching via advanced caching rules">
    ...
    <Frame>![Advanced caching rules](/images/docs/cdn/cdn-resource-options/cache/specify-cache-lifetime-on-a-cdn-resource-or-origin/specify-cache-lifetime-on-a-cdn-resource-or-origin-image5.png)</Frame>
...
<Frame>![Headers tab](/images/docs/cdn/cdn-resource-options/cache/specify-cache-lifetime-on-a-cdn-resource-or-origin/specify-cache-lifetime-on-a-cdn-resource-or-origin-image6.png)</Frame>
