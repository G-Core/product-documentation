...
description: Configure Cache-Control header max-age and CDN caching lifetime via origin server directives or CDN control panel to control file retention duration.
---
