...
ai-navigation: Configure Cache-Control header max-age and CDN caching lifetime via origin server directives or CDN control panel to control file retention duration.
ai-navigation: Configure CDN caching lifetime via Cache-Control header (origin controlled) or CDN control panel with default expiry timespan.
---
