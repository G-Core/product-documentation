...
[Newly created CDN resources](/cdn/getting-started/create-a-cdn-resource/create-a-cdn-resource-for-only-static-files) have Cache Sharding enabled automatically. If you're a long-term user unsure whether the feature is activated, please contact our [support team](mailto:support@gcore.com) to request activation.

**Note** : The Cache Sharding option is not used for [Streaming CDN resources](/streaming-platform/how-the-streaming-platform-interact-with-the-cdn).