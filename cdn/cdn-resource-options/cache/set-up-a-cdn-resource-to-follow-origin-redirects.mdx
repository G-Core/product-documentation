...
ai-navigation: Enable CDN origin redirection to follow HTTP 3xx status codes (301, 302, 303, 307, 308) returned by the origin server, with automatic content retrieval and caching via Gcore Customer Portal or API using the enabled and codes properties.
---
...
### Via the Gcore Customer Porta

To configure origin redirection using the [Gcore Customer Portal](https://portal.gcore.com/accounts/reports/dashboard):

1\. Go to **CDN** and select the CDN resource you want to configure.


<Frame>![CDN resource](/images/docs/cdn/cdn-resource-options/cache/set-up-a-cdn-resource-to-follow-origin-redirects/set-up-a-cdn-resource-to-follow-origin-redirects-image1.png)</Frame>
...
<Frame>![Cache section](/images/docs/cdn/cdn-resource-options/cache/set-up-a-cdn-resource-to-follow-origin-redirects/set-up-a-cdn-resource-to-follow-origin-redirects-image2.png)</Frame>
...
<Frame>![Follow redirect from origin](/images/docs/cdn/cdn-resource-options/cache/set-up-a-cdn-resource-to-follow-origin-redirects/set-up-a-cdn-resource-to-follow-origin-redirects-image3.png)</Frame>
...
<Frame>![Redirect status codes](/images/docs/cdn/cdn-resource-options/cache/set-up-a-cdn-resource-to-follow-origin-redirects/set-up-a-cdn-resource-to-follow-origin-redirects-image4.png)</Frame>
...
<Frame>![Save changes](/images/docs/cdn/cdn-resource-options/cache/set-up-a-cdn-resource-to-follow-origin-redirects/set-up-a-cdn-resource-to-follow-origin-redirects-image5.png)</Frame>
...
This example shows a [CDN update request](/api-reference/cdn/cdn-resources/change-cdn-resource-1) that activates the Redirection from Origin and instructs the CDN to follow redirects for status codes _301_, _302_, and _303_.



<Frame>![CDN update request ](/images/docs/cdn/cdn-resource-options/cache/set-up-a-cdn-resource-to-follow-origin-redirects/set-up-a-cdn-resource-to-follow-origin-redirects-image6.png)</Frame>
