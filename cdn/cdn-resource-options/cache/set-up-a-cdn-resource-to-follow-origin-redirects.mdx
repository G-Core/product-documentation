...
<p>To configure origin redirection using the [Gcore Customer Portal](https://portal.gcore.com/cdn/resources/list):</p>
...
<p>To configure origin redirection using the API, include the `follow_origin_redirect` object in the request body. The following is a sample code for the object:</p>
...
<p>The `follow_origin_redirect` object passes the following information:</p>
...
<p>This example shows a [CDN&nbsp;update&nbsp;request](/api-reference/cdn/cdn-resources/change-cdn-resource-1) that activates the Redirection from Origin and instructs the CDN to follow redirects for status codes 301, 302, and 303.</p>
