...
ai-navigation: Enable CDN to follow origin HTTP 3xx redirects (301, 302, 303, 307, 308) via Portal or API with configurable status codes.
ai-navigation: Enable CDN resource to follow origin redirects for HTTP 301, 302, 303, 307, 308 status codes via portal or API.
---
