...
<Frame>
  ![CDN resources tab from where you can open settings](/images/docs/cdn/cdn-resource-options/cache/specify-cache-lifetime-for-user-browsers/specify-cache-lifetime-for-user-browsers-image1.png)
</Frame>

The new page opens. Perform the remaining steps there.

<Frame>
  ![Configure Browser Caching Option](/images/docs/cdn/cdn-resource-options/cache/specify-cache-lifetime-for-user-browsers/specify-cache-lifetime-for-user-browsers-image2.png)
</Frame>
...
<Accordion title="Configure CDN controlled mode">
  ...
  <Frame>
    ![CDN Controlled Cache Expiry](/images/docs/cdn/cdn-resource-options/cache/specify-cache-lifetime-for-user-browsers/specify-cache-lifetime-for-user-browsers-image3.png)
  </Frame>
  ...
  <Frame>
    ![CDN Controlled Cache Expiry Custom](/images/docs/cdn/cdn-resource-options/cache/specify-cache-lifetime-for-user-browsers/specify-cache-lifetime-for-user-browsers-image4.png)
  </Frame>
</Accordion>
