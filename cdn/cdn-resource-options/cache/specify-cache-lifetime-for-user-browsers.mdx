...
<Accordion title="Configure CDN controlled mode">
 ...
 <Frame>
    ![CDN origin configuration/browser-caching-30.png](/images/docs/cdn/cdn-resource-options/cache/specify-cache-lifetime-for-user-browsers/)
  </Frame>
  ...
  <Frame>
    ![CDN origin configuration/browser-caching-40.png](/images/docs/cdn/cdn-resource-options/cache/specify-cache-lifetime-for-user-browsers/)
  </Frame>
</Accordion>
