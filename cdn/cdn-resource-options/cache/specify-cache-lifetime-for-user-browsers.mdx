...
ai-navigation: Configure browser cache lifetime using Origin-controlled Cache-Control headers or CDN-controlled max-age values via Gcore Customer Portal.
ai-navigation: Configure Browser Caching option to set cache lifetime in user browsers via Origin controlled or CDN controlled mode.
---
