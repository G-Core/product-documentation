...
description: Configure cache key variables (URI, protocol, normalized URI) in CDN resource settings to control cache object identification and improve hit ratio.
---
