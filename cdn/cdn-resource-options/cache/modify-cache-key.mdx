...
ai-navigation: Configure cache key variables (URI, protocol, normalized URI) in CDN resource settings to control cache object identification and improve hit ratio.
ai-navigation: Configure CDN cache key variables using URI, protocol, and normalized URI to optimize cache hit ratio and content delivery.
---
