...
description: Serve stale cached content when origin is unavailable due to network errors, timeouts, or HTTP 5xx/4xx errors; configure error codes in Resource Advanced Set...
---
