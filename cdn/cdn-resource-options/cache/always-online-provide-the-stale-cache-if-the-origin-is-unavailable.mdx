...
ai-navigation: Serve stale cached content when origin is unavailable due to network errors, timeouts, or HTTP 5xx/4xx errors; configure error codes in Resource Advanced Set
ai-navigation: Enable Always Online to serve stale cached content when origin unavailable due to network errors, timeouts, or HTTP 5xx/4xx status codes.
---
