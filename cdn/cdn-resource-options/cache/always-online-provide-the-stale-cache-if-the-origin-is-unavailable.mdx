...
ai-navigation: Configure Always Online to serve stale cached content when origin is unavailable due to network errors, timeouts, invalid headers, or HTTP 5xx/4xx errors, with X-Cache - Stale response header and automatic origin availability checks per request.
---
...
<Frame>![Always Online toggle enabled](/images/docs/cdn/cdn-resource-options/cache/always-online-provide-the-stale-cache-if-the-origin-is-unavailable/always-online-provide-the-stale-cache-if-the-origin-is-unavailable-image1.png)</Frame>