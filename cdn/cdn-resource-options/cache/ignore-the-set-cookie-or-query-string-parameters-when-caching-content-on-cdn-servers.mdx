...
ai-navigation: Configure CDN cache behavior for query string parameters using Ignore All, Ignore All Except, or Ignore Only modes to control cache key generation.
ai-navigation: Configure CDN Query String caching modes: Ignore All, Ignore All Except, or Ignore Only to control cache key generation.
---
...
<Frame>![Set-Cookie setting](/images/docs/cdn/cdn-resource-options/cache/ignore-the-set-cookie-or-query-string-parameters-when-caching-content-on-cdn-servers/Screenshot-2018.png)</Frame>
