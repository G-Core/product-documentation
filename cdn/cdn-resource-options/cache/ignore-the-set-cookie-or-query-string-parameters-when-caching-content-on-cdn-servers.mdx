...
ai-navigation: Configure CDN query string caching behavior using Ignore All, Ignore All Except, or Ignore Only modes to control cache key generation for URLs with query parameters.
---
...
<Frame>![CDN resource ](/images/docs/cdn/cdn-resource-options/cache/ignore-the-set-cookie-or-query-string-parameters-when-caching-content-on-cdn-servers/ignore-the-set-cookie-or-query-string-parameters-when-caching-content-on-cdn-servers-image1.png)</Frame>
...
<Frame>![Cache](/images/docs/cdn/cdn-resource-options/cache/ignore-the-set-cookie-or-query-string-parameters-when-caching-content-on-cdn-servers/ignore-the-set-cookie-or-query-string-parameters-when-caching-content-on-cdn-servers-image2.png)</Frame>
...
<Frame>![Ignore All](/images/docs/cdn/cdn-resource-options/cache/ignore-the-set-cookie-or-query-string-parameters-when-caching-content-on-cdn-servers/ignore-the-set-cookie-or-query-string-parameters-when-caching-content-on-cdn-servers-image3.png)</Frame>
...
<Frame>![ Parameter field,](/images/docs/cdn/cdn-resource-options/cache/ignore-the-set-cookie-or-query-string-parameters-when-caching-content-on-cdn-servers/ignore-the-set-cookie-or-query-string-parameters-when-caching-content-on-cdn-servers-image4.png)</Frame>
...
<Frame>![ Parameter field](/images/docs/cdn/cdn-resource-options/cache/ignore-the-set-cookie-or-query-string-parameters-when-caching-content-on-cdn-servers/ignore-the-set-cookie-or-query-string-parameters-when-caching-content-on-cdn-servers-image5.png)</Frame>
...
<Frame>![Set-Cookie setting](/images/docs/cdn/cdn-resource-options/cache/ignore-the-set-cookie-or-query-string-parameters-when-caching-content-on-cdn-servers/ignore-the-set-cookie-or-query-string-parameters-when-caching-content-on-cdn-servers-image6.png)</Frame>
