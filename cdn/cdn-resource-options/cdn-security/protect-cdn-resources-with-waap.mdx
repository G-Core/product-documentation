...
<Frame>
  ![Create rule form showing Rule name, Match criteria, and Options sections](/images/docs/cdn/cdn-resource-options/cdn-security/protect-cdn-resources-with-waap/cdn-create-rule.png)
</Frame>
