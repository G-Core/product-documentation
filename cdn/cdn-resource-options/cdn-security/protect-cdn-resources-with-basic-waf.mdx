...
ai-navigation: Enable WAAP Layer 7 DDoS and web application protection for CDN resources via Customer Portal Security settings with exception rules.
ai-navigation: Enable WAAP protection for CDN resources to activate Layer 7 DDoS, web app, and API security with built-in rules and behavioral analytics.
---
...
<Frame>
  ![CDN resource settings page in the Customer Portal](/images/docs/waap/getting-started/cdn-resources-page.png)
</Frame>
...
<Frame>
  ![WAAP toggle](/images/docs/waap/getting-started/security-section-waap-enabled.png)
</Frame>
...
<Frame>
  ![WAAP toggle](/images/docs/waap/getting-started/rule-name-match-options.png)
</Frame>
