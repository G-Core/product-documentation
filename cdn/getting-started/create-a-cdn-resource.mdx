...
There are two types of CDN resources available:
  ...
  * **Standard CDN resource**. Accelerate a website or specific assets using either a CNAME record or Gcore Managed DNS delegation. Supports an optional WAAP integration for Layer 7 DDoS and web application protection. Consult our guide on [creating a CDN resource](/cdn/getting-started/create-a-cdn-resource/create-a-cdn-resource-for-only-static-files).
