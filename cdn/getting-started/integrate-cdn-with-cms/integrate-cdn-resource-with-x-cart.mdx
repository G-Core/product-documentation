...
sidebarTitle: X-Cart
description: Configure X-Cart 4.4.x+ to deliver static content via Gcore CDN by modifying smarty.php, func.files.php, and template files with CNAME records.
---
