...
sidebarTitle: X-Cart
ai-navigation: Configure X-Cart 4.4.x+ to deliver static content via Gcore CDN by modifying smarty.php, func.files.php, and template files with CNAME records.
ai-navigation: Integrate CDN resource with X-Cart by configuring CNAME and modifying smarty.php, func.files.php, function.get_category_image_url.php files.
---
