...
description: Install Gcore CDN plugin for Cs-cart, configure CNAME in Universal CDN Add-on settings, and verify static asset URLs are rewritten to CDN domain.
---
