...
ai-navigation: Install Gcore CDN plugin for Cs-cart, configure CNAME in Universal CDN Add-on settings, and verify static asset URLs are rewritten to CDN domain.
ai-navigation: Install Gcore CDN Universal Add-on for Cs-cart, configure CNAME in plugin settings, enable to rewrite static file URLs.
---
