...
ai-navigation: Configure B2evolution CMS to serve static assets through Gcore CDN by replacing base URL variables with CNAME in configuration file.
ai-navigation: Integrate CDN resource with B2evolution by configuring CNAME and replacing base URL variables in CMS configuration file.
---
