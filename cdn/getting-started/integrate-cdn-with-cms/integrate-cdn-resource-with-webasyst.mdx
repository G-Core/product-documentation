...
ai-navigation: Configure Gcore CDN CNAME in Webasyst administration settings and verify URL rewriting in browser Network tab.
ai-navigation: Integrate Gcore CDN resource with Webasyst CMS using CNAME custom domain configuration.
---
