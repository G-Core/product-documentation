...
ai-navigation: Configure Gcore CDN CNAME integration in PyroCMS admin panel Settings to rewrite static asset URLs.
ai-navigation: Integrate CDN resource with PyroCMS via CNAME configuration in admin Settings panel.
---
