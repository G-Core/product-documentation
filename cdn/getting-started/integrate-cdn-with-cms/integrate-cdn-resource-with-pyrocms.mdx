---
title: Integrate a CDN resource with PyroCMS
...
<Steps>
  ...
  <Step title="Set the CDN domain">
    Enter the custom domain configured for the CDN resource.
  </Step>
  <Step title="Apply the changes">
    Click **Save**.
  </Step>
  <Step title="Verify asset delivery">
    Open the browser's developer tools by pressing <kbd>F12</kbd>, select the **Network** tab, and refresh the page. Static assets should load from the custom domain instead of the origin domain.
  </Step>
</Steps>
