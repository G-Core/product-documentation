...
Log in to the [Gcore Customer Portal](https://portal.gcore.com/accounts/reports/dashboard) and [create a CDN resource](/cdn/getting-started/create-a-cdn-resource/create-a-cdn-resource). Use S3 Endpoint as an origin source. For example, bucket.s3-website.eu-central-1.amazonaws.com
