...
sidebarTitle: AWS S3
ai-navigation: Configure Gcore CDN resource with AWS S3 bucket as origin, enable static website hosting, set bucket policy, and verify content delivery through CDN CNAME.
ai-navigation: Configure Gcore CDN resource with AWS S3 bucket as origin, enable static website hosting, set bucket policy, and route traffic via CNAME.
---
