...
sidebarTitle: AWS S3
description: Configure Gcore CDN resource with AWS S3 bucket as origin, enable static website hosting, set bucket policy, and verify content delivery through CDN CNAME.
---
