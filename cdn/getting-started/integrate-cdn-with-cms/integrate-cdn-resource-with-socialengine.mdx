...
ai-navigation: Configure Gcore CDN CNAME in SocialEngine admin panel Settings/General Settings and verify URL rewriting in browser Network tab.
ai-navigation: Integrate CDN resource with SocialEngine CMS via CNAME in admin panel Settings/General Settings.
---
