...
ai-navigation: Configure Django CMS urls.py and settings.py to deliver static files via Gcore CDN using CNAME, then run collectstatic command.
ai-navigation: Create CDN resource and configure Django CMS urls.py, settings.py, CNAME record to deliver static files via CDN.
---
