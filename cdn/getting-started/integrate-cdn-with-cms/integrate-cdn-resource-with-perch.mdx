...
sidebarTitle: Perch
ai-navigation: Configure Perch CMS to deliver static assets through Gcore CDN by updating configuration files with CDN resource CNAME and bucket paths.
ai-navigation: Configure Perch CMS to deliver static assets through Gcore CDN resource using CNAME domain and bucket path prefixes.
---
