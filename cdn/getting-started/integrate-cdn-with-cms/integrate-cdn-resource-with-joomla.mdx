...
sidebarTitle: Joomla
ai-navigation: Install Gcore CDN plugin for Joomla 3.4.1+, configure CNAME in System - CDN plugin settings, verify static asset URLs rewritten to CDN domain.
ai-navigation: Install Gcore CDN plugin for Joomla 3.4.1+, configure CNAME record, verify static file URLs rewritten.
---
