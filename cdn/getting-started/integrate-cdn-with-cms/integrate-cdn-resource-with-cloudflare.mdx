...
<Steps>
  ...
  <Step title="Select the origin pull protocol">
    ...
    <Frame>
      ![Origin pull protocol with HTTP, HTTPS, and HTTP and HTTPS options](/images/docs/cdn/getting-started/integrate-cdn-with-cms/integrate-cdn-resource-with-cloudflare/integrate-cdn-resource-with-cloudflare-image1.png)
    </Frame>
  </Step>
  ...
  <Step title="Configure SNI for HTTPS">
    ...
    <Frame>
      ![SNI hostname settings with dynamic and custom hostname options](/images/docs/cdn/getting-started/integrate-cdn-with-cms/integrate-cdn-resource-with-cloudflare/integrate-cdn-resource-with-cloudflare-image2.png)
    </Frame>
  </Step>
