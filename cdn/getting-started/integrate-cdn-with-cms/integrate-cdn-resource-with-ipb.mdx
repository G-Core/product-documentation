...
sidebarTitle: IPB
ai-navigation: Configure IPB CMS to deliver static assets through Gcore CDN by setting CNAME in System settings image, CSS, and JS URL fields.
ai-navigation: Integrate Gcore CDN resource with IPB via CNAME in System settings General configuration images CSS JS URL fields.
---
