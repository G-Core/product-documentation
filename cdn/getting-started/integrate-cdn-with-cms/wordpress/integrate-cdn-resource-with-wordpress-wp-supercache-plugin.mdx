...
ai-navigation: Configure WP Super Cache plugin CDN tab with Gcore CNAME, enable CDN support, and verify static file URL rewriting in WordPress.
ai-navigation: Configure CDN resource with WordPress WP Super Cache plugin using CNAME and Enable CDN Support setting.
---
