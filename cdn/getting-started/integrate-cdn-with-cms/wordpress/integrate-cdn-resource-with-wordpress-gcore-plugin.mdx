...
ai-navigation: Install and configure the Gcore CDN WordPress plugin to enable CDN delivery by setting Enable CDN checkbox, Personal domain, file types (basic or advanced mode with custom extensions), folder paths, and exception URLs.
---
...
<Frame>![Install the plugin](/images/docs/cdn/getting-started/integrate-cdn-with-cms/wordpress/integrate-cdn-resource-with-wordpress-gcore-plugin/integrate-cdn-resource-with-wordpress-gcore-plugin-image1.png)</Frame>
...
<Frame>![Integration with CDN](/images/docs/cdn/getting-started/integrate-cdn-with-cms/wordpress/integrate-cdn-resource-with-wordpress-gcore-plugin/integrate-cdn-resource-with-wordpress-gcore-plugin-image2.png)</Frame>
...
<Frame>![Specify the file extensions ](/images/docs/cdn/getting-started/integrate-cdn-with-cms/wordpress/integrate-cdn-resource-with-wordpress-gcore-plugin/integrate-cdn-resource-with-wordpress-gcore-plugin-image3.png)</Frame>
...
<Frame>![Advanced settings](/images/docs/cdn/getting-started/integrate-cdn-with-cms/wordpress/integrate-cdn-resource-with-wordpress-gcore-plugin/integrate-cdn-resource-with-wordpress-gcore-plugin-image4.png)</Frame>
...
<Frame>![Folders](/images/docs/cdn/getting-started/integrate-cdn-with-cms/wordpress/integrate-cdn-resource-with-wordpress-gcore-plugin/integrate-cdn-resource-with-wordpress-gcore-plugin-image5.png)</Frame>
...
<Frame>![advanced settings](/images/docs/cdn/getting-started/integrate-cdn-with-cms/wordpress/integrate-cdn-resource-with-wordpress-gcore-plugin/integrate-cdn-resource-with-wordpress-gcore-plugin-image6.png)</Frame>
...
<Frame>![Exceptions](/images/docs/cdn/getting-started/integrate-cdn-with-cms/wordpress/integrate-cdn-resource-with-wordpress-gcore-plugin/integrate-cdn-resource-with-wordpress-gcore-plugin-image7.png)</Frame>
