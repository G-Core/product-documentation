...
ai-navigation: Configure XenForo CDN integration by editing config.php and updating Style image path to Gcore CNAME for static asset delivery.
ai-navigation: Configure XenForo CDN integration by editing config.php and replacing image path with Gcore CDN CNAME in Style settings.
---
