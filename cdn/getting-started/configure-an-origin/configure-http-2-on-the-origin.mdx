...
sidebarTitle: HTTP/2
description: Enable HTTP/2 protocol on origin servers using Nginx 1.9.5+ or Apache 2.4.17+ with mod_http2 module for improved CDN content delivery performance.
---
