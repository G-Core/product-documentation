...
sidebarTitle: HTTP/2
ai-navigation: Enable HTTP/2 protocol on origin servers using Nginx 1.9.5+ or Apache 2.4.17+ with mod_http2 module for improved CDN content delivery performance.
ai-navigation: Enable HTTP/2 protocol on CDN origin servers via Nginx 1.9.5+ or Apache 2.4.17+ with mod_http2 module configuration.
---
