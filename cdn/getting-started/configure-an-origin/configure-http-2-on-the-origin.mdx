...
sidebarTitle: HTTP/2
ai-navigation: Enable HTTP/2 protocol on CDN origin servers by configuring Nginx 1.9.5+ with listen directive or Apache 2.4.17+ with mod_http2 module to support multiplexed content delivery over single TCP connections.
---
