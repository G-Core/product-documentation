...
ai-navigation: Whitelist CDN edge servers on origin via HTTP headers, IP addresses, or subnets using API endpoints or request headers.
ai-navigation: Whitelist CDN servers on origin via HTTP headers, IP addresses, or subnets using ACL rules.
---
