...
<Frame>![Client ID location](/images/docs/cdn/cdn-resource-options/configure-live-streams-and-video-delivery-via-cdn-only-for-paid-tariffs/create-a-cdn-resource-for-video-streaming-image1.png)</Frame>
...
<Tabs>
  <Tab title="For Live HLS Streaming">
    ...
    **Why these values?**
    ...
    <Frame>![Cache settings for live streaming](/images/docs/cdn/cdn-resource-options/configure-live-streams-and-video-delivery-via-cdn-only-for-paid-tariffs/create-a-cdn-resource-for-video-streaming-image2.png)</Frame>
  </Tab>
...
<Frame>![Turn on LIVE STREAMING preset](/images/docs/cdn/cdn-resource-options/configure-live-streams-and-video-delivery-via-cdn-only-for-paid-tariffs/create-a-cdn-resource-for-video-streaming-image3.png)</Frame>
