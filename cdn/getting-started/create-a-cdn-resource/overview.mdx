...
ai-navigation: Create a standard CDN resource for websites or a video-streaming resource for HLS, DASH, or FLV, with a thirty-resource account limit.
---

A CDN resource is the configuration for delivering one or more custom domains (a primary domain and optional aliases) through Gcore CDN. It maps these domains to one or several origins and defines all delivery settings — caching rules, SSL certificates, HTTP headers, and security options. Domains that need different settings require separate CDN resources.
...
<Note>
You can create up to thirty CDN resources of all types combined. If you need an increase to this limitation, contact your Account Manager or [Gcore Support](mailto:support@gcore.com).
</Note>
