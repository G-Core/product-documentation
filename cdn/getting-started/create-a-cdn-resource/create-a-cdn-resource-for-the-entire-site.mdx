...
description: Create a CDN resource for entire site acceleration using Gcore CDN and Managed DNS to deliver static and dynamic content without code changes.
---
