...
ai-navigation: Display CDN statistics in Grafana using the cdn-stats plugin to visualize Total Traffic, Byte Cache Hit Ratio, Edges Traffic, Shield Traffic, Origin Traffic, Total Requests, HTTP response codes (2xx, 3xx, 4xx, 5xx), Bandwidth, Cache Hit Ratio, and Shield Traffic Ratio, grouped by Clients, Resource, Region, Country, Data Center, or Vhost parameters.
---
...
<Frame>![Download and install the plugin](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image1.png)</Frame>
...
<Frame>![Configuration](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image2.png)</Frame>
...
<Frame>![data source](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image3.png)</Frame>
...
<Frame>![cdn-stats plugin](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image4.png)</Frame>
...
<Frame>![Add a permanent API token](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image5.png)</Frame>
...
<Frame>![Insert the received API token](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image6.png)</Frame>
...
<Frame>![Save ](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image7.png)</Frame>
...
<Frame>![Configure the Dashboard](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image8.png)</Frame>
...
<Frame>![Add an empty pane](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image9.png)</Frame>


Make sure that "cdn-stats" is set as the data source in the Query section.


<Frame>![query.png](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image10.png)</Frame>
...
<Frame>![Select the necessary metric,](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image11.png)</Frame>
...
<Frame>![Legend](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image12.jpg)</Frame>
...
<Frame>![Traffic ](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image13.png)</Frame>


Open the dashboard settings by clicking on the gear icon in the upper-right corner.


<Frame>![dashboard settings](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image14.png)</Frame>
...
<Frame>![Variables](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image15.png)</Frame>
...
<Frame>![Update](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image16.png)</Frame>
...
<Frame>![Go back t](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image17.png)</Frame>
...
<Frame>![Resources](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image18.png)</Frame>
...
<Frame>![chart](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image19.png)</Frame>
...
<Frame>![Save the Dashboard](/images/docs/cdn/grafana-terraform/view-cdn-statistics-in-grafana/view-cdn-statistics-in-grafana-image20.png)</Frame>
...
<Frame>
<iframe width="100%" src="https://www.youtube.com/embed/EZUdzlpyyDU" title="Dashboard setup: EN" frameborder="0" allow="fullscreen; accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</Frame>
