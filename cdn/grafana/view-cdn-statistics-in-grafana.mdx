...
<Frame>![Download and install the plugin](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/_____________.png)</Frame>
...
<Frame>![Configuration](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/data_source.png)</Frame>
...
<Frame>![data source](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/_________Data_Source.png)</Frame>
...
<Frame>![cdn-stats plugin](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/cdn-stats.png)</Frame>
...
<Frame>![Add a permanent API token](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/mceclip0.png)</Frame>
...
<Frame>![Insert the received API token](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/api_token_1.png)</Frame>
...
<Frame>![Save ](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/save_test.png)</Frame>
...
<Frame>![Configure the Dashboard](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/dashboard.png)</Frame>
...
<Frame>![Add an empty pane](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/add_panel.png)</Frame>


Make sure that "cdn-stats" is set as the data source in the Query section.


<Frame>![query.png](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/query.png)</Frame>
...
<Frame>![Select the necessary metric,](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/query_props_1.png)</Frame>
...
<Frame>![Legend](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/grafa.jpg)</Frame>
...
<Frame>![Traffic ](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/15717167195025.png)</Frame>


Open the dashboard settings by clicking on the gear icon in the upper-right corner.


<Frame>![dashboard settings](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/panel_settings.png)</Frame>
...
<Frame>![Variables](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/add_variable.png)</Frame>
...
<Frame>![Update](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/variables_edit.png)</Frame>
...
<Frame>![Go back t](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/go_back.png)</Frame>
...
<Frame>![Resources](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/filters.png)</Frame>
...
<Frame>![chart](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/pane_____.png)</Frame>
...
<Frame>![Save the Dashboard](/images/docs/cdn/grafana/view-cdn-statistics-in-grafana/save.png)</Frame>
