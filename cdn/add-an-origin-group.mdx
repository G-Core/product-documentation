...
<Frame>![Resource name highlighted](/images/docs/cdn/add-an-origin-group/add-an-origin-group-image1.png)</Frame>
...
<Frame>![Choose a new origin group in resource settings](/images/docs/cdn/add-an-origin-group/add-an-origin-group-image2.png)</Frame>
...
1\. In the [Gcore Customer Portal](https://portal.gcore.com/accounts/reports/dashboard), navigate to **CDN** > **Origin groups**.


<Frame>![Choose a new origin group in resource settings](/images/docs/cdn/add-an-origin-group/add-an-origin-group-image3.png)</Frame>
...
<Frame>![Choose a new origin group in resource settings](/images/docs/cdn/add-an-origin-group/add-an-origin-group-image4.png)</Frame>
...
<Frame>![Amazon S3 authentication for a new origin](/images/docs/cdn/add-an-origin-group/add-an-origin-group-image5.png)</Frame>
...
<Frame>![Other S3 storage](/images/docs/cdn/add-an-origin-group/add-an-origin-group-image6.png)</Frame>
...
<Frame>![Without authentication](/images/docs/cdn/add-an-origin-group/add-an-origin-group-image7.png)</Frame>
...
<Frame>![Set up multiple origins](/images/docs/cdn/add-an-origin-group/add-an-origin-group-image8.png)</Frame>
...
<Frame>![Amazon S3 authentication for a new origin](/images/docs/cdn/add-an-origin-group/add-an-origin-group-image2.png)</Frame>
