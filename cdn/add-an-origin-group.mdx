...
ai-navigation: Create and attach origin groups with single or multiple origins to CDN resources, configuring failover logic and round-robin distribution between primary and
ai-navigation: Create origin groups with single or multiple origins, configure round-robin or backup failover logic, attach to CDN resources.
---
