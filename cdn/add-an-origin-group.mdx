...
description: Create and attach origin groups with single or multiple origins to CDN resources, configuring failover logic and round-robin distribution between primary and...
---
