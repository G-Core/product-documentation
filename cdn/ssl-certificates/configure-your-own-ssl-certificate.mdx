...
ai-navigation: Upload custom SSL certificates in PEM format with certificate chain (personal certificate, intermediate CA, root CA) and private key to Gcore CDN, then attach to CDN resources for custom domains and wildcard subdomains.
---
...
1\. Go to [SSL certificates](https://portal.gcore.com/cdn/ssl/) and click **Add SSL certificate**. 


<Frame>![SSL certificates](/images/docs/cdn/ssl-certificates/configure-your-own-ssl-certificate/configure-your-own-ssl-certificate-image1.png)</Frame>
...
<Frame>![new page will open](/images/docs/cdn/ssl-certificates/configure-your-own-ssl-certificate/configure-your-own-ssl-certificate-image2.png)</Frame>
...
That's it. The certificate will be added to the list of certificates in the [SSL Certificates](https://portal.gcore.com/cdn/ssl/) section. 


<Frame>![Create SSL Certificate](/images/docs/cdn/ssl-certificates/configure-your-own-ssl-certificate/configure-your-own-ssl-certificate-image3.png)</Frame>
...
<Frame>![certificate chain](/images/docs/cdn/ssl-certificates/configure-your-own-ssl-certificate/configure-your-own-ssl-certificate-image4.png)</Frame>
...
<Frame>![new line at the end of the certificate chain](/images/docs/cdn/ssl-certificates/configure-your-own-ssl-certificate/configure-your-own-ssl-certificate-image5.png)</Frame>
...
<Frame>![Create a CDN resource](/images/docs/cdn/ssl-certificates/configure-your-own-ssl-certificate/configure-your-own-ssl-certificate-image6.png)</Frame>
...
<Frame>![ Add SSL certificate](/images/docs/cdn/ssl-certificates/configure-your-own-ssl-certificate/configure-your-own-ssl-certificate-image7.png)</Frame>
...
1\. Select the resource you want to configure in the [CDN resources](https://portal.gcore.com/cdn/resources/list) section.


<Frame>![CDN resources section](/images/docs/cdn/ssl-certificates/configure-your-own-ssl-certificate/configure-your-own-ssl-certificate-image8.png)</Frame>
...
<Frame>![General section](/images/docs/cdn/ssl-certificates/configure-your-own-ssl-certificate/configure-your-own-ssl-certificate-image9.png)</Frame>
...
<Frame>![Add or select your own SSL certificate](/images/docs/cdn/ssl-certificates/configure-your-own-ssl-certificate/configure-your-own-ssl-certificate-image10.png)</Frame>
...
<Frame>![SSL certificates overview](/images/docs/cdn/ssl-certificates/configure-your-own-ssl-certificate/configure-your-own-ssl-certificate-image7.png)</Frame>
...
The certificate will be displayed in the [SSL certificates](https://portal.gcore.com/cdn/ssl/list) section in the Gcore Customer Portal. This page contains a table that lists your personal certificates and associated information, such as the ID, name, CDN resources connected to the certificate, and expiration date.


<Frame>![Renew an SSL certificate](/images/docs/cdn/ssl-certificates/configure-your-own-ssl-certificate/configure-your-own-ssl-certificate-image11.png)</Frame>
...
1\. Go to the [SSL Certificates](https://portal.gcore.com/cdn/ssl/list) page and [upload a new certificate](/cdn/ssl-certificates/configure-your-own-ssl-certificate#how-to-upload-an-ssl-certificate-to-your-account).
...
<Frame>![verify that the SSL certificate](/images/docs/cdn/ssl-certificates/configure-your-own-ssl-certificate/configure-your-own-ssl-certificate-image12.png)</Frame>
...
In addition, when you log in to your account during the fourteen days before certificate expiration or any time after that, you will see a reminder. The [SSL certificates](https://portal.gcore.com/cdn/ssl/list) in the side panel will also be marked with an exclamation point if there are expired certificates or certificates that will expire within the next fourteen days.


<Frame>![SSL certificates](/images/docs/cdn/ssl-certificates/configure-your-own-ssl-certificate/configure-your-own-ssl-certificate-image13.png)</Frame>
...
<Frame>![certificate has already expired](/images/docs/cdn/ssl-certificates/configure-your-own-ssl-certificate/configure-your-own-ssl-certificate-image14.png)</Frame>
...
<Frame>![certificate is due to expire](/images/docs/cdn/ssl-certificates/configure-your-own-ssl-certificate/configure-your-own-ssl-certificate-image15.png)</Frame>
...
<Frame>![Delete an SSL certificate](/images/docs/cdn/ssl-certificates/configure-your-own-ssl-certificate/configure-your-own-ssl-certificate-image16.png)</Frame>
