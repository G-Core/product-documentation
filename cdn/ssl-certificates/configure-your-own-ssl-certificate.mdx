...
1\. Follow steps 1–3 of the guide [Create a CDN resource for static assets only](/cdn/getting-started/create-a-cdn-resource/create-a-cdn-resource) until the "Custom domain" field is filled in.
...
<Frame>![General section](/images/docs/cdn/ssl-certificates/configure-lets-encrypt-certificate/lets-encrypt-3.png)</Frame>
