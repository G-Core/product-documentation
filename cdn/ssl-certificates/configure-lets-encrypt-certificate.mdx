...
<Frame>
  ![Pre-validation failed status](/images/docs/cdn/ssl-certificates/configure-lets-encrypt-certificate/pre-issuing-failed-10.png)
</Frame>
...
<Frame>
  ![Failed status](/images/docs/cdn/ssl-certificates/configure-lets-encrypt-certificate/failed-50.png)
</Frame>
...
<Frame>
  ![Failed status (reissuing)](/images/docs/cdn/ssl-certificates/configure-lets-encrypt-certificate/ssl-renew-certificate.png)
</Frame>
