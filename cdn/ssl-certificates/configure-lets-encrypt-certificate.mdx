...
<Frame>
  ![During resource creation](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/configure-lets-encrypt-certificate-image1.png)
</Frame>
...
<Frame>
  ![CDN resource](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/configure-lets-encrypt-certificate-image2.png)
</Frame>

2. In the navigation panel, under the **General** section, click **SSL**.

<Frame>
  ![General section](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/configure-lets-encrypt-certificate-image3.png)
</Frame>
...
<Frame>
  ![SSL section](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/configure-lets-encrypt-certificate-image1.png)
</Frame>
...
<Frame>
  ![Warning](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/configure-lets-encrypt-certificate-image4.png)
</Frame>
...
<Frame>
  ![Revoke a Let's Encrypt certificate](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/configure-lets-encrypt-certificate-image5.png)
</Frame>
...
<Frame>
  ![Restrictions and features of the option](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/configure-lets-encrypt-certificate-image6.png)
</Frame>
...
<Frame>
  ![Status](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/configure-lets-encrypt-certificate-image7.png)
</Frame>
...
<Frame>
  ![Pre-validation failed status](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/configure-lets-encrypt-certificate-image8.png)
</Frame>
...
<Frame>
  ![Processing status](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/configure-lets-encrypt-certificate-image9.png)
</Frame>
...
<Frame>
  ![Processing with issue status](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/configure-lets-encrypt-certificate-image10.png)
</Frame>
...
<Frame>
  ![Success status](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/configure-lets-encrypt-certificate-image5.png)
</Frame>
...
<Frame>
  ![Failed status](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/configure-lets-encrypt-certificate-image11.png)
</Frame>
...
<Frame>
  ![Failed status (reissuing)](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/configure-lets-encrypt-certificate-image12.png)
</Frame>
