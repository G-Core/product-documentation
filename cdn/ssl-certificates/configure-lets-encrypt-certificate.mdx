...
<Frame>
  ![General section](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/ssl-menu.png)
</Frame>
...
<Frame>
  ![Warning](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/warning.png)
</Frame>
...
<Frame>
  ![Revoke a Let's Encrypt certificate](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/ssl-revoke.png)
</Frame>
...
<Frame>
  ![Restrictions and features of the option](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/ssl-certificates.png)
</Frame>
...
<Frame>
  ![Status](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/configure-lets-encrypt-certificate-image8.png)
</Frame>
...
<Frame>
  ![Pre-validation failed status](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/configure-lets-encrypt-certificate-image9.png)
</Frame>
...
<Frame>
  ![Processing status](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/ssl-processing.png)
</Frame>
...
<Frame>
  ![Processing with issue status](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/ssl-force-retry.png)
</Frame>
...
<Frame>
  ![Success status](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/ssl-revoke.png)
</Frame>
...
<Frame>
  ![Failed status](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/configure-lets-encrypt-certificate-image13.png)
</Frame>
...
<Frame>
  ![Failed status (reissuing)](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/ssl-renew-certificate.png)
</Frame>
