...
ai-navigation: Enable HTTPS with free Let's Encrypt certificates on CDN resources using HTTP-01 or DNS-01 challenge validation methods.
ai-navigation: Enable HTTPS with free Let's Encrypt certificate on CDN resources using HTTP-01 or DNS-01 challenge validation.
---
...
3\. Enable the `use_dns01_le_challenge` option. Check our [API documentation](/api-reference/cdn/lets-encrypt-certificates/issue-lets-encrypt-certificate#issue-lets-encrypt-certificate) for help with this.
