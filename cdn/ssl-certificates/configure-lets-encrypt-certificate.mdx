...
<p>The **Failed** status can also occur when the Let's Encrypt certificate isn't renewed automatically. Correct the error (for example, change the domain's DNS records) and click **Renew certificate** to issue a new certificate and attach it to your CDN resource.</p>
