...
<Frame>
  ![CDN resource](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/cdn-resource-name.png)
</Frame>
...
<Frame>
  ![SSL section](/images/docs/cdn/ssl-certificates/configure-lets-encypt-certificate/lets-encrypt-4.png)
</Frame>
