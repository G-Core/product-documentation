...
ai-navigation: Create and manage CDN resources in the Gcore Customer Portal with filtering by status (Active, Suspended, Processing, Deleted), search by CNAME or resource ID, and operations including Settings, Prefetch, Purge, Statistics, Suspend resource, and LIVE STREAMING preset configuration.
---
...
<Frame>![CDN resources page showing the resource list with status filter and search bar](/images/docs/cdn/about-cdn-resources-interface-how-it-is-arranged/about-cdn-resources-interface-how-it-is-arranged-image1.png)</Frame>

## Create a CDN resource

Click the **Create CDN resource** button in the upper-right corner of the page.

<Frame>![CDN resources page with Create CDN resource button highlighted](/images/docs/cdn/about-cdn-resources-interface-how-it-is-arranged/about-cdn-resources-interface-how-it-is-arranged-image2.png)</Frame>
...
<Frame>![Status filter dropdown showing filter options: Active, Suspended, Processing, and Deleted](/images/docs/cdn/about-cdn-resources-interface-how-it-is-arranged/about-cdn-resources-interface-how-it-is-arranged-image3.png)</Frame>

### Manage options

Each CDN resource in the list has a three-dot icon that opens a menu of management options.

<Frame>![CDN resource three-dot menu showing management options](/images/docs/cdn/about-cdn-resources-interface-how-it-is-arranged/about-cdn-resources-interface-how-it-is-arranged-image4.png)</Frame>
...
<Frame>![CDN resource menu with Delete resource option highlighted](/images/docs/cdn/about-cdn-resources-interface-how-it-is-arranged/about-cdn-resources-interface-how-it-is-arranged-image5.png)</Frame>
...
<Frame>![Suspension confirmation dialog shown when deleting an active CDN resource](/images/docs/cdn/about-cdn-resources-interface-how-it-is-arranged/about-cdn-resources-interface-how-it-is-arranged-image6.png)</Frame>
