...
ai-navigation: Navigate CDN resources interface: create resources, filter by status (Active, Suspended, In processing, Deleted), search by CNAME or ID, and access Settings
ai-navigation: Create, filter, search, and manage CDN resources by status, CNAME, ID; access Settings, Prefetch, Purge, Statistics, LIVE STREAMING preset.
---
