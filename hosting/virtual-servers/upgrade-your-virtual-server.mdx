...
ai-navigation: Upgrade Virtual Server plan by selecting a new tariff with matching location and equal or higher vCPU, RAM, disk space, bandwidth, and traffic specifications, then submit a support ticket with server ID and desired plan for replacement within 30-60 minutes of downtime.
---
...
<Frame>![Upgrade your Virtual Server](/images/docs/hosting/virtual-servers/upgrade-your-virtual-server/upgrade-your-virtual-server-image1.png)</Frame>
...
<Frame>![Support tickets section](/images/docs/hosting/virtual-servers/upgrade-your-virtual-server/upgrade-your-virtual-server-image2.png)</Frame>
...
<Frame>![End date](/images/docs/hosting/virtual-servers/upgrade-your-virtual-server/upgrade-your-virtual-server-image3.png)</Frame>