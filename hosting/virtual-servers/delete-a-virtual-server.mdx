...
sidebarTitle: Delete
ai-navigation: Remove virtual servers from Control Panel; permanently deletes data and stops billing after minimum 1-month service term.
ai-navigation: Delete virtual server from Control Panel; removes all data and stops billing after minimum 1-month term.
---
