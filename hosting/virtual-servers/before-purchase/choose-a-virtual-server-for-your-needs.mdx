...
ai-navigation: Compare Virtual Server plan categories KVM-SSD, KVM-SAS, KVM-HIGHCPU-SSD, and KVM-HIGHCPU-SAS by CPU cores, RAM, disk type (SSD or HDD SAS), data center location, and operating system availability to select appropriate billing plans.
---
...
[On the shop window](https://hosting.gcore.com/billmgr), choose the location of a data center and the system will display a list of available servers there. The description contains server specifications.


<Frame>![mceclip0.png](/images/docs/hosting/virtual-servers/before-purchase/choose-a-virtual-server-for-your-needs/choose-a-virtual-server-for-your-needs-image1.png)</Frame>



[On our website](https://gcore.com/hosting/vds), we have a full list of plans and a filter by technical specifications. You can specify the required data center, number of CPU cores, amount of RAM, amount of disk space, operating system, and price. The system will show the available plans after you specify your requirements.

<Frame>![mceclip6.png](/images/docs/hosting/virtual-servers/before-purchase/choose-a-virtual-server-for-your-needs/choose-a-virtual-server-for-your-needs-image2.png)</Frame>
...
<Frame>![mceclip1.png](/images/docs/hosting/virtual-servers/before-purchase/choose-a-virtual-server-for-your-needs/choose-a-virtual-server-for-your-needs-image3.png)</Frame>

<Frame>![mceclip8.png](/images/docs/hosting/virtual-servers/before-purchase/choose-a-virtual-server-for-your-needs/choose-a-virtual-server-for-your-needs-image4.png)</Frame>
...
**Regardless of the plan, each server** has one IPv4 and one IPv6 address. If you want more than one IP, you can additionally buy up to nine IPv4 and nine IPv6 addresses at any plan. You can buy only one additional IPv4 and IPv6 address on it. Also, you can replace OS on any server [with one of our template OS](/hosting/virtual-servers/manage/operating-system/install-a-linux-os-from-a-template) or [with one your ISO images](/hosting/virtual-servers/manage/operating-system/install-a-linux-os-from-your-iso-image) .
...
If you are not sure how many resources your tasks will consume and what plan is needed, you can order any appropriate plan and check if the server is suitable for your tasks. We can [upgrade your plan](/hosting/virtual-servers/upgrade-your-virtual-server) if the server you have chosen doesn't have enough performance. If you want to order the upgrade, write to technical support and specify the desired configuration.