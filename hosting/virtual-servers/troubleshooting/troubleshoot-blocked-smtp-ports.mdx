...
ai-navigation: Troubleshoot blocked SMTP ports 25, 465, and 587 on Virtual Servers by checking Support tickets for spam-related blocks, verifying compliance with Acceptable Use Policy, and contacting technical support with domain name or server configuration details to request port unblocking.
---
...
<Frame>![Support ticket in the Control Panel](/images/docs/hosting/virtual-servers/troubleshooting/troubleshoot-blocked-smtp-ports/troubleshoot-blocked-smtp-ports-image1.png)</Frame>

 
<Frame>![Troubleshoot blocked SMTP ports](/images/docs/hosting/virtual-servers/troubleshooting/troubleshoot-blocked-smtp-ports/troubleshoot-blocked-smtp-ports-image2.png)</Frame>
