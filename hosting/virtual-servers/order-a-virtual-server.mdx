...
sidebarTitle: Order
description: Purchase virtual server with OS selection, additional IP addresses, domain configuration, and automatic activation within 3 hours via cart checkout and payment.
---
