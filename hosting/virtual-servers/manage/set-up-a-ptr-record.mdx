...
ai-navigation: "Configure PTR records for Virtual Private Servers and Dedicated Servers by mapping IP addresses to domain names via the IP addresses management interface to enable email server identification and prevent spam filtering."
---
...
<Frame>
  ![Edit tab](/images/docs/hosting/virtual-servers/manage/set-up-a-ptr-record/set-up-a-ptr-record-image2.png)
</Frame>
...
<Frame>
  ![IP addresses window](/images/docs/hosting/virtual-servers/manage/set-up-a-ptr-record/set-up-a-ptr-record-image3.png)
</Frame>
...
<Frame>
  ![IP addresses list](/images/docs/hosting/virtual-servers/manage/set-up-a-ptr-record/4-ip-addressess-old.png)
</Frame>

3. Choose the IP address for which you want to set or change a PTR record and click on **Edit**.

<Frame>
  ![Edit tab](/images/docs/hosting/virtual-servers/manage/set-up-a-ptr-record/5-edit-old.png)
</Frame>

4. In the newly opened window, put a domain name into the **Domain** field and click **OK**. The PTR record will be created automatically.

<Frame>
  ![IP addresses window](/images/docs/hosting/virtual-servers/manage/set-up-a-ptr-record/6-domain-old.png)
</Frame>