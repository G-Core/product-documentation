...
ai-navigation: Mount ISO images to VMmanager 6 virtual servers via HTTP(S) or FTP URLs with optional OS tags for script execution.
ai-navigation: Mount ISO image to Virtual Server in VMmanager 6 via HTTP(S) or FTP URL with optional OS tags.
---
...
<Frame>![Virtual private servers](/images/docs/hosting/virtual-servers/manage/operating-system/install-an-os-from-iso-image/1-to-panel-old-interface.png)</Frame>
...
<Frame>![To Panel](/images/docs/hosting/virtual-servers/manage/operating-system/install-an-os-from-iso-image/2-to-panel-new-interface.png)</Frame>
...
<Frame>![Mount ISO-image](/images/docs/hosting/virtual-servers/manage/operating-system/install-an-os-from-iso-image/3-mount-iso.png)</Frame>
...
<Frame>![upload](/images/docs/hosting/virtual-servers/manage/operating-system/install-an-os-from-iso-image/4-url-tags.png)</Frame>
...
Now you can use the server with the operating system that you installed from an ISO image. To connect to your server via VNC, you can refer to [our PD article](/hosting/virtual-servers/manage/connect/connect-to-a-virtual-server-via-vnc).