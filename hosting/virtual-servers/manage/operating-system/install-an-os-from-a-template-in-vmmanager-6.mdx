...
ai-navigation: Reinstall virtual machine operating systems from CentOS, Debian, FreeBSD, or Ubuntu templates in VMmanager 6 with optional application scripts and password c
ai-navigation: Deploy operating system from template (CentOS, Debian, FreeBSD, Ubuntu) to VMmanager 6 virtual machine with optional scripts.
---
...
For more information about VMmanager 6's features and functions, refer to [our PD article](/hosting/virtual-servers/manage/main-features-and-functions-of-vmmanager-6).

To proceed with the OS installation, follow these steps:

  1. Go to the [Virtual machines](https://bix-v6.vm.gcore.com/vm/manager/host) page and find the desired server.

  2. Click the three-dot menu on the right-hand side and select Reinstall OS.



<Frame>![Virtual machines page ](/images/docs/hosting/virtual-servers/manage/operating-system/install-an-os-from-a-template/1-menu.png)</Frame>
...
<Frame>![next page,](/images/docs/hosting/virtual-servers/manage/operating-system/install-an-os-from-a-template/2-configuration-options.png)</Frame>
