...
description: Install XFCE desktop environment on Ubuntu, CentOS, and Debian servers via apt/yum package managers and configure lightdm or xinit display manager.
---
