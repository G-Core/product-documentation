...
Follow these instructions to modify the SSH port through which you connect to your Linux server.
  ...
  4. Find the **Port** line in the open file and replace the value 22 with the port number you want to use. Also, remove the **#** symbol if it is present before the **Port** line.
    ...
    <Frame>![terminal](/images/docs/hosting/virtual-servers/manage/connect/linux-server/change-the-port-for-ssh-connections/1-port-22.png)</Frame>

    
    <Frame>![terminal](/images/docs/hosting/virtual-servers/manage/connect/linux-server/change-the-port-for-ssh-connections/2-port-2233.png)</Frame>
  ...
  8. Verify if everything is functioning properly by using the command:
    ...
    <Frame>![output](/images/docs/hosting/virtual-servers/manage/connect/linux-server/change-the-port-for-ssh-connections/3-output.png)</Frame>
