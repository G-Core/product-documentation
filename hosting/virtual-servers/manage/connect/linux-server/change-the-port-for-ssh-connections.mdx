...
ai-navigation: Modify SSH port in sshd_config, restart SSH service, update firewall rules, and verify connectivity on Linux servers.
ai-navigation: Configure SSH port in sshd_config, restart SSH service, add firewall rule, verify connectivity on Linux server.
---
