...
<Frame>![ DCImanager](/images/docs/hosting/dedicated-servers/manage/connect/manage-ssh-keys/manage-ssh-keys-image1.png)</Frame>
...
<Frame>![Manage SSH keys](/images/docs/hosting/dedicated-servers/manage/connect/manage-ssh-keys/manage-ssh-keys-image2.png)</Frame>
