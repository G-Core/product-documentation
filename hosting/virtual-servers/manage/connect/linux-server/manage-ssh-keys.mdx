...
ai-navigation: Create, edit, and delete SSH public keys for automated server authentication across dedicated server instances.
ai-navigation: Create SSH keys with public key and name; automatically added to future servers and OS reinstalls.
---
