...
ai-navigation: Establish SSH remote connections to Linux servers (CentOS, Debian, Ubuntu, FreeBSD) using credentials from server instructions panel.
ai-navigation: Connect to Linux servers (CentOS, Debian, Ubuntu, FreeBSD) via SSH using username, server IP address, and password authentication.
---
