...
sidebarTitle: VNC
ai-navigation: Connect to a Virtual Server via VNC console in VMmanager 6 using Remote Frame Buffer protocol with root credentials from the Instructions tab.
---
