...
ai-navigation: Allocate and view IPv6 subnets and addresses assigned to Virtual Servers in VMmanager 6 Virtual machines tab.
ai-navigation: Allocate IPv6 subnet and address to Virtual Server in VMmanager 6 via Virtual machines tab.
---
