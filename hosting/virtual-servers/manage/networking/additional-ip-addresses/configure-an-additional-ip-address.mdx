...
<Frame>
  ![Configure an additional IP address on CentOS](/images/docs/hosting/virtual-servers/manage/networking/additional-ip-addresses/configure-an-additional-ip-address/configure-an-additional-ip-address-image1.png)
</Frame>

<Frame>
  ![Configure an additional IP address on CentOS](/images/docs/hosting/virtual-servers/manage/networking/additional-ip-addresses/configure-an-additional-ip-address/configure-an-additional-ip-address-image2.png)
</Frame>
...
<Frame>
  ![Configure an additional IP address on CentOS](/images/docs/hosting/virtual-servers/manage/networking/additional-ip-addresses/configure-an-additional-ip-address/configure-an-additional-ip-address-image3.png)
</Frame>

<Frame>
  ![Configure an additional IP address on CentOS](/images/docs/hosting/virtual-servers/manage/networking/additional-ip-addresses/configure-an-additional-ip-address/configure-an-additional-ip-address-image4.png)
</Frame>
