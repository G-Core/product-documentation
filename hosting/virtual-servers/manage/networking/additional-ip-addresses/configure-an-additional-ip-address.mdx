...
ai-navigation: "Configure additional IP addresses on Virtual Private Servers and Dedicated Servers by editing network configuration files on Debian/Ubuntu, CentOS, or Windows Server 2012, specifying interface serial number, IPv4/IPv6 address, and netmask."
---
...
<Frame>
  ![Configure an additional IP address on CentOS](/images/docs/hosting/dedicated-servers/manage/networking/additional-ip-addresses/configure-an-additional-ip-address/configure-an-additional-ip-address-image1.png)
</Frame>

<Frame>
  ![Configure an additional IP address on CentOS](/images/docs/hosting/dedicated-servers/manage/networking/additional-ip-addresses/configure-an-additional-ip-address/configure-an-additional-ip-address-image2.png)
</Frame>
...
<Frame>
  ![Configure an additional IP address on CentOS](/images/docs/hosting/dedicated-servers/manage/networking/additional-ip-addresses/configure-an-additional-ip-address/configure-an-additional-ip-address-image3.png)
</Frame>

<Frame>
  ![Configure an additional IP address on CentOS](/images/docs/hosting/dedicated-servers/manage/networking/additional-ip-addresses/configure-an-additional-ip-address/configure-an-additional-ip-address-image4.png)
</Frame>
