...
<Steps>
  ...
  <Step title="Open VMmanager 6">
    ...
    <Frame>![Virtual private servers list with a server row selected and the To panel button highlighted in the toolbar](/images/docs/hosting/virtual-servers/manage/main-features-and-functions-of-vmmanager-6/main-features-and-functions-of-vmmanager-6-image3.png)</Frame>
  </Step>
</Steps>
