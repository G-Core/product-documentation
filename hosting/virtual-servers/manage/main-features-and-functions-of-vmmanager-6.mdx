...
ai-navigation: Manage VPS instances via VMmanager 6 control panel: start/stop/restart servers, reinstall OS, mount ISO images, manage disks, access VNC console, run scripts
ai-navigation: Manage virtual servers via VMmanager 6: start/stop, restart, reinstall OS, mount ISO, change password, manage disks, access VNC, run scripts.
---
...
<Frame>![Navigation in the VMmanager 6](/images/docs/hosting/virtual-servers/manage/vmmanager-6/1-navigation.jpg)</Frame>
