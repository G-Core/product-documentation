...
description: Set user permissions in Control Panel via Client > Users > Perm to enable/disable access to sections, operations, and subsections; configure full access or b...
---
