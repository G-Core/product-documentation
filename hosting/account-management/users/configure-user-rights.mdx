...
ai-navigation: Configure user rights in Control Panel by enabling or disabling access to sections, subsections, and operations per user via Perm settings, or grant Full access permissions to bypass restrictions.
---
...
<Frame>![Users](/images/docs/hosting/account-managemnt/users/configure-user-rights/configure-user-rights-image1.png)</Frame>
...
<Frame>![Enable in the top menu](/images/docs/hosting/account-managemnt/users/configure-user-rights/configure-user-rights-image2.png)</Frame>
...
<Frame>![Users section](/images/docs/hosting/account-managemnt/users/configure-user-rights/configure-user-rights-image3.png)</Frame>
...
<Frame>![Full access](/images/docs/hosting/account-managemnt/users/configure-user-rights/configure-user-rights-image4.png)</Frame>
...
<Frame>![User blocking](/images/docs/hosting/account-managemnt/users/configure-user-rights/configure-user-rights-image5.png)</Frame>
