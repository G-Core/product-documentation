...
ai-navigation: Set user permissions in Control Panel via Client > Users > Perm to enable/disable access to sections, operations, and subsections; configure full access or b
ai-navigation: Configure user permissions by section, enable/disable Control Panel access, or grant full access rights in Client - Users.
---
