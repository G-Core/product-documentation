...
description: Change Control Panel password via Client Profile with 8+ characters including uppercase and number; recover forgotten password via recovery page or contact s...
---
