...
ai-navigation: Change or recover Control Panel password via Client Profile section or password recovery page; password must contain minimum 8 characters including uppercase letter and number; account temporarily disabled after 3 failed login attempts.
---
...
<Frame>![Profile section in the control panel](/images/docs/hosting/account-managemnt/manage-your-password/manage-your-password-image1.png)</Frame>
