...
ai-navigation: Request hardware upgrades for Dedicated Servers including RAID configuration, disk/RAM/network card changes via support tickets with 150 USD/EUR service fee.
ai-navigation: Upgrade Dedicated Server hardware: RAID configuration, disk volume, RAM, SSD/HDD swap, 10 Gbps network cards via support ticket.
---
...
1\. You select the desired specifications in the [Dedicated Servers section](https://gcore.com/hosting/dedicated) of our website. 10 Gbps network cards are not listed there, but they can be installed too. New specifications must not be lower than the current ones. 


<Frame>![Dedicated Servers section](/images/docs/hosting/dedicated-servers/upgrade-your-dedicated-server/image7.png)</Frame>
...
<Frame>![Contact the technical support ](/images/docs/hosting/dedicated-servers/upgrade-your-dedicated-server/mceclip1.png)</Frame>
...
<Frame>![Information](/images/docs/hosting/dedicated-servers/upgrade-your-dedicated-server/mceclip0.png)</Frame>
...
<Frame>![Dedicated Servers](/images/docs/hosting/dedicated-servers/upgrade-your-dedicated-server/image4.png)</Frame>
...
<Frame>![Edit button](/images/docs/hosting/dedicated-servers/upgrade-your-dedicated-server/image12.png)</Frame>
...
<Frame>![Order Information](/images/docs/hosting/dedicated-servers/upgrade-your-dedicated-server/image8.png)</Frame>
...
<Frame>![Pay for the order.](/images/docs/hosting/dedicated-servers/upgrade-your-dedicated-server/image4.png)</Frame>