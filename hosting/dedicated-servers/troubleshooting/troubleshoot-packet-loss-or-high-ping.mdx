...
description: Diagnose packet loss and latency exceeding 110ms using ping, tracert/traceroute/mtr commands; disable VPN/proxy or reset network settings via OS reinstall.
---
