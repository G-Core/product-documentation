...
ai-navigation: Diagnose packet loss and latency exceeding 110ms using ping, tracert/traceroute/mtr commands; disable VPN/proxy or reset network settings via OS reinstall.
ai-navigation: Diagnose packet loss and high ping using ping, traceroute, tracert, mtr commands; disable VPN/proxy and reset network settings.
---
...
To return your network settings to the default parameters, reinstall your OS. Refer to the guides:
  ...
  * [Reinstall your OS from our templates](/hosting/dedicated-servers/manage/operating-system/install-a-linux-os-from-a-template). 
  * [Reinstall your OS from an ISO image](/hosting/dedicated-servers/manage/operating-system/install-a-linux-os-from-your-iso-image).



3\. If the steps above are not applicable to you, or they don't help, [contact our technical support](/hosting/contact-our-technical-support). Please provide the following information in your message:
