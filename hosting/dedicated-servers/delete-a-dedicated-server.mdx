...
sidebarTitle: Delete
ai-navigation: Remove dedicated server instances via Control Panel; permanently erases data and stops billing after deletion confirmation.
ai-navigation: Delete dedicated server via Control Panel with confirmation; erases all data and stops billing.
---
