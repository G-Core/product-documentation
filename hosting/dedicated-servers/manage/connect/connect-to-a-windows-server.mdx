...
Windows servers support Remote Desktop Protocol (RDP) for remote access. Connection requires the server IP address, username, and password — available in the [Hosting&nbsp;portal](https://hosting.gcore.com) and in the activation email sent after provisioning.
