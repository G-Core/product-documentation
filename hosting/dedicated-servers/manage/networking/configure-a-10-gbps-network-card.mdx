...
ai-navigation: Configure 10 Gbps network interfaces on Dedicated Servers by identifying active interfaces with ethtool, checking supported link modes, and activating 10 Gbps-capable network cards on Ubuntu/Debian using ip, ethtool, and nano configuration tools.
---
...
<Frame>![output ](/images/docs/hosting/dedicated-servers/manage/networking/configure-a-10-gbps-network-card/configure-a-10-gbps-network-card-image1.png)</Frame>
...
<Frame>![output ](/images/docs/hosting/dedicated-servers/manage/networking/configure-a-10-gbps-network-card/configure-a-10-gbps-network-card-image2.png)</Frame>
...
<Frame>![output ](/images/docs/hosting/dedicated-servers/manage/networking/configure-a-10-gbps-network-card/configure-a-10-gbps-network-card-image3.png)</Frame>
...
<Frame>![output ](/images/docs/hosting/dedicated-servers/manage/networking/configure-a-10-gbps-network-card/configure-a-10-gbps-network-card-image4.png)</Frame>
...
<Frame>![output ](/images/docs/hosting/dedicated-servers/manage/networking/configure-a-10-gbps-network-card/configure-a-10-gbps-network-card-image5.png)</Frame>
...
<Frame>![output ](/images/docs/hosting/dedicated-servers/manage/networking/configure-a-10-gbps-network-card/configure-a-10-gbps-network-card-image6.png)</Frame>
...
<Frame>![output ](/images/docs/hosting/dedicated-servers/manage/networking/configure-a-10-gbps-network-card/configure-a-10-gbps-network-card-image7.png)</Frame>
...
<Frame>![output ](/images/docs/hosting/dedicated-servers/manage/networking/configure-a-10-gbps-network-card/configure-a-10-gbps-network-card-image8.png)</Frame>
