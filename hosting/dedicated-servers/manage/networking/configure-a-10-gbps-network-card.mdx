...
ai-navigation: Enable 10 Gbps network interface on Dedicated Servers using ethtool, ip commands, and network configuration files for Ubuntu/Debian with LACP support.
ai-navigation: Configure 10 Gbps network interface on Dedicated Server using ethtool, ip commands, and network configuration files for Ubuntu/Debian.
---
