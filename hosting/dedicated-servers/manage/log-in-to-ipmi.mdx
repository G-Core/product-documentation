...
ai-navigation: Access IPMI interface for Dedicated Servers to remotely power on/off, reboot, or reinstall OS via DCI manager or server panel.
ai-navigation: Access IPMI console for Dedicated Server remote power management, OS reinstall, and server monitoring via DCI manager.
---
