...
<Frame>
  ![Dedicated Server section](/images/docs/hosting/dedicated-servers/manage/log-in-to-ipmi/login-to-ipmi-image1.png)
</Frame>

In DCI manager, choose the server you need and click on the monitor button to go to IPMI.

<Frame>
  ![DCI manager,](/images/docs/hosting/dedicated-servers/manage/log-in-to-ipmi/mceclip0.png)
</Frame>
...
<Frame>
  ![Login ](/images/docs/hosting/dedicated-servers/manage/log-in-to-ipmi/3.png)
</Frame>