...
ai-navigation: "Access IPMI interface for Dedicated Servers to remotely power on, power off, reboot servers, or reinstall OS via ISO through DCI manager or Gcore portal using local username and password authentication."
---
...
<Frame>
  ![Dedicated Server section](/images/docs/hosting/dedicated-servers/manage/log-in-to-ipmi/log-in-to-ipmi-image1.png)
</Frame>

In DCI manager, choose the server you need and click on the monitor button to go to IPMI.

<Frame>
  ![DCI manager,](/images/docs/hosting/dedicated-servers/manage/log-in-to-ipmi/log-in-to-ipmi-image2.png)
</Frame>
...
<Frame>
  ![Login ](/images/docs/hosting/dedicated-servers/manage/log-in-to-ipmi/log-in-to-ipmi-image3.png)
</Frame>