...
ai-navigation: Access DCImanager panel with dedicated credentials to manage servers, reboot, or stop instances via the Servers menu.
ai-navigation: Access DCImanager panel with dedicated server login credentials to reboot, stop, or manage servers directly.
---
