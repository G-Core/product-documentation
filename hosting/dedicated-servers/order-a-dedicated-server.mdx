...
sidebarTitle: Order
ai-navigation: Purchase dedicated servers by selecting tariffs, configuring parameters (OS, domain, traffic, IPv4/IPv6 addresses), and completing payment through Control Pa
ai-navigation: Create Dedicated Server order by selecting tariff, location, operating system, traffic allocation, and additional IPv4/IPv6 addresses.
---
...
<Frame>![shop window](/images/docs/hosting/dedicated-servers/order-a-dedicated-server/image2.png)</Frame>
...
<Frame>![Server configurator](/images/docs/hosting/dedicated-servers/order-a-dedicated-server/image4.png)</Frame>

 
<Frame>![Server configurator](/images/docs/hosting/dedicated-servers/order-a-dedicated-server/image1.png)</Frame>
...
<Frame>![service order page](/images/docs/hosting/dedicated-servers/order-a-dedicated-server/image3.png)</Frame>
