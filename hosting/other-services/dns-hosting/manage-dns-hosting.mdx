...
ai-navigation: Activate and configure Gcore DNS hosting service to manage DNS records for up to 25 domains, setting administrator email, name servers, mail servers (MX records), and subdomains (A records) via the control panel.
---
...
<Frame>![ list of services](/images/docs/hosting/other-services/dns-hosting/manage-dns-hosting/manage-dns-hosting-image1.png)</Frame>
...
<Frame>![Order](/images/docs/hosting/other-services/dns-hosting/manage-dns-hosting/manage-dns-hosting-image2.png)</Frame>
...
<Frame>![Add to cart](/images/docs/hosting/other-services/dns-hosting/manage-dns-hosting/manage-dns-hosting-image3.png)</Frame>
...
<Frame>![Proceed to checkout](/images/docs/hosting/other-services/dns-hosting/manage-dns-hosting/manage-dns-hosting-image4.png)</Frame>
...
<Frame>![DNS hosting service section](/images/docs/hosting/other-services/dns-hosting/manage-dns-hosting/manage-dns-hosting-image5.png)</Frame>
...
<Frame>![DNS settings](/images/docs/hosting/other-services/dns-hosting/manage-dns-hosting/manage-dns-hosting-image6.png)</Frame>
...
<Frame>![Provide the following settings](/images/docs/hosting/other-services/dns-hosting/manage-dns-hosting/manage-dns-hosting-image7.png)</Frame>
...
<Frame>![Manage domains](/images/docs/hosting/other-services/dns-hosting/manage-dns-hosting/manage-dns-hosting-image5.png)</Frame>
...
<Frame>![Add a new domain](/images/docs/hosting/other-services/dns-hosting/manage-dns-hosting/manage-dns-hosting-image8.png)</Frame>
...
<Frame>![Specify the domain](/images/docs/hosting/other-services/dns-hosting/manage-dns-hosting/manage-dns-hosting-image9.png)</Frame>
...
<Frame>![Domain names tab](/images/docs/hosting/other-services/dns-hosting/manage-dns-hosting/manage-dns-hosting-image10.png)</Frame>
...
<Frame>![DNS Hosting control panel](/images/docs/hosting/other-services/dns-hosting/manage-dns-hosting/manage-dns-hosting-image10.png)</Frame>
...
<Frame>![add a new record](/images/docs/hosting/other-services/dns-hosting/manage-dns-hosting/manage-dns-hosting-image11.png)</Frame>
...
<Frame>![Modify the record](/images/docs/hosting/other-services/dns-hosting/manage-dns-hosting/manage-dns-hosting-image12.png)</Frame>
