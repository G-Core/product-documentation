...
ai-navigation: Configure Link Aggregation Control Protocol (LACP) bonding on Gcore Bare Metal servers using Port Channel service, ifenslave package, bonding kernel module, and network interface configuration to aggregate multiple Ethernet channels for load balancing and fault tolerance.
---
...
<Frame>![Port Channel from the Control Panel](/images/docs/hosting/other-services/link-aggreagtion/activate-link-aggregation/activate-link-aggregation-image1.png)</Frame>
