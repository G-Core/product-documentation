...
ai-navigation: Enable auto payment with configurable monthly charge limit to automatically recharge account balance from bank card for service plan renewals.
ai-navigation: Enable auto payment with maximum monthly charge limit and bank card confirmation for automatic account balance recharging.
---
...
<Frame>![Auto payment tab](/images/docs/hosting/payments/set-up-auto-payment/________-____________eng.png)</Frame>
...
<Frame>![Configure](/images/docs/hosting/payments/set-up-auto-payment/configure_eng_2.png)</Frame>
...
<Frame>![Set a maximum payment amount](/images/docs/hosting/payments/set-up-auto-payment/confirm_eng_3.png)</Frame>
...
<Frame>![Confirm your bank card](/images/docs/hosting/payments/set-up-auto-payment/confirm_en_4.png)</Frame>
