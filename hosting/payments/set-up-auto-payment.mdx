...
ai-navigation: Enable auto payment with configurable monthly charge-off limits to automatically recharge account balance from bank card when funds are insufficient for service renewal; auto payment does not cover traffic overcommitment charges.
---
...
<Frame>![Auto payment tab](/images/docs/hosting/payments/set-up-auto-payment/set-up-auto-payment-image1.png)</Frame>
...
<Frame>![Configure](/images/docs/hosting/payments/set-up-auto-payment/set-up-auto-payment-image2.png)</Frame>
...
<Frame>![Set a maximum payment amount](/images/docs/hosting/payments/set-up-auto-payment/set-up-auto-payment-image3.png)</Frame>
...
<Frame>![Confirm your bank card](/images/docs/hosting/payments/set-up-auto-payment/set-up-auto-payment-image4.png)</Frame>
