...
description: Install, build, and execute FastEdge HTTP applications locally using FastEdge CLI with Rust, including environment variables, geo headers, and request testin...
---
