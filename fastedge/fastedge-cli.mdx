...
ai-navigation: Install FastEdge CLI from the FastEdge-lib repository, build the Rust-based tool, and execute local HTTP applications with commands supporting environment variables, geo headers, and request/response inspection.
---
