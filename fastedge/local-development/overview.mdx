...
[AI-assisted&nbsp;development](/fastedge/local-development/ai-assisted-development) plugs [gcore-fastedge](https://github.com/G-Core/FastEdge-plugin) into Claude Code or Codex, so a plain-language request scaffolds, builds, and deploys an application through the bundled [MCP&nbsp;server](https://github.com/G-Core/FastEdge-mcp-server).
