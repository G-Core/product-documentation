...
description: Store and manage encrypted secrets across FastEdge applications using Secrets Manager with create, edit, delete, and slot-based access operations.
---
