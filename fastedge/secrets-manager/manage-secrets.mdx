...
sidebarTitle: Managing secrets
ai-navigation: Store and manage encrypted secrets across FastEdge applications using Secrets Manager with create, edit, delete, and slot-based access operations.
ai-navigation: Create encrypted secrets in FastEdge Secrets Manager with name, description, slot number, and value for edge network access.
---
