...
<Frame>
  ![FastEdge Secrets
  Manager](/images/docs/fastedge/secret-manager/manage-secrets-image1.png)
</Frame>
...
<Frame>
  ![FastEdge Secrets
  Creation](/images/docs/fastedge/secret-manager/manage-secrets-image2.png)
</Frame>
...
<Frame>
  ![FastEdge Secrets List](/images/docs/fastedge/secret-manager/manage-secrets-image3.png)
</Frame>

3\. You can replace an encrypted secret by clicking the edit button.

<Frame>
  ![FastEdge Secrets Edit](/images/docs/fastedge/secret-manager/manage-secrets-image4.png)
</Frame>
...
<Frame>
  ![FastEdge Delete List](/images/docs/fastedge/secret-manager/manage-secrets-image5.png)
</Frame>
...
<Frame>
  ![FastEdge Delete
  Detachment](/images/docs/fastedge/secret-manager/manage-secrets-image6.png)
</Frame>
