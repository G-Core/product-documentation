...
<Frame>
![Secrets Manager page with the Add secret button](/images/docs/fastedge/secrets-manager/secrets-list.png)
</Frame>
...
<Frame>
![Create secret form with name, description, and slot value encrypted](/images/docs/fastedge/secrets-manager/create-secret-encrypted.png)
</Frame>
...
<Frame>
![Secrets Manager list showing a secret entry](/images/docs/fastedge/secrets-manager/secrets-list-with-item.png)
</Frame>

3. To replace an encrypted value, click the pencil icon next to the **Value** field, enter the new value, and click **Encrypt**.

<Frame>
![Edit secret form with the pencil icon next to the encrypted value field](/images/docs/fastedge/secrets-manager/edit-secret-form.png)
</Frame>
...
<Frame>
![Secrets Manager list with the three-dot menu showing Edit and Delete options](/images/docs/fastedge/secrets-manager/delete-secret-menu.png)
</Frame>

3. Click **Yes, delete** to confirm.

<Frame>
![Delete Secret confirmation dialog with Yes, delete button](/images/docs/fastedge/secrets-manager/delete-secret-confirm.png)
</Frame>
