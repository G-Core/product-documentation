...
ai-navigation: Create and manage encrypted secrets in FastEdge Secrets Manager with slot numbers and secret values, then access them in applications via JavaScript SDK and Rust SDK.
---
