...
ai-navigation: Implement secret rotation using Slots mechanism to access versioned encrypted secrets by index or timestamp without deleting old values.
ai-navigation: Enable secret rotation using Secrets Slots with indexed or timestamped versions; retrieve specific slot values via get_secret API.
---
...
For more information regarding secret usage in applications see the [JavaScript SDK](https://g-core.github.io/FastEdge-sdk-js/reference/fastedge/secret/get-secret/) and the [Rust SDK](https://docs.rs/fastedge/latest/fastedge/secret/index.html)
...
<Frame>
  ...
  Example](/images/docs/fastedge/secret-manager/slots-example-indices.png)
</Frame>
...
<Frame>
  ...
  Example](/images/docs/fastedge/secret-manager/slots-example-timestamps.png)
</Frame>
