...
<Frame>
![Create secret form with two slots — index 0 for original password and index 5 for updated password](/images/docs/fastedge/secrets-manager/slots/slots-example-indices.png)
</Frame>
...
<Frame>
![Create secret form with two slots — index 0 for original password and index 1741790697 for new password](/images/docs/fastedge/secrets-manager/slots/slots-example-timestamps.png)
</Frame>
