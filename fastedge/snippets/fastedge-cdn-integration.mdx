...
<Frame>
  ![CDN resources page with resource settings context
  menu](/images/docs/cdn/getting-started/integrate-cdn-with-fastedge/cdn-resource-settings-button.png)
</Frame>
...
<Frame>
  ![FastEdge app settings with delete
  button](/images/docs/cdn/getting-started/integrate-cdn-with-fastedge/remove-app-fstedge.png)
</Frame>
...
<Frame>
  ...
  dialog](/images/docs/cdn/getting-started/integrate-cdn-with-fastedge/confirm-deletion.png)
</Frame>
