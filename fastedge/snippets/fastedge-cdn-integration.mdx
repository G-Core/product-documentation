...
<Tabs>
  <Tab title="Deploy from the template">
    ...
    <Frame>![Create from a template section showing Validate JWT template](/images/docs/cdn/getting-started/integrate-cdn-with-fastedge/validate-jwt.png)</Frame>
  ...
  <Tab title="Deploy a custom CDN application">
    ...
    <Frame>![Application configuration form with Name and environment variables fields](/images/docs/cdn/getting-started/integrate-cdn-with-fastedge/upload-binary-dialog.png)</Frame>
