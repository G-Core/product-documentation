...
description: Deploy distributed key-value storage instances co-located with FastEdge WASM runtime at every edge location for sub-millisecond read latency and eventual con...
---
