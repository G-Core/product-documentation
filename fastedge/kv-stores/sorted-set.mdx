...
<Frame>
  ![FastEdge Insert Sorted Set](/images/docs/fastedge/kv-stores/manage-kv-store/insert-zset.png)
</Frame>

4\. Give the Sorted Set a key, then click **Insert value**

<Frame>
  ![FastEdge Create Sorted Set](/images/docs/fastedge/kv-stores/manage-kv-store/create-zset.png)
</Frame>
...
<Frame>
  ...
  Values](/images/docs/fastedge/kv-stores/manage-kv-store/insert-zset-values.png)
</Frame>
...
<Frame>
  ...
  Edit](/images/docs/fastedge/kv-stores/manage-kv-store/edit-zset-store.png)
</Frame>
