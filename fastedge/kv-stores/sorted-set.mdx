...
<Frame>
  ![FastEdge Insert Sorted Set](/images/docs/fastedge/kv-stores/sorted-set/insert-zset.png)
</Frame>

4\. Give the Sorted Set a key, then click **Insert value**

<Frame>
  ![FastEdge Create Sorted Set](/images/docs/fastedge/kv-stores/sorted-set/create-zset.png)
</Frame>
...
<Frame>
  ...
  Values](/images/docs/fastedge/kv-stores/sorted-set/insert-zset-values.png)
</Frame>
...
<Frame>
  ...
  Edit](/images/docs/fastedge/kv-stores/sorted-set/edit-zset-store.png)
</Frame>
