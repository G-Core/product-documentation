...
description: Create and manage key-value pairs in Edge Storage across Gcore's global edge network with insert, edit, delete, and file upload operations via FastEdge portal.
---
