...
ai-navigation: Create and manage key-value pairs in FastEdge Edge Storage with support for file uploads up to 1 MB, key size limits of 256 bytes, expiration dates, and edit/delete operations via Gcore Customer Portal.
---
...
<Frame>
  ![FastEdge Edge Storage](/images/docs/fastedge/kv-stores/manage-kv-store/add-store.png)
</Frame>
...
<Frame>
  ...
  Creation](/images/docs/fastedge/kv-stores/manage-kv-store/create-store.png)
</Frame>
...
<Frame>
  ![FastEdge Insert KV Pair](/images/docs/fastedge/kv-stores/manage-kv-store/insert-pair.png)
</Frame>

In the side panel insert as many KV pairs as you need.

<Frame>
  ![FastEdge Insert KV Pair](/images/docs/fastedge/kv-stores/manage-kv-store/first-pair.png)
</Frame>
...
<Frame>
  ![FastEdge Insert KV Pair](/images/docs/fastedge/kv-stores/manage-kv-store/upload-pair.png)
</Frame>
...
<Frame>
  ![FastEdge Insert KV Pair](/images/docs/fastedge/kv-stores/manage-kv-store/expire-pair.png)
</Frame>
...
<Frame>
  ![FastEdge Edge Storage Edit](/images/docs/fastedge/kv-stores/manage-kv-store/edit-store.png)
</Frame>
...
<Frame>
  ...
  Delete](/images/docs/fastedge/kv-stores/manage-kv-store/bulk-delete.png)
</Frame>
...
<Frame>
  ![FastEdge Edge Storage BYOD](/images/docs/fastedge/kv-stores/manage-kv-store/byod-store.png)
</Frame>
