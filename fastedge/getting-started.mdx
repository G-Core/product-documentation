...
FastEdge supports three application types. The application type determines how the application integrates with FastEdge and which setup guide to follow.
