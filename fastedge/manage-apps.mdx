...
ai-navigation: View, start, stop, and configure FastEdge HTTP and CDN applications; manage environment variables, secrets, Edge Storage, response headers, metrics, and appl
ai-navigation: Manage FastEdge HTTP and CDN applications: start, stop, configure, view logs, metrics, environment variables, secrets, and Edge Storage.
---
