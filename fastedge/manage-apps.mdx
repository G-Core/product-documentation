...
<Warning>
Deleting an application is permanent. All configuration, environment variables, secrets, and associated data are removed and cannot be recovered.
</Warning>
...
<p>The response includes all application fields: `id`, `binary`, `name`, `status`, `rsp_headers`, `env`, `secrets`, and `stores`.</p>
