...
ai-navigation: Manage FastEdge HTTP and CDN applications via the Customer Portal: start or stop applications, view metrics and logs, configure response headers, environment variables, secrets, and Edge Storage key-value storage.
---
