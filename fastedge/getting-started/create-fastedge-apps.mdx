...
<Tabs>
  <Tab title="Deploy an app from a binary">
    ...
    <Frame>![Create an HTTP app button highlighted](/images/docs/fastedge/getting-started/create-fastedge-apps/http-apps-create-app.png)</Frame>

    3\. Click **Upload binary**.

    <Frame>![Add raw binary dialog](/images/docs/fastedge/getting-started/create-fastedge-apps/http-apps-upload-binary.png)</Frame>

    4\. Choose your custom binary file.

    <Frame>![Add raw binary dialog](/images/docs/fastedge/getting-started/create-fastedge-apps/upload-binary-dialog.png)</Frame>
    ...
    <Frame>![A page with a link to an app and its configuration](/images/docs/fastedge/getting-started/create-fastedge-apps/http-apps-create-app-env-vars.png)</Frame>
    ...
    **Info**
    ...
    <Frame>![A page with a link to an app and its configuration](/images/docs/fastedge/getting-started/create-fastedge-apps/http-app-created.png)</Frame>
  ...
  <Tab title="Deploy an app from a template">
    ...
    <Frame>![Section with Github and Markdown templates](/images/docs/fastedge/getting-started/create-fastedge-apps/http-apps-create-app.png)</Frame>

    3\. In the **Create from a template** section, select the preferred template.

    <Frame>![Section with Github and Markdown templates](/images/docs/fastedge/getting-started/create-fastedge-apps/http-apps-create-from-template.png)</Frame>
    ...
    <Frame>![A page with a link to an app and its configuration](/images/docs/fastedge/getting-started/create-fastedge-apps/http-app-from-template-setup.png)</Frame>

    7\. Click **Save and deploy**.

    Your application has been successfully deployed.

    <Frame>![A page with a link to an app and its configuration](/images/docs/fastedge/getting-started/create-fastedge-apps/http-app-created-from-template.png)</Frame>
...
<Frame>
  ![A page with a link to an app and its
  configuration](/images/docs/fastedge/getting-started/create-fastedge-apps/test-http-app.png)
</Frame>
...
<Frame>
  ![HTTP Applications with the list of FastEdge
  apps](/images/docs/fastedge/getting-started/create-fastedge-apps/http-apps-application-list.png)
</Frame>
