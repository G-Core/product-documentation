...
<Tabs>
  <Tab title="Deploy an app from a binary">
    ...
    <Frame>![Create an HTTP app button highlighted](/images/docs/fastedge/create-http-apps/create-fastedge-apps-image1.png)</Frame>

    3\. Click **Upload binary**.

    <Frame>![Add raw binary dialog](/images/docs/fastedge/create-http-apps/create-fastedge-apps-image2.png)</Frame>

    4\. Choose your custom binary file.

    <Frame>![Add raw binary dialog](/images/docs/fastedge/create-http-apps/create-fastedge-apps-image3.png)</Frame>
    ...
    <Frame>![A page with a link to an app and its configuration](/images/docs/fastedge/create-http-apps/create-fastedge-apps-image4.png)</Frame>
    ...
    **Info**
    ...
    <Frame>![A page with a link to an app and its configuration](/images/docs/fastedge/create-http-apps/create-fastedge-apps-image5.png)</Frame>
  ...
  <Tab title="Deploy an app from a template">
    ...
    <Frame>![Section with Github and Markdown templates](/images/docs/fastedge/create-http-apps/create-fastedge-apps-image1.png)</Frame>

    3\. In the **Create from a template** section, select the preferred template.

    <Frame>![Section with Github and Markdown templates](/images/docs/fastedge/create-http-apps/create-fastedge-apps-image6.png)</Frame>
    ...
    <Frame>![A page with a link to an app and its configuration](/images/docs/fastedge/create-http-apps/create-fastedge-apps-image7.png)</Frame>

    7\. Click **Save and deploy**.

    Your application has been successfully deployed.

    <Frame>![A page with a link to an app and its configuration](/images/docs/fastedge/create-http-apps/create-fastedge-apps-image8.png)</Frame>
...
<Frame>
  ...
  configuration](/images/docs/fastedge/create-http-apps/create-fastedge-apps-image9.png)
</Frame>
...
<Frame>
  ...
  apps](/images/docs/fastedge/create-http-apps/create-fastedge-apps-image10.png)
</Frame>
