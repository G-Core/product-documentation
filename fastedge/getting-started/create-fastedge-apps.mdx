...
You can create a FastEdge app in two ways: from a custom binary file using [JavaScript SDK](https://github.com/G-Core/FastEdge-sdk-js) or [Rust](https://github.com/G-Core/FastEdge-sdk-rust) as well as from a preconfigured template. If you chose the latter option, skip Stage 1.
...
<Tabs>
  <Tab title="Deploy an app from a binary">
    ...
    <Frame>![A page with a link to an app and its configuration](/images/docs/fastedge/create-http-apps/http-apps-create-app-env-vars.png)</Frame>

    <Info>
    **Info**

    If you're adding sensitive information or want to ensure that any data in the app's configuration remains secure, click **\+ Add Secret** and use the <a href="/fastedge/secrets-manager/create-secrets" target="_blank" rel="noopener noreferrer">Secrets Manager</a>.
    </Info>
...
<Tabs>
  <Tab title="In the Customer Portal">
    ...
    <Frame>![HTTP Applications with the list of FastEdge apps](/images/docs/fastedge/create-http-apps/http-apps-application-list.png)</Frame>
