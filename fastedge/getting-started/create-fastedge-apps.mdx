...
ai-navigation: Build FastEdge HTTP applications using Rust or JavaScript SDKs to compile WebAssembly binaries, then deploy via Customer Portal or API.
ai-navigation: Create FastEdge HTTP applications using Wasm binaries built with JavaScript SDK or Rust, or deploy from preconfigured templates via portal or API.
---
...
<Frame>
  ...
  configuration](/images/docs/fastedge/create-http-apps/test-http-app.png)
</Frame>
...
<Frame>
  ...
  apps](/images/docs/fastedge/create-http-apps/http-apps-application-list.png)
</Frame>
