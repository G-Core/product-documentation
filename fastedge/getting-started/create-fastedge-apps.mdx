...
Deploy a compiled WebAssembly application to the FastEdge edge network using the Gcore API.

<Info>
A permanent [API token](/account-settings/api-tokens) from the Gcore Customer Portal is required.
</Info>
