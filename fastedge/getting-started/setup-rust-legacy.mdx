...
The Legacy Rust SDK is based on the `fastedge` crate, Gcore's original Rust library for FastEdge HTTP applications. Most existing FastEdge applications written in Rust use this SDK.
