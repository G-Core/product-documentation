...
<p>Deploying requires two API calls: upload the binary to get its ID, then create the application. A permanent [API token](/account-settings/api-tokens) is required.</p>
