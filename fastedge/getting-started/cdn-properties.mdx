...
ai-navigation: Access and modify HTTP request/response properties via Proxy-Wasm ABI hooks using read/write methods; properties include URL path, headers, geolocation data
ai-navigation: Configure Proxy-Wasm CDN properties via get/set methods to read request data, modify headers, routing, and response behavior across onRequestHeaders
---
