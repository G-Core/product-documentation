...
ai-navigation: Reference for HTTP request and response properties in FastEdge CDN Proxy-Wasm apps, including get_property and set_property paths, reserved x-cdn and x-gcdn header prefixes, and custom properties.
---
