...
description: Access and modify HTTP request/response properties via Proxy-Wasm ABI hooks using read/write methods; properties include URL path, headers, geolocation data,...
---
