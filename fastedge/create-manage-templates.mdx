...
ai-navigation: Create FastEdge templates with custom binaries, parameters, secrets, and environment variables for HTTP and CDN applications via Customer Portal.
ai-navigation: Create FastEdge templates with binary files, parameters, secrets, and usage instructions for HTTP and CDN applications.
---
...
<Frame>
  ![Edit template menu
  item](/images/docs/fastedge/create-manage-templates/edit-template-menu.png)
</Frame>
...
<Frame>
  ![Edit template
  form](/images/docs/fastedge/create-manage-templates/edit-template-form.png)
</Frame>
...
<Frame>
  ![Delete
  template](/images/docs/fastedge/create-manage-templates/delete-template.png)
</Frame>
...
<Frame>
  ![Update template
  binary](/images/docs/fastedge/create-manage-templates/update-template-binary.png)
</Frame>
...
<Frame>
  ![Upload template binary
  dialog](/images/docs/fastedge/create-manage-templates/create-template-upload-binary.png)
</Frame>

5\. Verify the current configuration and click **Save template** to apply the updates.

<Frame>
  ![Edit template binary
  form](/images/docs/fastedge/create-manage-templates/edit-template-binary.png)
</Frame>
