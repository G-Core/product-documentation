...
<Tabs>
  <Tab title="From the Templates page">
    ...
    When creating an application based on this template, this parameter will appear as a "secret" that you can assign from the Secret Manager. Check detailed instructions on how to add environment variables for [HTTP apps](/fastedge/getting-started/create-fastedge-apps#secure-variables-http-apps) and [CDN apps](/cdn/getting-started/integrate-cdn-with-fastedge#secure-variables-cdn-apps).
...
<Frame>
  ...
  menu](/images/docs/fastedge/create-manage-templates/create-template-from-app.png)
</Frame>
