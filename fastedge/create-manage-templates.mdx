...
<Tabs>
  <Tab title="From the Templates page">
    ...
    <Frame>![Create template button](/images/docs/fastedge/create-manage-templates/create-manage-templates-image1.png)</Frame>

    3\. Add your custom binary file. Once the upload is finished, the file will be automatically assigned to the template.

    <Frame>![Add raw binary dialog](/images/docs/fastedge/create-manage-templates/create-manage-templates-image2.png)</Frame>
    ...
    <Frame>![Secret parameter marked as required](/images/docs/fastedge/create-manage-templates/create-manage-templates-image3.png)</Frame>
    ...
    <Frame>![Example of a secret parameter in an app](/images/docs/fastedge/create-manage-templates/create-manage-templates-image4.png)</Frame>
  ...
  <Tab title="From an existing application">
    ...
    <Frame>![Create template from app menu](/images/docs/fastedge/create-manage-templates/create-manage-templates-image5.png)</Frame>
...
<Frame>
  ![Edit template menu
  item](/images/docs/fastedge/create-manage-templates/create-manage-templates-image6.png)
</Frame>
...
<Frame>
  ![Edit template
  form](/images/docs/fastedge/create-manage-templates/create-manage-templates-image7.png)
</Frame>
...
<Frame>
  ![Delete
  template](/images/docs/fastedge/create-manage-templates/create-manage-templates-image8.png)
</Frame>
...
<Frame>
  ![Update template
  binary](/images/docs/fastedge/create-manage-templates/create-manage-templates-image9.png)
</Frame>
...
<Frame>
  ...
  dialog](/images/docs/fastedge/create-manage-templates/create-manage-templates-image2.png)
</Frame>
...
<Frame>
  ...
  form](/images/docs/fastedge/create-manage-templates/create-manage-templates-image10.png)
</Frame>
