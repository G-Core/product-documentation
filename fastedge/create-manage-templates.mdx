...
description: Create FastEdge templates with custom binaries, parameters, secrets, and environment variables for HTTP and CDN applications via Customer Portal.
---
