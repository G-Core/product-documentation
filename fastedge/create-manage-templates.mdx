...
ai-navigation: Create FastEdge templates with custom binary files, mandatory parameters, and Secret environment variables for HTTP and CDN applications via Customer Portal.
---
