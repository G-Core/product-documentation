...
ai-navigation: Monitor CPU Utilization, RAM Utilization, Network Traffic, and Network Packets metrics for Kubernetes nodes via Monitoring tab in Cloud console.
ai-navigation: Monitor Kubernetes node CPU Utilization, RAM Utilization, Network Traffic, and Network Packets metrics via Monitoring tab.
---
...
<Frame>![Navigate to monitoring](/images/docs/cloud/kubernetes/monitor-load-on-a-specific-node/13348768823569.png)</Frame>
...
<Frame>![Pools section,](/images/docs/cloud/kubernetes/monitor-load-on-a-specific-node/13348772802833.png)</Frame>
...
<Frame>![Monitoring tab.](/images/docs/cloud/kubernetes/monitor-load-on-a-specific-node/13348867859473.png)</Frame>
