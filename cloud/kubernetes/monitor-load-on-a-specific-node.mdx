...
1. In the [Gcore Customer Portal](https://portal.gcore.com), navigate to **Cloud** > **Managed Kubernetes**, click the cluster name, expand the required pool in the **Pools** section, and then click the node name.

<Frame>
<img src="/images/docs/cloud/kubernetes/monitor-load-on-a-specific-node/managed-kubernetes-clusters-list.png" alt="Managed Kubernetes page with the Kubernetes Clusters list and Create Cluster button" width="70%"/>
</Frame>

2. On the node details panel, select the **Monitoring** tab.

<Frame>
<img src="/images/docs/cloud/kubernetes/monitor-load-on-a-specific-node/13348867859473.png" alt="Monitoring tab on a Kubernetes worker node with time range and refresh controls above metric graphs" width="70%"/>
</Frame>
