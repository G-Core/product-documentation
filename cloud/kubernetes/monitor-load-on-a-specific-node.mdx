...
ai-navigation: Monitor Kubernetes node CPU Utilization, RAM Utilization, Network Traffic, and Network Packets metrics via the Monitoring tab in Gcore Cloud portal, with configurable time period and data refresh frequency.
---
...
<Frame>![Navigate to monitoring](/images/docs/cloud/kubernetes/monitor-load-on-a-specific-node/monitor-load-on-a-specific-node-image1.png)</Frame>
...
<Frame>![Pools section,](/images/docs/cloud/kubernetes/monitor-load-on-a-specific-node/monitor-load-on-a-specific-node-image2.png)</Frame>
...
<Frame>![Monitoring tab.](/images/docs/cloud/kubernetes/monitor-load-on-a-specific-node/monitor-load-on-a-specific-node-image3.png)</Frame>
