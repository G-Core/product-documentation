...
<Frame>
![Managed Kubernetes page with the Kubernetes Clusters list and Create Cluster button](/images/docs/cloud/kubernetes/monitor-load-on-a-specific-node/managed-kubernetes-clusters-list.png)
</Frame>

2. On the node details panel, select the **Monitoring** tab.

<Frame>
![Monitoring tab on a Kubernetes worker node with time range and refresh controls above metric graphs](/images/docs/cloud/kubernetes/monitor-load-on-a-specific-node/13348867859473.png)
</Frame>
