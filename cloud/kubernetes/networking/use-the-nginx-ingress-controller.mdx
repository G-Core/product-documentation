...
ai-navigation: Deploy Nginx Ingress Controller using kubectl to create Ingress objects with ingressClassResource, Service routing, and port configuration.
ai-navigation: Create Nginx Ingress Controller manifest with ingressClass, service backend, path routing, and port configuration.
---
