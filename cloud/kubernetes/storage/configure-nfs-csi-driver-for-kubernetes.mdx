...
<Frame>![File Shares page with a highlighted button to create file share](/images/docs/cloud/kubernetes/storage/configure-nfs-csi-driver-for-kubernetes-image1.png)</Frame>
