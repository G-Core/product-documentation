...
ai-navigation: Create PersistentVolumeClaim (PVC) with StorageClass for standard, ssd_hiiops, or ssd_lowlatency disk types and bind to Kubernetes pods.
ai-navigation: Create PersistentVolumeClaim with StorageClass, disk type (standard, ssd_highiops, ssd_lowlatency), and storage capacity.
---
