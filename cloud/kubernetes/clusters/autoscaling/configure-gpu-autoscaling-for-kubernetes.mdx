...
<Frame>![Pools configuration section on the Create Kubrnetes cluster page.jpg](/images/docs/cloud/kubernetes/clusters/autoscaling/gpu-autoscaling/configure-pools.png)</Frame>
...
<Frame>![A list of toggles with configurations for steps 6-9](/images/docs/cloud/kubernetes/clusters/autoscaling/gpu-autoscaling/configure-toggles.png)</Frame>
...
<Frame>![Kubernetes cluster overview page](/images/docs/cloud/kubernetes/clusters/autoscaling/gpu-autoscaling/kubernetes-config.png)</Frame>
