...
<Frame>
  ![Pools configuration section on the Create Kubernetes cluster page](/images/docs/cloud/kubernetes/clusters/autoscaling/gpu-autoscaling/configure-pools.png)
</Frame>
