...
<Frame>
  ![Pools configuration section on the Create Kubrnetes cluster page.jpg](/images/docs/cloud/kubernetes/clusters/autoscaling/gpu-autoscaling/configure-gpu-autoscaling-for-kubernetes-image1.png)
</Frame>
...
<Frame>
  ![A list of toggles with configurations for steps 6-9](/images/docs/cloud/kubernetes/clusters/autoscaling/gpu-autoscaling/configure-gpu-autoscaling-for-kubernetes-image2.png)
</Frame>
...
<Frame>
  ![Kubernetes cluster overview page](/images/docs/cloud/kubernetes/clusters/autoscaling/gpu-autoscaling/configure-gpu-autoscaling-for-kubernetes-image3.png)
</Frame>
