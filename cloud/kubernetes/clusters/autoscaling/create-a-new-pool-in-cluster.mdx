...
ai-navigation: Create Kubernetes cluster pools with node configuration, autoscaling limits, VM/Bare Metal selection, placement policies, labels, taints, and autohealing set
ai-navigation: Create Kubernetes pool with node count, VM/Bare Metal flavor, volume type, placement policy, labels, taints, autohealing.
---
