...
- Select the type of a worker node: a [Virtual Machine](/cloud/virtual-instances/types-of-virtual-machines) (VM) or a [Bare Metal server](/cloud/bare-metal-servers/create-a-bare-metal-server). For VMs, select a flavor, volume size in GiB, and the [volume type](/cloud/virtual-instances/volumes/about-volumes#available-volume-types).
