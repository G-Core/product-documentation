...
<Frame>![Managed Kubernetes page](/images/docs/cloud/kubernetes/clusters/autoscaling/create-a-new-pool-in-cluster/create-a-new-pool-in-cluster-image1.png)</Frame>
...
<Frame>![Managed Kubernetes cluster with add pool button highlighted](/images/docs/cloud/kubernetes/clusters/autoscaling/create-a-new-pool-in-cluster/create-a-new-pool-in-cluster-image2.png)</Frame>
...
<Frame>![Pools configuration section on the Create Kubrnetes cluster page](/images/docs/cloud/kubernetes/clusters/autoscaling/create-a-new-pool-in-cluster/create-a-new-pool-in-cluster-image3.png)</Frame>
...
<Frame>![Pools configuration section on the Create Kubrnetes cluster page](/images/docs/cloud/kubernetes/clusters/autoscaling/create-a-new-pool-in-cluster/create-a-new-pool-in-cluster-image4.png)</Frame>
...
<Frame>![Kubelet configuration in the advanced settings for Kubrnetes cluster](/images/docs/cloud/kubernetes/clusters/autoscaling/create-a-new-pool-in-cluster/create-a-new-pool-in-cluster-image5.png)</Frame>
...
<Frame>![Cri-O configuration in the advanced settings for Kubrnetes cluster](/images/docs/cloud/kubernetes/clusters/autoscaling/create-a-new-pool-in-cluster/create-a-new-pool-in-cluster-image6.png)</Frame>
