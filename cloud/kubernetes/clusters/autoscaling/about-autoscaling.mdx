...
description: Configure Kubernetes node pool autoscaling with minimum/maximum limits to automatically scale nodes based on pod resource requests and idle time thresholds.
---
