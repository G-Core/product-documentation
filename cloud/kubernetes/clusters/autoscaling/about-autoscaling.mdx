...
ai-navigation: Configure Kubernetes node pool autoscaling with minimum/maximum limits to automatically scale nodes based on pod resource requests and idle time thresholds.
ai-navigation: Configure Kubernetes node pool autoscaling with minimum and maximum node limits based on pod resource requests and idle timeout.
---
