...
ai-navigation: Configure Kubernetes cluster autoscaler parameters: scan interval, expander strategy (random, most-pods, least-waste, price, priority, gRPC), node provision
ai-navigation: Configure Kubernetes cluster autoscaler scan interval, expander strategy, node provision timeout, scale-down delays, and unready node thresholds.
---
