...
<Frame>![Advanced settings section in the cluster settings](/images/docs/cloud/kubernetes/clusters/autoscaling/advanced-cluster-autoscaler-settings/advanced-cluster-autoscaler-settings-image1.png)</Frame>
...
<Frame>![Restore defaults button highlighted](/images/docs/cloud/kubernetes/clusters/autoscaling/advanced-cluster-autoscaler-settings/advanced-cluster-autoscaler-settings-image2.png)</Frame>
