...
ai-navigation: Configure OpenID Connect authentication for Kubernetes clusters with issuer URL, client ID, groups claim, signing algorithms, and username claim settings.
ai-navigation: Enable OpenID Connect (OIDC) authentication for Managed Kubernetes clusters with issuer URL, client ID, groups claim, and signing algorithms.
---
