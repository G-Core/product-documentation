...
<Frame>![OpenID Connect authentication settings for a Kubernetes container](/images/docs/cloud/kubernetes/clusters/oidc-authentication/secure-cluster-with-oidc-image1.png)</Frame>
...
<Frame>![OpenID Connect authentication settings for a Kubernetes container](/images/docs/cloud/kubernetes/clusters/oidc-authentication/secure-cluster-with-oidc-image2.png)</Frame>
...
<Frame>![Disabled OpenID Connect authentication toggle](/images/docs/cloud/kubernetes/clusters/oidc-authentication/secure-cluster-with-oidc-image3.png)</Frame>
