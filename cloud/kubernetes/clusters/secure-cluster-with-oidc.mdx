...
description: Configure OpenID Connect authentication for Kubernetes clusters with issuer URL, client ID, groups claim, signing algorithms, and username claim settings.
---
