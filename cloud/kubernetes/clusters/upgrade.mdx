...
ai-navigation: Upgrade Kubernetes cluster version using rolling updates with API compatibility checks and downgrade support for one patch version.
ai-navigation: Upgrade Kubernetes cluster version via Managed Kubernetes portal with rolling update approach and API stability considerations.
---
