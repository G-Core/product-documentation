...
<Frame><img src="/images/docs/cloud/kubernetes/clusters/upgrade/upgrade-kubernetes-clusters-list.png" alt="Kubernetes Clusters page with the Create Cluster button" width="70%" /></Frame>
...
<Frame><img src="/images/docs/cloud/kubernetes/clusters/upgrade/upgrade-3.png" alt="Cluster General Info section with Kubernetes version and Change link" width="70%" /></Frame>
...
<Frame><img src="/images/docs/cloud/kubernetes/clusters/upgrade/upgrade-4.png" alt="Change Kubernetes cluster version dialog with version dropdown and Change button" width="70%" /></Frame>

<p>A confirmation dialog asks to confirm the version upgrade. Click **Yes, upgrade** to start the upgrade.</p>

<Frame><img src="/images/docs/cloud/kubernetes/clusters/upgrade/upgrade-5.png" alt="Upgrade cluster version confirmation dialog with Yes, upgrade button" width="70%" /></Frame>
...
<Frame><img src="/images/docs/cloud/kubernetes/clusters/upgrade/upgrade-6.png" alt="Cluster General Info showing updated Kubernetes version after upgrade" width="70%" /></Frame>
