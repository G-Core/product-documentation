...
ai-navigation: Upgrade Kubernetes cluster version via Managed Kubernetes portal by selecting target version and confirming the rolling update, which terminates worker nodes sequentially and may impact performance without spare capacity.
---
...
<Frame>![upgrade](/images/docs/cloud/kubernetes/clusters/upgrade/upgrade-image1.png)</Frame>
...
<Frame>![upgrade](/images/docs/cloud/kubernetes/clusters/upgrade/upgrade-image2.png)</Frame>
...
<Frame>![upgrade](/images/docs/cloud/kubernetes/clusters/upgrade/upgrade-image3.png)</Frame>
...
<Frame>![upgrade](/images/docs/cloud/kubernetes/clusters/upgrade/upgrade-image4.png)</Frame>
...
<Frame>![upgrade](/images/docs/cloud/kubernetes/clusters/upgrade/upgrade-image5.png)</Frame>
...
<Frame>![upgrade](/images/docs/cloud/kubernetes/clusters/upgrade/upgrade-image6.png)</Frame>