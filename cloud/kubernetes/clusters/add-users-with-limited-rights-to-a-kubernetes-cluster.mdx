...
<Frame>![image1.jpg](/images/docs/cloud/kubernetes/clusters/add-users-with-limited-rights-to-a-kubernetes-cluster/add-users-with-limited-rights-to-a-kubernetes-cluster-image1.jpg)</Frame>
...
<Frame>![image2.jpg](/images/docs/cloud/kubernetes/clusters/add-users-with-limited-rights-to-a-kubernetes-cluster/add-users-with-limited-rights-to-a-kubernetes-cluster-image2.png)</Frame>
...
<Frame>![image3.png](/images/docs/cloud/kubernetes/clusters/add-users-with-limited-rights-to-a-kubernetes-cluster/add-users-with-limited-rights-to-a-kubernetes-cluster-image3.png)</Frame>
...
<Frame>![image4.png](/images/docs/cloud/kubernetes/clusters/add-users-with-limited-rights-to-a-kubernetes-cluster/add-users-with-limited-rights-to-a-kubernetes-cluster-image4.png)</Frame>
