...
ai-navigation: Create Kubernetes service accounts and namespaces with kubectl to grant users restricted API access via kubeconfig files scoped to specific namespaces.
ai-navigation: Create service accounts and kubeconfig files with namespace-scoped RBAC permissions for limited Kubernetes cluster access.
---
