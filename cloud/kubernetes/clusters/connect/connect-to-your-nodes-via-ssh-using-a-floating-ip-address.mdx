...
ai-navigation: Assign floating IP addresses to Kubernetes nodes and connect via SSH using floating IP and private key authentication.
ai-navigation: Attach floating IP address to Kubernetes node and connect via SSH with private key authentication.
---
