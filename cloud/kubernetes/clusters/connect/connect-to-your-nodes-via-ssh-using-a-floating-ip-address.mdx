...
- To create a new floating IP: in the **Assign a floating IP** section, enable the **Assign to existing instance** toggle, select the node and the interface, and click **Create a new floating IP**.
...
- To assign an existing floating IP: find the required address in the list below the **Assign a floating IP** section and click **Assign to instance**.
...
In the dialog, select the node and the interface, then click **Assign floating IP**.

The floating IP is now assigned to the node.
