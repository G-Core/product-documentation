...
1\. Download kubectl for Windows. The example below downloads v1.23.0. For the latest version, find the updated command in the [Kubernetes official documentation](https://kubernetes.io/docs/tasks/tools/install-kubectl-windows/#install-kubectl-binary-with-curl-on-windows):
