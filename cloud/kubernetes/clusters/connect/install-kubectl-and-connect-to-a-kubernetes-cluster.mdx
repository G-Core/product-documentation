...
ai-navigation: Install kubectl binary on Windows, configure PATH environment variable, and set up kubeconfig file in .kube directory for cluster access.
ai-navigation: Install kubectl binary via CURL, configure PATH environment variable, and add kubeconfig file to .kube directory.
---
