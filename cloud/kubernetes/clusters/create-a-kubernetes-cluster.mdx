...
sidebarTitle: Create
ai-navigation: Configure Kubernetes cluster region, version, node pools with VM/Bare Metal flavors, disk types (High IOPS SSD, Standard, SSD Low Latency), autoscaling min/m
ai-navigation: Create Kubernetes cluster with region, version, node pools, VM/Bare Metal flavors, disk types, autoscaling min/max nodes.
---
