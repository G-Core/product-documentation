...
sidebarTitle: Create
description: Configure Kubernetes cluster region, version, node pools with VM/Bare Metal flavors, disk types (High IOPS SSD, Standard, SSD Low Latency), autoscaling min/m...
---
