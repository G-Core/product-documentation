...
A [K8s versions](/api-reference/cloud/managed-kubernetes/list-k8s-cluster-versions) list is also available in the API reference.
...
The full [create cluster](/api-reference/cloud/managed-kubernetes/create-k8s-cluster) and [list flavors](/api-reference/cloud/managed-kubernetes/list-k8s-cluster-flavors) references are in the API docs.
