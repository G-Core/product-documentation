...
sidebarTitle: Create
ai-navigation: Create a Kubernetes cluster by selecting region, version, and configuring node pools with flavor (Standard, vCPU, Memory, High Frequency), disk type (High IOPS SSD, Standard, SSD Low Latency), disk size in GiB, minimum/maximum nodes for autoscaling, and worker node type (Virtual Machine or Bare Metal).
---
...
<Frame>![Start Kubernetes container creation](/images/docs/cloud/kubernetes/clusters/create-a-kubernetes-cluster/create-a-kubernetes-cluster-image1.png)</Frame>
...
<Frame>![Kubernetes region](/images/docs/cloud/kubernetes/clusters/create-a-kubernetes-cluster/create-a-kubernetes-cluster-image2.png)</Frame>
...
<Frame>![Kubernetes cluster version](/images/docs/cloud/kubernetes/clusters/create-a-kubernetes-cluster/create-a-kubernetes-cluster-image3.png)</Frame>
...
<Frame>![Pools](/images/docs/cloud/kubernetes/clusters/create-a-kubernetes-cluster/create-a-kubernetes-cluster-image4.png)</Frame>
...
<Frame>![Enable CNI provider section](/images/docs/cloud/kubernetes/clusters/create-a-kubernetes-cluster/create-a-kubernetes-cluster-image5.png)</Frame>
...
<Frame>![Network stack](/images/docs/cloud/kubernetes/clusters/create-a-kubernetes-cluster/create-a-kubernetes-cluster-image5.png)</Frame>
...
<Frame>![Network settings for Cluster](/images/docs/cloud/kubernetes/clusters/create-a-kubernetes-cluster/create-a-kubernetes-cluster-image6.png)</Frame>
...
<Frame>![create network dialog](/images/docs/cloud/kubernetes/clusters/create-a-kubernetes-cluster/create-a-kubernetes-cluster-image7.png)</Frame>
...
<Frame>![Configure profile template](/images/docs/cloud/kubernetes/clusters/create-a-kubernetes-cluster/create-a-kubernetes-cluster-image8.png)</Frame>
...
<Frame>![SSH settings for Cluster](/images/docs/cloud/kubernetes/clusters/create-a-kubernetes-cluster/create-a-kubernetes-cluster-image9.png)</Frame>
...
<Frame>![Name for Cluster](/images/docs/cloud/kubernetes/clusters/create-a-kubernetes-cluster/create-a-kubernetes-cluster-image10.png)</Frame>
...
<Frame>![Logging for Cluster](/images/docs/cloud/kubernetes/clusters/create-a-kubernetes-cluster/create-a-kubernetes-cluster-image11.png)</Frame>
