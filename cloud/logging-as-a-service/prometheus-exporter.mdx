...
ai-navigation: Export OpenSearch index metrics via Prometheus exporter endpoint using HTTPS Basic Authentication with Managed Logging credentials and gauge metrics.
ai-navigation: Configure Prometheus exporter endpoint with Managed Logging credentials via HTTPS Basic Authentication to scrape OpenSearch index metrics.
---
