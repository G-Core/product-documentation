...
description: Export OpenSearch index metrics via Prometheus exporter endpoint using HTTPS Basic Authentication with Managed Logging credentials and gauge metrics.
---
