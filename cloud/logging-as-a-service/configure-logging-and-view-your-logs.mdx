...
<Frame>![Discover view showing the index pattern with log data](/images/docs/cloud/logging-as-a-service/configure-logging-and-view-your-logs/configure-logging-and-view-your-logs-image8.png)</Frame>
