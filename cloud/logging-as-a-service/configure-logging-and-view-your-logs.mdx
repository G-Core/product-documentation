...
ai-navigation: Enable Managed Logging in region, create namespace and Kafka topic, generate credentials, configure log shipper (Fluent Bit, Filebeat, Logstash) with Kafka e
ai-navigation: Configure Managed Logging namespace, create Kafka topics, generate credentials, and connect log shippers via Kafka endpoints.
---
