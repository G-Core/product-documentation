...
description: Collect and store logs from Virtual Machines and Bare Metal servers via Kafka-compatible shippers, accessed through OpenSearch Dashboards for error detection...
---
