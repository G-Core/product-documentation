...
<Frame>![Plugins page in Grafana featuring OpenSearch plugin](/images/docs/cloud/logging-as-a-service/view-opensearch-logs-in-Grafana/grafana-plugins-search.png)</Frame>
...
<Frame>![OpenSearch plugin overview in Grafana](/images/docs/cloud/logging-as-a-service/view-opensearch-logs-in-Grafana/grafana-add-data-source.png)</Frame>
...
<Frame>![HTTP settings of the OpenSearch plugin in Grafana](/images/docs/cloud/logging-as-a-service/view-opensearch-logs-in-Grafana/grafana-opensearch-http-config.png)</Frame>
...
<Frame>![Authentication settings of the OpenSearch plugin in Grafana](/images/docs/cloud/logging-as-a-service/view-opensearch-logs-in-Grafana/grafana-opensearch-auth-config.png)</Frame>
...
<Frame>![Dashboards page in Grafana with the new dashboard button highlighted](/images/docs/cloud/logging-as-a-service/view-opensearch-logs-in-Grafana/grafana-add-dashboard.png)</Frame>
...
<Frame>![Grafana dashboard with the Add visualization button highlighted](/images/docs/cloud/logging-as-a-service/view-opensearch-logs-in-Grafana/grafana-add-visualization.png)</Frame>
