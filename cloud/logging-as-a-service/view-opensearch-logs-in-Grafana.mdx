...
<Frame>![Plugins page in Grafana featuring OpenSearch plugin](/images/docs/cloud/laas/view-logs-in-grafana/view-opensearch-logs-in-Grafana-image1.png)</Frame>
...
<Frame>![OpenSearch plugin overview in Grafana](/images/docs/cloud/laas/view-logs-in-grafana/view-opensearch-logs-in-Grafana-image2.png)</Frame>
...
<Frame>![HTTP settings of the OpenSearch plugin in Grafana](/images/docs/cloud/laas/view-logs-in-grafana/view-opensearch-logs-in-Grafana-image3.png)</Frame>
...
<Frame>![Authentication settings of the OpenSearch plugin in Grafana](/images/docs/cloud/laas/view-logs-in-grafana/view-opensearch-logs-in-Grafana-image4.png)</Frame>
...
<Frame>![Dashboards page in Grafana with the new dashboard button highlighted](/images/docs/cloud/laas/view-logs-in-grafana/view-opensearch-logs-in-Grafana-image5.png)</Frame>
...
<Frame>![Grafana dashboard with the Add visualization button highlighted](/images/docs/cloud/laas/view-logs-in-grafana/view-opensearch-logs-in-Grafana-image6.png)</Frame>
