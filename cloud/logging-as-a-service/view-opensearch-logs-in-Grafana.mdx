...
ai-navigation: Integrate Gcore Managed Logging with Grafana using OpenSearch plugin for consolidated log visualization and alerting.
ai-navigation: Configure OpenSearch Grafana Data Source plugin with HTTP endpoint, Basic auth credentials, and timeout to view Gcore Managed Logging logs.
---
