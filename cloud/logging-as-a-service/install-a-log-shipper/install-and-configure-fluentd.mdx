...
ai-navigation: Configure Fluentd with Kafka output plugin to stream logs to Gcore Managed Logging using brokers, SASL authentication, and topic settings.
ai-navigation: Configure Fluentd with Kafka output plugin to stream logs to Gcore Managed Logging via brokers, SASL authentication, and topic routing.
---
