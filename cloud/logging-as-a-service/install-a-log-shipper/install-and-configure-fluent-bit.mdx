...
description: Configure Fluent Bit [INPUT] and [OUTPUT] sections with log source, Kafka brokers, SASL authentication, and Gcore Logging endpoint to ship logs to OpenSearch...
---
