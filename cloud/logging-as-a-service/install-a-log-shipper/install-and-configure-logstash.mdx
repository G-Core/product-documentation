...
ai-navigation: Install Logstash and configure Kafka output plugin with SASL authentication to send logs to Gcore Managed Logging.
ai-navigation: Configure Logstash with Kafka output plugin to send logs to Gcore Managed Logging via topic_id, bootstrap_servers, SASL authentication, and
---
