...
ai-navigation: Install Filebeat and configure inputs, output.kafka, Kafka endpoint, SASL authentication, and SSL encryption for log shipping to Gcore Managed Logging.
ai-navigation: Configure Filebeat inputs and output.kafka section with Kafka Endpoint, topic, SASL authentication, and SSL to ship logs to Gcore Managed Logging.
---
