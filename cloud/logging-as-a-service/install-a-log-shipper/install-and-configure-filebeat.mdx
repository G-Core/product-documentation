...
description: Install Filebeat and configure inputs, output.kafka, Kafka endpoint, SASL authentication, and SSL encryption for log shipping to Gcore Managed Logging.
---
