...
SMTP ports 25, 465, and 587 are blocked by default on Gcore Cloud VMs to prevent spam abuse. Before setting up a mail server, [contact the Gcore support team](https://gcore.com/contact-us) to request port unblocking. Provide a business justification for using email services. The use of email services must comply with [Gcore terms of use](https://gcore.com/legal); accounts violating these terms will be blocked.
</Warning>
