...
SMTP ports 25, 465, and 587 are blocked by default on Gcore Cloud VMs to prevent spam abuse. Before setting up a mail server, [contact the Gcore support team](https://gcore.com/contact-us) to request port unblocking with a business justification. The use of email services must comply with [Gcore terms of use](https://gcore.com/legal); accounts violating these terms will be blocked. For managed email hosting without these restrictions, consider [Gcore Hosting](https://hosting.gcore.com).
</Warning>
...
Ensure SMTP ports are unblocked before proceeding with mail server installation. See the warning at the top of this guide for details.
</Info>
