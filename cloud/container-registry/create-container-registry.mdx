...
ai-navigation: Create a Container Registry with OCI-compatible artifact storage by specifying region, registry name, and storage limit in the Gcore Customer Portal, then add users with push/pull permissions and configurable credential expiration.
---
...
<Frame>![Container registry page in the Customer Portal](/images/docs/cloud/container-registry/create-container-registry/create-container-registry-image1.png)</Frame>
...
<Frame>![Create Container registry dialog in the Customer Portal](/images/docs/cloud/container-registry/create-container-registry/create-container-registry-image2.png)</Frame>
...
<Frame>![Users tab with no users created](/images/docs/cloud/container-registry/create-container-registry/create-container-registry-image3.png)</Frame>
...
<Frame>![Add users dialog](/images/docs/cloud/container-registry/create-container-registry/create-container-registry-image4.png)</Frame>
...
<Frame>![A dialog with a username and password](/images/docs/cloud/container-registry/create-container-registry/create-container-registry-image5.png)</Frame>
...
<Frame>![Registry overview page with highlighted push and pull buttons](/images/docs/cloud/container-registry/create-container-registry/create-container-registry-image6.png)</Frame>
...
<Frame>![Registry overview page with highlighted images tab](/images/docs/cloud/container-registry/create-container-registry/create-container-registry-image7.png)</Frame>
