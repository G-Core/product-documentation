...
The full list of registry parameters is in the [create registry](https://api.gcore.com/docs/cloud#tag/Registry/operation/RegistriesHandler.post) endpoint spec.
