...
ai-navigation: Create OCI-compatible Container Registry with region selection, storage limits, and user authentication for pushing/pulling images.
ai-navigation: Create Container Registry with region, name, storage limit, and user credentials for OCI-compatible artifacts.
---
