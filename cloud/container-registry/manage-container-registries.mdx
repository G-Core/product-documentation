...
ai-navigation: Manage Container Registry storage limits, images, and artifacts via Gcore Customer Portal; adjust storage capacity, view image metadata (name, pull count, last modified), manage image artifacts with tags and push/pull operation history, and delete images or artifacts.
---

All created Container Registries appear in the Gcore Customer Portal on the **Container Registries** page:


<Frame>![Container registry page in the Customer Portal](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image1.png)</Frame>
...
<Frame>![Container registry settings with change limit button highlighted](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image2.png)</Frame>
...
<Frame>![A confirmation dialog to change storage limit](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image3.png)</Frame>
...
<Frame>![Images tab in the registry overview](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image4.png)</Frame>
...
<Frame>![Images tab with the list of image artifacts](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image5.png)</Frame>
...
<Frame>![Image settings with the highlighted delete and delete tags buttons](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image6.png)</Frame>
...
<Frame>![Image settings with the highlighted delete button](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image7.png)</Frame>
...
<Frame>![Image deletion dialog](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image8.png)</Frame>
...
<Frame>![Group actions dropdown on the Images tab](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image9.png)</Frame>
...
<Frame>![Users tab in the registry overview](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image10.png)</Frame>
...
<Frame>![Users settings with the highlighted change permissions button](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image11.png)</Frame>
...
<Frame>![Change permissions dialog](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image12.png)</Frame>
...
<Frame>![Users settings with the highlighted reset password button](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image13.png)</Frame>
...
<Frame>![Reset password confirmation dialog](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image14.png)</Frame>
...
<Frame>![Users settings with the highlighted delete button](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image15.png)</Frame>
...
<Frame>![Delete user confirmation dialog](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image16.png)</Frame>
...
<Frame>![Users settings with the highlighted group actions dropdown](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image17.png)</Frame>
...
<Frame>![Container registry page with the highlighed delete button](/images/docs/cloud/container-registry/manage-container-registries/manage-container-registries-image18.png)</Frame>
