...
```bash
curl -s -X PATCH \
  "https://api.gcore.com/cloud/v1/registries/$PROJECT_ID/$REGION_ID/$REGISTRY_ID/resize" \
...
```bash
curl -s \
  "https://api.gcore.com/cloud/v1/registries/$PROJECT_ID/$REGION_ID/$REGISTRY_ID/repositories" \
  -H "Authorization: APIKey $GCORE_API_KEY"
```
...
curl -s \
  "https://api.gcore.com/cloud/v1/registries/$PROJECT_ID/$REGION_ID/$REGISTRY_ID/repositories/$REPOSITORY_NAME/artifacts" \
  -H "Authorization: APIKey $GCORE_API_KEY"
```
...
curl -s -X DELETE \
  "https://api.gcore.com/cloud/v1/registries/$PROJECT_ID/$REGION_ID/$REGISTRY_ID/repositories/$REPOSITORY_NAME/artifacts/$DIGEST/tags/$TAG_NAME" \
  -H "Authorization: APIKey $GCORE_API_KEY"
```
  </Tab>
</Tabs>
...
curl -s -X DELETE \
  "https://api.gcore.com/cloud/v1/registries/$PROJECT_ID/$REGION_ID/$REGISTRY_ID/repositories/$REPOSITORY_NAME/artifacts/$DIGEST" \
  -H "Authorization: APIKey $GCORE_API_KEY"
```
  </Tab>
</Tabs>
...
curl -s -X DELETE \
  "https://api.gcore.com/cloud/v1/registries/$PROJECT_ID/$REGION_ID/$REGISTRY_ID/repositories/$REPOSITORY_NAME" \
  -H "Authorization: APIKey $GCORE_API_KEY"
```
  </Tab>
</Tabs>
...
curl -s -X PATCH \
  "https://api.gcore.com/cloud/v1/registries/$PROJECT_ID/$REGION_ID/$REGISTRY_ID/users/$USER_ID" \
  -H "Authorization: APIKey $GCORE_API_KEY" \
  -H "Content-Type: application/json" \
...
curl -s -X POST \
  "https://api.gcore.com/cloud/v1/registries/$PROJECT_ID/$REGION_ID/$REGISTRY_ID/users/$USER_ID/refresh_secret" \
  -H "Authorization: APIKey $GCORE_API_KEY"
```
