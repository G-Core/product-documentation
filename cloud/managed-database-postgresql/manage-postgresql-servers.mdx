...
<Info>
An [API token](/developer-tools/rest-api/authentication) is required, along with a [project ID](https://gcore.com/docs/api-reference/cloud/projects/list-projects) and a [region ID](https://gcore.com/docs/api-reference/cloud/regions/list-regions).
</Info>
