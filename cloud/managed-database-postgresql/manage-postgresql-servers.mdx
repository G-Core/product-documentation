...
ai-navigation: Create a PostgreSQL server in Gcore Database for PostgreSQL by selecting region, PostgreSQL version, compute flavor, storage volume type and size, and optionally enabling High Availability with asynchronous or synchronous replication mode.
---
...
<Frame>![manage postgresql](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image1.png)</Frame>
...
<Frame>![manage postgresql send quotas request](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image2.png)</Frame>
...
<Frame>![manage postgresql create a server](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image3.png)</Frame>
...
<Frame>![manage postgresql choose region](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image4.png)</Frame>
...
<Frame>![manage postgresql select version](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image5.png)</Frame>
...
<Frame>![manage postgresql select server flavor](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image6.png)</Frame>
...
<Frame>![manage postgresql choose volume](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image7.png)</Frame>
...
<Frame>![manage postgresql manage replication mode](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image8.png)</Frame>
...
<Frame>![manage postgresql manage network interface](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image9.png)</Frame>
...
<Frame>![manage postgresql manage authentication](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image10.png)</Frame>
...
<Frame>![manage postgresql specify server details](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image11.png)</Frame>
...
<Frame>![manage postgresql generate credentials](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image12.jpg)</Frame>
...
<Frame>![manage postgresql update version](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image13.png)</Frame>
...
<Frame>![manage postgresql update version pop up](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image14.png)</Frame>
...
<Frame>![manage postgresql delete server](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image15.jpg)</Frame>
...
<Frame>![manage postgresql confirm deletion](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image16.png)</Frame>
...
<Frame>![manage postgresql connection details](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image17.png)</Frame>
...
<Frame>![manage postgresql connect phpmyadmin 1](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image18.png)</Frame>
...
<Frame>![manage postgresql connect phpmyadmin 2](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image19.png)</Frame>
...
<Frame>![manage postgresql connect phpmyadmin 3](/images/docs/cloud/database-for-postgresql/manage-postgresql-servers/manage-postgresql-servers-image19.png)</Frame>
