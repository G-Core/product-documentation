...
<Frame>![manage postgresql connection details](/images/docs/cloud/managed-database-postgresql/manage-postgresql-servers/manage-postgresql-170.png)</Frame>
  ...
  * Username. You can find it in the "Connection details"
...
<Info>
A permanent [API token](/developer-tools/rest-api/authentication) is required, along with a [project ID](https://api.gcore.com/docs/cloud#tag/Projects/operation/GetProjectList.get) and a [region ID](https://api.gcore.com/docs/cloud#tag/Regions/operation/GetRegionList.get).
</Info>
