...
ai-navigation: Create PostgreSQL servers with region, version, compute flavor, storage volume, and optional high-availability replication modes (asynchronous/synchronous).
ai-navigation: Create PostgreSQL server with region, version, compute flavor, storage volume, and high availability replication mode.
---
