...
<Frame>![manage postgresql manage replication mode and network](/images/docs/cloud/managed-database-postgresql/manage-postgresql-servers/manage-postgresql-90.png)</Frame>

<p>This feature can be enabled or disabled later.</p>
...
<p>Replace `hostname`, `port`, `dbname`, and `username` with the actual connection values.</p>
