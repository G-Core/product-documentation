...
description: Create PostgreSQL servers with region, version, compute flavor, storage volume, and optional high-availability replication modes (asynchronous/synchronous).
---
