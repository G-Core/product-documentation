...
ai-navigation: Create a PostgreSQL server in Gcore Managed Database via Customer Portal by selecting region, version, flavor, and storage, or via REST API by activating the service, creating a cluster, and connecting with psql.
---
