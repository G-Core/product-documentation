...
## Step 1. Install external utilities
...
The restore command depends on the backup format used in Step 3.
...
Where `backup_path` is the path to the backup file (`.tar`, `.dump`) or directory created in Step 3.
