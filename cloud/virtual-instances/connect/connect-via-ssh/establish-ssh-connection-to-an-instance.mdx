...
<Frame>
  ![Ubuntu terminal displaying successful SSH connection](/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/linux-connected.png)
</Frame>
...
<Frame>
  ![PuTTY Session settings with Host Name and Port fields](/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/puttygen-session.png)
</Frame>
...
<Frame>
  ![PuTTY Credentials tab with the Browse button for selecting a private key](/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/puttygen-session-annotated.png)
</Frame>
...
<Frame>
  ![PuTTY security alert asking to cache the server host key](/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/putty-cache-server.png)
</Frame>
...
<Frame>
  ![PuTTY terminal displaying successful SSH connection](/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/putty-connected.png)
</Frame>
...
<Frame>
  ![Windows Settings home page](/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/windows-settings.png)
</Frame>

2. Navigate to **Apps** and select **Optional features**.

<Frame>
  ![Windows Apps and features page showing Optional features link](/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/windows-optional-features.png)
</Frame>

3. Find **OpenSSH Client**, expand it, and select **Install**.

<Frame>
  ![Windows Optional features page with OpenSSH Client ready to install](/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/windows-openssh.png)
</Frame>
...
<Frame>
  ![Command Prompt displaying successful SSH connection](/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/linux-connected.png)
</Frame>