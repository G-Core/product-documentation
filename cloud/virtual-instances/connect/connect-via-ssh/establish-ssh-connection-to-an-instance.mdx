...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/linux-connected.png" alt="Ubuntu terminal displaying successful SSH connection" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/puttygen-session.png" alt="PuTTY Session settings with Host Name and Port fields" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/puttygen-session-annotated.png" alt="PuTTY Credentials tab with the Browse button for selecting a private key" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/putty-cache-server.png" alt="PuTTY security alert asking to cache the server host key" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/putty-connected.png" alt="PuTTY terminal displaying successful SSH connection" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/windows-settings.png" alt="Windows Settings home page" width="70%"/>
</Frame>

2. Navigate to **Apps** and select **Optional features**.

<Frame>
  <img src="/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/windows-optional-features.png" alt="Windows Apps and features page showing Optional features link" width="70%"/>
</Frame>

3. Find **OpenSSH Client**, expand it, and select **Install**.

<Frame>
  <img src="/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/windows-openssh.png" alt="Windows Optional features page with OpenSSH Client ready to install" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/connect/connect-via-ssh/establish-ssh-connection-to-an-instance/linux-connected.png" alt="Command Prompt displaying successful SSH connection" width="70%"/>
</Frame>