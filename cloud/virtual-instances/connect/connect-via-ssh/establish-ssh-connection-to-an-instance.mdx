...
ai-navigation: Establish SSH connection to Virtual Machine instances using SSH key pairs or password authentication via terminal, WSL, Command Prompt, or PuTTY with floating IP address and firewall rules configured.
---
...
<Frame>![Ubuntu terminal displaying successful connection](/images/docs/cloud/virtual-instances/connect/establish-ssh-connection-to-an-instance/establish-ssh-connection-to-an-instance-image1.png)</Frame>
...
<Frame>![Puttygen application with highlighted Port and Host name fields](/images/docs/cloud/virtual-instances/connect/establish-ssh-connection-to-an-instance/establish-ssh-connection-to-an-instance-image2.png)</Frame>
...
<Frame>![PuttyGen application with open Credentials tab](/images/docs/cloud/virtual-instances/connect/establish-ssh-connection-to-an-instance/establish-ssh-connection-to-an-instance-image3.png)</Frame>
...
<Frame>![Putty security alert that asks to cache the server's host key](/images/docs/cloud/virtual-instances/connect/establish-ssh-connection-to-an-instance/establish-ssh-connection-to-an-instance-image4.png)</Frame>
...
<Frame>![Putty terminal displaying successful connection](/images/docs/cloud/virtual-instances/connect/establish-ssh-connection-to-an-instance/establish-ssh-connection-to-an-instance-image5.png)</Frame>
...
<Frame>![Windows settings page](/images/docs/cloud/virtual-instances/connect/establish-ssh-connection-to-an-instance/establish-ssh-connection-to-an-instance-image6.png)</Frame>
...
<Frame>![Windows Apps and features page](/images/docs/cloud/virtual-instances/connect/establish-ssh-connection-to-an-instance/establish-ssh-connection-to-an-instance-image7.png)</Frame>
...
<Frame>![Windows Apps and features page that displays OpenSSH Client app](/images/docs/cloud/virtual-instances/connect/establish-ssh-connection-to-an-instance/establish-ssh-connection-to-an-instance-image8.png)</Frame>
