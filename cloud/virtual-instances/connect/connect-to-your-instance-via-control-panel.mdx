...
ai-navigation: Connect to Gcore Virtual Machines via VNC console in the Customer Portal using password authentication for Windows and Linux instances, or SSH keys for Linux VMs without configured passwords.
---
...
<Tabs>
  <Tab title="Connect to a Windows Virtual Machine">
    ...
    **Info**
    ...
    <Frame>![A Virtual Machines tab in the Gcore Customer Portal](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-control-panel/connect-to-your-instance-via-control-panel-image1.png)</Frame>
    ...
    <Frame>![Overview of a Virtual Machine with the Access to console link highlighted](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-control-panel/connect-to-your-instance-via-control-panel-image2.png)</Frame>
    ...
    <Frame>![Windows login screen](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-control-panel/connect-to-your-instance-via-control-panel-image3.png)</Frame>
    ...
    <Frame>![Windows desktop](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-control-panel/connect-to-your-instance-via-control-panel-image4.png)</Frame>
  </Tab>
  <Tab title="Connect to a Linux Virtual Machine">
    ...
    **Info**
    ...
    <Frame>![A virtual instances tab in the Gcore Customer Portal](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-control-panel/connect-to-your-instance-via-control-panel-image1.png)</Frame>
    ...
    <Frame>![Overview of a Virtual Machine with the Access to console link highlighted](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-control-panel/connect-to-your-instance-via-control-panel-image5.png)</Frame>
    ...
    <Frame>![Ubuntu terminal displaying login information](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-control-panel/connect-to-your-instance-via-control-panel-image6.png)</Frame>
    ...
    **Tip**
    ...
    <Frame>![Ubuntu terminal displaying successful connection to an instance](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-control-panel/connect-to-your-instance-via-control-panel-image7.png)</Frame>
  </Tab>
</Tabs>
