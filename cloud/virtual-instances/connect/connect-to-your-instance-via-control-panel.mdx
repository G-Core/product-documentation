...
<Tabs>
  <Tab title="Connect to a Windows Virtual Machine">
    ...
    <Frame>
    <img src="/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-control-panel/vm-list.png" alt="Virtual Instances list in the Gcore Customer Portal" width="70%"/>
    </Frame>
    ...
    <Frame>
    <img src="/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-control-panel/vm-access-to-console.png" alt="VM overview with IP address, Access to Console button, and SSH login link" width="70%"/>
    </Frame>
    ...
    <Frame>
    <img src="/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-control-panel/windows-login.png" alt="Windows login screen" width="70%"/>
    </Frame>
    ...
    <Frame>
    <img src="/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-control-panel/windows-connected.png" alt="Windows desktop after connecting to the VM" width="70%"/>
    </Frame>
  </Tab>
  <Tab title="Connect to a Linux Virtual Machine">
    ...
    <Frame>
    <img src="/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-control-panel/linux-login-prompt.png" alt="Ubuntu terminal displaying the VNC login prompt" width="70%"/>
    </Frame>
    ...
    <Frame>
    <img src="/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-control-panel/linux-connected.png" alt="Ubuntu terminal displaying successful connection to an instance" width="70%"/>
    </Frame>
  </Tab>
</Tabs>
