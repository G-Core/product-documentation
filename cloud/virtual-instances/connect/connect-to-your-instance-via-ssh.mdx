...
ai-navigation: Generate and manage SSH key pairs in Gcore Customer Portal; add public keys to VMs; store private keys locally for authentication.
ai-navigation: Generate SSH key pairs in Gcore Customer Portal or via CLI tools; add public keys to portal for VM authentication.
---
...
<Tabs>
  <Tab title="Generate an SSH key when creating a VM">
    ...
    <Frame>
      ![SSH keys section with three options: select, generate, or add a new SSH key](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/create-instance-ssh-keys.png)
    </Frame>
    ...
    <Frame>
      ![A dialog with options to name and create an SSH key](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/autogenerate-ssh-key.png)
    </Frame>
  </Tab>
  <Tab title="Generate an SSH key in the SSH Keys section">
    ...
    <Frame>
      ![An SSH keys tab in the Gcore Customer Portal](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/cloud-ssh-keys-annotated.png)
    </Frame>
...
<Tabs>
  ...
  <Tab title="PuTTYgen">
    ...
    <Frame>
      ![Puttygen app with two options selected: RSA type of key and 2048 number of bits](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/puttygen-connect.png)
    </Frame>

    5. Click **Generate**. While the key is being generated, move the cursor in the "Key" field until the key appears in the field.

    <Frame>
      ![Puttygen app with a generated public key](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/puttygen-generate-key.png)
    </Frame>
...
<Frame>
  ![An SSH keys tab in the Gcore Customer Portal](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/cloud-ssh-keys-add.png)
</Frame>
...
<Frame>
  ![An SSH keys tab in the Gcore Customer Portal](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/add-ssh-key-annotated.png)
</Frame>
...
<Frame>
  ![An SSH keys tab in the Gcore Customer Portal](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/cloud-ssh-keys.png)
</Frame>
...
<Frame>
  ![SSH key options menu displaying the Delete button](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/delete-ssh-keys.png)
</Frame>
...
<Frame>
  ![SSH key options menu displaying the Stop sharing button](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/stop-sharing-ssh-keys.png)
</Frame>
