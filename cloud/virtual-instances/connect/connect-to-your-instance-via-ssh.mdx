...
<Tabs>
  <Tab title="Generate an SSH key when creating a VM">
    ...
    <Frame>
      ![SSH key section with a dropdown and links to add or generate a key](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/create-instance-ssh-keys.png)
    </Frame>
    ...
    <Frame>
      ![Autogenerate SSH Key dialog with name field and Create SSH Key button](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/autogenerate-ssh-key.png)
    </Frame>
  </Tab>
  <Tab title="Generate an SSH key in the SSH Keys section">
    ...
    <Frame>
      ![SSH Keys page in the Gcore Customer Portal with Autogenerate SSH Key and Add SSH Key buttons](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/cloud-ssh-keys-annotated.png)
    </Frame>
...
<Tabs>
  ...
  <Tab title="PuTTYgen">
    ...
    <Frame>
      ![PuTTYgen with RSA type and 2048 bits selected](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/puttygen-connect.png)
    </Frame>

    5. Click **Generate**. While the key is being generated, move the cursor in the **Key** field until the key appears.

    <Frame>
      ![PuTTYgen with a generated public key](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/puttygen-generate-key.png)
    </Frame>
...
<Frame>
  ![SSH Keys page with the Add SSH Key button](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/cloud-ssh-keys-annotated.png)
</Frame>
...
<Frame>
  ![Add new SSH Key dialog with SSH key content and name fields](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/add-ssh-key-annotated.png)
</Frame>
...
<Frame>
  ![SSH Keys list in the Gcore Customer Portal](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/cloud-ssh-keys.png)
</Frame>
...
<Frame>
  ![SSH key action menu with the Delete option](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/delete-ssh-keys.png)
</Frame>
...
<Frame>
  ![SSH key action menu with the Stop sharing option](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/stop-sharing-ssh-keys.png)
</Frame>
