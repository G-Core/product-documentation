...
<Tabs>
  <Tab title="Generate an SSH key when creating a VM">
    ...
    <Frame>
      ![SSH keys section with three options: select, generate, or add a new SSH key](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/connect-to-your-instance-via-ssh-image1.png)
    </Frame>
    ...
    <Frame>
      ![A dialog with options to name and create an SSH key](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/connect-to-your-instance-via-ssh-image2.png)
    </Frame>
  </Tab>
  <Tab title="Generate an SSH key in the SSH Keys section">
    ...
    <Frame>
      ![An SSH keys tab in the Gcore Customer Portal](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/connect-to-your-instance-via-ssh-image3.png)
    </Frame>
...
<Tabs>
  <Tab title="Terminal or Command Prompt">
    ...
    3. You'll be asked to enter the file where the keys should be saved. You can specify a custom location (for example, `.ssh/`), or press **Enter** to save the keys to the default directory. The default directory is `~/.` for Linux/macOS and `C:\Users\\` for Windows.
  ...
  <Tab title="PuTTYgen">
    ...
    <Frame>
      ![Puttygen app with two options selected: RSA type of key and 2048 number of bits](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/connect-to-your-instance-via-ssh-image4.png)
    </Frame>

    5. Click **Generate**. While the key is being generated, move the cursor in the "Key" field until the key appears in the field.

    <Frame>
      ![Puttygen app with a generated public key](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/connect-to-your-instance-via-ssh-image5.png)
    </Frame>
...
<Frame>
  ![An SSH keys tab in the Gcore Customer Portal](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/connect-to-your-instance-via-ssh-image6.png)
</Frame>
...
<Frame>
  ![An SSH keys tab in the Gcore Customer Portal](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/connect-to-your-instance-via-ssh-image7.png)
</Frame>
...
<Frame>
  ![An SSH keys tab in the Gcore Customer Portal](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/connect-to-your-instance-via-ssh-image8.png)
</Frame>
...
<Frame>
  ![SSH key options menu displaying the Delete button](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/connect-to-your-instance-via-ssh-image9.png)
</Frame>
...
<Frame>
  ![SSH key options menu displaying the Stop sharing button](/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/connect-to-your-instance-via-ssh-image10.png)
</Frame>
