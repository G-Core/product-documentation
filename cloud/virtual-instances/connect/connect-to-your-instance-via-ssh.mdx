...
<Tabs>
  <Tab title="Generate an SSH key when creating a VM">
    ...
    <Frame>
      <img src="/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/create-instance-ssh-keys.png" alt="SSH key section with a dropdown and links to add or generate a key" width="70%"/>
    </Frame>
  ...
  <Tab title="Generate an SSH key in the SSH Keys section">
    ...
    <Frame>
      <img src="/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/cloud-ssh-keys-annotated.png" alt="SSH Keys page in the Gcore Customer Portal with Autogenerate SSH Key and Add SSH Key buttons" width="70%"/>
    </Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/cloud-ssh-keys-annotated.png" alt="SSH Keys page with the Add SSH Key button" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/add-ssh-key-annotated.png" alt="Add new SSH Key dialog with SSH key content and name fields" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/delete-ssh-keys.png" alt="SSH key action menu with the Delete option" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/connect/connect-to-your-instance-via-ssh/stop-sharing-ssh-keys.png" alt="SSH key action menu with the Stop sharing option" width="70%"/>
</Frame>
