...
<p>Provision a placement group using the Gcore [Terraform provider](/developer-tools/terraform/overview).</p>

<Tip>
See the [Terraform Registry](https://registry.terraform.io/providers/G-Core/gcore/latest/docs) for the full provider reference. This tab uses the [gcore_cloud_placement_group](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_placement_group) resource.
</Tip>
