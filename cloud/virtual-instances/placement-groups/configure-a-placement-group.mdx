...
1. In the [Gcore Customer Portal](https://portal.gcore.com), go to **Cloud** and select the target region.
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/placement-groups/configure-a-placement-group/image-6.png" alt="Create Placement Group dialog with Name and Policy fields" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/placement-groups/configure-a-placement-group/image-8.png" alt="Add to placement group checkbox and Placement Group dropdown on the create instance form" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/placement-groups/configure-a-placement-group/image-9.png" alt="Placement Group tab with group selector and Add button" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/placement-groups/configure-a-placement-group/image-10.png" alt="Placement Group tab showing assigned group and Remove button" width="70%"/>
</Frame>

<Frame>
  <img src="/images/docs/cloud/virtual-instances/placement-groups/configure-a-placement-group/image-11.png" alt="Placement Group dropdown after removal, ready to select a new group" width="70%"/>
</Frame>
</MethodSection>
