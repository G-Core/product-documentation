...
<p>Configure placement groups and assign Virtual Machines to them in the Customer Portal.</p>

## Create a placement group

<p>Placement groups control how Virtual Machines are distributed across physical hosts. For policy descriptions, see [Overview](/cloud/virtual-instances/placement-groups/about-placement-groups).</p>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/placement-groups/configure-a-placement-group/create-placement-group-dialog.png" alt="Create Placement Group dialog with Name and Policy fields" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/placement-groups/configure-a-placement-group/create-instance-placement-group.png" alt="Add to placement group checkbox and Placement Group dropdown on the create instance form" width="70%"/>
</Frame>

## Add an existing Virtual Machine to a group

<p>The Virtual Instance must already exist in the same region. See [Create](/cloud/virtual-instances/create-an-instance) if one is needed.</p>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/placement-groups/configure-a-placement-group/placement-group-selector.png" alt="Placement Group tab with group selector and Add button" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/placement-groups/configure-a-placement-group/placement-group-assigned.png" alt="Placement Group tab showing assigned group and Remove button" width="70%"/>
</Frame>

<Frame>
  <img src="/images/docs/cloud/virtual-instances/placement-groups/configure-a-placement-group/placement-group-selector.png" alt="Placement Group dropdown after removal, ready to select a new group" width="70%"/>
</Frame>
</MethodSection>
...
A [placement group](/api-reference/cloud#tag/Placement-groups) defines the policy that controls how VMs assigned to it are distributed across physical hosts.
