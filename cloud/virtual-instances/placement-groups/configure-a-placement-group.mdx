...
description: Create and manage placement groups with affinity, anti-affinity, or soft anti-affinity policies to control Virtual Machine hardware placement and fault toler...
---
