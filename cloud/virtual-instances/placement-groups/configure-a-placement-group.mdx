...
<Tip>
The [gcore_cloud_placement_group](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_placement_group) reference on Terraform Registry includes additional configuration examples.
</Tip>
