...
ai-navigation: Create and manage Virtual Machine placement groups with affinity, anti-affinity, or soft anti-affinity policies to control VM co-location on physical hardware for performance optimization or fault tolerance.
---
...
<Frame>![Additional options](/images/docs/cloud/virtual-instances/placement-groups/configure-a-placement-group/configure-a-placement-group-image1.png)</Frame>
...
<Frame>![Placement Group](/images/docs/cloud/virtual-instances/placement-groups/configure-a-placement-group/configure-a-placement-group-image2.png)</Frame>
...
<Frame>![Placement Group](/images/docs/cloud/virtual-instances/placement-groups/configure-a-placement-group/configure-a-placement-group-image3.png)</Frame>
...
<Frame>![Placement Group](/images/docs/cloud/virtual-instances/placement-groups/configure-a-placement-group/configure-a-placement-group-image4.png)</Frame>

<Frame>![Placement Group](/images/docs/cloud/virtual-instances/placement-groups/configure-a-placement-group/configure-a-placement-group-image5.png)</Frame>
