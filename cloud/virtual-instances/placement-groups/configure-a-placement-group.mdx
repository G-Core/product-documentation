...
1. In the [Gcore Customer Portal](https://portal.gcore.com), navigate to **Cloud** > **Placement Groups**.

2. Click **Create Placement Group**.

3. Enter a **Name** for the group.

4. Select a **Policy** — **Affinity**, **Anti-Affinity**, or **Soft Anti-Affinity**.

5. In the dialog, click **Create**.
