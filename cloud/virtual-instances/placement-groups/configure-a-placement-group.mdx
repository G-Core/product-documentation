...
ai-navigation: Create and manage placement groups with affinity, anti-affinity, or soft anti-affinity policies to control Virtual Machine hardware placement and fault toler
ai-navigation: Create Placement Groups with affinity, anti-affinity, or soft anti-affinity policies; assign Virtual Machines to groups.
---
