...
ai-navigation: Configure Virtual Machine placement policies using affinity, anti-affinity, or soft anti-affinity groups to control physical server distribution and fault to
ai-navigation: Create placement groups with Affinity, Anti-affinity, or Soft anti-affinity policies to control Virtual Machine physical server distribution.
---
