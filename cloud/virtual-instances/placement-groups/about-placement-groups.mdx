...
description: Configure Virtual Machine placement policies using affinity, anti-affinity, or soft anti-affinity groups to control physical server distribution and fault to...
---
