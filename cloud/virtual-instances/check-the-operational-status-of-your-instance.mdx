...
<Frame><img src="/images/docs/cloud/virtual-instances/check-the-operational-status-of-your-instance/vm-list-status-column.png" alt="Virtual Instances list showing the Status column with a Power on badge" width="70%"/></Frame>
