...
ai-navigation: Check Virtual Machine operational status via the Customer Portal, REST API, or Terraform using the gcore_cloud_instances or gcore_cloud_instance data sources.
---
...
<p>Run `terraform apply` — Terraform queries the API and prints the current status for each instance:</p>
