...
ai-navigation: Monitor Virtual Machine operational statuses (Building, Power on, Power off, Error, Deleted) in Virtual Instances page Status column.
ai-navigation: Check Virtual Machine operational status: Building, Power on, Power off, Error, Deleted states in Virtual Instances page.
---
