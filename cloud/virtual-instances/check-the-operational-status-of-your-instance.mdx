...
<Tip>
The [gcore_cloud_instance](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/data-sources/cloud_instance) data source reference on Terraform Registry includes additional configuration examples.
</Tip>
