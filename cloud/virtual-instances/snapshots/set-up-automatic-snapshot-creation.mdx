...
<Frame><img src="/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image1.png" alt="Snapshot Schedules page with Create Snapshot Schedule button" width="70%" /></Frame>
...
<Frame><img src="/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image2.png" alt="Create Snapshot Schedule form with schedule name, type, and volume fields" width="70%" /></Frame>
...
<Frame><img src="/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image4.png" alt="Select Volumes dropdown with boot and regular volumes listed" width="70%" /></Frame>

5. Select a **Schedule Type** and configure the timing fields that appear below it.

<Frame><img src="/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image3.png" alt="Schedule Type dropdown showing Daily, Weekly, Monthly, Yearly, and Period options" width="70%" /></Frame>
...
<Frame><img src="/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image5.png" alt="Weekly schedule fields with week day selector and time field" width="70%" /></Frame>
...
<Frame><img src="/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image6.png" alt="Period schedule fields with repeat every interval and unit selector" width="70%" /></Frame>
