...
ai-navigation: Create Snapshot Schedules to automate volume snapshot creation at specified days, hours, minutes, or intervals, with configurable name templates using {volume_id} variables and maximum snapshot retention limits.
---
...
<Frame>![Set up automatic snapshot creation](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image1.png)</Frame>
...
<Frame>![Create a schedule](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image1.png)</Frame>
...
<Frame>![mceclip2.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image2.png)</Frame>
...
<Frame>![mceclip11.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image3.png)</Frame>

 
<Frame>![mceclip41.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image4.png)</Frame>
...
<Frame>![mceclip42.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image5.png)</Frame>
...
<Frame>![mceclip43.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image6.png)</Frame>

 
<Frame>![mceclip18.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image7.png)</Frame>
...
<Frame>![mceclip20.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image8.png)</Frame>
...
<Frame>![mceclip23.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image9.png)</Frame>
...
<Frame>![mceclip24.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image10.png)</Frame>
...
<Frame>![mceclip26.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image11.png)</Frame>
...
<Frame>![mceclip27.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image12.png)</Frame>
...
<Frame>![mceclip30.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image13.png)</Frame>
...
<Frame>![mceclip38.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image14.png)</Frame>
...
<Frame>![mceclip39.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image15.png)</Frame>

 
<Frame>![mceclip0.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image1.png)</Frame>
...
<Frame>![mceclip44.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image16.png)</Frame>

 
<Frame>![mceclip45.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image17.png)</Frame>
...
<Frame>![mceclip3.png](/images/docs/cloud/virtual-instances/snapshots/set-up-automatic-snapshot-creation/set-up-automatic-snapshot-creation-image18.png)</Frame>