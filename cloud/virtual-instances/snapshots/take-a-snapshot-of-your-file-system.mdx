...
ai-navigation: Create volume snapshots from system or regular volumes via Snapshots, Volumes, or Instances pages for backup and VM deployment.
ai-navigation: Create snapshots of system and regular volumes for backup, recovery, and VM deployment via Snapshots, Volumes, or Instances pages.
---
