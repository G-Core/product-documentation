...
<Tabs>
  <Tab title="From the Snapshots page">
    ...
    <Frame>
      ![Take snapshot form with volume selected and Create snapshot button](/images/docs/cloud/virtual-instances/snapshots/take-a-snapshot-of-your-file-system/take-a-snapshot-of-your-file-system-image2.png)
    </Frame>
