...
<Tip>
The [gcore_cloud_instance](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_instance) reference on Terraform Registry includes additional configuration examples.
</Tip>
