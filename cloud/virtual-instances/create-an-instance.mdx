...
ai-navigation: Create Linux or Windows Virtual Instances in Gcore Cloud via Customer Portal by configuring image, flavor, volumes, network, and SSH key, or via REST API and Terraform.
---
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/create-an-instance/1-create-instancebutton.png" alt="The Create VM button" width="70%"/>
</Frame>

2. Choose the region where the Virtual Instance will be deployed.

<Frame>
  <img src="/images/docs/cloud/virtual-instances/create-an-instance/2-region-selection.png" alt="Region selection" width="70%"/>
</Frame>
...
<Frame>
  <img
    ...
    alt="Choose x86-64 or ARM architecture" width="70%"
  />
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/create-an-instance/add-volume.png" alt="Configure Volumes" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/create-an-instance/vm-network-section.png" alt="Network settings section with Public network interface selected" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/create-an-instance/add-new-network.png" alt="Private interface with highlighted Add a new network link" width="70%"/>
</Frame>
...
<Accordion title="Create a new network">
  ...
  <Frame>
    <img src="/images/docs/cloud/virtual-instances/create-an-instance/create-network.png" alt="Add a new network" width="70%"/>
  </Frame>
</Accordion>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/create-an-instance/add-new-subnetwork.png" alt="Add a new subnetwork" width="70%"/>
</Frame>
...
<Accordion title="Create a new subnetwork">
  ...
  <Frame>
    <img src="/images/docs/cloud/virtual-instances/create-an-instance/create-subnetwork-annotated.png" alt="Add a new subnetwork dialog" width="70%"/>
  </Frame>
</Accordion>
...
<Accordion title="Interface naming when using multiple interfaces">
  ...
  <Frame>
    <img src="/images/docs/cloud/virtual-instances/create-an-instance/vm-network-interface-order-diagram.png" alt="Diagram showing how interface order set during VM creation maps to the Networking tab and OS interface names" width="70%"/>
  </Frame>
...
<Tabs>
  <Tab title="Linux Virtual Machine">
    ...
    <Frame>
      <img src="/images/docs/cloud/virtual-instances/create-an-instance/11-ssh-key.png" alt="SSH keys section with three options: select, generate, or add a new SSH key" width="70%"/>
    </Frame>
  ...
  <Tab title="Windows Virtual Machine">
    ...
    <Frame>
      <img src="/images/docs/cloud/virtual-instances/create-an-instance/12-access-for-windows-instance.png" alt="Access field with a password" width="70%"/>
    </Frame>
    <Info>
      **Info**
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/create-an-instance/13-add-user-data.png" alt="User data field with password configuration" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/create-an-instance/15-add-placement-group.png" alt="The field to add the VM to a placement group" width="70%"/>
</Frame>
...
<Frame>
  <img src="/images/docs/cloud/virtual-instances/create-an-instance/16-number-of-instances.png" alt="The field to set the number of instances" width="70%"/>
</Frame>
