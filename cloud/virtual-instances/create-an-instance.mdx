...
<Frame>![The Create VM button](/images/docs/cloud/virtual-instances/create-an-instance/1-create-instancebutton.png)</Frame>
...
<Frame>![Region selection](/images/docs/cloud/virtual-instances/create-an-instance/2-region-selection.png)</Frame>
...
<Frame>![Choose x86-64 or ARM architecture](/images/docs/cloud/virtual-instances/create/configure-image.png)</Frame>
...
<Frame>![VM types and flavors](/images/docs/cloud/virtual-instances/create/vm-type.png)</Frame>
...
<Frame>![Configure Volumes](/images/docs/cloud/virtual-instances/create/add-volume.png)</Frame>
...
<Frame>![Network settings with highlighted Reserved IP toggle](/images/docs/cloud/virtual-instances/create/use-reserved-ip.png)</Frame>
...
<Tabs>
  <Tab title="Configure a network">
    ...
    <Frame>![Private interface with highlighted Add a new network link](/images/docs/cloud/virtual-instances/create/add-new-network.png)</Frame>
    ...
    <Frame>![Add a new network](/images/docs/cloud/virtual-instances/create/create-network.png)</Frame>
  </Tab>
  <Tab title="Configure a subnetwork">
    ...
    **Info**
    ...
    <Frame>![Add a new subnetwork](/images/docs/cloud/virtual-instances/create/add-new-subnetwork.png)</Frame>
    ...
    <Frame>![Add a new subnetwork dialog](/images/docs/cloud/virtual-instances/create/create-subnetwork-annotated.png)</Frame>
...
<Frame>![The Firewall settings](/images/docs/cloud/virtual-instances/create-an-instance/10-firewall-settings.png)</Frame>
...
<Tabs>
  <Tab title="Linux Virtual Machine">
    ...
    <Frame>![SSH keys section with three options: select, generate, or add a new SSH key](/images/docs/cloud/virtual-instances/create-an-instance/11-ssh-key.png)</Frame>
  ...
  <Tab title="Windows Virtual Machine">
    ...
    <Frame>![Access field with a password](/images/docs/cloud/virtual-instances/create-an-instance/12-access-for-windows-instance.png)</Frame>
...
<Frame>![User data field with password configuration](/images/docs/cloud/virtual-instances/create-an-instance/13-add-user-data.png)</Frame>
...
<Frame>![The field to add tags](/images/docs/cloud/virtual-instances/create-an-instance/14-add-tags.png)</Frame>
...
<Frame>![The field to add the VM to a placement group](/images/docs/cloud/virtual-instances/create-an-instance/15-add-placement-group.png)</Frame>
...
<Frame>![The field to set the number of instances](/images/docs/cloud/virtual-instances/create-an-instance/16-number-of-instances.png)</Frame>
