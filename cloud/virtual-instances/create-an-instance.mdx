...
<Info>
  **Info**
  ...
  On Cloud VMs with Windows OS, you can't use the `password` parameter both in the "Access" and "User data" fields. Since the "Access" field is required, configuring user data on Windows Virtual Machines is not possible. Read more about the allowed VM parameters in our [API docs](/api-reference/cloud#tag/Instances/operation/InstanceCreateSetV2.post).
</Info>
