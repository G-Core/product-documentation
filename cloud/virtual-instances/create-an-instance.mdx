...
<Info>
  When a Virtual Instance has several subnetworks, keep only one routable — [default&nbsp;gateway&nbsp;conflicts](/cloud/networking/create-and-manage-a-subnetwork#set-up-the-default-gateway) otherwise prevent connecting to the instance.
</Info>
