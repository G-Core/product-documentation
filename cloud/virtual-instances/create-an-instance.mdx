...
<p>Provisioning a Virtual Machine with the [Gcore Terraform provider v2](/developer-tools/terraform/overview) requires two separate resources — [`gcore_cloud_volume`](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_volume) for the boot disk and [`gcore_cloud_instance`](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_instance). Declare the volume first, as the instance references it by ID.</p>
