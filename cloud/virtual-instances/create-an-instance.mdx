...
<Frame>
  ![Add a new subnet](/images/docs/cloud/virtual-instances/create-an-instance/add-new-subnet.png)
</Frame>
...
<Accordion title="Create a new subnet">
  ...
  <Frame>
    ![Add a new subnet dialog](/images/docs/cloud/virtual-instances/create-an-instance/create-subnet-annotated.png)
  </Frame>
</Accordion>
