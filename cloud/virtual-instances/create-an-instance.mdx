...
In this example, Interface 1 (`enp3s0`) is the public interface and Interface 2 (`enp4s0`) is the private interface. The interface order cannot be changed after the instance is created.
