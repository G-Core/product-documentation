...
ai-navigation: Create Linux or Windows Virtual Machines in Gcore Cloud by selecting region (Core or Edge), configuring x86-64 or ARM architecture with OS image, and choosing VM flavor with Intel Xeon Scalable or ARM Ampere Altra Max CPU generation.
---
...
<Frame>
  ![The Create VM button](/images/docs/cloud/virtual-instances/create-an-instance/create-an-instance-image1.png)
</Frame>

2. Choose the region where you want to deploy your Virtual Machine (VM).

<Frame>
  ![Region selection](/images/docs/cloud/virtual-instances/create-an-instance/create-an-instance-image2.png)
</Frame>
...
<Frame>
  <img
    src="/images/docs/cloud/virtual-instances/create-an-instance/create-an-instance-image3.png"
...
<Frame>
  ![VM types and flavors](/images/docs/cloud/virtual-instances/create-an-instance/create-an-instance-image4.png)
</Frame>
...
<Frame>
  ![Configure Volumes](/images/docs/cloud/virtual-instances/create-an-instance/create-an-instance-image5.png)
</Frame>
...
![Network settings](/images/docs/cloud/virtual-instances/create-an-instance/create-an-instance-image6.png)
...
<Tabs>
  <Tab title="Configure a network">
    ...
    <Frame>
      ![Private interface with highlighted Add a new network link](/images/docs/cloud/virtual-instances/create-an-instance/create-an-instance-image7.png)
    </Frame>
    ...
    <Frame>
      ![Add a new network](/images/docs/cloud/virtual-instances/create-an-instance/create-an-instance-image8.png)
    </Frame>
  </Tab>
  <Tab title="Configure a subnetwork">
    ...
    <Frame>
      ![Add a new subnetwork](/images/docs/cloud/virtual-instances/create-an-instance/create-an-instance-image9.png)
    </Frame>
    ...
    <Frame>
      ![Add a new subnetwork dialog](/images/docs/cloud/virtual-instances/create-an-instance/create-an-instance-image10.png)
    </Frame>
    <Tip>
      **Tip**
...
![Diagram showing how interface order set during VM creation maps to the Networking tab and OS interface names](/images/docs/cloud/virtual-instances/create-an-instance/create-an-instance-image11.png)
...
<Tabs>
  <Tab title="Linux Virtual Machine">
    ...
    <Frame>
      ![SSH keys section with three options: select, generate, or add a new SSH key](/images/docs/cloud/virtual-instances/create-an-instance/create-an-instance-image12.png)
    </Frame>
  ...
  <Tab title="Windows Virtual Machine">
    ...
    <Frame>
      ![Access field with a password](/images/docs/cloud/virtual-instances/create-an-instance/create-an-instance-image13.png)
    </Frame>
    <Info>
      **Info**
...
<Frame>
  ![User data field with password configuration](/images/docs/cloud/virtual-instances/create-an-instance/create-an-instance-image14.png)
</Frame>
...
<Frame>
  ![The field to add tags](/images/docs/cloud/virtual-instances/create-an-instance/create-an-instance-image15.png)
</Frame>

- Turn on **Add to placement group** to determine how to place multiple VMs.

<Frame>
  ![The field to add the VM to a placement group](/images/docs/cloud/virtual-instances/create-an-instance/create-an-instance-image16.png)
</Frame>
...
<Frame>
  ![The field to set the number of instances](/images/docs/cloud/virtual-instances/create-an-instance/create-an-instance-image17.png)
</Frame>
