...
<Info>
  When using VAST-based file shares, GPU clusters or other compute resources should be provisioned only after the corresponding [VAST file shares](/cloud/file-shares/configure-file-shares) have been created.
</Info>
