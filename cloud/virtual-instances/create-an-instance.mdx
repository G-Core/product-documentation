...
sidebarTitle: "Create"
description: Provision Linux or Windows Virtual Machines with region selection, x86-64/ARM architecture, OS image configuration, and CPU flavor selection in Gcore Cloud.
---
