...
<Info>
  When using VAST-based file share type, the recommended sequence is to provision GPU clusters or other compute resources only after the corresponding VAST shares have been created.
</Info>
