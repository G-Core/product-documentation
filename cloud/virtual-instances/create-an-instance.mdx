...
<Info>
  When using a VAST-based file share type, the recommended sequence is to provision GPU clusters or other compute resources only after the corresponding [VAST file shares](/cloud/file-shares/configure-file-shares) have been created.
</Info>
