...
If you keep the default firewall, inbound traffic over ICMP, SSH (TCP/22), and RDP (TCP/3389 and UDP/3389) is allowed. Outbound traffic is unrestricted except SMTP (TCP/25 and UDP/25), which is blocked by default.
