...
sidebarTitle: "Create"
ai-navigation: Provision Linux or Windows Virtual Machines with region selection, x86-64/ARM architecture, OS image configuration, and CPU flavor selection in Gcore Cloud.
ai-navigation: Create Linux or Windows Virtual Machines in Gcore Cloud with region, architecture (x86-64/ARM), CPU generation, and flavor selection.
---
