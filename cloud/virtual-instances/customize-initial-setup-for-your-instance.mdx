...
<p>The `user_data` field in the [instance creation](/api-reference/cloud#tag/Instances/operation/InstanceCreateSetV2.post) request accepts a base64-encoded cloud-init YAML string. The encoding step is required — the API rejects plain-text YAML.</p>
