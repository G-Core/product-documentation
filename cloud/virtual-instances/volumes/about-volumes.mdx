...
| SSD Low-Latency | SSD block storage for applications requiring low-latency storage and real-time data processing. 50 IOPS per 1 GB; minimum 1,000 IOPS; maximum 75,000 IOPS. Bandwidth limit: 1,500 MB/s. Average latency: 300 µs. |
