...
ai-navigation: Create and manage cloud block storage volumes for Virtual Machines with boot/regular volume types, High IOPS SSD, Standard, and SSD Low-Latency options using
ai-navigation: Create boot and regular volumes with High IOPS SSD, Standard, or SSD Low-Latency types for VM storage and OS installation.
---
