...
ai-navigation: Create and configure volumes in Gcore Customer Portal: specify size, volume type, attach to Virtual Machine, set IOPS/MBps limits, and manage metadata tags.
ai-navigation: Create volumes with configurable size, type, region, and optional VM attachment via Gcore Customer Portal or API.
---
