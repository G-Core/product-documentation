...
ai-navigation: Create and configure volumes in Gcore Cloud Storage by specifying capacity in GB, selecting volume type, setting IOPS/MBps limits and burst parameters, attaching to Virtual Machines, and adding metadata tags via the Customer Portal or API.
---

You can view, create, and manage volumes in the Gcore Customer Portal on the **Volumes** page. Here's how to navigate the page:


<Frame>![Volumes page with numbered UI elements](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image1.png)</Frame>
...
<Tabs>
  <Tab title="From the Volumes page">
    ...
    <Frame>![Volumes page with numbered storage and create volume tabs](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image2.png)</Frame>

    3\. A new **Add volume** page will open. Here you can customize volume settings.

    <Frame>![Dialog with options for configuring new volume](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image3.png)</Frame>
  ...
  <Tab title="From a volume snapshot">
    ...
    <Frame>![Snapshots tab with expanded settings menu](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image4.png)</Frame>
    ...
    <Frame>![Create volume dialog with options to select Virtual Machine and add volume name](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image5.png)</Frame>
...
<Tabs>
  <Tab title="From the Volumes page">
    ...
    <Frame>![Volumes page with annotated attach to Virtual Machine link](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image6.png)</Frame>

    3\. Select the Virtual Machine from the **Choose instance to attach to** dropdown.

    4\. (Optional) Add an attachment tag.

    <Frame>![Attach volume dialog with options to select Virtual Machine and add a tag](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image7.png)</Frame>
  ...
  <Tab title="From Virtual Machine settings">
    ...
    <Frame>![Virtual Machines tab with two created instances](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image8.png)</Frame>

    3\. Open the **Volumes** tab.

    4\. Click **Add volume**.

    <Frame>![Volumes tab with Add volume button highlighted](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image9.png)</Frame>
    ...
    <Frame>![Add volume menu with options to add Virtual Machine and tags](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image10.png)</Frame>
...
<Frame>![Volumes tab with expanded settings menu](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image11.png)</Frame>
...
<Frame>![Rename volume dialog](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image12.png)</Frame>
...
<Frame>![Volumes tab with expanded settings menu](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image13.png)</Frame>
...
<Frame>![Dialog asking to select a VM to detach the volume from](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image14.png)</Frame>
...
<Frame>![Dialog asking for a new volume size](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image15.png)</Frame>
...
<Frame>![Dialog asking to select a new volume type](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image16.png)</Frame>
...
<Frame>![Dialog asking to add a snapshot name](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image17.png)</Frame>
...
<Frame>![Dialog asking to confirm volume reverting](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image18.png)</Frame>
...
<Frame>![Volumes tab with expanded settings menu](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image19.png)</Frame>
...
<Frame>![Dialog to select image and and architecture](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image20.png)</Frame>
...
<Frame>![Dialog asking to confirm volume deletion](/images/docs/cloud/virtual-instances/volumes/create-and-configure-volumes/create-and-configure-volumes-image21.png)</Frame>
