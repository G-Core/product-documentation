...
description: Create and configure volumes in Gcore Customer Portal: specify size, volume type, attach to Virtual Machine, set IOPS/MBps limits, and manage metadata tags.
---
