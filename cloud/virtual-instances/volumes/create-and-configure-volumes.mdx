...
<p>Provision a block storage volume with the [Gcore Terraform provider v2](/developer-tools/terraform/overview) ([`gcore_cloud_volume`](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_volume)). The most common case is `source = "image"` — this creates a boot volume from an OS image for use with a Virtual Machine.</p>
