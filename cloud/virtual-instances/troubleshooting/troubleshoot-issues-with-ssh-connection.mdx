...
The default username depends on the operating system. When creating a VM, the portal displays the correct username in the format `ssh [username]@ipaddress`. Common examples:
- Ubuntu: `ubuntu`
- Debian: `debian`
- Fedora: `fedora`
- CentOS: `cloud-user`
