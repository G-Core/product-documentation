...
2. If no password was configured: boot recovery mode from the console and install a new public key. See [Recover SSH access in recovery mode](/cloud/virtual-instances/troubleshooting/recover-ssh-access-via-recovery-mode).
