...
ai-navigation: Monitor VM performance metrics including CPU utilization, RAM usage, network BPS/PPS ingress/egress, and disk IOPS read/write operations via the Monitoring tab.
ai-navigation: Monitor Virtual Machine CPU, RAM, network BPS/PPS, and disk IOPS metrics via Monitoring tab with configurable time period and refresh rate.
---
