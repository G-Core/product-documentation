...
<Tabs>
  ...
  <Tab title="G3a">
    Machines powered with the **AMD EPYC™ 4th Gen** processors. Optimized for balanced compute, memory, and networking resources suitable for a wide variety of workloads.
...
<Tabs>
  ...
  <Tab title="G3a">
    Machines powered with the **AMD EPYC™ 4th Gen** processors. Production-grade machines designed for high workloads with intensive CPU usage.
...
<Tabs>
  ...
  <Tab title="G3a">
    Machines powered with the **AMD EPYC™ 4th Gen** processors. Designed for workloads that rely heavily on RAM for optimal performance.
