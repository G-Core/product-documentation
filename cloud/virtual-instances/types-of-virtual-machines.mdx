...
description: Compare Gcore VM types: Standard, GPU, CPU, Memory, High-frequency, Basic, TPM, and Network-optimised instances with network bandwidth specifications.
---
