...
<Tabs>
  ...
  <Tab title="Private">
    ...
    <p>To create a new subnet, click **Add a new subnet** and follow the [subnet guide](/cloud/networking/create-and-manage-a-subnet#create-a-subnet).</p>

    <Info>
      With multiple subnets, set only one as [routable](/cloud/networking/create-and-manage-a-subnet#set-up-the-default-gateway). Multiple routable subnets cause default gateway conflicts that prevent connecting to the server.
    </Info>
