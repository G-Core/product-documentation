...
<Tip>
The [gcore_cloud_baremetal_server](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_baremetal_server) reference on Terraform Registry includes additional configuration examples.
</Tip>
