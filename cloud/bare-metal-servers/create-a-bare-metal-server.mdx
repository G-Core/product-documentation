...
<Frame>
  ![Bare metal page in Gcore Customer Portal](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/bare-metal-page-2.png)
</Frame>

## Step 2. Select a region

<p>Choose the region where the server will be deployed.</p>
...
<Frame>
  ![A menu with available OS images](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/select-image-2.png)
</Frame>
...
<Frame>
  ![A menu with available server types](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/server-type-2.png)
</Frame>

## Step 5. Configure network interfaces

<p>Configure network interfaces. Up to six networks can be attached. An external network cannot be added after the server is created.</p>

### Public interface

1. Select the **Network type**: **Public** or **Private**. The **Dedicated public** option is available in select regions and for specific server configurations.

<Frame>
  ![Network interfaces configuration showing Network type, IP Family, and DDoS Protection options](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/bm-network-type-3.png)
</Frame>
...
<Frame>
  ![Network interfaces configuration](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/bm-network-section-2.png)
</Frame>
...
<Frame>
  ![Network creation dialog showing network name, Bare Metal Network and Create router options](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/create-network-dialog-2.png)
</Frame>
...
<Frame>
  ![A menu with SSH key settings](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/ssh-keys-2.png)
</Frame>
...
<Frame>
  ![A menu with user data settings](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/user-data-2.png)
</Frame>
...
<Frame>
  ![A menu with an option to choose a number of servers](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/servers-number-2.png)
</Frame>
...
<Frame>
  ![Bare Metal server Networking tab showing Interface 1 (Trunk Interface 1) with the Add Sub-Interface button](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/bm-multi-bond-networking-tab-2.png)
</Frame>
...
<p>The scripts below list available flavors and images, provision a Bare Metal server with a public interface, and print its IP address. Replace `my-key` with an existing SSH key name from the project. Provisioning takes 4–5 minutes.</p>
...
<p>`volumes: []` is expected — Bare Metal servers use local NVMe storage; external block volumes cannot be attached.</p>
