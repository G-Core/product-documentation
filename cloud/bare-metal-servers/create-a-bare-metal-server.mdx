...
ai-navigation: Create a Bare Metal server on dedicated physical hardware via Customer Portal by selecting region, OS, and server type, or deploy via REST API by selecting a flavor and image, polling the provisioning task, and connecting via SSH.
---
