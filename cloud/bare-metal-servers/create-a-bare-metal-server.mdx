...
<Frame>
  ![Bare metal page in Gcore Customer Portal](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/create-a-bare-metal-server-image1.png)
</Frame>
...
<Frame>
  ![A menu with available OS images](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/create-a-bare-metal-server-image2.png)
</Frame>
...
<Frame>
  ![A menu with available server types](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/create-a-bare-metal-server-image3.png)
</Frame>
...
<Frame>
  ![Network interfaces configuration](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/create-a-bare-metal-server-image4.png)
</Frame>
...
<Tabs>
  <Tab title="Configure a network">
    ...
    <Frame>
      ![A menu with available network settings and highlighted reserved ip toggle](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/create-a-bare-metal-server-image5.png)
    </Frame>
  </Tab>
...
<Frame>
  ![Diagram showing how Sub-Interface 1 and Sub-Interface 2 in the creation form map to the Networking tab entries and to bond0 and bond0.2853 in the OS](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/create-a-bare-metal-server-image6.png)
</Frame>
...
<Frame>
  ![A menu with SSH keys settings settings](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/create-a-bare-metal-server-image7.png)
</Frame>
...
<Frame>
  ![A menu with access settings](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/create-a-bare-metal-server-image8.png)
</Frame>
...
<Frame>
  ![A menu with user data settings](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/create-a-bare-metal-server-image9.png)
</Frame>
...
<Frame>
  ![A menu with an option to choose a number of servers](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/create-a-bare-metal-server-image10.png)
</Frame>
...
<Frame>
  ![Bare Metal server Networking tab showing multi-bond configuration with Interface 1 (Trunk Interface 1) and Interface 2 (Trunk Interface 2), each with one sub-interface](/images/docs/cloud/bare-metal-servers/create-a-bare-metal-server/create-a-bare-metal-server-image11.png)
</Frame>
