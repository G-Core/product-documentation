...
In this example, Sub-Interface 1 (`bond0`) is the public interface and Sub-Interface 2 (`bond0.2853`) is the private interface. The sub-interface order cannot be changed after the server is created.
