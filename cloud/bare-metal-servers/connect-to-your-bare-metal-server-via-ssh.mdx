...
ai-navigation: Connect to Bare Metal servers via SSH using RSA key pairs (2048 bits) generated with ssh-keygen or PuTTYgen, or authenticate with password; configure firewall rules to permit incoming SSH traffic.
---
...
<Frame>![putty_gen.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image1.png)</Frame>
...
<Frame>![___________.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image2.png)</Frame>
...
<Frame>![notepad.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image3.png)</Frame>
...
<Frame>![_____________1.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image4.png)</Frame>
...
<Frame>![autogenetae.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image5.png)</Frame>
...
<Frame>![________________________.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image6.png)</Frame>
...
<Frame>![add_a_ssh.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image7.png)</Frame>
...
<Frame>![add_an_ssh_2.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image8.png)</Frame>
...
<Frame>![ssh_delete.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image9.png)</Frame>
...
<Frame>![_________________________________.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image10.png)</Frame>
...
<Frame>![______________.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image11.png)</Frame>
...
<Frame>![autogenerate_2.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image12.png)</Frame>
...
<Frame>![mceclip0.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image13.png)</Frame>
...
<Frame>![13.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image14.png)</Frame>
...
<Frame>![____________________________.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image15.png)</Frame>
...
<Frame>![add_ip_float.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image16.png)</Frame>
...
<Frame>![browse.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image17.png)</Frame>
...
<Frame>![login_as.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image18.png)</Frame>
...
<Frame>![SETTINGS.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image19.png)</Frame>
...
<Frame>![OPTIONAL_FEATURES.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image20.png)</Frame>
...
<Frame>![instal_open_sssh.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image21.png)</Frame>
...
<Frame>![yes.png](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-image22.png)</Frame>
