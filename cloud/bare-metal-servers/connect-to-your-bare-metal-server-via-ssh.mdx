...
<Frame>
  ![SSH key row menu with Delete and Stop sharing options](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-delete-menu.png)
</Frame>
...
<Frame>
  ![Create Bare Metal page with SSH key dropdown and add or generate links](/images/docs/cloud/bare-metal-servers/connect-to-your-bare-metal-server-via-ssh/connect-to-your-bare-metal-server-via-ssh-create-ssh-keys.png)
</Frame>
