...
There are several options to manage a Bare Metal server:
  ...
  * API. To learn more, see [our API documentation](/api-reference/cloud)
...
Bare Metal servers have the following benefits:
  ...
  * **Easy management.** Create, rebuild, and control your Bare Metal via the [Gcore Customer Portal](https://cloud.gcore.com), [API](/api-reference/cloud), or [Terraform provider](https://registry.terraform.io/providers/G-Core/gcore).
