...
description: Deploy serverless functions via Gcore FaaS with automatic Kubernetes pod management, zero-scaler for idle resources, and HTTP endpoints for invocation.
---
