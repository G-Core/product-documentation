...
ai-navigation: Deploy serverless functions via Gcore FaaS with automatic Kubernetes pod management, zero-scaler for idle resources, and HTTP endpoints for invocation.
ai-navigation: Deploy serverless functions via Gcore FaaS with automatic pod scaling, zero-scaler, and HTTP endpoints.
---
...
2\. In your Gcore [Customer Portal](https://cloud.gcore.com/cloud) or in an API request, you create a function and insert your code into it.
...
You can find available runtimes and locations on [our website](https://gcore.com/cloud/faas) and the Gcore [Customer Portal](https://cloud.gcore.com/cloud).

You can manage your functions via the Gcore [Customer Portal](https://cloud.gcore.com/cloud) and [REST API](https://api.gcore.com/docs/cloud).
