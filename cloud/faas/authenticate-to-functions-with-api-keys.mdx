...
<Frame>![API keys for functions in the Cloud menu](/images/docs/cloud/faas/authenticate-to-functions-with-api-keys/authenticate-to-functions-with-api-keys-image1.png)</Frame>
...
<Frame>![Fill in the general information about API keys](/images/docs/cloud/faas/authenticate-to-functions-with-api-keys/authenticate-to-functions-with-api-keys-image2.png)</Frame>
...
<Frame>![Specify functions that can be authorized with the API key](/images/docs/cloud/faas/authenticate-to-functions-with-api-keys/authenticate-to-functions-with-api-keys-image3.png)</Frame>
...
<Frame>![Set the expiration period for an API key](/images/docs/cloud/faas/authenticate-to-functions-with-api-keys/authenticate-to-functions-with-api-keys-image4.png)</Frame>
...
<Frame>![Edit API key settings](/images/docs/cloud/faas/authenticate-to-functions-with-api-keys/authenticate-to-functions-with-api-keys-image5.png)</Frame>
...
<Frame>![Delete an API key](/images/docs/cloud/faas/authenticate-to-functions-with-api-keys/authenticate-to-functions-with-api-keys-image6.png)</Frame>
