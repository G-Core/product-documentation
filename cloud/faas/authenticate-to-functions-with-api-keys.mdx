...
ai-navigation: Create, edit, and delete API keys for Gcore Functions endpoints to enforce authentication and control function access permissions.
ai-navigation: Create API keys for Functions endpoints with name, description, access scope, and expiration date.
---
