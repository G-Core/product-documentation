...
<Tip>
The [gcore_cloud_instance_image](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_instance_image) reference on Terraform Registry includes additional configuration examples.
</Tip>
