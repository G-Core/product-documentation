...
<Frame>![Gcore Customer Portal - Import an image via URL in the Images section](/images/docs/cloud/images/upload-an-image-to-the-storage/upload-an-image-to-the-storage-image1.png)</Frame>
...
<Frame>![Enter the image name and URL for uploading](/images/docs/cloud/images/upload-an-image-to-the-storage/upload-an-image-to-the-storage-image2.png)</Frame>
...
<Frame>![Click the Upload button to finalize image import](/images/docs/cloud/images/upload-an-image-to-the-storage/upload-an-image-to-the-storage-image3.png)</Frame>