...
sidebarTitle: Upload
ai-navigation: Upload images to Gcore cloud storage via URL with support for raw, vhd, vhdx, vdi, ploop, qcow2, and AMI formats; configure VirtIO drivers, cloud-init, archi
ai-navigation: Upload image to Gcore cloud storage via URL with format (raw, vhd, vhdx, vdi, ploop, qcow2, ami), architecture, and VirtIO drivers.
---
