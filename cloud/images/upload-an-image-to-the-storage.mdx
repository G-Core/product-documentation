...
<p>Declare a custom image using the [Terraform provider](/developer-tools/terraform/overview) v2. Gcore fetches the image from the URL and stores it in the selected region.</p>

<Tip>
See the [Terraform Registry](https://registry.terraform.io/providers/G-Core/gcore/latest/docs) for the full provider reference. This tab uses the [gcore_cloud_instance_image](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_instance_image) resource.
</Tip>
