...
3\. In the GitHub repository settings, go to **Secrets and variables** > **Actions** and add `GCLOUD_API_TOKEN` as a repository secret with the value of the [API token](/account-settings/api-tokens).
