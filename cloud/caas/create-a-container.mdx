...
ai-navigation: Deploy containerized applications in Gcore Container as a Service by specifying container image (public or private with registry credentials), port, resource configuration (mCPU and MB memory), and autoscaling parameters (minimum pods, maximum pods, cooldown period).
---
...
<Frame>![CaaS page in the Customer Portal](/images/docs/cloud/caas/create-a-container-image1.png)</Frame>
...
<Frame>![Container image settings](/images/docs/cloud/caas/add-a-container/create-a-container-image2.png)</Frame>
...
<Frame>![Container port](/images/docs/cloud/caas/add-a-container/create-a-container-image3.png)</Frame>
...
<Frame>![Container configuration](/images/docs/cloud/caas/add-a-container/create-a-container-image4.png)</Frame>
...
<Frame>![Container autoscaling limits](/images/docs/cloud/caas/add-a-container/create-a-container-image5.png)</Frame>
...
<Frame>![Container autoscaling thresholds](/images/docs/cloud/caas/add-a-container/create-a-container-image6.png)</Frame>
...
<Frame>![Container lifetime settings](/images/docs/cloud/caas/add-a-container/create-a-container-image7.png)</Frame>
...
<Frame>![Enviroment variables settings](/images/docs/cloud/caas/add-a-container/create-a-container-image8.png)</Frame>
...
<Frame>![API keys settings](/images/docs/cloud/caas/add-a-container/create-a-container-image9.png)</Frame>
...
<Frame>![Container details settings](/images/docs/cloud/caas/add-a-container/create-a-container-image10.png)</Frame>
