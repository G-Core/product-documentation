...
ai-navigation: Deploy containerized applications via Container as a Service with image URL, registry credentials, port configuration, CPU/memory allocation, and autoscaling
ai-navigation: Deploy containerized application in Container as a Service with image URL, registry credentials, port, CPU/memory, and autoscaling limits.
---
