...
description: Deploy containerized applications via Container as a Service with image URL, registry credentials, port configuration, CPU/memory allocation, and autoscaling...
---
