...
ai-navigation: View and update container configuration including status, image, ports, CPU/memory, autoscaling, API key authentication, environment variables, and logs in G
ai-navigation: View, update, and manage container configuration, status, ports, memory, CPU, autoscaling, API key authentication, and environment variables.
---
