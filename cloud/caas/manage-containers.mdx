...
description: View and update container configuration including status, image, ports, CPU/memory, autoscaling, API key authentication, environment variables, and logs in G...
---
