...
<Tip>
The [gcore_cloud_file_share](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_file_share) reference on Terraform Registry includes additional configuration examples.
</Tip>
