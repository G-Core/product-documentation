...
6. Add static route to the VAST network:
   - Replace `198.51.102.1` with an address formed by the first three octets from the CIDR range in Step 2, keeping `1` as the last octet for the gateway IP, and use the same interface name.
...
- Replace `/home/ubuntu/mount` with the mount directory.

`sudo mount mount -o vers=3,nconnect=56,remoteports=dns,spread_reads,spread_writes,noextend ndp1-2-vast.cloud.gc.onl:/manila/manila-01234567-89ab-cdef-0123-456789abcdef /home/ubuntu/mount`
