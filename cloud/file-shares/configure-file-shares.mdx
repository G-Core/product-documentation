...
1. Go to the **Cloud** menu, select the **Storage** tab, and click **File Shares**.
2. Click the file share to be resized.
3. Click **Resize** in the **Overview** tab.
4. Enter the new share size and click **Confirm**. The file share resizing process begins, and the new size will be reflected in the file share details.
