...
For Bare Metal servers, create the VLAN interface and run the DHCP client:
...
Replace `bond0.2998` with the actual VLAN interface name and VLAN ID.

The DHCP client automatically configures the IP address, subnet mask, gateway, and routing information for the VAST subnet connection.
