...
### Step 2: Create the server and add the VAST network interface

Once the VAST file share is created, add the VAST interface during the creation and provisioning of the GPU cluster or other compute resource:
