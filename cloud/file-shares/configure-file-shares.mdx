...
<Info>
  Verify that quotas are sufficient for the file share. The quotas for File Shares are on the **Storage** tab and include File Share count and File Share size (GiB). To increase quotas, contact Gcore support.
</Info>
...
<Frame>
  ![File Shares Standard](/images/file-shares-standard-4.png)
</Frame>

3. In the **Network settings** panel, select the private _Network_ and _Subnet_ to use for the file share.
4. In the **Access** panel, select **Custom access rules**, click **Add rule**, and specify the IP addresses of the resources that should have access to the file share and their access modes.
...
<Frame>
  ![File Share VAST](/images/file-share-vast.png)
</Frame>
...
<Frame>
  ![File Share details](/images/file-share-details.png)
</Frame>
...
<Frame>
  ![File Share mount](/images/file-share-mount.png)
</Frame>
...
1. In the **Cloud** menu, go to **Storage**, select **File Shares**, and click the file share to be resized.
