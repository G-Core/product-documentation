...
<Info>
  **VAST shares** should be created prior to provisioning the corresponding GPU clusters or other compute resources.
</Info>
...
### Step 2: Create your server and add the VAST network interface

Once the VAST file share is created, add the VAST interface during the creation and provisioning of you GPU cluster or other compute resource:
