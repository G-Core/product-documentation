...
<Info>
A permanent [API token](/account-settings/api-tokens) is required, along with a [project ID](https://api.gcore.com/docs/cloud#tag/Projects/operation/GetProjectList.get) and [region ID](https://api.gcore.com/docs/cloud#tag/Regions/operation/GetRegionList.get) from a region where `has_sfs` is `true` - call <code>GET&nbsp;/cloud/v1/regions</code> to check.
</Info>
