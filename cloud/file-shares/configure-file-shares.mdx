...
### Step 2: Add the VAST network interface to a compute resouce
...
The VAST network interface can also be added to an already-provisioned [GPU cluster](/edge-ai/ai-infrastructure/create-an-ai-cluster) or [compute resource](/cloud/virtual-instances/types-of-virtual-machines).
