...
<Info>
  It's best to create VAST shares either **during** the creation of [GPU clusters](/edge-ai/ai-infrastructure/create-an-ai-cluster) or **prior** to provisioning the corresponding [compute resources](/cloud/virtual-instances/types-of-virtual-machines) (such as VMs).
</Info>
...
1. Choose or create a directory to mount the file share.
