...
ai-navigation: Create NFS-based file shares with Standard (Ceph-backed) or VAST (high-performance) types, mount to Linux VMs or bare-metal servers, configure Network and Access rules, and set up NFS client support on Ubuntu, Debian, or CentOS.
---
...
<Frame>
  ![Storage tab ](/images/docs/cloud/file-shares/configure-file-shares-image1.png)
</Frame>
...
<Frame>
  ![Bare Metal Network toggle](/images/docs/cloud/file-shares/configure-file-shares-image2.png)
</Frame>
...
<Frame>
  ![File Shares](/images/docs/cloud/file-shares/configure-file-shares-image3.png)
</Frame>
...
<Frame>
  ![Mount the file share](/images/docs/cloud/file-shares/configure-file-shares-image4.jpg)
</Frame>
...
<Frame>
  ![Overview tab](/images/docs/cloud/file-shares/configure-file-shares-image5.png)
</Frame>