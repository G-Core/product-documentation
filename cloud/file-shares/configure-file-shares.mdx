...
description: Create NFS-based file shares (Standard or VAST) and mount them to Linux VMs, bare metal servers, or GPU clusters with network and access configuration.
---
