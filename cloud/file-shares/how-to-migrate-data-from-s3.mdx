...
<Info>
Direct migration between Amazon EFS and Gcore File Shares is not possible. First, migrate data to Gcore Object Storage using the steps in the previous section, then transfer it to a File Share.
</Info>

A Gcore instance with public Internet access, Linux, and rclone is required before starting.
