...
Gcore File Shares and Amazon EFS are private to their respective cloud infrastructures. Direct migration between them isn't possible. First, migrate data to Gcore Object Storage using the steps in the previous section, then transfer it to a File Share.
