...
<MethodTabs methods={[
  { label: "Cloud UI", href: "/cloud/file-shares/configure-file-shares" },
  { label: "REST API", href: "/cloud/api/file-shares/configure-file-shares" },
...
Image selection, flavor lookup, and SSH key registration are covered in the [VM guide](/cloud/api/virtual-instances/create-an-instance).
