...
<MethodTabs methods={[
  { label: "Cloud UI", href: "/cloud/managed-database-postgresql/manage-postgresql-servers" },
  { label: "REST API", href: "/cloud/api/managed-database-postgresql/manage-postgresql-servers" },
