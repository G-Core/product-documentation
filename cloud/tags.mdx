...
Add tags during resource creation or to existing resources.
...
After adding tags to your resources, you can filter them in the Customer Portal:

1. Navigate to the resource list page (for example, **Cloud** > **Virtual Instances**).
...
This helps you quickly find all resources belonging to a specific environment, team, or project.
...
Use the [gcore-python](https://github.com/G-Core/gcore-python) SDK to create resources with tags:
...
Use the [gcore-go](https://github.com/G-Core/gcore-go) SDK to create resources with tags:
