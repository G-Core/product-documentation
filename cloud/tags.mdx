...
<Tabs>
  <Tab title="Python SDK">
    ...
    flavors = client.cloud.flavors.list(project_id=project_id, region_id=region_id)
    flavor = next(
        f for f in flavors
    ...
    images = client.cloud.images.list(
        project_id=project_id, region_id=region_id, visibility="public"
    )
