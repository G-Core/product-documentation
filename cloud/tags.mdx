...
title: Tags
sidebarTitle: Tags
ai-navigation: Assign key-value tag pairs to Cloud resources via portal, API, Terraform, or SDK; filter resources by tags; enforce tag formatting rules (3-255 characters, n
ai-navigation: Create, attach, and filter Cloud resource tags using key-value pairs via portal, API, Terraform, or SDK.
---
