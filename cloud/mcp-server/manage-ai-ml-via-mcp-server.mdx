...
Gcore MCP Server provides AI and machine learning infrastructure management through natural language. AI assistants can manage GPU instances, deploy inference models, and monitor training workloads.

<Info>
Before starting, [install and configure Gcore MCP Server](/account-settings/integrations/install-and-configure-gcore-mcp-server) with `GCORE_TOOLS="cloud.*"` to load Cloud tools including AI/ML infrastructure.
</Info>
