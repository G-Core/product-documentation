...
sidebarTitle: Quotas
ai-navigation: Request quota increases for Gcore Cloud resources including Virtual Machines, vCPUs, RAM, Storage, Network Service, Load Balancer Service, Kubernetes Service, AI, Functions Service, Logging Service, and Database Service via the Quotas Viewer in Customer Portal by selecting region, resource category, desired amount, and submitting with support comment for review within two business days.
---
...
<Frame>![Region selection](/images/docs/cloud/getting-started/request-a-quota-increase/request-a-quota-increase-image1.png)</Frame>
...
<Frame>![Category selection](/images/docs/cloud/getting-started/request-a-quota-increase/request-a-quota-increase-image2.png)</Frame>
...
<Frame>![Final check](/images/docs/cloud/getting-started/request-a-quota-increase/request-a-quota-increase-image3.png)</Frame>
...
<Frame>![The field for the explanation comment](/images/docs/cloud/getting-started/request-a-quota-increase/request-a-quota-increase-image4.png)</Frame>
