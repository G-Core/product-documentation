...
description: Reserve Cloud servers for 1 or 3 years at discounted rates via Gcore Customer Portal Reservations with region, server type, Windows License, and quantity con...
---
