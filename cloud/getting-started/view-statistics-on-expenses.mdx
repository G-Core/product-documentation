...
description: View Cloud resource usage costs filtered by project, region, resource type, and consumption period using Pay-As-You-Go pricing model via Cost Report page or ...
---
