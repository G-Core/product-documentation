...
<Tabs>
  <Tab title="Detailed CSV report">
    ...
    **Column** | **Description**  
    ...
    Region_id | ID of a region where the resource has been created. You can check the ID via [API](https://gcore.com/docs/api-reference/cloud/regions/list-regions).  
...
Feature | Billing identifier of a billable resource that combines the resource type, configuration, region, and pricing model. Every resource has a feature value, even resources with a single configuration like IP addresses.  
Region_id | ID of a region where the resource has been reserved. You can check the ID via [API](https://gcore.com/docs/api-reference/cloud/regions/list-regions).  
