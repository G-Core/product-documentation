...
You can check information about Cloud resource usage and associated costs on the following pages: 
  ...
  * **Cost Report** : view costs for all Cloud resources you've used. This report calculates all costs using the Pay-As-You-Go pricing model. If you have active resource commitments, the prices shown in this report won't reflect your actual costs because commit discounts are not applied.
  * **Reservation Cost Report** : check monthly resource usage and costs that account for your resource commitments. This report shows how much of your committed resources you've consumed, whether you've fully utilized your commits, and any overcommit costs incurred when usage exceeded the reserved amount.
...
This report calculates all costs using Pay-As-You-Go rates and doesn't account for resource commitments. If you have active commits, the prices shown here won't reflect your actual costs. Check the [Reservation Cost Report](/cloud/getting-started/view-statistics-on-expenses#reservation-cost-report) for accurate cost data that includes commit discounts.
</Info>
...
<Frame>![Show deleted projects checkbox](/images/docs/cloud/getting-started/view-statistics-on-expenses/view-statistics-on-expenses-image1.png)</Frame>
...
<Frame>![Projects dropdown expanded](/images/docs/cloud/getting-started/view-statistics-on-expenses/view-statistics-on-expenses-image2.png)</Frame>
...
<Frame>![Cost report graph with resource usage](/images/docs/cloud/getting-started/view-statistics-on-expenses/view-statistics-on-expenses-image3.png)</Frame>
...
<Frame>![A table with resources overview](/images/docs/cloud/getting-started/view-statistics-on-expenses/view-statistics-on-expenses-image4.png)</Frame>
...
<Frame>![Resource type dropdown with External IP selected](/images/docs/cloud/getting-started/view-statistics-on-expenses/view-statistics-on-expenses-image5.png)</Frame>
...
<Frame>![Resource attribute dropdown with IP Address selected](/images/docs/cloud/getting-started/view-statistics-on-expenses/view-statistics-on-expenses-image6.png)</Frame>
...
<Frame>![Example of table and graph updated for External IP address](/images/docs/cloud/getting-started/view-statistics-on-expenses/view-statistics-on-expenses-image7.png)</Frame>
...
<Frame>![Export CSV dropdown with Detailed and Total options](/images/docs/cloud/getting-started/view-statistics-on-expenses/view-statistics-on-expenses-image8.png)</Frame>
...
<Tabs>
  <Tab title="Detailed CSV report">
    ...
    **Column** | **Description**  
    ...
    Feature | Billing identifier of a billable resource that combines the resource type, configuration, region, and pricing model. Every resource has a feature value, even resources with a single configuration like IP addresses.  
    ...
    First_seen | The date when the resource was first detected in the billing system during the selected period. This helps identify when a resource started generating costs.  
    Last_seen | The date when the resource was last detected in the billing system during the selected period. This helps identify when a resource stopped generating costs, though it doesn't necessarily indicate the resource was deleted.  
    Period_from | The start date of the reporting period for which the resource usage is calculated. This reflects the selected date range, not when the resource was created.  
    Period_to | The end date of the reporting period for which the resource usage is calculated. This reflects the selected date range, not when the resource was stopped or deleted.  
    ...
    Error | Any errors associated with the costs incurred during the specified period.  
    Cost | Cost of the resource for the specified period.  
    Currency | The type of currency in which the cost is calculated.  
    Attached_to | A Cloud product to which the resource has been connected. For example, it can be an ID of a Virtual Machine that the volume has been attached to.  
...
This report presents monthly information about your prepaid and [reserved](/cloud/getting-started/resource-reservation/about-resource-reservation) resources. Unlike the Cost Report, this report accounts for your active resource commitments and shows:

* How much of your committed resources you've consumed
* Whether you've fully utilized your commits
* Any overcommit costs incurred when usage exceeded the reserved amount

The Reservation Cost Report doesn't show statistics for individual resources and only displays aggregated data for each month. 
...
<Frame>![Projects dropdown](/images/docs/cloud/getting-started/view-statistics-on-expenses/view-statistics-on-expenses-image9.png)</Frame>
...
<Frame>![Reservation cost report graph](/images/docs/cloud/getting-started/view-statistics-on-expenses/view-statistics-on-expenses-image10.png)</Frame>
...
<Frame>![Export reservation cost report button](/images/docs/cloud/getting-started/view-statistics-on-expenses/view-statistics-on-expenses-image11.png)</Frame>
