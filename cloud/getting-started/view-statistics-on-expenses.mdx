...
You can filter the cost data by: 
  ...
  * **Tags** : Filter resources by specific tags you've assigned to them.
...
The report also contains statistics for deleted projects and regions. Deleted projects are displayed in the Projects dropdown with a **(Deleted)** label next to their names, allowing you to include them in your cost analysis.
