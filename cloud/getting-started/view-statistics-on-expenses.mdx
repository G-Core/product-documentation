...
ai-navigation: View Cloud resource usage costs filtered by project, region, resource type, and consumption period using Pay-As-You-Go pricing model via Cost Report page or
ai-navigation: View Cloud resource usage and costs filtered by project, region, resource type, and consumption period in Cost Report.
---
