...
ai-navigation: Invite users to Gcore projects via email with role assignment in Customer Portal Access settings.
ai-navigation: Invite users to Gcore project with email and role assignment via Customer Portal Access tab.
---
