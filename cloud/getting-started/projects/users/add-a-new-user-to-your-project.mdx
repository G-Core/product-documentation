...
ai-navigation: Invite users to Gcore projects via the Customer Portal Access tab by entering email addresses and assigning Administrator, User, or Viewer roles; invitations trigger account creation links for new users or access notifications for existing users.
---
...
<Frame>![Project settings](/images/docs/cloud/getting-started/projects/users/add-a-new-user-to-your-project/add-a-new-user-to-your-project-image1.png)</Frame>
...
<Frame>![The invite user button](/images/docs/cloud/getting-started/projects/users/add-a-new-user-to-your-project/add-a-new-user-to-your-project-image2.png)</Frame>
...
<Frame>![The invite user window](/images/docs/cloud/getting-started/projects/users/add-a-new-user-to-your-project/add-a-new-user-to-your-project-image3.png)</Frame>
