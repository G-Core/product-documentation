...
ai-navigation: Edit user roles (User, Observer, Administrator), revoke project access via Delete role, and restore access by reassigning roles in project settings.
ai-navigation: Manage project user access by assigning roles (User, Observer, Administrator), denying access, or restoring permissions.
---
