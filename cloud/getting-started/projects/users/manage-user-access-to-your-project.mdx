...
description: Edit user roles (User, Observer, Administrator), revoke project access via Delete role, and restore access by reassigning roles in project settings.
---
