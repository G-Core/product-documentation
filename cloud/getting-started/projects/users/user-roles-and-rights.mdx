...
ai-navigation: Define role-based access control with Client Administrator, Project Administrator, Project User, and Project Internal Network Only User roles for account and
ai-navigation: Assign user roles (Client Administrator, Project Administrator, Project User, Internal Network Only) with scoped permissions for resource and account
---
