...
ai-navigation: Create and manage Edge Cloud projects as isolated resource containers for Virtual Machines, volumes, and networks with per-project user permission controls via Gcore Customer Portal Projects page, list/grid view layouts, and project creation interface.
---
...
<Tabs>
  <Tab title="From the Project dropdown">
    ...
    <Frame>![A dropdown displaying a list of projects](/images/docs/cloud/getting-started/projects/create-a-project/create-a-project-image1.png)</Frame>
    ...
    <Frame>![A list of projects with the highlighted Open project button](/images/docs/cloud/getting-started/projects/create-a-project/create-a-project-image2.png)</Frame>
  </Tab>
  <Tab title="From the Cloud Management page">
    ...
    <Frame>![A list of projects with the highlighted project name](/images/docs/cloud/getting-started/projects/create-a-project/create-a-project-image3.png)</Frame>
  </Tab>
</Tabs>
...
<Frame>![](/images/docs/cloud/getting-started/projects/create-a-project/create-a-project-image4.png)</Frame>
...
<Frame>![](/images/docs/cloud/getting-started/projects/create-a-project/create-a-project-image5.png)</Frame>
...
<Frame>![A search bar with adjacent buttons to change page layout](/images/docs/cloud/getting-started/projects/create-a-project/create-a-project-image6.png)</Frame>
...
<Frame>![The Projects page with the Create project button highlighted](/images/docs/cloud/getting-started/projects/create-a-project/create-a-project-image7.png)</Frame>
...
<Frame>![A dialog with configuration of project name and description](/images/docs/cloud/getting-started/projects/create-a-project/create-a-project-image8.png)</Frame>
...
<Frame>![Project settings menu with Open and Settings options](/images/docs/cloud/getting-started/projects/create-a-project/create-a-project-image9.png)</Frame>
...
<Frame>![Project settings menu with options to change project name and description](/images/docs/cloud/getting-started/projects/create-a-project/create-a-project-image10.png)</Frame>
...
<Frame>![Project access tab displaying one user added to the project](/images/docs/cloud/getting-started/projects/create-a-project/create-a-project-image11.png)</Frame>
...
<Frame>![Project settings menu with Open, Settings, and Delete options](/images/docs/cloud/getting-started/projects/create-a-project/create-a-project-image12.png)</Frame>
...
<Frame>![Delete project dialog](/images/docs/cloud/getting-started/projects/create-a-project/create-a-project-image13.png)</Frame>
