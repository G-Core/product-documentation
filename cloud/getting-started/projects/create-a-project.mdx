...
<Tip>
The [gcore_cloud_project](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_project) reference on Terraform Registry includes additional configuration examples.
</Tip>
