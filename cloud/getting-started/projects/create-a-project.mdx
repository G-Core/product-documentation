...
<p>Manage Edge Cloud projects as infrastructure code using the [`gcore_cloud_project`](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_project) resource from the [Gcore Terraform provider v2](/developer-tools/terraform/overview). Deleting a project through Terraform removes all resources inside it — default projects cannot be deleted.</p>
