...
<p>Projects are accessible in the [Gcore Customer Portal](https://portal.gcore.com) via **Cloud Management** in the left sidebar.</p>

1. Navigate to **Cloud** in the Customer Portal.

2. In the left sidebar, expand **Cloud Management**.

3. Click **Projects**. The **Projects** page opens.

<Frame>![Projects page in list view showing project ID, name, and description columns](/images/docs/cloud/getting-started/projects/create-a-project/open-projects.png)</Frame>
