...
Outgoing traffic for [Bare Metal servers](/cloud/bare-metal-servers/create-a-bare-metal-server) is billed separately as [egress&nbsp;traffic](/cloud/bare-metal-servers/egress-traffic).
