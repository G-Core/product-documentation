...
- Specify `image_id` — the Bare Metal image ID. Use the [Images API](/api-reference/cloud#tag/Images/operation/ImageListV1ProjectsProjectIdRegionsRegionIdImagesGet) or the Portal to look up available images for the target region.
