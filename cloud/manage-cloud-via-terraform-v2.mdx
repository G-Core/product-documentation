...
- Specify `image_id` — the Bare Metal image ID. Use the [Images API](/api-reference/cloud/images/list-images) or the Portal to look up available images for the target region.
