...
Fetch the current list of Cloud egress IP ranges using the public API. This endpoint requires no authentication.
...
For complete API details, see [List cloud egress public IPs](/api-reference/cloud#tag/ip-ranges/GET/cloud/public/v1/ipranges/egress) in the Cloud API reference.
