...
| **AMQP messaging** | Cloud connects to your AMQP message brokers when you [subscribe to user-action logs via AMQP](/api-reference/cloud/user-actions/list-user-actions). Allowlist these ranges to receive event messages. |
...
Fetch the current list of Cloud egress IP ranges using the [public API endpoint](/api-reference/cloud/ip-ranges/list-cloud-egress-public-ips). This endpoint requires no authentication.
