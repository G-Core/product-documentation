...
<p>Declare a subnet inside an existing [network](/cloud/networking/create-and-manage-a-network) using the [Gcore Terraform provider v2](/developer-tools/terraform/overview).</p>
...
<Tip>
See the [Terraform Registry](https://registry.terraform.io/providers/G-Core/gcore/latest/docs) for the full provider reference. This tab uses the [gcore_cloud_network_subnet](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_network_subnet) resource.
</Tip>
