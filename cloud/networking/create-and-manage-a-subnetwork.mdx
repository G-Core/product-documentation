...
<Frame>
  ![Networks page open in the Customer Portal](/images/docs/cloud/networking/create-and-manage-a-subnet/networks-page.png)
</Frame>
...
<Frame>
  ![Network settings section with the highlighted Create subnet button](/images/docs/cloud/networking/create-and-manage-a-subnet/network-settings-create-subnet.png)
</Frame>
...
<Frame>
  ![Create a subnet dialog](/images/docs/cloud/networking/create-and-manage-a-subnet/create-subnet.png)
</Frame>
...
<Frame>
  ![Network configuration example](/images/docs/cloud/networking/create-and-manage-a-subnet/create-subnet-name-cidr-dhcp.png)
</Frame>
...
<Frame>
  ![Edit subnet dialog](/images/docs/cloud/networking/create-and-manage-a-subnet/disable-router-gateway.png)
</Frame>

<Frame>
  ![Gateway IP validation error](/images/docs/cloud/networking/create-and-manage-a-subnet/gateway-ip-validation-error.png)
</Frame>
...
<Frame>
  ![Create subnet dialog showing non-routable option](/images/docs/cloud/networking/create-and-manage-a-subnet/enable-non-routable-subnet.png)
</Frame>
...
<Frame>
  ![Custom DNS and host routes fields in the Create Subnet dialog](/images/docs/cloud/networking/create-and-manage-a-subnet/create-subnet-custom-dns.png)
</Frame>
...
<Frame>
  ![Network settings with the highlighted edit button](/images/docs/cloud/networking/create-and-manage-a-subnet/rename-subnet.png)
</Frame>
...
<Frame>
  ![Delete subnet confirmation dialog](/images/docs/cloud/networking/create-and-manage-a-subnet/confirm-subnet-deletion.png)
</Frame>
