...
ai-navigation: Create and configure subnetwork IP ranges, DHCP, DNS, host routes, and non-routable settings within Gcore cloud networks using CIDR notation (10.0.0.0/8, 172
ai-navigation: Create subnetwork with CIDR range, DHCP, gateway IP, host routes, DNS servers, and tags in Gcore cloud network.
---
