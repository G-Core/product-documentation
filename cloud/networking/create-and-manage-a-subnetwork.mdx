...
<Tip>
The [gcore_cloud_network_subnet](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_network_subnet) reference on Terraform Registry includes additional configuration examples.
</Tip>
