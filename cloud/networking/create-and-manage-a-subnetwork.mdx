...
<p>8. (optional) Turn off the **Connect to network router** toggle to block access to the subnet from external networks and other subnets. When enabled, specify a custom **Gateway IP** address or leave it set to **Automatically** to assign one automatically.</p>
