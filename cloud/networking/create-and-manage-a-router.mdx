...
sidebarTitle: Router
ai-navigation: Create and configure Cloud Router with static routes, SNAT, subnets, and route tables to dynamically exchange routes between networks and control traffic flow using destination prefixes and next hop IP addresses.
---
...
<Frame>![Routers page in the Customer Portal](/images/docs/cloud/networking/create-and-manage-a-router/create-and-manage-a-router-image1.png)</Frame>
...
<Frame>![Create router button highlighted](/images/docs/cloud/networking/create-and-manage-a-router/create-and-manage-a-router-image2.png)</Frame>
...
<Frame>![Create router form](/images/docs/cloud/networking/create-and-manage-a-router/create-and-manage-a-router-image3.png)</Frame>
...
<Frame>![SNAT and static routes configuration](/images/docs/cloud/networking/create-and-manage-a-router/create-and-manage-a-router-image4.png)</Frame>
...
<Frame>![Router name configuration](/images/docs/cloud/networking/create-and-manage-a-router/create-and-manage-a-router-image5.png)</Frame>
...
<Frame>![Routers page with example router](/images/docs/cloud/networking/create-and-manage-a-router/create-and-manage-a-router-image6.png)</Frame>
...
<Frame>![Router Details with SNAT toggle](/images/docs/cloud/networking/create-and-manage-a-router/create-and-manage-a-router-image7.png)</Frame>
...
<Frame>![Static routes settings](/images/docs/cloud/networking/create-and-manage-a-router/create-and-manage-a-router-image8.png)</Frame>
