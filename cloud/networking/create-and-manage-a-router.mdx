...
sidebarTitle: Router
ai-navigation: Create and configure Cloud Router instances with static routes, SNAT, and subnet associations for dynamic route exchange between networks.
ai-navigation: Create Cloud Router with network, subnetwork, SNAT, and static routes; manage route tables and traffic routing.
---
