...
<Tabs>
  ...
  <Tab title="After VM creation">
    ...
    <Warning>
To replace an existing public IP with a specific reserved IP, detach the existing public subnetwork first before adding the new interface with the reserved IP.
</Warning>
  </Tab>
</Tabs>
