...
For private and shared [networks](/cloud/networking/create-and-manage-a-network), a specific [subnetwork](/cloud/networking/create-and-manage-a-subnetwork) can also be selected. When a network is selected without specifying a subnetwork, the IP address is allocated in any available subnet of that network.
