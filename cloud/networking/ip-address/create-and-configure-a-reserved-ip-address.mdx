...
ai-navigation: Create and assign reserved IP addresses to Virtual Machines, Bare Metal servers, or Load Balancers with configurable network type (Public, Private, Dedicated public), IP family (IPv4, IPv6, Dual), and optional custom IP selection within subnetworks.
---
...
<Frame>
  ![How it is charged](/images/docs/cloud/networking/ip-address/create-and-configure-a-reserved-ip-address/create-and-configure-a-reserved-ip-address-image1.png)
</Frame>
...
<Frame>
  ![Networks page in the Customer Portal](/images/docs/cloud/networking/ip-address/create-and-configure-a-reserved-ip-address/create-and-configure-a-reserved-ip-address-image2.png)
</Frame>
...
<Frame>
  ![Reserved IPs page in the Customer Portal](/images/docs/cloud/networking/ip-address/create-and-configure-a-reserved-ip-address/create-and-configure-a-reserved-ip-address-image3.png)
</Frame>
...
![Reserve IP dialog](/images/docs/cloud/networking/ip-address/create-and-configure-a-reserved-ip-address/create-and-configure-a-reserved-ip-address-image1.png)
...
If the machine is already connected to the target subnetwork, detach it first before assigning a new IP. This removes the existing IP from the interface.
    ...
    <Frame>
      ![Detach subnetwork](/images/docs/cloud/networking/ip-address/create-and-configure-a-reserved-ip-address/create-and-configure-a-reserved-ip-address-image4.png)
    </Frame>
    2. Add a new interface (public or private) and enable the **Use reserved IP** toggle.

    <Frame>
      ![Assign after Virtual Machine creation](/images/docs/cloud/networking/ip-address/create-and-configure-a-reserved-ip-address/create-and-configure-a-reserved-ip-address-image5.png)
    </Frame>
...
<Frame>
  ![Network interface details in VM settings](/images/docs/cloud/networking/ip-address/create-and-configure-a-reserved-ip-address/create-and-configure-a-reserved-ip-address-image6.png)
</Frame>
...
<Frame>
  ![Detach from the Virtual Machine](/images/docs/cloud/networking/ip-address/create-and-configure-a-reserved-ip-address/create-and-configure-a-reserved-ip-address-image4.png)
</Frame>
...
<Frame>
  ![Reserved IPs page in the Customer Portal](/images/docs/cloud/networking/ip-address/create-and-configure-a-reserved-ip-address/create-and-configure-a-reserved-ip-address-image7.png)
</Frame>
...
<Frame>
  ![Delete a reserved IP button](/images/docs/cloud/networking/ip-address/create-and-configure-a-reserved-ip-address/create-and-configure-a-reserved-ip-address-image8.png)
</Frame>
