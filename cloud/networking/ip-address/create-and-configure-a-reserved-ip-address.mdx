...
<Tabs>
  ...
  <Tab title="curl">
    ```bash
    curl "https://api.gcore.com/cloud/v1/reserved_fixed_ips/$PROJECT_ID/$REGION_ID/$PORT_ID" \
      -H "Authorization: APIKey $GCORE_API_KEY"
    ```
...
<Tabs>
  ...
  <Tab title="curl">
    ```bash
    curl -X DELETE "https://api.gcore.com/cloud/v1/reserved_fixed_ips/$PROJECT_ID/$REGION_ID/$PORT_ID" \
      -H "Authorization: APIKey $GCORE_API_KEY"
    ```
