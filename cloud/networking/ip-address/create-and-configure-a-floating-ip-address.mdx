...
ai-navigation: Create and assign floating IP addresses to Virtual Machines, Bare Metal servers, and Load Balancers in Gcore Cloud; configure routable private subnets with enabled router gateway to forward incoming traffic while outgoing traffic uses private IP addresses.
---
...
<Frame>
  ![floating-ip-01.png](/images/docs/cloud/networking/ip-address/create-and-configure-a-floating-ip-address/create-and-configure-a-floating-ip-address-image1.png)
</Frame>

2. Click the three-dot menu, then select **Edit**.

<Frame>
  ![floating-ip-02.png](/images/docs/cloud/networking/ip-address/create-and-configure-a-floating-ip-address/create-and-configure-a-floating-ip-address-image2.png)
</Frame>
...
<Frame>
  ![floating-ip-03.png](/images/docs/cloud/networking/ip-address/create-and-configure-a-floating-ip-address/create-and-configure-a-floating-ip-address-image3.png)
</Frame>
...
<Frame>
  ![floating-ip-04.png](/images/docs/cloud/networking/ip-address/create-and-configure-a-floating-ip-address/create-and-configure-a-floating-ip-address-image4.png)
</Frame>
...
<Frame>
  ![floating-ip-05.png](/images/docs/cloud/networking/ip-address/create-and-configure-a-floating-ip-address/create-and-configure-a-floating-ip-address-image5.png)
</Frame>
...
<Frame>
  ![floating-ip-06.png](/images/docs/cloud/networking/ip-address/create-and-configure-a-floating-ip-address/create-and-configure-a-floating-ip-address-image6.png)
</Frame>
...
<Frame>
  ![floating-ip-07.png](/images/docs/cloud/networking/ip-address/create-and-configure-a-floating-ip-address/create-and-configure-a-floating-ip-address-image7.png)
</Frame>
...
<Frame>
  ![floating-ip-08.png](/images/docs/cloud/networking/ip-address/create-and-configure-a-floating-ip-address/create-and-configure-a-floating-ip-address-image8.png)
</Frame>
...
<Frame>
  ![floating-ip-09.png](/images/docs/cloud/networking/ip-address/create-and-configure-a-floating-ip-address/create-and-configure-a-floating-ip-address-image9.png)
</Frame>
...
<Frame>
  ![floating-ip-10.png](/images/docs/cloud/networking/ip-address/create-and-configure-a-floating-ip-address/create-and-configure-a-floating-ip-address-image10.png)
</Frame>
...
<Frame>
  ![floating-ip-11.png](/images/docs/cloud/networking/ip-address/create-and-configure-a-floating-ip-address/create-and-configure-a-floating-ip-address-image11.png)
</Frame>
...
<Frame>
  ![floating-ip-12.png](/images/docs/cloud/networking/ip-address/create-and-configure-a-floating-ip-address/create-and-configure-a-floating-ip-address-image12.png)
</Frame>