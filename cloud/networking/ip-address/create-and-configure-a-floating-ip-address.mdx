...
<Tabs>
  <Tab title="Python SDK">
    ...
    fip = client.cloud.floating_ips.unassign(fip.id)
    print(f"Unassigned: status {fip.status}")

    # Step 4. Delete the floating IP
    client.cloud.floating_ips.delete_and_poll(fip.id)
...
<Tabs>
  <Tab title="Python SDK">
    ...
    fip = client.cloud.floating_ips.unassign(os.environ["FIP_ID"])
...
<Tabs>
  <Tab title="Python SDK">
    ...
    client.cloud.floating_ips.delete_and_poll(os.environ["FIP_ID"])
    print("Floating IP deleted.")
    ```
  </Tab>
  <Tab title="Go SDK">
