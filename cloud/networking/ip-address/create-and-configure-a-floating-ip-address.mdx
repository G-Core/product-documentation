...
ai-navigation: Assign static public IP addresses to VMs, Bare Metal servers, and Load Balancers using floating IPs with subnet routing configuration and traffic forwarding.
ai-navigation: Create and assign Floating IP addresses to VMs, Bare Metal servers, and Load Balancers with subnet routing enabled.
---
