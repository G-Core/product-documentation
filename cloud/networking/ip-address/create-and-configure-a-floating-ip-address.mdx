...
<Tip>
The [gcore_cloud_floating_ip](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_floating_ip) reference on Terraform Registry includes additional configuration examples.
</Tip>
