...
| Failover | No, but can be reassigned via [API](https://gcore.com/docs/api-reference/cloud/floating-ips/update-floating-ip) or [Customer Portal](https://gcore-doc-1280.mintlify.app/cloud/networking/ip-address/create-and-configure-a-floating-ip-address#assign-a-floating-ip-to-a-virtual-machine) | No (manual reassignment) | Yes (shared ownership enables failover) |
