...
description: Compare Floating IP, Reserved IP, and Virtual IP address types in Gcore Cloud: DNAT mapping, pre-allocation, shared failover, assignment scope, billing, and ...
---
