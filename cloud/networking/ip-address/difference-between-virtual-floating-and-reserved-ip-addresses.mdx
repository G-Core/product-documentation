...
ai-navigation: Compare Floating IP, Reserved IP, and Virtual IP address types in Gcore Cloud: DNAT mapping, pre-allocation, shared failover, assignment scope, billing, and
ai-navigation: Compare Floating IP, Reserved IP, and Virtual IP address types: assignment scope, failover capability, billing, and Bare Metal support.
---
...
| Failover | No, but can be reassigned via [API](https://gcore.com/docs/api-reference/cloud/floating-ips/update-floating-ip) or [Customer Portal](https://gcore.com/docs/cloud/networking/ip-address/create-and-configure-a-floating-ip-address#assign-a-floating-ip-to-a-virtual-machine) | No (manual reassignment) | Yes (shared ownership enables failover) |
