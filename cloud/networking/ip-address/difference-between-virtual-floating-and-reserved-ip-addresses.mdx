...
| Failover | No, but can be reassigned via [API](/api-reference/cloud/floating-ips/update-floating-ip) or [Customer Portal](/cloud/networking/ip-address/create-and-configure-a-floating-ip-address#assign-a-floating-ip-to-a-virtual-machine) | No (manual reassignment) | Yes (shared ownership enables failover) |
