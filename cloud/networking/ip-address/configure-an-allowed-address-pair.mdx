...
- **INSTANCE\_ID**: the UUID of the virtual machine whose port to configure. To create a VM or find its ID, see [Create a virtual machine](/cloud/virtual-instances/create-an-instance).
