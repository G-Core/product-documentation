...
<p>The Gcore Terraform provider v2 manages the VIP lifecycle — reservation, enabling or disabling VIP mode, and deletion. To connect VM ports to the VIP, use the [REST API](#api) or [Portal](#portal) tab.</p>
...
<Tip>
See the [Terraform Registry](https://registry.terraform.io/providers/G-Core/gcore/latest/docs) for the full provider reference. This tab uses the [gcore_cloud_reserved_fixed_ip](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_reserved_fixed_ip) resource.
</Tip>
