...
<p>A Virtual Machine can have multiple external IP addresses on a single server. The number of allowed IPs depends on the external network type:</p>

- **Standard public network (pub_net)**: limited by the project's external IP quota per region. Contact support to request a quota increase.
- **Dedicated external network**: unlimited IPs per server. The total number depends on the size of the assigned subnet. A single interface supports up to 64 IP addresses.

<p>A VM can be connected to only one external network at a time. Multiple IP addresses within that one external network are supported, but connecting the VM to two different external networks simultaneously is not allowed.</p>

<p>For dual-stack interfaces (IPv4 + IPv6), only the IPv4 address counts against the external IP quota.</p>

<p>Each external IP address is billed separately, including addresses that share one network port in a dedicated external network.</p>

<p>Floating IPs from private network interfaces are also supported, subject to quotas. In a multi-network setup, each subnet can have one Floating IP. Within a single network, multiple subnets can exist, and each subnet of a single machine (VM/BM) is allowed one Floating IP.</p>
...
<Frame>![Reserved IPs page with Reserve new IP button](/images/docs/cloud/networking/ip-address/create-and-configure-a-virtual-ip-vip-address/vip-reserved-ips-list.png)</Frame>
...
<Frame>![Reserve IP dialog showing Network type and IP Family options](/images/docs/cloud/networking/ip-address/create-and-configure-a-virtual-ip-vip-address/vip-create-dialog.png)</Frame>

3. In the list of reserved IPs, find the new address, click **⋯** next to it, and select **Set as VIP**.

<Frame>![Reserved IPs row context menu with Set as VIP option](/images/docs/cloud/networking/ip-address/create-and-configure-a-virtual-ip-vip-address/vip-set-as-vip-menu.png)</Frame>
...
<Frame>![Reserved IPs row context menu showing VIP settings option](/images/docs/cloud/networking/ip-address/create-and-configure-a-virtual-ip-vip-address/vip-manage-menu.png)</Frame>
...
<Frame>![VIP settings dialog with Select VM and Select Port dropdowns](/images/docs/cloud/networking/ip-address/create-and-configure-a-virtual-ip-vip-address/vip-settings-add-instance.png)</Frame>
...
- **[VIP]** is the virtual IP address to add to the interface.
...
<Frame>![Terminal output of ip addr showing interface names](/images/docs/cloud/networking/ip-address/create-and-configure-a-virtual-ip-vip-address/12946900210833.png)</Frame>
...
<Frame>![Terminal showing ip addr add command example](/images/docs/cloud/networking/ip-address/create-and-configure-a-virtual-ip-vip-address/12946938150161.png)</Frame>
...
<Frame>![Windows TCP/IPv4 Properties dialog](/images/docs/cloud/networking/ip-address/create-and-configure-a-virtual-ip-vip-address/12946990237457.png)</Frame>
...
<Frame>![Windows ipconfig output showing IP details](/images/docs/cloud/networking/ip-address/create-and-configure-a-virtual-ip-vip-address/12947005842961.png)</Frame>
...
<Frame>![Windows Advanced TCP/IP settings button](/images/docs/cloud/networking/ip-address/create-and-configure-a-virtual-ip-vip-address/12947053843345.png)</Frame>
...
<Frame>![Windows IP Settings tab with Add button](/images/docs/cloud/networking/ip-address/create-and-configure-a-virtual-ip-vip-address/20.png)</Frame>
...
<Frame>![Windows Add IP address dialog](/images/docs/cloud/networking/ip-address/create-and-configure-a-virtual-ip-vip-address/21.png)</Frame>
