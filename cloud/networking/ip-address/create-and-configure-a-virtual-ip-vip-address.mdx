...
ai-navigation: Reserve and assign virtual IP addresses (VIP) to VMs using Keepalived and VRRP for fault tolerance or as secondary network interface addresses.
ai-navigation: Create and reserve virtual IP addresses as public or private secondary IPs for Virtual Machines via Reserved IPs.
---
