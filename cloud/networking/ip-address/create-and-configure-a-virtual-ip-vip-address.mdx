...
<p>The Gcore Terraform provider v2 manages the VIP lifecycle — reservation, enabling or disabling VIP mode, and deletion. Connecting VM ports to the VIP is not supported in the provider; use the [REST API tab](#api) or the [Customer Portal tab](#portal) for that step.</p>
