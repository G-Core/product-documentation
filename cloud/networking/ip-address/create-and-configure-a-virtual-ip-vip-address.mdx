...
<Tip>
The [gcore_cloud_reserved_fixed_ip](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_reserved_fixed_ip) reference on Terraform Registry includes additional configuration examples.
</Tip>
