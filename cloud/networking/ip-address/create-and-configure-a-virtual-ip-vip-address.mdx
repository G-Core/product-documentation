...
description: Reserve and assign virtual IP addresses (VIP) to VMs using Keepalived and VRRP for fault tolerance or as secondary network interface addresses.
---
