...
ai-navigation: Configure Load Balancer region, computing resources (vCPU/GiB), network type (Public/Private/Dedicated), IP family (IPv4/IPv6/Dual), reserved IP assignment
ai-navigation: Create Load Balancer with region, vCPU/GiB configuration, network type (Public/Private/Dedicated), IP family (IPv4/IPv6/Dual), and L2/L3 connectivity
---
