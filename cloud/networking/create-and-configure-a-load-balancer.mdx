...
ai-navigation: Create and configure a Load Balancer with region selection, computing configuration (vCPU, GiB), network type (Public, Private, Dedicated public), IP family (IPv4, IPv6, Dual), reserved IP assignment, and preferred connectivity method (L2 or L3) for distributing traffic across Virtual Machines in active-standby high availability mode.
---
...
<Frame>
  ![Initiate the process of Load Balancer creation](/images/docs/cloud/networking/create-and-configure-a-load-balancer/create-and-configure-a-load-balancer-image1.png)
</Frame>
...
<Frame>
  ![Select type](/images/docs/cloud/networking/create-and-configure-a-load-balancer/create-and-configure-a-load-balancer-image2.png)
</Frame>
...
<Frame>
  ![Network-Optimized flavor tab](/images/docs/cloud/networking/create-and-configure-a-load-balancer/create-and-configure-a-load-balancer-image3.png)
</Frame>
...
![Network configuration](/images/docs/cloud/networking/create-and-configure-a-load-balancer/create-and-configure-a-load-balancer-image4.png)
...
<Frame>
  ![Select Layer 2 connectivity option](/images/docs/cloud/networking/create-and-configure-a-load-balancer/create-and-configure-a-load-balancer-image5.png)
</Frame>
...
<Frame>
  ![Add listener](/images/docs/cloud/networking/create-and-configure-a-load-balancer/create-and-configure-a-load-balancer-image6.png)
</Frame>
...
<Frame>
  ![step 8 cidr validation](/images/docs/cloud/networking/create-and-configure-a-load-balancer/create-and-configure-a-load-balancer-image7.png)
</Frame>
...
<Frame>
  ![Listener configuration](/images/docs/cloud/networking/create-and-configure-a-load-balancer/create-and-configure-a-load-balancer-image8.png)
</Frame>
...
<Frame>
  ![Add pools](/images/docs/cloud/networking/create-and-configure-a-load-balancer/create-and-configure-a-load-balancer-image9.png)
</Frame>
...
<Frame>
  ![Pool protocol dropdown showing PROXY and PROXY V2 options](/images/docs/cloud/networking/create-and-configure-a-load-balancer/create-and-configure-a-load-balancer-image17.png)
</Frame>
...
<Frame>
  ![Pool configuration](/images/docs/cloud/networking/create-and-configure-a-load-balancer/create-and-configure-a-load-balancer-image10.png)
</Frame>

#### Instances

<Frame>
  ![Add Virtual Machine](/images/docs/cloud/networking/create-and-configure-a-load-balancer/create-and-configure-a-load-balancer-image11.png)
</Frame>

Click **Add Instance** to add the backend servers that will receive traffic from this pool.

1. Select Custom IP, Virtual Machine, or Bare Metal and the appropriate configuration.

2. Specify the instance's port and weight. Weight controls how much traffic is directed to each instance relative to others in the pool.

#### Health check

<Frame>
  ![Configure Health Check](/images/docs/cloud/networking/create-and-configure-a-load-balancer/create-and-configure-a-load-balancer-image12.png)
</Frame>

1. Select the protocol for checking: TCP, Ping, or HTTP.

2. Specify check interval (sec)—time between health check requests.

3. Specify response time (sec)—the time to wait for a response from a server.

4. Specify unhealthy threshold—the number of consecutive failed checks after which traffic will no longer be sent to the instance.

5. Specify healthy threshold—the number of consecutive successful checks after which the instance will be considered ready to receive traffic.
...
<Frame>
  ![Configure timeouts](/images/docs/cloud/networking/create-and-configure-a-load-balancer/create-and-configure-a-load-balancer-image13.png)
</Frame>
...
<Frame>
  ![Enter Load Balancer name](/images/docs/cloud/networking/create-and-configure-a-load-balancer/create-and-configure-a-load-balancer-image14.png)
</Frame>
...
<Frame>
  ![Configure Logging](/images/docs/cloud/networking/create-and-configure-a-load-balancer/create-and-configure-a-load-balancer-image15.png)
</Frame>
...
<Frame>
  ![Configure tags](/images/docs/cloud/networking/create-and-configure-a-load-balancer/create-and-configure-a-load-balancer-image16.png)
</Frame>
