...
description: Configure Load Balancer region, computing resources (vCPU/GiB), network type (Public/Private/Dedicated), IP family (IPv4/IPv6/Dual), reserved IP assignment, ...
---
