...
A firewall is a network security device used to protect servers from network threats. The firewall monitors incoming and outgoing network traffic and decides whether to allow or block specific traffic based on a defined set of security rules. Rules can be set for all connections except SMTP ports (25, 465, and 587) for outbound traffic, which are blocked by default for abuse prevention.
...
Outbound traffic over SMTP ports 25, 465, and 587 is blocked by default to prevent spam and abuse. All other outbound ports are open.
</Info>
...
To unblock SMTP ports (25, 465, or 587) for outbound email, [contact the Gcore support team](https://gcore.com/contact-us) with a business justification.
