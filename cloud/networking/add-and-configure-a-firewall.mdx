...
The scripts below create a security group with SSH, HTTP, and HTTPS rules, attach it to a running VM, add an ICMP rule, then detach and delete the group.
...
<Info>
Attach this security group to a [Virtual Machine](/cloud/virtual-instances/create-an-instance) by referencing it in the instance resource.
</Info>
