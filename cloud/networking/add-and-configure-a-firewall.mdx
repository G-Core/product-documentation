...
<Tip>
The [gcore_cloud_security_group](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_security_group) reference on Terraform Registry includes additional configuration examples.
</Tip>
