...
ai-navigation: Create inbound and outbound firewall rules for Virtual Machines using template rules (SSH, HTTP, HTTPS, MySQL, DNS, PostgreSQL, RDP) or custom protocol and port specifications, with source filtering by CIDR IP ranges or security groups; port 25 SMTP outbound traffic is blocked by default.
---
...
<Frame>![Firewalls ](/images/docs/cloud/networking/add-and-configure-a-firewall/add-and-configure-a-firewall-image1.png)</Frame>
...
<Frame>![Add rule dropdown showing template options and Custom rule](/images/docs/cloud/networking/add-and-configure-a-firewall/add-and-configure-a-firewall-image2.png)</Frame>
...
<Frame>![Add firewall rule dialog showing protocol, port, and sources configuration](/images/docs/cloud/networking/add-and-configure-a-firewall/add-and-configure-a-firewall-image3.png)</Frame>
...
<Frame>![Firewalls](/images/docs/cloud/networking/add-and-configure-a-firewall/add-and-configure-a-firewall-image4.png)</Frame>
...
<Frame>![Firewalls](/images/docs/cloud/networking/add-and-configure-a-firewall/add-and-configure-a-firewall-image5.png)</Frame>
...
<Frame>![Delete a firewall](/images/docs/cloud/networking/add-and-configure-a-firewall/add-and-configure-a-firewall-image6.png)</Frame>
...
<Frame>![Restore Default option for resetting firewall settings](/images/docs/cloud/networking/add-and-configure-a-firewall/add-and-configure-a-firewall-image7.png)</Frame>
