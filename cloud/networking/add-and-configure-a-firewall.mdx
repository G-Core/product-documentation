...
ai-navigation: Create firewall rules with inbound/outbound traffic policies, template rules (SSH/HTTP/HTTPS/MySQL/DNS/PostgreSQL/RDP), custom protocols/ports, CIDR sources
ai-navigation: Create firewall with inbound/outbound rules, template or custom protocols/ports, IP CIDR sources, security groups.
---
