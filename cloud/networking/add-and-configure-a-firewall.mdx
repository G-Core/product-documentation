...
description: Create firewall rules with inbound/outbound traffic policies, template rules (SSH/HTTP/HTTPS/MySQL/DNS/PostgreSQL/RDP), custom protocols/ports, CIDR sources,...
---
