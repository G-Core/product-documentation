...
<Info>
By default, all outbound traffic is allowed except port 25 (TCP/UDP), which is restricted. Add outbound rules only if specific destinations or protocols need to be restricted.
</Info>
...
## Firewall on Bare Metal servers

<p>The firewall feature available for Virtual Machines is not supported for Bare Metal servers.</p>
