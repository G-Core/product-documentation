...
ai-navigation: Configure Prometheus listeners on load balancers to expose metrics endpoints for scraping with Prometheus and Grafana visualization.
ai-navigation: Enable Prometheus listener on load balancers to expose metrics endpoint for Prometheus scraping and Grafana visualization.
---
