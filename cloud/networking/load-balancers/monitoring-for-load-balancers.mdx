...
<Steps>
  <Step title="Open the listener settings">
    ...
    <img
      src="/images/docs/cloud/networking/load-balancers/manage-load-balancers/load-balancers-page.png"
  ...
  <Step title="Initialize the listener creation">
    ...
    <img
      src="/images/docs/cloud/networking/load-balancers/manage-load-balancers/listeners-tab.png"
      alt="Load balancers details dialog with Listeners tab"
      style={{ width:"36%" }}
    />
...
<Steps>
  ...
  <Step title="Initialize logging">
    ...
    <img
      src="/images/docs/cloud/networking/load-balancers/logging-for-load-balancers/logging-load-balancer-20.png"
      alt="Load balancer logging tab with Enable Logging toggle"
      style={{ width:"73%" }}
    />
  </Step>
...
<Steps>
  <Step title="Open Managed Logging">
    ...
    <img
      src="/images/docs/cloud/networking/load-balancers/logging-for-load-balancers/logging-namespace.png"
...
<Steps>
  ...
  <Step title="Deactivate logging">
    ...
    <img
      src="/images/docs/cloud/networking/load-balancers/manage-load-balancers/logging-tab.png"
      alt="Load balancer logging tab"
      style={{ width:"49%" }}
    />
  </Step>
</Steps>
...
- [Status of one specific load balancer](/api-reference/cloud/load-balancers/get-load-balancer-status)
- [Status of all load balancers](/api-reference/cloud/load-balancers/list-load-balancers-statuses)
...
- [Metrics of one specific load balancer](/api-reference/cloud/load-balancers/get-load-balancer-metrics)
...
- [Get one specific load balancer](/api-reference/cloud/load-balancers/get-load-balancer)
- [Get one listener](/api-reference/cloud/load-balancers/get-load-balancer-listener)
- [Get all listeners](/api-reference/cloud/load-balancers/list-load-balancer-listeners)
