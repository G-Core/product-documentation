...
<Tabs>
  <Tab title="During Load Balancer creation">
    ...
    <Frame>
      ![Create a listener dialog](/images/docs/cloud/networking/load-balancers/add-certificates-to-load-balancer/add-listener-name-port.png)
    </Frame>
    ...
    <Frame>
      ![Create a listener dialog](/images/docs/cloud/networking/load-balancers/add-certificates-to-load-balancer/add-listener-headers-cni.png)
    </Frame>
    ...
    <Frame>
      ![Create a listener dialog](/images/docs/cloud/networking/load-balancers/add-certificates-to-load-balancer/create-listener.png)
    </Frame>
  </Tab>
