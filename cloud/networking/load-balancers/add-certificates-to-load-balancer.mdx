...
ai-navigation: Configure multiple TLS certificates on Gcore Load Balancer listeners using Server Name Indication (SNI) to serve different certificates per domain; add certificates to Secrets Manager, then attach them to Terminated HTTPS or Prometheus protocol listeners during Load Balancer creation or modification.
---
...
<Tabs>
  <Tab title="During Load Balancer creation">
    ...
    <Frame>![Create a listener dialog](/images/docs/cloud/networking/load-balancers/add-certificates-to-load-balancer/add-certificates-to-load-balancer-image1.png)</Frame>
    ...
    <Frame>![Create a listener dialog](/images/docs/cloud/networking/load-balancers/add-certificates-to-load-balancer/add-certificates-to-load-balancer-image2.png)</Frame>
    ...
    <Frame>![Create a listener dialog](/images/docs/cloud/networking/load-balancers/add-certificates-to-load-balancer/add-certificates-to-load-balancer-image3.png)</Frame>
  </Tab>
  <Tab title="From the Load Balancer settings">
    ...
    <Frame>![Load Balancers page in Customer Portal](/images/docs/cloud/networking/load-balancers/add-certificates-to-load-balancer/add-certificates-to-load-balancer-image4.png)</Frame>
    ...
    <Frame>![Listener tab in the Load Balancer settings](/images/docs/cloud/networking/load-balancers/add-certificates-to-load-balancer/add-certificates-to-load-balancer-image5.png)</Frame>
...
<Frame>![Encrypted password in listener settings](/images/docs/cloud/networking/load-balancers/add-certificates-to-load-balancer/add-certificates-to-load-balancer-image6.png)</Frame>