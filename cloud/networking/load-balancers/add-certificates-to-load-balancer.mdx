...
<Tip>
The [gcore_cloud_load_balancer_listener](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_load_balancer_listener) reference on Terraform Registry includes additional configuration examples.
</Tip>
