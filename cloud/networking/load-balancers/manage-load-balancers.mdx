...
<p>Failover is an operational trigger. Use the [Customer Portal tab](#portal) or the [REST API tab](#api) to initiate it.</p>

## Delete a load balancer

<p>Terraform removes the pool, listeners, and the load balancer itself. The operation takes about 30 seconds.</p>
