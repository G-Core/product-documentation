...
ai-navigation: List, inspect, rename, update tags, initiate failover, and delete Load Balancers via the Customer Portal or Gcore REST API with Python SDK, Go SDK, and curl examples.
---
...
A Load Balancer exists as a named resource with a virtual IP address, a set of listeners, and associated tags. The management API covers four operations: inspecting the current state, renaming or updating tags, triggering a failover, and deleting the balancer.
