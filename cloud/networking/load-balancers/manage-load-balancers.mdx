...
<p>Terraform manages load balancer properties declaratively. Use data sources to inspect existing balancers, and update resource attributes to rename, retag, or resize.</p>
...
<p>Run `terraform plan` to display the list without making any infrastructure changes.</p>
...
<p>Failover is an operational trigger and is not available as a Terraform operation. Use the [Customer Portal tab](#portal) or the [REST API tab](#api) to initiate a failover.</p>
