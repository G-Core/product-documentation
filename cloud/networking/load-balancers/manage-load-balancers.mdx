...
<p>Create, update, or inspect load balancers with the [Gcore Terraform provider v2](/developer-tools/terraform/overview). Use the [`gcore_cloud_load_balancer`](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_load_balancer) resource to manage the full lifecycle, or the data source to read an existing load balancer without taking ownership of it.</p>
