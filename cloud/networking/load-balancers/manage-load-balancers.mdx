...
**Tip**
  ...
  For optimized performance, we recommend making batch updates of pool settings. To perform comprehensive simultaneous updates, use the [Gcore API](/api-reference/cloud/load-balancers/update-load-balancer-pool).
</Tip>
