...
ai-navigation: Manage Load Balancer resources in the Customer Portal by viewing configuration details, IP addresses, listeners, regions, tags, and operating/provisioning statuses including Online, Draining, Offline, Degraded, Error, and No_monitor states.
---
...
<Frame>![Load Balancers page in the Customer Portal](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image1.png)</Frame>
...
<Frame>![Load Balancers overview page](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image2.png)</Frame>
...
<Frame>![Flavor tab in Load Balancer settings](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image3.png)</Frame>
...
<Frame>![Monitoring tab in Load Balancer settings](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image4.png)</Frame>
...
<Frame>![Listeners tab in Load Balancer settings](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image5.png)</Frame>
...
<Frame>![Listeners tab with pool settings](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image6.png)</Frame>
...
<Frame>![Listeners tab with instance settings](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image7.png)</Frame>
...
<Frame>![Listeners tab with health check settings](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image8.png)</Frame>
...
<Frame>![Listeners tab with timeouts settings](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image9.png)</Frame>
...
<Frame>![Listeners tab with listener statistics](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image10.png)</Frame>
...
<Frame>![Configuration tab settings](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image11.png)</Frame>
...
<Frame>![Logging tab settings](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image12.png)</Frame>
...
<Frame>![Tags tab settings](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image13.png)</Frame>
...
<Frame>![Load Balancers page with initiate failover settings](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image14.png)</Frame>
...
<Frame>![Initiate failover dialog asking whether to procceed with failover](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image15.png)</Frame>
...
<Frame>![Rename button in the Load Balancer settings](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image16.png)</Frame>
...
<Frame>![Rename dialog in the Load Balancer settings](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image17.png)</Frame>
...
<Frame>![Delete button in the Load Balancer settings](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image18.png)</Frame>
...
<Frame>![Delete dialog in the Load Balancer settings](/images/docs/cloud/networking/load-balancers/manage-a-load-balancer/manage-load-balancers-image19.png)</Frame>
