...
description: View Load Balancer properties, statuses, listeners, IP addresses, regions, and tags in Customer Portal; monitor operating and provisioning status of Load Bal...
---
