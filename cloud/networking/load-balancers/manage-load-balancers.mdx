...
<Frame>
  ![Listeners tab with timeouts settings](/images/docs/cloud/networking/load-balancers/manage-load-balancers/listeners-tab-timeouts.png)
</Frame>
...
<Frame>
  ![Load Balancers page with initiate failover settings](/images/docs/cloud/networking/load-balancers/manage-load-balancers/failover.png)
</Frame>
...
<Frame>
  ![Initiate failover dialog asking whether to procceed with failover](/images/docs/cloud/networking/load-balancers/manage-load-balancers/initiating-failover.png)
</Frame>
...
<Frame>
  ![Rename button in the Load Balancer settings](/images/docs/cloud/networking/load-balancers/manage-load-balancers/rename.png)
</Frame>
...
<Frame>
  ![Rename dialog in the Load Balancer settings](/images/docs/cloud/networking/load-balancers/manage-load-balancers/rename-confirmation.png)
</Frame>
...
<Frame>
  ![Delete button in the Load Balancer settings](/images/docs/cloud/networking/load-balancers/manage-load-balancers/delete-three-dot-icon.png)
</Frame>
...
<Frame>
  ![Delete dialog in the Load Balancer settings](/images/docs/cloud/networking/load-balancers/manage-load-balancers/delete-confirmation.png)
</Frame>
