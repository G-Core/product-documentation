...
ai-navigation: Configure mutual TLS authentication between Gcore Load Balancers and backend servers using PKCS12/PEM certificates, CA verification, and mTLS pool parameters.
ai-navigation: Configure mutual TLS authentication between Load Balancer and backend servers using PKCS12 and PEM certificates via API.
---
