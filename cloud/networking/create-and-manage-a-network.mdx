...
<p>Declare a network and subnet together using the Gcore [Terraform provider](/developer-tools/terraform/overview) — a subnet is required to assign IP addresses to resources.</p>

<Tip>
See the [Terraform Registry](https://registry.terraform.io/providers/G-Core/gcore/latest/docs) for the full provider reference. This tab uses the [gcore_cloud_network](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_network) resource.
</Tip>
