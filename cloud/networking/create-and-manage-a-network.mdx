...
4. (Optional) To create a network for Bare Metal servers, select the **Bare Metal Network** checkbox.
5. (Optional) Select **Add tags** to include metadata.
...
<p>All configured network interfaces and their subnetworks appear in the Customer Portal, on the **Networks** page.</p>
