...
<Tip>
The [gcore_cloud_network](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_network) reference on Terraform Registry includes additional configuration examples.
</Tip>
