...
<Frame>
  ![Create network page in the Customer Portal](/images/docs/cloud/networking/create-and-manage-a-network/create-and-manage-a-network-image1.png)
</Frame>
...
<Frame>
  ![Create network dialog](/images/docs/cloud/networking/create-and-manage-a-network/create-and-manage-a-network-image2.png)
</Frame>
...
<Frame>
  ![Networking tab in the VM settings](/images/docs/cloud/networking/create-and-manage-a-network/create-and-manage-a-network-image3.png)
</Frame>
...
<Frame>
  ![Network settings with the detach subnetwork option](/images/docs/cloud/networking/create-and-manage-a-network/create-and-manage-a-network-image4.png)
</Frame>
...
<Frame>
  ![Network details page](/images/docs/cloud/networking/create-and-manage-a-network/create-and-manage-a-network-image5.png)
</Frame>
...
<Frame>
  ![Disable port security](/images/docs/cloud/networking/create-and-manage-a-network/create-and-manage-a-network-image6.png)
</Frame>
...
<Frame>
  ![Network settings menu with the rename button highlighted](/images/docs/cloud/networking/create-and-manage-a-network/create-and-manage-a-network-image7.png)
</Frame>

4. Enter a new name and click **Save** to apply the changes.

<Frame>
  ![Edit network name and description dialog](/images/docs/cloud/networking/create-and-manage-a-network/create-and-manage-a-network-image8.png)
</Frame>
...
<Frame>
  ![Network settings menu with the delete button highlighted.png](/images/docs/cloud/networking/create-and-manage-a-network/create-and-manage-a-network-image9.png)
</Frame>

4. Click **Delete network** to confirm your action.

<Frame>
  ![Delete network dialog](/images/docs/cloud/networking/create-and-manage-a-network/create-and-manage-a-network-image10.png)
</Frame>
