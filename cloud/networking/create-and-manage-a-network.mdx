...
ai-navigation: Create and manage private, public, and dedicated networks for VMs, Bare Metal, Load Balancers, and Kubernetes via Customer Portal, or set up a private network between two VMs via REST API by creating a network, subnet, and instances.
---
