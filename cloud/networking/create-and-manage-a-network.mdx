...
<p>Declare a network and subnet together using the [Gcore Terraform provider v2](/developer-tools/terraform/overview) — a subnet is required to assign IP addresses to resources.</p>
...
<Info>
Attach this network to a [Virtual Machine](/cloud/virtual-instances/create-an-instance) or [Bare Metal](/cloud/bare-metal-servers/create-a-bare-metal-server) server.
</Info>
