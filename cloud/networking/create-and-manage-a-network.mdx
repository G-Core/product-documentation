...
ai-navigation: Create and attach private, public, and dedicated networks to Virtual Machines, Bare Metal servers, Load Balancers, and Managed Kubernetes clusters using VxLAN and VLAN protocols; assign Floating IP addresses and multiple public IPs to enable external connectivity and traffic balancing.
---
