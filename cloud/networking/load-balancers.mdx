...
ai-navigation: Distribute incoming requests across Virtual Machines and Bare Metal servers using Load Balancer flavors with performance metrics, SSE/WebSocket support, and
ai-navigation: Create Load Balancer with flavor selection (1-8 vCPU) for request distribution across VMs and Bare Metal with HTTP/HTTPS throughput and latency
---
