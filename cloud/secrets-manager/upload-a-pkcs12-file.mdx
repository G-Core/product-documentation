...
ai-navigation: Upload SSL/TLS certificates and private keys to Secrets Manager via PKCS12 file or manual entry for HTTPS load balancer listeners.
ai-navigation: Create SSL/TLS secrets in Secrets Manager via PKCS12 file upload or manual certificate, chain, and private key entry for HTTPS Load Balancers.
---
