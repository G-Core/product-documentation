...
<Tip>
The [gcore_cloud_secret](https://registry.terraform.io/providers/G-Core/gcore/latest/docs/resources/cloud_secret) reference on Terraform Registry includes additional configuration examples.
</Tip>
