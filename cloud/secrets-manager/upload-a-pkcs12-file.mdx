...
<p>The [delete secret](https://api.gcore.com/docs/cloud#tag/Secrets/operation/SecretViewSet.delete) endpoint removes a secret permanently. A secret attached to a load balancer listener cannot be deleted — remove the listener first, then delete the secret.</p>
