...
ai-navigation: Create SSL/TLS secrets in Gcore Secrets Manager by uploading PKCS12 files or manually entering certificate, certificate chain, and private key for HTTPS Load Balancer listeners.
---
...
curl "https://api.gcore.com/cloud/v1/secrets/$PROJECT_ID/$REGION_ID/$SECRET_ID" \
  -H "Authorization: APIKey $GCORE_API_KEY"
```
