...
ai-navigation: Configure Gcore Cloud resources using Ansible Galaxy Collection modules and plugins for provisioning, deploying, and orchestrating instances, volumes, networks, and other cloud services via playbooks with API key authentication and region/project parameters.
---
