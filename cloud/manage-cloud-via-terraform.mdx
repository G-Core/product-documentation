...
All examples use provider v0. Provider v2 resources are under active development; the current v2 resource list is in the [v2 documentation on Terraform Registry.](https://registry.terraform.io/providers/G-Core/gcore/2.0.0-alpha.6/docs)
</Info>

Provider v2 is a ground-up rewrite of the Gcore Terraform provider, auto-generated from the OpenAPI spec. It supports `terraform import` for most resources. The [Terraform page](/developer-tools/terraform/manage-with-terraform) covers v2 installation, authentication, and a full comparison with v0.
