...
ai-navigation: Deploy Gcore Cloud resources including Virtual Machines, Managed Kubernetes clusters, and Bare Metal servers via Terraform provider using main.tf configuration files, API tokens, and terraform plan/apply commands.
---
