...
Replace `251$d33611b35f26d8` with your permanent API token. Check the [Terraform Registry](https://registry.terraform.io/providers/G-Core/gcore/latest) for the latest v0 release and update the version accordingly.
...
To try v2, replace your provider configuration in `main.tf` with the following:
...
- Requires Terraform CLI 1.11 or later (v0 requires 0.13.0 or later).
