...
ai-navigation: Enable 5G Network connectivity with eSIM technology to connect devices and applications to Gcore Cloud across 183 countries with ultra-low latency, local network access, and encrypted data transmission for real-time applications, IoT, industrial automation, and live streaming.
---
...
<Frame>![how 5G works with the Gcore Cloud Platform](/images/docs/cloud/5g-esim/about-5g-esim/about-5g-esim-image1.png)</Frame>
