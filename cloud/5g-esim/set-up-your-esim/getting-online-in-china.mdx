...
ai-navigation: Configure device compatibility and LTE band settings (bands 3, 41) for internet connectivity in China to avoid network blocking.
ai-navigation: Configure mobile devices for China network access: verify LTE bands 3/41 support, use tablet/Mi-Fi/USB modem to avoid emergency call blocking.
---
