...
description: Activate eSIM via QR code, assigned plan, or manual entry; switch between multiple eSIMs, change cellular data line, and delete or deactivate eSIM profiles i...
---
