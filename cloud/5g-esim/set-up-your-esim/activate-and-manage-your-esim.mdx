...
ai-navigation: Activate eSIM via QR code scan, assigned carrier plan installation, or manual entry; switch between multiple stored eSIMs, change cellular data line, and deactivate eSIM profiles through iOS Settings.
---
