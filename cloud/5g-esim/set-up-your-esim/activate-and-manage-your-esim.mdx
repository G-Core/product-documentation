...
sidebarTitle: Activate and manage you eSIM
ai-navigation: Activate eSIM via QR code, assigned plan, or manual entry; switch between multiple eSIMs, change cellular data line, and delete or deactivate eSIM profiles i
ai-navigation: Activate eSIM via QR code scan, assigned plan installation, or manual entry; switch between multiple eSIMs; manage cellular data line.
---
