...
ai-navigation: Configure QoS presets (32 Kbps to 2 Mbps) to limit bandwidth, throttle specific activities, or reduce speed after data threshold breaches.
ai-navigation: Configure QoS bandwidth limits using presets (32 Kbps–2 Mbps) or data thresholds to restrict user speed.
---
