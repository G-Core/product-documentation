...
ai-navigation: Configure Quality of Service bandwidth limits using predefined QoS presets ranging from 32 Kbps to 2 Mbps, set permanent speed restrictions, or apply data threshold-based bandwidth throttling to manage user internet access and online activities.
---
