...
ai-navigation: Define user and teammate account types with role-based permissions: Owner, Admin, Accountant, Manager controlling access to SIM cards, reports, system settin
ai-navigation: Manage account types, user and teammate roles, and permission levels: Owner, Admin, Accountant, Manager.
---
