...
sidebarTitle: Account types and permissions
ai-navigation: Configure teammate permissions in Gcore Connectivity workspace with Owner, Admin, Accountant, or Manager roles to control access to SIM Cards, users, reports, user support, system settings, group management, package management, teammates, data export, and business profile management.
---
