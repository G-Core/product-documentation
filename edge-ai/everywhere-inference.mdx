...
ai-navigation: Deploy trained AI models on edge inference nodes using Anycast endpoints and Smart Routing for ultra-low latency inference across global regions.
ai-navigation: Deploy trained AI models on edge inference nodes using Gcore Everywhere Inference with Anycast endpoints and Smart Routing for low-latency inference.
---
...
<Frame>
  ![Diagram depicting Smart Routing technology](/images/docs/cloud/everywhere-inference/about-everywhere-inference/smart-routing-diagram.png)
</Frame>
...
<Frame>
  ![Map depicting Smart Routing across locations](/images/docs/cloud/everywhere-inference/about-everywhere-inference/smart-routing-map.png)
</Frame>
