...
description: Deploy trained AI models on edge inference nodes using Anycast endpoints and Smart Routing for ultra-low latency inference across global regions.
---
