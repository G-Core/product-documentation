...
<Frame>![How Smart Routing works to speed up requests via Gcore Everywhere Inference](/images/docs/edge-ai/everywhere-inference/overview/everywhere-inference-image1.png)</Frame>
...
<Frame>![Healthchecks redirects traffic to the next-closest edge node if the closest node is unavailable](/images/docs/edge-ai/everywhere-inference/overview/everywhere-inference-image2.png)</Frame>
