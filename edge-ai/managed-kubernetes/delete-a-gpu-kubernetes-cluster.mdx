...
<Steps>
  ...
  <Step title="Type Delete in the confirmation field">
    <Frame>
      <img src="/images/docs/edge-ai/managed-kubernetes/manage-node-pools/delete-cluster-dialog.png" alt="Delete cluster confirmation dialog requiring 'Delete' text input" />
    </Frame>
  </Step>
...
<Tabs>
  <Tab title="Python SDK">
    ...
    cluster = client.cloud.k8s.clusters.delete_and_poll(cluster_name=CLUSTER)
  ...
  <Tab title="Go SDK">
    ...
    func main() {
    	...
    	_, err := client.Cloud.K8S.Clusters.DeleteAndPoll(
    		ctx,
    		clusterName,
