...
ai-navigation: Create GPU Kubernetes clusters with Bare Metal GPU pools via Customer Portal, REST API, or Terraform, then download the kubeconfig.
---
...
<Tabs>
  <Tab title="Python SDK">
    ...
    # Step 4. Create the cluster and wait until provisioned
