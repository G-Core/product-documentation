...
<Steps>
  ...
  <Step title="Configure the parameters and click Save changes">
    <Frame>
      <img src="/images/docs/edge-ai/managed-kubernetes/manage-node-pools/autoscaler-settings.png" alt="Cluster Autoscaler settings showing scan interval, expander, and scale-down parameters" />
    </Frame>
  </Step>
</Steps>
