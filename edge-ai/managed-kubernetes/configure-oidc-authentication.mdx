...
<Steps>
  <Step title="Navigate to the Advanced settings tab">
    <Frame>
      <img src="/images/docs/edge-ai/managed-kubernetes/configure-oidc-authentication/configure-oidc-authentication-image1.png" alt="Advanced settings tab showing OIDC authentication and Cluster Autoscaler sections" />
    </Frame>
  </Step>
  ...
  <Step title="Configure the identity provider settings and click Save changes">
    <Frame>
      <img src="/images/docs/edge-ai/managed-kubernetes/configure-oidc-authentication/configure-oidc-authentication-image2.png" alt="OIDC authentication form showing Issuer URL, Client ID, groups claim, signing algorithms, and username fields" />
    </Frame>
  </Step>
</Steps>
...
<Tabs>
  <Tab title="Python SDK">
    ...
    print(f"OIDC configured for cluster: {cluster.name}")
    ```
  </Tab>
  <Tab title="Go SDK">
    ```go
    ...
    func main() {
        ...
        fmt.Printf("OIDC configured for cluster: %s\n", cluster.Name)
    }
    ```
  </Tab>
  <Tab title="curl">
...
<Tabs>
  <Tab title="Python SDK">
    ...
    print(f"OIDC removed from cluster: {cluster.name}")
    ```
  </Tab>
  <Tab title="Go SDK">
    ```go
    ...
    func main() {
        ...
        fmt.Printf("OIDC removed from cluster: %s\n", cluster.Name)
    }
    ```
  </Tab>
  <Tab title="curl">
