...
<Steps>
  ...
  <Step title="Configure the identity provider settings and click Save changes">
    <Frame>
      <img src="/images/docs/edge-ai/managed-kubernetes/manage-node-pools/oidc-settings.png" alt="OIDC authentication settings showing issuer URL, client ID, and claim configuration" />
    </Frame>
  </Step>
</Steps>
