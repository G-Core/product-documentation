...
For clusters with InfiniBand networking, SHARP (Scalable Hierarchical Aggregation and Reduction Protocol) allocations update automatically during resize operations. When scaling up, new nodes are added to existing SHARP reservations. When scaling down, SHARP reservations are updated to remove deleted nodes. No manual configuration is required.

For more information about SHARP optimization, see [About GPU Cloud](/edge-ai/ai-infrastructure/about-gpu-cloud#sharp-optimization).
