...
ai-navigation: Monitor and manage Bare Metal GPU cluster nodes, resize clusters by adding/removing nodes, configure network interfaces, manage power states, and delete clus
ai-navigation: Manage Bare Metal GPU cluster nodes, resize instance count, configure power state, and delete specific nodes via cluster details page.
---
