...
<Steps>
  ...
  <Step title="Configure the volume">
    ...
    <Frame>
      ![Create volume form](/images/docs/edge-ai/ai-infrastructure/create-and-manage-volumes/create-and-manage-volumes-image2.png)
    </Frame>
  </Step>
  <Step title="Confirm creation">
    ...
    <Frame>
      ![Volumes list showing the newly created volume](/images/docs/edge-ai/ai-infrastructure/create-and-manage-volumes/create-and-manage-volumes-image1.png)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Confirm deletion">
    ...
    <Frame>
      ![Delete volume confirmation dialog](/images/docs/edge-ai/ai-infrastructure/create-and-manage-volumes/create-and-manage-volumes-image4.png)
    </Frame>
