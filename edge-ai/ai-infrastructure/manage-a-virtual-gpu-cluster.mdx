...
ai-navigation: Monitor Virtual GPU cluster nodes, manage power state (power on/off, reboot), configure volumes and network interfaces, and delete cluster resources via Gcor
ai-navigation: Manage Virtual GPU cluster power state, volumes, networking, and delete resources via cluster details page tabs.
---
...
The [GPU Virtual API reference](/api-reference/cloud/gpu-virtual) provides endpoint details and code examples.
