...
After [creating a Virtual GPU cluster](/edge-ai/ai-infrastructure/create-a-virtual-gpu-cluster), use the cluster details page to monitor nodes, manage power state, change flavor, configure disks and network interfaces, and delete cluster resources.
