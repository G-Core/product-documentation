...
<p>The list endpoint returns all clusters in a project and region. Query string filters — by name, flavor, node count, tags, and timestamps — are documented in the [API&nbsp;reference](/api-reference/cloud/gpu-virtual). Multiple filters are ANDed.</p>
