...
ai-navigation: Manage Virtual GPU cluster nodes, power state, volumes, and network interfaces via cluster details page tabs including Overview, Volumes, Networking, Power, Tags, and Delete operations.
---
...
<Frame>![Cluster details page with Overview tab showing cluster instances](/images/docs/edge-ai/ai-infrastructure/create-a-virtual-gpu-cluster/manage-a-virtual-gpu-cluster-image1.png)</Frame>
...
<Frame>![Power tab with Power on, Power off, Soft reboot, and Hard reboot options](/images/docs/edge-ai/ai-infrastructure/create-a-virtual-gpu-cluster/manage-a-virtual-gpu-cluster-image2.png)</Frame>
...
<Frame>![Volumes tab showing instance volumes with Add Volume button](/images/docs/edge-ai/ai-infrastructure/create-a-virtual-gpu-cluster/manage-a-virtual-gpu-cluster-image3.png)</Frame>
...
<Frame>![Add Interface dialog with network type and configuration options](/images/docs/edge-ai/ai-infrastructure/create-a-virtual-gpu-cluster/manage-a-virtual-gpu-cluster-image4.png)</Frame>
...
<Frame>![Delete Cluster dialog with volume selection and confirmation](/images/docs/edge-ai/ai-infrastructure/create-a-virtual-gpu-cluster/manage-a-virtual-gpu-cluster-image5.png)</Frame>
