...
<p>Manage virtual GPU clusters through the REST API: list, inspect, control power state, and delete.</p>
...
# Clusters with node count between 2 and 8
curl -G "https://api.gcore.com/cloud/v3/gpu/virtual/${GCORE_CLOUD_PROJECT_ID}/${GCORE_CLOUD_REGION_ID}/clusters" \
  -H "Authorization: APIKey ${GCORE_API_KEY}" \
  --data-urlencode "servers_count[gte]=2" \
  --data-urlencode "servers_count[lte]=8"

# Clusters whose tag key contains "team"
curl -G "https://api.gcore.com/cloud/v3/gpu/virtual/${GCORE_CLOUD_PROJECT_ID}/${GCORE_CLOUD_REGION_ID}/clusters" \
  -H "Authorization: APIKey ${GCORE_API_KEY}" \
  --data-urlencode "tag_key[contains]=team"

# Clusters with specific IDs
curl -G "https://api.gcore.com/cloud/v3/gpu/virtual/${GCORE_CLOUD_PROJECT_ID}/${GCORE_CLOUD_REGION_ID}/clusters" \
  -H "Authorization: APIKey ${GCORE_API_KEY}" \
  --data-urlencode "ids=uuid-1" \
  --data-urlencode "ids=uuid-2"
```
