...
InfiniBand configurations include SHARP optimization automatically. For more details about SHARP, see [About GPU Cloud](/edge-ai/ai-infrastructure/about-gpu-cloud#sharp-optimization).
