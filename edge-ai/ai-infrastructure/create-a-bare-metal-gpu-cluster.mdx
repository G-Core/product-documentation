...
1. In the **Cluster capacity** section, select the **GPU Cluster type**:
   ...
   - **Spot Bare Metal GPU** for discounted, interruptible instances (available in select regions) — see [Spot Bare Metal GPU](/edge-ai/ai-infrastructure/spot-bare-metal-gpu) for pricing, reclamation policy, and data preservation details
