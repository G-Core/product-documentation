...
- **Spot Bare Metal GPU**: Discounted servers ideal for batch processing, training, and testing that can be paused or reclaimed with 24 hours' notice. [Learn more about Spot clusters](/edge-ai/ai-infrastructure/spot-bare-metal-gpu).
