...
ai-navigation: Create Bare Metal GPU clusters with dedicated physical servers, selecting region, GPU model, cluster type (Bare Metal GPU or Spot Bare Metal GPU), node count, and InfiniBand networking via Gcore Customer Portal GPU Cloud interface.
---
...
Each cluster consists of one or more dedicated bare-metal GPU servers. When creating a multi-node cluster, all servers are placed in the same private network and share an identical configuration, including the image, network settings, and file shares.
...
<Frame>
  <img src="/images/docs/edge-ai/ai-infrastructure/create-a-bare-metal-gpu-cluster/create-a-bare-metal-gpu-cluster-image1.png" alt="Region selection section showing available regions grouped by geography" />
</Frame>
...
<Frame>
  <img src="/images/docs/edge-ai/ai-infrastructure/create-a-bare-metal-gpu-cluster/create-a-bare-metal-gpu-cluster-image2.png" alt="Cluster capacity section showing GPU Cluster type, GPU Model selector, and flavor card with specifications" />
</Frame>
...
<Frame>
  <img src="/images/docs/edge-ai/ai-infrastructure/create-a-bare-metal-gpu-cluster/create-a-bare-metal-gpu-cluster-image3.png" alt="Number of Instances section with instance counter" />
</Frame>
...
The maximum number of instances is limited by the current stock availability in the region. There is no fixed per-cluster limit—clusters can scale to hundreds of nodes if capacity is available.
...
<Frame>
  <img src="/images/docs/edge-ai/ai-infrastructure/create-a-bare-metal-gpu-cluster/create-a-bare-metal-gpu-cluster-image4.png" alt="Image section with Public and Custom tabs and image selector" />
</Frame>
...
<Frame>
  <img src="/images/docs/edge-ai/ai-infrastructure/create-a-bare-metal-gpu-cluster/create-a-bare-metal-gpu-cluster-image6.png" alt="Create VAST File Share dialog with basic settings and additional options" />
</Frame>

3. Specify the mount path for the file share on cluster nodes (default: `/home/ubuntu/mnt/nfs`). Additional file shares can be attached by clicking **Add File Share**.
...
<Frame>
  <img src="/images/docs/edge-ai/ai-infrastructure/create-a-bare-metal-gpu-cluster/create-a-bare-metal-gpu-cluster-image7.png" alt="Network settings section showing interface configuration" />
</Frame>
...
| **Dedicated public** | Reserved static public IP | Production APIs, services requiring stable endpoints |
   ...
   For multi-node clusters, a private interface keeps internal traffic separate from internet-facing traffic.
...
<Frame>
  <img src="/images/docs/edge-ai/ai-infrastructure/create-a-bare-metal-gpu-cluster/create-a-bare-metal-gpu-cluster-image8.png" alt="Firewall settings section with firewall selector" />
</Frame>
...
<Frame>
  <img src="/images/docs/edge-ai/ai-infrastructure/create-a-bare-metal-gpu-cluster/create-a-bare-metal-gpu-cluster-image9.png" alt="SSH key section with dropdown and options to add or generate keys" />
</Frame>
...
<Frame>
  <img src="/images/docs/edge-ai/ai-infrastructure/create-a-bare-metal-gpu-cluster/create-a-bare-metal-gpu-cluster-image10.png" alt="Additional options section with User data and Add tags checkboxes" />
</Frame>
...
<Frame>
  <img src="/images/docs/edge-ai/ai-infrastructure/create-a-bare-metal-gpu-cluster/create-a-bare-metal-gpu-cluster-image11.png" alt="GPU Cluster Name section with name input field" />
</Frame>
...
The [Gcore Customer Portal](https://portal.gcore.com) is suitable for creating and managing individual clusters. For automated workflows—such as CI/CD pipelines, infrastructure-as-code, or batch provisioning—use the GPU Bare Metal API.
