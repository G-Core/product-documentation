...
description: Create Bare Metal GPU clusters with dedicated physical servers, configurable node count, GPU models, and InfiniBand networking for distributed AI/ML training...
---
