...
- **Spot Bare Metal GPU**: Discounted bare metal servers with non-guaranteed availability, suitable for batch processing, training, and testing where interruptions are acceptable. Like standard Bare Metal GPUs, [Spot clusters](/edge-ai/ai-infrastructure/spot-bare-metal-gpu) provide full hardware access but may be reclaimed with 24 hours' notice.
