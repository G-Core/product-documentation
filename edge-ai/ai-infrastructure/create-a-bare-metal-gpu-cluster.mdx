...
<Tabs>
  <Tab title="Python SDK">
    ...
    # Step 3. Create the cluster and wait until provisioned
    ...
    print(f"Cluster provisioned: {cluster.name} (ID: {cluster.id})")

    # Step 4. Get the public IP and print SSH command
  ...
  <Tab title="Go SDK">
    ...
    func main() {
        ...
        // Step 3. Create the cluster and wait until provisioned
        cluster, err := client.Cloud.GPUBaremetal.Clusters.NewAndPoll(ctx,
        ...
        fmt.Printf("Cluster provisioned: %s (ID: %s)\n", cluster.Name, cluster.ID)
