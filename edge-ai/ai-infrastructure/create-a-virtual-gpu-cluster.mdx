...
ai-navigation: Provision Virtual GPU cluster nodes with GPU flavors, network boot disks, local data disks, and optional network data disks in Gcore GPU Cloud.
ai-navigation: Create Virtual GPU cluster with GPU model, flavor, instance count, network boot disk, and optional network data disks.
---
