...
<Info>
Virtual GPU clusters support a maximum of 3 network interfaces (Public and Private combined) per node. If Vast file share integration is enabled, the limit is reduced to 2 interfaces, because one interface is reserved for NFS connectivity.
