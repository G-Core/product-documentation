...
<Tabs>
  <Tab title="Python SDK">
    ...
    ifaces = client.cloud.gpu_virtual.clusters.interfaces.list(cluster_id=cluster.id)
...
|-----------|----------|-------------|
| `name` | Yes | Cluster name (two–63 characters, alphanumeric, hyphens, underscores) |
