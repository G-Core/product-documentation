...
ai-navigation: Create Virtual GPU clusters with configurable node count, GPU models, flavors, network boot disks, local data disks, optional network data disks, file share integration, and InfiniBand networking in Gcore GPU Cloud.
---
...
<Frame>![Virtual GPU Clusters page with cluster list and Create Cluster button](/images/docs/edge-ai/ai-infrastructure/create-a-virtual-gpu-cluster/create-a-virtual-gpu-cluster-image1.png)</Frame>
...
<Frame>![Cluster capacity section with GPU cluster type selection and available flavors](/images/docs/edge-ai/ai-infrastructure/create-a-virtual-gpu-cluster/create-a-virtual-gpu-cluster-image2.png)</Frame>
...
<Frame>![Image section with Public and Custom tabs and Ubuntu image dropdown](/images/docs/edge-ai/ai-infrastructure/create-a-virtual-gpu-cluster/create-a-virtual-gpu-cluster-image3.png)</Frame>
...
<Frame>![Volumes section with System and Local volumes configuration](/images/docs/edge-ai/ai-infrastructure/create-a-virtual-gpu-cluster/create-a-virtual-gpu-cluster-image4.png)</Frame>
...
<Frame>![File share integration section with toggle and file share selector](/images/docs/edge-ai/ai-infrastructure/create-a-virtual-gpu-cluster/create-a-virtual-gpu-cluster-image5.png)</Frame>
...
<Frame>![Network settings section with Public and Private interfaces configured](/images/docs/edge-ai/ai-infrastructure/create-a-virtual-gpu-cluster/create-a-virtual-gpu-cluster-image6.png)</Frame>
...
<Frame>![Additional options section with User data and Add tags toggles](/images/docs/edge-ai/ai-infrastructure/create-a-virtual-gpu-cluster/create-a-virtual-gpu-cluster-image7.png)</Frame>
