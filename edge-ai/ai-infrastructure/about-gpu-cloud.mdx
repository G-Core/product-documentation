...
Gcore enables SHARP (Scalable Hierarchical Aggregation and Reduction Protocol) automatically on InfiniBand configurations. It offloads collective communication operations to network switches, reducing latency for distributed training and HPC workloads.

This matters most for multi-node AI training where frequent gradient synchronization occurs between nodes.
