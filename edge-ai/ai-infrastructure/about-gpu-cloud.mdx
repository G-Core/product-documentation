...
[InfiniBand](/edge-ai/networking/about-infiniband) provides high-bandwidth, low-latency interconnect for multi-node clusters and is configured automatically at cluster creation. The [InfiniBand&nbsp;networking](/edge-ai/networking/about-infiniband) article covers configuration details, SHARP protocol, and workload guidance.
...
4. **Resize**: Add or remove nodes on demand — new nodes inherit the cluster configuration. [Bare&nbsp;Metal&nbsp;GPU](/edge-ai/ai-infrastructure/manage-a-bare-metal-gpu-cluster) cluster management covers node resize operations.
