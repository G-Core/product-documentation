...
Gcore enables SHARP (Scalable Hierarchical Aggregation and Reduction Protocol) by default on InfiniBand clusters. It offloads collective operations to network switches, reducing latency for distributed AI and HPC workloads.
