...
ai-navigation: Deploy GPU clusters with Bare Metal GPU, Spot Bare Metal GPU, or Virtual GPU instance types, configured with NVIDIA H200, H100, A100, or L40S GPUs, InfiniBand or Ethernet interconnect, and NVMe storage for distributed LLM training, inference, and HPC workloads.
---
...
<Frame>
  ![GPU Cloud create cluster page showing region selection, cluster type, and GPU configuration options](/images/docs/edge-ai/ai-infrastructure/about-gpu-cloud/about-gpu-cloud-image1.png)
</Frame>
