...
5. Under **Application modules**, check the **Open WebUI** checkbox.
   ...
   <Frame>![Deployment form with Open WebUI module enabled](/images/docs/edge-ai/everywhere-inference/ai-models/chat-with-open-webui/chat-with-open-webui-image1.png)</Frame>
...
<Frame>![Deployment overview showing both endpoints](/images/docs/edge-ai/everywhere-inference/ai-models/chat-with-open-webui/chat-with-open-webui-image2.png)</Frame>
...
<Frame>![Open WebUI chat interface with model loaded](/images/docs/edge-ai/everywhere-inference/ai-models/chat-with-open-webui/chat-with-open-webui-image3.png)</Frame>
