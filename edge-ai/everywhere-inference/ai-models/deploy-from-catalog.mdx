...
The endpoint URL becomes available on the deployment detail page. Use it to send inference requests as described in [Query your deployed model](/edge-ai/everywhere-inference/ai-models/query-deployed-model).
