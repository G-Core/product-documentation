...
<Frame>![Deployments page showing the Deploy application from catalog and Deploy custom inference buttons](/images/docs/edge-ai/everywhere-inference/ai-models/deploy-from-catalog/deploy-from-catalog-image1.png)</Frame>
