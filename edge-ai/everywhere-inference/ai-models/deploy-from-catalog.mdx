...
<Frame>![Deployments page showing the Deploy application from catalog and Deploy custom inference buttons](/images/docs/edge-ai/everywhere-inference/ai-models/deploy-an-ai-model/deploy-a-custom-model-image1.png)</Frame>

### Step 2. Select an application

Under **Deployment Configuration**, click the **Application** dropdown and select the model to deploy.

<Frame>![Create Deployment form — Deployment Configuration and Routing placement sections](/images/docs/edge-ai/everywhere-inference/ai-models/deploy-from-catalog/deploy-from-catalog-image2.png)</Frame>
...
<Frame>![Application modules section showing Parameters and Open WebUI module](/images/docs/edge-ai/everywhere-inference/ai-models/deploy-from-catalog/deploy-from-catalog-image3.png)</Frame>
...
<Frame>![Open WebUI module enabled showing Expose, Flavor type, Flavor, and pod count settings](/images/docs/edge-ai/everywhere-inference/ai-models/deploy-from-catalog/deploy-from-catalog-image4.png)</Frame>
...
<Frame>![Additional options section with Enable API Key authentication toggle enabled and API key selector](/images/docs/edge-ai/everywhere-inference/ai-models/deploy-from-catalog/deploy-from-catalog-image5.png)</Frame>
