...
<Frame>![Deployment detail page](/images/docs/edge-ai/everywhere-inference/ai-models/manage-ai-model-deployments/manage-ai-model-deployments-image1.png)</Frame>
...
<Frame>![Monitoring tab showing CPU Usage, Memory Usage, Disk I/O, and GPU Utilization charts](/images/docs/edge-ai/everywhere-inference/ai-models/manage-ai-model-deployments/manage-ai-model-deployments-image2.png)</Frame>
...
<Frame>![Logs tab overview](/images/docs/edge-ai/everywhere-inference/ai-models/manage-ai-model-deployments/manage-ai-model-deployments-image3.png)</Frame>
...
<Frame>![Settings tab — routing and flavor configuration](/images/docs/edge-ai/everywhere-inference/ai-models/manage-ai-model-deployments/manage-ai-model-deployments-image4.png)</Frame>
...
<Frame>![Settings tab — pod configuration](/images/docs/edge-ai/everywhere-inference/ai-models/manage-ai-model-deployments/manage-ai-model-deployments-image5.png)</Frame>
