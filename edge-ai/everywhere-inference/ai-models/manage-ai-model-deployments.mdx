...
ai-navigation: View and modify AI model deployment configurations, endpoint URLs, replica status, hardware settings, autoscaling parameters, and environment variables in Ev
ai-navigation: Manage AI model deployments: view status, endpoint URLs, replica locations, hardware, autoscaling, environment variables; start, stop, delete.
---
