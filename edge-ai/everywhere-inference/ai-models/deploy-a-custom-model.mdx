...
The endpoint URL becomes available on the deployment detail page. Use it to send inference requests as described in [Query your deployed model](/edge-ai/everywhere-inference/ai-models/query-deployed-model). Logs, compute settings, and other deployment options are available on the [deployment detail page](/edge-ai/everywhere-inference/ai-models/manage-ai-model-deployments).
