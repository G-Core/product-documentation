...
<Frame>![API Keys page](/images/docs/edge-ai/everywhere-inference/api-keys/create-inference-deployment-with-auth/create-inference-deployment-with-auth-image1.png)</Frame>
...
<Frame>![Add API Key dialog](/images/docs/edge-ai/everywhere-inference/api-keys/create-inference-deployment-with-auth/create-inference-deployment-with-auth-image2.png)</Frame>

Click **Add**. The key value appears once — copy it immediately and store it securely. It cannot be retrieved later.

<Frame>![API key value shown once after creation](/images/docs/edge-ai/everywhere-inference/api-keys/create-inference-deployment-with-auth/create-inference-deployment-with-auth-image3.png)</Frame>
...
<Frame>![Enable API Key authentication toggle with key selected](/images/docs/edge-ai/everywhere-inference/api-keys/create-inference-deployment-with-auth/create-inference-deployment-with-auth-image4.png)</Frame>
...
<Frame>![API Keys authentication tab on deployment detail page](/images/docs/edge-ai/everywhere-inference/api-keys/create-inference-deployment-with-auth/create-inference-deployment-with-auth-image5.png)</Frame>
