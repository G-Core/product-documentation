...
ai-navigation: Deploy inference instances with authorization enabled, generate API keys, and authenticate requests using the Authorization header.
ai-navigation: Create inference deployment with authorization enabled and retrieve API Key for client authentication via header.
---
