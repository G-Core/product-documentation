...
description: Configure private and public container image registries in Everywhere Inference with authentication credentials for custom model deployments.
---
