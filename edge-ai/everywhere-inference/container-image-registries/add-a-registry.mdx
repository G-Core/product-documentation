...
<Frame>![Registries page with Add registry button](/images/docs/edge-ai/everywhere-inference/container-image-registries/add-a-registry/add-a-registry-image1.png)</Frame>

Fill in the four fields in the **Add registry** dialog and click **Add**.

<Frame>![Add registry dialog filled with Docker Hub example values](/images/docs/edge-ai/everywhere-inference/container-image-registries/add-a-registry/add-a-registry-image2.png)</Frame>
