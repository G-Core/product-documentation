...
ai-navigation: Deploy AI models for inference using Gcore Everywhere Inference via Customer Portal or API, or create GPU clusters for model training with Gcore GPU Cloud and bare-metal infrastructure.
---
...
**If you want to train AI models**, check out or guide on [creating an AI cluster](/edge-ai/ai-infrastructure/create-a-bare-metal-gpu-cluster) to set up an AI cluster with the [Gcore GPU Cloud](https://gcore.com/cloud/ai-gpu) via the Gcore Customer Portal.

<Tip>
**Tip**

Check out [our API docs](/api-reference/cloud/gpu-virtual/list-virtual-gpu-clusters) if you want to control your GPU resources programmatically.
</Tip>
...
Check out [our API docs](/api-reference/cloud/everywhere-inference/list-inference-deployments) if you want to control your inference resources programmatically.
</Tip>