...
<Frame>![Create a storage](/images/docs/storage/create-storage/create-an-s3-or-sftp-storage-image1.png)</Frame>
...
<Frame>![Delete storage](/images/docs/storage/create-storage/create-an-s3-or-sftp-storage-image2.png)</Frame>
...
<Frame>![create an SFTP storage,](/images/docs/storage/create-storage/create-an-s3-or-sftp-storage-image3.png)</Frame>
...
<Frame>![Dropdown](/images/docs/storage/create-storage/create-an-s3-or-sftp-storage-image4.png)</Frame>
...
<Frame>![Edit popup](/images/docs/storage/create-storage/create-an-s3-or-sftp-storage-image5.png)</Frame>
