...
ai-navigation: Create and manage S3 Standard, S3 Fast, or SFTP storage via Customer Portal, REST API, or Terraform - covers creation, access keys, SFTP password updates, and deletion.
---
