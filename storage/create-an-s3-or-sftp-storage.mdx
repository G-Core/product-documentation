...
ai-navigation: Create S3 Standard, S3 Fast, or SFTP storage with access keys, SSH keys, password authentication, and configure server aliases and Expires headers.
ai-navigation: Create Object Storage (S3 Standard, S3 Fast) or SFTP storage with name, location, authentication method, and access keys.
---
