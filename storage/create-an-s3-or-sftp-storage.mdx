...
<Frame>![Storage list showing orange and green status circles next to storage entries](/images/docs/storage/create-storage/storage-status-indicator-60.png)</Frame>
