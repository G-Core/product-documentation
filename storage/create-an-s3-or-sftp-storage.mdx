...
<Frame>![Create a storage](/images/docs/storage/create-an-s3-or-sftp-storage/s3-storage-created-10.png)</Frame>
...
<Frame>![Delete storage](/images/docs/storage/create-an-s3-or-sftp-storage/s3-storage-settings-20.png)</Frame>
...
<Frame>![create an SFTP storage,](/images/docs/storage/create-an-s3-or-sftp-storage/sftp-storage-created-30.png)</Frame>
...
<Frame>![Dropdown](/images/docs/storage/create-an-s3-or-sftp-storage/sftp-storage-settings-40.png)</Frame>
...
<Frame>![Edit popup](/images/docs/storage/create-an-s3-or-sftp-storage/sftp-expires-header-50.png)</Frame>
