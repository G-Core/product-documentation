...
<Steps>
  ...
  <Step title="Enter storage details">
    ...
    <Frame>![Add new object storage dialog with Name and Location fields](/images/docs/storage/create-storage/add-object-storage-dialog.png)</Frame>
...
Each S3 storage supports up to 1000 buckets and 10 million objects per bucket. For optimal performance, keep under 100K objects per bucket and distribute data across multiple buckets.

In the **Location** dropdown, select an **S3 Standard** or **S3 Fast** location, then click **Create** at the bottom of the dialog.

<Frame>![Location dropdown in the Add new object storage dialog showing S3 and SFTP location options](/images/docs/storage/create-storage/location-dropdown.png)</Frame>
...
<Frame>![Details dialog showing S3 storage credentials including access key, secret key, and hostname](/images/docs/storage/create-storage/s3-storage-created-10.png)</Frame>
...
<Frame>![Object storage list with actions dropdown showing Details, Generate new keys, Buckets, and Delete object storage](/images/docs/storage/create-storage/s3-storage-settings-20.png)</Frame>
...
<Steps>
  ...
  <Step title="Create">
    ...
    <Frame>![Add new object storage dialog with SFTP Amsterdam location and password authentication fields](/images/docs/storage/create-storage/sftp-storage-created-30.png)</Frame>
  </Step>
</Steps>
...
<Frame>![SFTP storage actions dropdown showing Details, Edit, password management, SSH keys manager, and Delete options](/images/docs/storage/create-storage/sftp-storage-settings-40.png)</Frame>

#### Edit dialog

The **Edit** dialog for SFTP storage has two fields. Open it by clicking **...** > **Edit** next to the storage name.

<Frame>![Edit dialog for SFTP storage with Server alias and Expires fields](/images/docs/storage/create-storage/sftp-expires-header-50.png)</Frame>
