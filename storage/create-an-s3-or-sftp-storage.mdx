...
<p>Store the secret key, because it is returned only when a key is created. Additional [access keys](/storage/manage-object-storage/manage-s3-access-keys) can be created after the storage exists.</p>
