...
ai-navigation: View storage usage metrics (used space, requests, traffic) in Statistics section with filtering by storage type, location, and custom time periods.
ai-navigation: View storage usage reports by used space, requests, traffic metrics; filter by storage type, location, time period in Statistics section.
---
