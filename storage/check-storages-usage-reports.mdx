...
description: View storage usage metrics (used space, requests, traffic) in Statistics section with filtering by storage type, location, and custom time periods.
---
