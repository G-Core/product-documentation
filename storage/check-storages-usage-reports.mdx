...
ai-navigation: View storage usage reports in Statistics section with metrics for used space, requests, and traffic; filter by time period (day, week, month, year, custom), storage type (Object Storage, SFTP Storage), location, and name; data aggregates hourly max and average values.
---
...
<Frame>![Check storages usage reports](/images/docs/storage/check-storages-usage-reports/check-storages-usage-reports-image1.png)</Frame>
