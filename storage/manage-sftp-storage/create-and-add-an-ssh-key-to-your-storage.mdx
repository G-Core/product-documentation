...
description: Upload SSH keys for SFTP storage authentication by pasting key text or importing from file, then assign keys to storages via SSH keys manager.
---
