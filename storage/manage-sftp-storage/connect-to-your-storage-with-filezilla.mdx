...
ai-navigation: Configure FileZilla SFTP connection to Gcore storage using hostname, port 2200, and password or SSH key authentication.
ai-navigation: Configure SFTP connection in FileZilla with hostname, port 2200, storage name user, password or SSH key authentication.
---
