...
ai-navigation: Request files from object storage and SFTP storage using HTTP/HTTPS URLs with bucket names, hostnames, and file paths.
ai-navigation: Request content from Object Storage and SFTP Storage using HTTP/HTTPS URLs with bucket name, hostname, and file path.
---
