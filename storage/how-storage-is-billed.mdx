...
High-performance storage optimized for AI/ML workloads and latency-sensitive applications. Available in Sines-2, Sines-3, and London-2.
...
<Info>
For current pricing and plan details, see the [pricing page](https://gcore.com/pricing/storage).
</Info>
