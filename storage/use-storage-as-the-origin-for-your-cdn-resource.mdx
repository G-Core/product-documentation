...
ai-navigation: Configure Object Storage or SFTP as CDN origin with bucket paths, authentication options, and custom domain setup for content delivery.
ai-navigation: Create CDN resource with Object Storage or SFTP storage as origin, specify bucket path and custom domain.
---
