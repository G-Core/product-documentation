...
<Frame>![link ](/images/docs/storage/manage-s3-storage/generate-a-presigned-url/generate-temporary-links-to-files-with-aws-cli-and-s3cmd-image1.png)</Frame>
...
<Frame>![AccessDenied](/images/docs/storage/manage-s3-storage/generate-a-presigned-url/generate-temporary-links-to-files-with-aws-cli-and-s3cmd-image2.png)</Frame>
