...
<Steps>
  ...
  <Step title="Create a key">
    Click **Create read-write key** or **Create read-only key**. The dialog shows the access key and secret key. Click **Copy credentials** and store both values, because the secret is shown only once.
