...
Vanity nameservers and white label replace the default `ns1.gcorelabs.net` and `ns2.gcdn.services` nameservers with custom ones, available on the Enterprise plan. To enable either feature, contact [Gcore support](mailto:support@gcore.com).
