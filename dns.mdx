---
title: Managed DNS
ai-navigation: Manage DNS zones and records using Gcore Managed DNS with Anycast routing, geo-balancing, health checks, DNSSEC, and OctoDNS and Certbot plugin integration.
---

Welcome to the [Gcore Managed DNS](https://gcore.com/dns) documentation page! Here we explain how to use and configure Gcore's Managed DNS.
