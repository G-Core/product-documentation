...
ai-navigation: Configure A, MX, PTR, and SPF TXT records in Gcore Managed DNS to enable email delivery, prevent spoofing, and block phishing via reverse DNS verification and Sender Policy Framework.
---
...
<Frame>![Adding an A record](/images/docs/dns/dns-records/set-up-dns-for-sending-email/set-up-dns-for-sending-email-image1.png)</Frame>
...
<Frame>![Adding an MX record](/images/docs/dns/dns-records/set-up-dns-for-sending-email/set-up-dns-for-sending-email-image2.png)</Frame>
...
<Frame>![Adding a TXT record](/images/docs/dns/dns-records/set-up-dns-for-sending-email/set-up-dns-for-sending-email-image3.png)</Frame>
...
<Frame>![Adding a TXT DMARC record](/images/docs/dns/dns-records/set-up-dns-for-sending-email/set-up-dns-for-sending-email-image4.png)</Frame>
