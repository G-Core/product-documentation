...
<Frame>![Adding an A record](/images/docs/dns/dns-records/set-up-dns-for-sending-email/email-records-10.png)</Frame>
...
<Frame>![Adding an MX record](/images/docs/dns/dns-records/set-up-dns-for-sending-email/email-records-20.png)</Frame>
...
<Frame>![Adding a TXT record](/images/docs/dns/dns-records/set-up-dns-for-sending-email/email-records-30.png)</Frame>
...
<Frame>![Adding a TXT DMARC record](/images/docs/dns/dns-records/set-up-dns-for-sending-email/email-records-40.png)</Frame>
