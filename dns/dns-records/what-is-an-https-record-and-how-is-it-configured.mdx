...
ai-navigation: Create HTTPS records in Gcore Managed DNS to provide protocol versions, IPv4/IPv6 addresses, and alternate servers in a single DNS query, reducing connection round trips and TLS negotiation latency.
---
...
1\. Navigate to [DNS](https://portal.gcore.com/dns/zones) in the Gcore Customer Portal. Click on the zone of the domain where you wish to add the HTTPS record.


<Frame>![All zones](/images/docs/dns/dns-records/what-is-an-https-record-and-how-is-it-configured/what-is-an-https-record-and-how-is-it-configured-image1.png)</Frame>
...
<Frame>![Add a record](/images/docs/dns/dns-records/what-is-an-https-record-and-how-is-it-configured/what-is-an-https-record-and-how-is-it-configured-image2.png)</Frame>
...
<Frame>![attribute configurations](/images/docs/dns/dns-records/what-is-an-https-record-and-how-is-it-configured/what-is-an-https-record-and-how-is-it-configured-image3.png)</Frame>
...
<Frame>![record ](/images/docs/dns/dns-records/what-is-an-https-record-and-how-is-it-configured/what-is-an-https-record-and-how-is-it-configured-image4.png)</Frame>
