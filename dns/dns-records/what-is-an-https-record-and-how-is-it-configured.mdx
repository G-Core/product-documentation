...
description: Configure HTTPS DNS records in Gcore Managed DNS to reduce TLS handshake round trips and communicate protocol versions, ports, and alternate servers via sing...
---
