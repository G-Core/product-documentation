...
ai-navigation: Create and manage DNS records (A, AAAA, CNAME, MX, TXT, CAA, NS, SRV, HTTPS) in Gcore Customer Portal with TTL configuration and wildcard support.
ai-navigation: Create A, AAAA, NS, CNAME, MX, SRV, HTTPS, TXT, CAA DNS records with Name, TTL, and Value fields in Gcore Managed DNS zones.
---
