...
description: Configure DNS dynamic response using pickers (GeoDistance, Weighted shuffle, ASN, Country, Continent, Region, IP) to deliver different records based on query...
---
