...
ai-navigation: Configure dynamic DNS responses using pickers (GeoDistance, Weighted shuffle, ASN, Country, Continent, Region, IP) and metadata to deliver different records based on user geolocation, autonomous system number, subnet, weight probability, or failover criteria in Gcore Managed DNS.
---
...
<Frame>![Dynamic response configuration](/images/docs/dns/dns-records/configure-weight-balancing-and-geobalancing/configure-weight-balancing-and-geobalancing-image1.png)</Frame>
...
<Tabs>
  <Tab title="Geo DNS">
    ...
    **Example** : You selected the "Geo DNS" preset, specified one record per response in the First N.
    ...
    <Frame>![Configure Geo DNS preset](/images/docs/dns/dns-records/configure-weight-balancing-and-geobalancing/configure-weight-balancing-and-geobalancing-image2.png)</Frame>
    ...
    <Frame>![Configure metadata](/images/docs/dns/dns-records/configure-weight-balancing-and-geobalancing/configure-weight-balancing-and-geobalancing-image3.png)</Frame>
  ...
  <Tab title="Geo distance">
    ...
    **Example**. You selected the "Geo distance" preset and specified one record per response in the First N.
    ...
    <Frame>![Configure Geo distance preset](/images/docs/dns/dns-records/configure-weight-balancing-and-geobalancing/configure-weight-balancing-and-geobalancing-image4.png)</Frame>
    ...
    <Frame caption="The orange color shows where two zones are close together, while the red and yellow show distinct zones">![Configure metadata](/images/docs/dns/dns-records/configure-weight-balancing-and-geobalancing/configure-weight-balancing-and-geobalancing-image5.png)</Frame>
  ...
  <Tab value="Weighted shuffle">
    ...
    **Example**. You enabled the "Weighted shuffle" preset and specified max one record per response in the First N:
    ...
    <Frame>![Configure Weighted shuffle picker](/images/docs/dns/dns-records/configure-weight-balancing-and-geobalancing/configure-weight-balancing-and-geobalancing-image6.png)</Frame>
    ...
    <Frame>![Configure records for weighted shuffle usage](/images/docs/dns/dns-records/configure-weight-balancing-and-geobalancing/configure-weight-balancing-and-geobalancing-image7.png)</Frame>
