...
description: Configure A/AAAA DNS records to resolve directly to Gcore CDN addresses, eliminating CNAME configuration and enabling automatic routing to optimal CDN endpoi...
---
