...
ai-navigation: Configure A/AAAA DNS records to resolve directly to Gcore CDN addresses, eliminating CNAME configuration and enabling automatic routing to optimal CDN endpoi
ai-navigation: Configure A/AAAA DNS records for CDN integration to resolve directly to Gcore CDN addresses without CNAME.
---
