...
description: Create DNS record sets (RRSets) with A, AAAA, NS, CNAME, MX, SRV, HTTPS, TXT, CAA types in Gcore Managed DNS advanced interface mode with TTL configuration.
---
