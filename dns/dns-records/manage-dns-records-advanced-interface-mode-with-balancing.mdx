...
<Frame>![How to ensure that advanced more is enabled](/images/docs/dns/dns-records/manage-dns-records-advanced-interface-mode-with-balancing/manage-dns-records-advanced-interface-mode-with-balancing-image2.png)</Frame>
...
<Frame>![Adding a record set \(RRset\)](/images/docs/dns/dns-records/manage-dns-records-advanced-interface-mode-with-balancing/manage-dns-records-advanced-interface-mode-with-balancing-image3.png)</Frame>
...
<Frame>![How to configure RRSets in advanced mode](/images/docs/dns/dns-records/manage-dns-records-advanced-interface-mode-with-balancing/manage-dns-records-advanced-interface-mode-with-balancing-image4.png)</Frame>
...
<Frame>![Manage DNS records](/images/docs/dns/dns-records/manage-dns-records-advanced-interface-mode-with-balancing/manage-dns-records-advanced-interface-mode-with-balancing-image5.png)</Frame>
