...
ai-navigation: Create PTR records in reverse DNS zones (in-addr.arpa for IPv4, ip6.arpa for IPv6) to map IP addresses to hostnames for anti-spam email authentication and subnet tracing via Gcore Managed DNS.
---
...
<Frame>![Configure reverse DNS zone and PTR record](/images/docs/dns/dns-records/set-up-a-ptr-record-and-reverse-dns-zone/set-up-a-ptr-record-and-reverse-dns-zone-image1.png)</Frame>
...
<Frame>![Configure reverse DNS zone and PTR record](/images/docs/dns/dns-records/set-up-a-ptr-record-and-reverse-dns-zone/set-up-a-ptr-record-and-reverse-dns-zone-image2.png)</Frame>
