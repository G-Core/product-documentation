...
<Frame>![Configure reverse DNS zone and PTR record](/images/docs/dns/dns-records/set-up-a-ptr-record-and-reverse-dns-zone/add-ptr-record-10.png)</Frame>
...
<Frame>![Configure reverse DNS zone and PTR record](/images/docs/dns/dns-records/set-up-a-ptr-record-and-reverse-dns-zone/added-record-20.png)</Frame>
