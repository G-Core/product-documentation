...
ai-navigation: Export DNS records to BIND zone files (.zone format) containing domain name, TTL, RRset, refresh/update/expiry intervals, and authoritative NS servers, or import records from .zone files into Gcore Managed DNS zones.
---
...
<Frame>![Import or export records](/images/docs/dns/dns-records/import-and-export-records/import-and-export-records-image2.png)</Frame>
...
<Tabs>
  ...
  <Tab title="Import">
    ...
    <Frame>![Import records](/images/docs/dns/dns-records/import-and-export-records/import-and-export-records-image3.png)</Frame>
  </Tab>
</Tabs>
