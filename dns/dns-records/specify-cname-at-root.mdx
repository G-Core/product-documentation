...
<Frame>![Delete an A record](/images/docs/dns/dns-records/specify-cname-at-root/records-in-the-apex-root.png)</Frame>
...
<Frame>![Ada a CNAME record to apex zone](/images/docs/dns/dns-records/specify-cname-at-root/cname-flattening.png)</Frame>
