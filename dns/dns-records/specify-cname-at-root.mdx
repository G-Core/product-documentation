...
ai-navigation: Configure CNAME flattening in Gcore Managed DNS to create CNAME records at zone apex by removing A records and resolving CNAME chains to IP addresses.
ai-navigation: Create CNAME record at zone apex using CNAME flattening to resolve root domain without RFC 1034 conflicts.
---
