...
ai-navigation: Create CNAME records at zone apex using CNAME flattening in Gcore Managed DNS to resolve CNAME chains to final A or AAAA records, bypassing RFC 1034 restrictions that prevent CNAME coexistence with NS and SOA records.
---
...
<Frame>![Delete an A record](/images/docs/dns/dns-records/specify-cname-at-root/specify-cname-at-root-image1.png)</Frame>
...
<Frame>![Ada a CNAME record to apex zone](/images/docs/dns/dns-records/specify-cname-at-root/specify-cname-at-root-image2.png)</Frame>
