...
description: Configure CNAME flattening in Gcore Managed DNS to create CNAME records at zone apex by removing A records and resolving CNAME chains to IP addresses.
---
