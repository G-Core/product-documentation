...
1\. In the [Gcore Customer Portal](https://portal.gcore.com), navigate to **DNS** → **Managed DNS**, click the zone name, and open the **Records** tab.

2\. Click the delete icon next to the A record for the root domain. In the **Delete record** dialog, click **Yes, delete**.
...
3\. Click **Add record** and configure the new record:
   - Set **Type** to **CNAME**.
