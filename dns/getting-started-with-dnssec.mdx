...
<Tabs>
  <Tab title="DNS API">
    ...
    1\. [Create a domain zone](/api-reference/dns/zones/create-zone) for which you want to use DNSSEC using the following API request:
    ...
    **Tip**
    ...
    2\. [Create an RRSet](/api-reference/dns/rrsets/create-rrset) using the following API request:
