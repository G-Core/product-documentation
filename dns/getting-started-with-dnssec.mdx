...
| `pending-disabled` | Disable was requested, but a DS record is still published at the registrar. | Transitional disable state (distinct from fully disabled) | Remove the DS record at the registrar to complete the process. |
