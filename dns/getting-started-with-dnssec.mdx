...
<Tabs>
  ...
  <Tab title="Customer Portal">
    ...
    <Frame>![Enable DNSSEC](/images/docs/dns/getting-started-with-dnssec/getting-started-with-dnssec-image1.png)</Frame>
    ...
    <Frame>![Copy the DS record](/images/docs/dns/getting-started-with-dnssec/getting-started-with-dnssec-image2.png)</Frame>
