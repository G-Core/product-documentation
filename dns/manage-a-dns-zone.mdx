...
<Frame>![The All zones page](/images/docs/dns/manage-a-dns-zone/manage-a-dns-zone-image1.png)</Frame>
...
<Frame>![The specify domain page](/images/docs/dns/manage-a-dns-zone/manage-a-dns-zone-image2.png)</Frame>
...
<Frame>![The existing DNS records page](/images/docs/dns/manage-a-dns-zone/manage-a-dns-zone-image3.png)</Frame>
...
<Frame>![The change nameservers page](/images/docs/dns/manage-a-dns-zone/manage-a-dns-zone-image4.png)</Frame>
...
<Frame>![The change nameservers notion](/images/docs/dns/manage-a-dns-zone/manage-a-dns-zone-image5.png)</Frame>
</Warning>
...
<Frame>![Manage DNS zones](/images/docs/dns/manage-a-dns-zone/manage-a-dns-zone-image6.png)</Frame>