...
description: Create DNS zones in Gcore Customer Portal or API, configure NS records, and manage DNS records with TTL settings via the managed DNS infrastructure.
---
