...
ai-navigation: Create DNS zones in Gcore Customer Portal or API, configure NS records, and manage DNS records with TTL settings via the managed DNS infrastructure.
ai-navigation: Create DNS zones in Gcore Managed DNS portal, specify NS servers, manage records and TTL settings.
---
