...
For ongoing monitoring of individual A, AAAA, or CNAME records after delegation succeeds, configure [DNS Healthchecks](/dns/dns-failover/configure-and-use-dns-failover).
