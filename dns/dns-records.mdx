...
DNS records are instructions stored in a zone file that tell resolvers how to handle queries for a domain — mapping domain names to IP addresses, delegating authority to name servers, configuring mail delivery, restricting certificate issuance, and more. [Gcore Managed DNS](https://gcore.com/dns) supports eleven record types, each described below with an example response and a field breakdown.


<Frame>![Supported DNS record types](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-10.png)</Frame>
...
<Frame>![Example of adding an A record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-20.png)</Frame>
...
<Frame>![Example of adding an AAAA record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-30.png)</Frame>



## NS record

An NS record defines the name of the authoritative name servers (primary and secondary are mandatory) for a domain zone. [Gcore Managed DNS](https://gcore.com/dns) provides the following name servers: _ns1.gcorelabs.net_ and _ns2.gcdn.services_.
...
<Frame>![Example of adding an NS record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-40.png)</Frame>
...
<Frame>![Example of adding an CNAME record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-50.png)</Frame>
...
<Frame>![Example of adding an MX record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-60.png)</Frame>
...
<Frame>![Example of adding a TXT record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-70.png)</Frame>
...
<Frame>![Example of adding a SRV record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-80.png)</Frame>
...
<Frame>![Example of adding a CAA record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-90.png)</Frame>
...
<Frame>![Example of adding an HTTPS record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-100.png)</Frame>
...
<Frame>![Example of adding an SVCB record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-110.png)</Frame>
