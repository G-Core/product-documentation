...
description: Reference eleven supported DNS record types in Gcore Managed DNS: A, AAAA, NS, CNAME, MX, TXT, SRV, CAA, PTR, SOA, and SPF with TTL and class parameters.
---
