...
ai-navigation: Reference eleven supported DNS record types in Gcore Managed DNS: A, AAAA, NS, CNAME, MX, TXT, SRV, CAA, PTR, SOA, and SPF with TTL and class parameters.
ai-navigation: Create A, AAAA, NS, CNAME DNS record types in Gcore Managed DNS with IPv4, IPv6, nameserver, and alias values.
---
