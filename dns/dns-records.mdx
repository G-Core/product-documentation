...
ai-navigation: Create A, AAAA, NS, CNAME, MX, TXT, SRV, SOA, CAA, TLSA, and PTR records in Gcore Managed DNS with TTL, class, and IPv4/IPv6 address values.
---
...
<Frame>![Supported DNS record types](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-image1.png)</Frame>
...
<Frame>![Example of adding an A record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-image2.png)</Frame>
...
<Frame>![Example of adding an AAAA record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-image3.png)</Frame>
...
<Frame>![Example of adding an NS record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-image4.png)</Frame>
...
<Frame>![Example of adding an CNAME record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-image5.png)</Frame>
...
<Frame>![Example of adding an MX record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-image6.png)</Frame>
...
<Frame>![Example of adding a TXT record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-image7.png)</Frame>
...
<Frame>![Example of adding a SRV record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-image8.png)</Frame>
...
<Frame>![Example of adding a CAA record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-image9.png)</Frame>
...
<Frame>![Example of adding an HTTPS record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-image10.png)</Frame>
...
<Frame>![Example of adding an SVCB record](/images/docs/dns/dns-records/supported-dns-record-types/dns-records-image11.png)</Frame>
