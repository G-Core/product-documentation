...
[Gcore Managed DNS](https://gcore.com/dns) supports eleven record types. Each section below describes one type with an example response and a field breakdown.
...
To add records, follow the guide on [managing&nbsp;records](/dns/dns-records/manage-dns-records-non-advanced-interface-mode).