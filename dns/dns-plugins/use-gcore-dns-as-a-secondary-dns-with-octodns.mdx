...
ai-navigation: Configure Gcore Managed DNS as secondary DNS using OctoDNS to synchronize DNS zones and records from primary DNS providers via Python virtual environment, pip package installation, and YAML configuration file with provider credentials.
---
...
<Frame>![Synchronize records of Gcore DNS with your DNS](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/use-gcore-dns-as-a-secondary-dns-with-octodns-image1.png)</Frame>
...
<Frame>![create a necessary DNS zone manually](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/use-gcore-dns-as-a-secondary-dns-with-octodns-image2.png)</Frame>
...
<Frame>![configuration file](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/use-gcore-dns-as-a-secondary-dns-with-octodns-image3.png)</Frame>
...
<Frame>![providers ](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/use-gcore-dns-as-a-secondary-dns-with-octodns-image1.png)</Frame>
...
<Frame>![Configuration](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/use-gcore-dns-as-a-secondary-dns-with-octodns-image2.png)</Frame>
...
<Frame>![DNS zones data](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/use-gcore-dns-as-a-secondary-dns-with-octodns-image2.png)</Frame>
...
<Frame>![configuration file](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/use-gcore-dns-as-a-secondary-dns-with-octodns-image4.png)</Frame>
...
<Frame>![output](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/use-gcore-dns-as-a-secondary-dns-with-octodns-image5.png)</Frame>



It means the changes have been made. You can see the updated list of records in the Gcore Customer Portal on the [DNS page](https://portal.gcore.com/dns/zones).


<Frame>![DNS page in the Gcore Customer Portal](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/use-gcore-dns-as-a-secondary-dns-with-octodns-image6.png)</Frame>
...
<Frame>![output](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/use-gcore-dns-as-a-secondary-dns-with-octodns-image7.png)</Frame>
