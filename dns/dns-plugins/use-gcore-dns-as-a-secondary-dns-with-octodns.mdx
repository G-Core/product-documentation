...
description: Configure Gcore managed DNS as secondary DNS using OctoDNS to synchronize zone records from primary DNS providers via Python virtualenv and YAML configuration.
---
