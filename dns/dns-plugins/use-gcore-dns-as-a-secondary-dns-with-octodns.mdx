...
<Frame>![Synchronize records of Gcore DNS with your DNS](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/mceclip3.png)</Frame>
...
<Frame>![create a necessary DNS zone manually](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/mceclip0.png)</Frame>
...
<Frame>![configuration file](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/mceclip1.png)</Frame>
...
<Frame>![providers ](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/mceclip3.png)</Frame>
...
<Frame>![Configuration](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/mceclip0.png)</Frame>
...
<Frame>![DNS zones data](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/mceclip0.png)</Frame>
...
<Frame>![configuration file](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/mceclip6.png)</Frame>
...
<Frame>![output](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/mceclip7.png)</Frame>
...
<Frame>![DNS page in the Gcore Customer Portal](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/mceclip8.png)</Frame>
...
<Frame>![output](/images/docs/dns/dns-plugins/use-gcore-dns-as-a-secondary-dns-with-octodns/mceclip9.png)</Frame>
