...
ai-navigation: Create and manage Gcore Managed DNS zones and records using Terraform gcore_dns_zone and gcore_dns_record resources, supporting A, AAAA, CNAME, MX, TXT, SRV, CAA record types, DNSSEC, SOA parameters, webhook notifications, and geo-balancing with continent and country blocks.
---
