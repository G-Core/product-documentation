...
For more information, refer to [Configure and use DNS failover](/dns/dns-failover/configure-and-use-dns-failover).

## Import existing DNS resources

If you already have DNS zones and records configured in the Gcore Customer Portal, you can import them into your Terraform state.
