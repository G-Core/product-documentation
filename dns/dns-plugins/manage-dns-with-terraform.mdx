...
Health checks — part of [DNS failover](/dns/dns-failover/configure-and-use-dns-failover) — automatically remove unhealthy records from DNS responses, directing traffic only to reachable endpoints.
