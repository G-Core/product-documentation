...
description: Configure Gcore DNS zones and records using Terraform provider with gcore_dns_zone and gcore_dns_record resources, supporting A, CNAME, MX, TXT, CAA records,...
---
