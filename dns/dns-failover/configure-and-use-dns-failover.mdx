...
ai-navigation: Configure DNS Healthchecks to monitor server availability and exclude non-responding IPs from DNS responses, supporting round-robin and Geobalancing load distribution across multiple servers.
---
...
<Frame>![Healthchecks scheme: both servers work](/images/docs/dns/dns-failover/about-dns-failover/configure-and-use-dns-failover-image1.png)</Frame>
...
<Frame>![Healthchecks scheme: one server is broken](/images/docs/dns/dns-failover/about-dns-failover/configure-and-use-dns-failover-image2.png)</Frame>
...
<Frame>![Healthchecks scheme: redirecting requests to a working server](/images/docs/dns/dns-failover/about-dns-failover/configure-and-use-dns-failover-image3.png)</Frame>
...
<Frame>![Health Checks scheme](/images/docs/dns/dns-failover/about-dns-failover/configure-and-use-dns-failover-image4.png)</Frame>

<Frame>![Health Checks scheme](/images/docs/dns/dns-failover/about-dns-failover/configure-and-use-dns-failover-image5.png)</Frame>

<Frame>![Health Checks scheme](/images/docs/dns/dns-failover/about-dns-failover/configure-and-use-dns-failover-image6.png)</Frame>

<Frame>![Health Checks scheme](/images/docs/dns/dns-failover/about-dns-failover/configure-and-use-dns-failover-image7.png)</Frame>

<Frame>![Health Checks scheme](/images/docs/dns/dns-failover/about-dns-failover/configure-and-use-dns-failover-image8.png)</Frame>

<Frame>![Health Checks scheme](/images/docs/dns/dns-failover/about-dns-failover/configure-and-use-dns-failover-image9.png)</Frame>



## Configure healthchecks

1\. Navigate to the [DNS](https://portal.gcore.com/dns/zones) section in the Gcore Customer Portal.

2\. Click the domain name of the DNS zone where you intend to set up Healthchecks. 

<Frame>![Open a DNS zone](/images/docs/dns/dns-records/manage-dns-records-non-advanced-interface-mode/manage-dns-records-non-advanced-interface-mode-image1.png)</Frame>
...
<Frame>![Open a Records list/Edit record set page](/images/docs/dns/dns-failover/configure-and-use-dns-failover/configure-and-use-dns-failover-image11.png)</Frame>

The "Records list/Edit record set" page will open. Perform the remaining steps there.

<Frame>![Select a Healthchecks picker](/images/docs/dns/dns-failover/configure-and-use-dns-failover/configure-and-use-dns-failover-image12.png)</Frame>
...
<Tabs>
  <Tab title="TCP/UDP">
    <Frame>![Configure a Healthchecks picker: TCP or UDP](/images/docs/dns/dns-failover/configure-and-use-dns-failover/configure-and-use-dns-failover-image13.png)</Frame>
  ...
  <Tab title="ICMP">
    <Frame>![Configure a Healthchecks picker: ICMP](/images/docs/dns/dns-failover/configure-and-use-dns-failover/configure-and-use-dns-failover-image14.png)</Frame>
  ...
  <Tab value="HTTP">
    <Frame>![Configure a Healthchecks picker: HTTP](/images/docs/dns/dns-failover/configure-and-use-dns-failover/configure-and-use-dns-failover-image15.png)</Frame>
...
<Frame>![Configure backup metadata](/images/docs/dns/dns-failover/configure-and-use-dns-failover/configure-and-use-dns-failover-image16.png)</Frame>
...
<Frame>![Check monitoring logs](/images/docs/dns/dns-failover/configure-and-use-dns-failover/configure-and-use-dns-failover-image17.png)</Frame>