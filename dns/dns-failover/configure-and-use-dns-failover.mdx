...
<Frame>![Healthchecks scheme: both servers work](/images/docs/dns/dns-failover/about-dns-failover/health-checks-1.png)</Frame>
...
<Frame>![Healthchecks scheme: one server is broken](/images/docs/dns/dns-failover/about-dns-failover/health-checks-2.png)</Frame>
...
<Frame>![Healthchecks scheme: redirecting requests to a working server](/images/docs/dns/dns-failover/about-dns-failover/health-checks-3.png)</Frame>
...
<Frame>![Health Checks scheme](/images/docs/dns/dns-failover/about-dns-failover/health-checks-4.png)</Frame>

<Frame>![Health Checks scheme](/images/docs/dns/dns-failover/about-dns-failover/health-checks-5.png)</Frame>

<Frame>![Health Checks scheme](/images/docs/dns/dns-failover/about-dns-failover/health-checks-6.png)</Frame>

<Frame>![Health Checks scheme](/images/docs/dns/dns-failover/about-dns-failover/health-checks-7.png)</Frame>

<Frame>![Health Checks scheme](/images/docs/dns/dns-failover/about-dns-failover/health-checks-8.png)</Frame>

<Frame>![Health Checks scheme](/images/docs/dns/dns-failover/about-dns-failover/health-checks-9.png)</Frame>
