...
1. In the <a href="https://portal.gcore.com/accounts/reports/dashboard" target="_blank">Gcore Customer Portal</a>, open the **GPU cloud** page. You'll be taken to the page for AI cluster creation.
