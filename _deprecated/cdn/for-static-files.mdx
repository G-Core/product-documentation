...
Go to the <a href="https://portal.gcore.com/cdn/resources/list" target="_blank">CDN</a> page and click **Create CDN resource**. 
...
Provide additional information about the CDN resource. This will not affect any settings but will only be displayed in the <a href="https://portal.gcore.com/cdn/resources/list" target="_blank">CDN resources</a> section next to the resource CNAME.
