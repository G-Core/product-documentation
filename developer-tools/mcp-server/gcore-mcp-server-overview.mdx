...
<Frame>![Claude Code planning a VM creation: it resolved region, flavor, and image automatically and asked for confirmation before proceeding](/images/docs/developer-tools/mcp-server/gcore-mcp-server-overview/gcore-mcp-server-overview-image1.png)</Frame>
