...
<Frame>![Gcore MCP Server connected in Cursor IDE settings with dns.* tools listed](/images/docs/developer-tools/mcp-server/connect-cursor-to-gcore-mcp-server/connect-cursor-to-gcore-mcp-server-image1.png)</Frame>
...
<Frame>![Cursor IDE returning DNS zone details via Gcore MCP Server](/images/docs/developer-tools/mcp-server/connect-cursor-to-gcore-mcp-server/connect-cursor-to-gcore-mcp-server-image2.png)</Frame>
