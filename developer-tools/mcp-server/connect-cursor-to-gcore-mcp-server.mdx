...
<Frame>![Gcore MCP Server connected in Cursor IDE settings with dns.* tools listed](/images/docs/developer-tools/mcp-server/connect-cursor-to-gcore-mcp-server/cursor-mcp-connected.png)</Frame>
...
<Frame>![Cursor IDE returning DNS zone details via Gcore MCP Server](/images/docs/developer-tools/mcp-server/connect-cursor-to-gcore-mcp-server/cursor-dns-query.png)</Frame>
