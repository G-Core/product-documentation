...
<Frame>![MCP Inspector showing connection error: McpError MCP error -32001 Request timed out](/images/docs/developer-tools/mcp-server/test-tools-with-mcp-inspector/connection-error.png)</Frame>
...
<Frame>![MCP Inspector Tools tab showing available Gcore DNS tools with descriptions](/images/docs/developer-tools/mcp-server/test-tools-with-mcp-inspector/tools-list.png)</Frame>
...
<Frame>![MCP Inspector showing dns_zones_ls tool execution with JSON response containing zone details](/images/docs/developer-tools/mcp-server/test-tools-with-mcp-inspector/executing-tool.png)</Frame>
...
<Frame>![MCP Inspector server log showing Connected status and INFO logs with HTTP requests to Gcore API](/images/docs/developer-tools/mcp-server/test-tools-with-mcp-inspector/server-output.png)</Frame>
