...
<Frame>![Claude Code displaying CDN resource details returned by Gcore MCP Server](/images/docs/developer-tools/mcp-server/connect-claude-code-to-gcore-mcp-server/claude-code-cdn-resources.png)</Frame>
