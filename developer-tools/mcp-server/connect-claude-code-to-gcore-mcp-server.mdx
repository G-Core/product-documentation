...
<Frame>![Claude Code displaying CDN resource details returned by Gcore MCP Server](/images/docs/developer-tools/mcp-server/connect-claude-code-to-gcore-mcp-server/connect-claude-code-to-gcore-mcp-server-image1.png)</Frame>
