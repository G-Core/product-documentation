...
After configuring, verify which tools are exposed using [MCP Inspector](/developer-tools/mcp-server/test-tools-with-mcp-inspector). Connect with the desired `GCORE_TOOLS` value and view the Tools panel to count and verify the tool list.
