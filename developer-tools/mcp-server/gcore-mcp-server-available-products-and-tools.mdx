...
Use the filter pattern from the **Pattern** column to load tools for a specific product. See [Filter tools](/developer-tools/mcp-server/filter-tools-with-gcore-tools) for syntax details.
...
<Info>
Tool counts are approximate and may change as the [Gcore API](https://api.gcore.com/docs) evolves. Use [MCP Inspector](/developer-tools/mcp-server/test-tools-with-mcp-inspector) to browse exact tool names and parameter schemas for any product.
</Info>
