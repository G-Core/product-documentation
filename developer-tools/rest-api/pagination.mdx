...
`count` is the total across all pages, not the current page alone. Use it to determine how many pages remain.
...
Pagination parameters are documented on each list endpoint in the [API reference](/api-reference/cloud).
