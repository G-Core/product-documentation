...
| All platforms | `pip install httpie` |
...
The [REST Client](https://marketplace.visualstudio.com/items?itemName=humao.rest-client) extension for Visual Studio Code lets you write and send HTTP requests directly from a `.http` file in the editor. Requests live alongside the code that uses them and can be committed to version control.
...
|------|-----------|----------|
| **curl** | Terminal | Shell scripts, CI/CD, any platform |
