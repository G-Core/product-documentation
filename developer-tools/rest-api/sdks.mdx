...
The package supports both **synchronous** (`Gcore`) and **asynchronous** (`AsyncGcore`) usage. All examples in this section use the sync client. See [Async and sync support](#async-and-sync-support) for the async equivalent.
