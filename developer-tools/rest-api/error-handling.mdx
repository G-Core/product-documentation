...
ai-navigation: Gcore API errors return a consistent JSON structure with a machine-readable error type, a human-readable message, and a request ID for support; covers common error types, HTTP status codes, and retry strategy.
---
