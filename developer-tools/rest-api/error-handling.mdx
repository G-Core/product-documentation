...
ai-navigation: Gcore API error response structure with exception_class, message, and request_id fields; common error types including ValidationError, NotFoundError, QuotaLimitExceed, ForbiddenError, and HTTP 405; retry strategy by error type.
---
