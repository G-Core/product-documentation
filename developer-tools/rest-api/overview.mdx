...
The Gcore API covers Cloud, CDN, DNS, Storage, and every other product in the [Gcore Customer Portal](https://portal.gcore.com). This section explains how to authenticate, make calls, and handle the response patterns that appear across all endpoints.
