...
One API token authenticates to every Gcore product — Cloud, CDN, DNS, Storage, FastEdge, and others in the [Gcore Customer Portal](https://portal.gcore.com). Authentication, request format, and async response handling are consistent across all of them.
