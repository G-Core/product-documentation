...
ai-navigation: Gcore Cloud API write operations return a task ID while the operation runs in the background; explains how to poll the task endpoint for completion, read the created resource ID from the response, and handle errors and timeouts.
---
