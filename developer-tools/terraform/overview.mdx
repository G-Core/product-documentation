...
The v0 provider supports [Cloud resources](/cloud/manage-cloud-via-terraform) — Virtual Machines, Bare Metal servers, Kubernetes clusters, Load Balancers, and networks — [CDN resources](/cdn/terraform/manage-cdn-via-terraform), and [WAAP resources](/waap/manage-waap-via-terraform) — domains, security policies, and rules. For v2, the full resource reference is on the [Terraform Registry](https://registry.terraform.io/providers/G-Core/gcore/latest/docs).
