...
<Tabs>
  ...
  <Tab title="Provider v0">
    ...
    Replace `YOUR_PERMANENT_API_TOKEN` with a [permanent API token](/account-settings/api-tokens). Check [Terraform Registry](https://registry.terraform.io/providers/G-Core/gcore/latest) for the latest v0 release. The `~> 0.34` notation allows patch updates within v0.34.
  </Tab>
</Tabs>
