...
pageTitle: What Healthchecks Are and How to Configure Them | Gcore
...
---
# What Healthcheck are and how to configure them
...
If all Healthchecks fail, their A records will be included in the DNS response, while stoll adhering to other filters like *geo county* or *first_n*.
