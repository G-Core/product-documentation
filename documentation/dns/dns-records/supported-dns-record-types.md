...
At the time of writing (June 2023) [Gcore DNS Hosting] (https://gcore.com/dns) supports eleven record types. In this article, we provide brief information about each of them.
