...
<img src="https://assets.gcore.pro/docs/account-settings/account/get-started-gcore-website-10.png" alt="Gcore website" width="635">

2. The Gcore platform option will pop up. Select **Go to Gcore Platform**.

<img src="https://assets.gcore.pro/docs/account-settings/account/select-gcore-platform-20.png" alt="Select the Gcore platform" width="80%">

3. Next, create an account using Google, GitHub, or your email account.

<img src="https://assets.gcore.pro/docs/account-settings/account/create-gcore-account-30.jpg" alt="Create an account" width="">
...
<img src="https://assets.gcore.pro/docs/account-settings/account/check-billing-info-60.jpg" alt="billing information details">
