...
<table>
    ...
    <tbody>
        <tr>
            <td id="ddos-profile"><code>loadbalancer.gcorelabs.com/ddos-profile</code></td>
        ...
        <tr>
            <td id="flavor"><code>loadbalancer.gcorelabs.com/flavor</code></td>
            <td style="text-align: left"><code>lb1-1-2</code></td>
            <td style="text-align: left">String</td>
            <td style="text-align: left">Specifies a custom name for the flavor</td>
        </tr>
        <tr>
            <td id="floating-cleanup"><code>loadbalancer.gcorelabs.com/floating-cleanup</code></td>
        ...
        <tr>
            <td id="logging-topic-name"><code>loadbalancer.gcorelabs.com/logging-topic-name</code></td>
        ...
        <tr id="logging-destination-region-id">
            <td style="text-align: left"><code>loadbalancer.gcorelabs.com/logging-destination-region-id</code></td>
        ...
        <tr>
            <td id="logging-retention-policy-period"><code>loadbalancer.gcorelabs.com/logging-retention-policy-period</code></td>
        ...
        <tr>
            <td id="proxy-protocol"><code>loadbalancer.gcorelabs.com/proxy-protocol</code></td>
            <td style="text-align: left"><code>true</code></td>
            <td style="text-align: left">Boolean</td>
        ...
        <tr>
            <td id="timeout-client-data"><code>loadbalancer.gcorelabs.com/timeout-client-data</code></td>
        ...
        <tr>
            <td id="timeout-member-connect"><code>loadbalancer.gcorelabs.com/timeout-member-connect </code></td>
            <td style="text-align: left"><code>6000</code></td>
            <td style="text-align: left">Integer</td>
        ...
        <tr>
            <td id="timeout-member-data"><code>loadbalancer.gcorelabs.com/timeout-member-data</code></td>
            <td style="text-align: left"><code>6000</code></td>
            <td style="text-align: left">Integer</td>
        ...
        <tr>
            <td id="x-forwarded-for"><code>loadbalancer.gcorelabs.com/x-forwarded-for</code></td>
            <td style="text-align: left"><code>true</code></td>
            <td style="text-align: left">Boolean</td>
            <td style="text-align: left">Adds the “X-Forwarded-For,” “X-Forwarded-Port” and “X-Forwarded-Proto“ headers to requests</td>
        </tr>
        <tr>
            <td id="gcore-internal-load-balancer"><code>service.beta.kubernetes.io/gcore-internal-load-balancer</code></td>
            <td style="text-align: left"><code>true</code></td>
            <td style="text-align: left">Boolean</td>
        ...
        <tr>
            <td id="gcore-external-load-balancer"><code>service.beta.kubernetes.io/gcore-external-load-balancer</code></td>
            <td style="text-align: left"><code>true</code></td>
            <td style="text-align: left">Boolean</td>
