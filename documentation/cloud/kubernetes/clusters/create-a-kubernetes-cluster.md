...
Dash, spacing is weird here, looks like double line break. Please check.
...
Dash, above maybe "the application will not stand idle: the node(s) will be replaced on a working machine, and..."
...
5\. Under the **Network settings** block, select an existing network and subnet or create new ones according to the instructions in our <a href="" target="_blank">dedicated guide</a>.
