...
3\. Select the **Load** button and then browse for the file with the key that you want to convert.
...
5\. Select a converted key by selecting either the **Save private key** or **Save public key** button. 
