...
<img src="https://assets.gcore.pro/docs/cloud/ssh-keys/convert-an-ssh-key-from-pem-to-ppk/putty_gen_load.png" alt="" width="60%">

3\. PuTTYgen will prompt you to confirm that you want to import the key. Click **OK**.

<img src="https://assets.gcore.pro/docs/cloud/ssh-keys/convert-an-ssh-key-from-pem-to-ppk/putty_load_2.png" alt="" width="60%">

4\. Click the **Save private key** button.

<img src="https://assets.gcore.pro/docs/cloud/ssh-keys/convert-an-ssh-key-from-pem-to-ppk/save_private_in_ppk.png" alt="" width="60%">
