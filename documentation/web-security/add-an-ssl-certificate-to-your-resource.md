...
<img src="https://assets.gcore.pro/docs/web-security/add-an-ssl-certificate-to-your-resource/mceclip0.png" alt="" width="80%">
...
<img src="https://assets.gcore.pro/docs/web-security/add-an-ssl-certificate-to-your-resource/mceclip1.png" alt="" width="80%">

4. There should be an empty string at the end of the certificate chain. 

<img src="https://assets.gcore.pro/docs/web-security/add-an-ssl-certificate-to-your-resource/mceclip2.png" alt="" width="80%"> 
