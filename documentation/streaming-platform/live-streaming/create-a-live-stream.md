...
1\. Navigate to <a href="https://streaming.gcore.com/streaming/list">Live Streaming</a> and select **Create Live stream**.
...
Dash, expandable block isn't showing on the live page. It just shows like normal content.
...
Dash, when is earlier exactly?
- <a href="https://gcore.com/docs/streaming-platform/live-streaming/record-your-live-streams-and-save-them-as-videos" target="_blank">Record</a> for live stream recording. If you enable the toggle, recording will be active when you start streaming.
- <a href="https://gcore.com/docs/streaming-platform/live-streaming/pause-and-rewind-the-live-streams" target="_blank">DVR</a> for an improved user experience. When the DVR feature is enabled, your viewers can pause and rewind the broadcast as it's happening.
...
Dash, in this image I would suggest highlighting the DVR and Record toggles just to make it really obvious how it relates to the copy.
...
Dash I just want to check the example is 100% accurate bc it's "ugly" that there is no division between the URLs. I guess it is right, but I want to double check :) 
</alert-element>
