...
1\. Go to the <a href="https://streaming.gcore.com/video/list" target="_blank">Video Hosting</a> tab and upload a video using one of the following actions: 
...
2\. Wait until your video is uploaded and processed. Waiting time varies depending on video size and internet speed.  
...
3\. Open video settings by clicking the video name or the three-dot icon next to it.
...
4\. Change the following video settings if necessary:
...
5\. In the top-right corner of the screen, click **Save** to apply the updates.
...
5\. Open the **Export** tab and copy an iFrame code to embed the video to your website, a URL of the video page, or a URL for your own player.

On this tab, you can also choose the video size and download the uploaded video in the required quality by selecting its bitrate and clicking **Download video**.   
...
If the video is requested over a direct link or from the website where you have inserted the iFrame code, all views will be counted for the statistics. You can check the statistics in video settings on the **Statistics** tab.