...
<img src="https://assets.gcore.pro/docs/cdn/cdn-resource-options/image-optimization-paid/possible-image-stack-errors/image2.png" alt="">
...
<tbody>
  <tr>
    <td colspan="4"><h2 id="common-errors-that-result-in-a-broken-image">Common errors that result in a broken image</h2></td>
  </tr>
  <tr>
    <td>1. Incorrect image request method</td>
  ...
  <tr>
    <td>2. Incorrect format for conversion in headers or query</td>
  ...
  <tr>
    <td>3. Image Stack internal error</td>
  ...
  <tr>
    <td>5. Too many requests to the origin</td>
  ...
  <tr>
    <td colspan="4"><h2 id="common-errors-that-deliver-an-image-in-its-original-state">Common errors that deliver an image in its original state</h2><br><b>Note</b>: The request’s body will be proxied from your origin. The response headers will include X-Img-Server and headers from the origin. The status code of the response will be 200 OK. </td>
  </tr>
  <tr>
    <td>1. Unsupported content type from the origin for the converter</td>
  ...
  <tr>
    <td>2. Quality difference skips for jpeg</td>
  ...
  <tr>
    <td>3. Invalid response code from the origin</td>
  ...
  <tr>
    <td colspan="4"><h2 id="compression-and-quality-operation-errors">Compression and Quality operation errors</h2><br><b>Note</b>: The request's body will be proxied from your origin. The response headers will include X-Img-Server and headers from the origin. The status code of the response will be 200 OK. </td>
  </tr>
  <tr>
    <td>1. Rate limit exceeded</td>
  ...
  <tr>
    <td>3. Unsupported format of the fmt value</td>
  ...
  <tr>
    <td>4. The WebP or AVIF format is not supported by the user client</td>
  ...
  <tr>
    <td>5. The output image size is bigger or equal to the original image size</td>
  ...
  <tr>
    <td>6. Conversation to WebP or AVIF internal error</td>
  ...
  <tr>
    <td colspan="4"><h2 id="resize-operation-errors">Resize operation errors</h2><br><b>Note</b>: The request’s body will be proxied from your origin. The response headers will include X-Img-Server and headers from the origin. The status code of the response will be 200 OK. </td>
  </tr>
  <tr>
    <td>1. Bad “width” parameter</td>
  ...
  <tr>
    <td>3. The output image width or height parameter is larger than the original image size</td>
  ...
  <tr>
    <td>4. Resizing internal error</td>
    <td><b>Response Header</b>: "IMG-SKIP-REASON":"resizing: internal error"</td>
    <td>Internal Image Stack error</td>
    <td>Contact our technical support team at <a href="mailto:support@gcore.com">support@gcore.com</a></td>
  </tr>
  <tr>
    <td colspan="4"><h2 id="crop-operation-errors">Crop operation errors</h2><br><b>Note</b>: The request’s body will be proxied from your origin. The response headers will include X-Img-Server and headers from the origin. The status code of the response will be 200 OK. </td>
  </tr>
  <tr>
    <td>1. Bad “width-ratio” or “height-ratio” parameter</td>
  ...
  <tr>
    <td>2. Bad “height ratio” parameter</td>
  ...
  <tr>
    <td>3. Bad “width ratio” parameter</td>
  ...
  <tr>
    <td>4. x or y parameter is not specified</td>
  ...
  <tr>
    <td>5. Bad x or/and y percentage parameter</td>
  ...
  <tr>
    <td>6. Bad x or y pixel parameter</td>
  ...
  <tr>
    <td>7. x and y pixels number parameter and percentage x and y parameter cannot be specified simultaneously</td>
  ...
  <tr>
    <td>8. Bad offset value for the x or y parameter</td>
  ...
  <tr>
    <td>9. “width”, “height” and “width-ratio”:”height-ratio” values cannot be specified simultaneously</td>
  ...
  <tr>
    <td>10. x and y percentage parameter cannot be more than 100</td>
  ...
  <tr>
    <td>11. “offset x”, “offset-y” parameters cannot be more than 100</td>
  ...
  <tr>
    <td>12. Output “height” and “width” are bigger than the original image size</td>
  ...
  <tr>
    <td>13. Output x or y pixel value is bigger than the original image value</td>
  ...
  <tr>
    <td>14. Output x or y percentage value cannot be more than the original image size </td>
  ...
  <tr>
    <td>15. Crop operation internal error</td>
