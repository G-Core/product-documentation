...
2\. Go to the [CDN](https://cdn.gcore.com/resources/list) section in the control panel and click the custom domain of the resource on which origin you configured the Cache-Control header.

<img src="https://support.gcore.com/hc/article_attachments/13249373793809" alt="mceclip3.png">

The new page opens. Do the remaining steps on it.

<img src="https://support.gcore.com/hc/article_attachments/13249168410769" alt="mceclip0.png">
...
1\. Go to the [CDN](https://cdn.gcore.com/resources/list) section in the control panel and click the custom domain of the resource for which you want to configure the CDN caching feature.

<img src="https://support.gcore.com/hc/article_attachments/13249311265809" alt="mceclip2.png">

The new page opens. Do the remaining steps on it.

<img src="https://support.gcore.com/hc/article_attachments/13249271726353" alt="mceclip1.png">
...
http://cdn.testdomain.com/css/style.css

where _http://cdn.testdomain.com/css/style.css_ is a link to your file delivered via CDN.
...
If you suspect any content caching issues, check the settings on the source, read the "[Troubleshooting Low Cache Hit Ratio](https://www.gcore.com/support/articles/360013291637/)" article, or contact [support@gcore.com](mailto:support@gcore.com).
...
<img src="https://support.gcore.com/hc/article_attachments/13249609604753" alt="mceclip4.png">

### Check caching HTTP headers

There are several HTTP header parameters that help analyze the state of the cache:

| \nHTTP header with parameters\n             | \nExplanation\n                                                                                                                                                                                                                                                                                           |
|---------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| \nCACHE: HIT\n                              | The file has been delivered from the CDN. This parameter indicates that caching is working correctly.                                                                                                                                                                                                     |
| \nCACHE: MISS\n                             | The file has been delivered from your origin server. Try to reload the page and clear the browser cache. If the value remains, it indicates something went wrong, and the file is not delivered from the cache.                                                                                           |
| X-ID: ab-cd-d123\n                          | The file has been delivered from the Gcore CDN server with the identifier ab-cd-d123.                                                                                                                                                                                                                     |
| X-Cached-Since: 2023-02-23T14:33:07+00:00\n | The time when the file was cached in the CDN server in UTC.                                                                                                                                                                                                                                               |
| Cache-Control: max-age=1000, public         | \nThe public parameter indicates that not only the end users' clients (browsers) can cache the file but also proxy servers, CDN servers, etc. The max-age=1000 parameter shows that the file is cached for 1000 seconds.\nThese parameters of the Cache-Control header are compatible with CDN caching.\n |
| Cache-Control: private                      | \nThis parameter indicates that the file cannot be cached by proxies.\nNote: It’s incompatible with CDN Caching.\n                                                                                                                                                                                        |
| \nCache-Control: no-cache\n                 | \nThis parameter indicates that the file is not cached on CDN and will be pulled from the origin each time. \nNote: It is incompatible with CDN caching.\n                                                                                                                                                |
