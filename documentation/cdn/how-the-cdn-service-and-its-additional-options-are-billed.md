...
Additional options are listed on <a href="https://gcore.com/pricing/" target="_blank">the CDN pricing page</a>. To activate it, contact our technical support via chat or email [support@gcore.com](support@gcore.com). Each option has a fixed price and is billed together with the plan fee on the 3rd day of every month. For example, if you activate a plan for €100/month and the "Extended statistics" option for €200. On the 3rd day of a following month, the system will charge you €300.
