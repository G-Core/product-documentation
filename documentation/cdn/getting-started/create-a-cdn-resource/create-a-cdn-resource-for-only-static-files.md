...
order: 10
toc:
   --1--1. Start the creation: "step-1-start-creation"
   --1--2. Choose acceleration type: "step-2-choose-acceleration-type"
   --1--3. Set up initial configuration: "step-3-configure"
...
I moved the screenshot up to make sure the relationship between the following line and the numbered list is obvious.
Fill in the following fields to configure your CDN resource on the open page:
...
If there is no **... steps left** box in the upper-right corner, everything is ok and the resource is working. 
...
If there are integration issues, you will see an error message. Contact our [support team](maito:support@gcore.com) or retry the integration according to our <a href="https://gcore.com/docs/cdn/getting-started/integrate-cdn-with-cms" target="_blank">instructions</a>.
