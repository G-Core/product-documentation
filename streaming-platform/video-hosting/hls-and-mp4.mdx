...
You can also find a description of supported video formats and relevant use cases in our [API documentation](/docs/api-reference/streaming/videos/get-video). 
...
Where:
  ...
  * `[-cmaf]`: The HLS CMAF version of the manifest. For details, check the hls_cmaf_url field description in our [API docs](/docs/api-reference/streaming/videos/get-list-of-videos). 
...
You can get links to videos in two ways: in the Gcore Customer Portal or via the [API](/docs/api-reference/streaming/videos/get-video).
...
To get information about the video, [API Documentation](/docs/api-reference/streaming/videos/get-video)
