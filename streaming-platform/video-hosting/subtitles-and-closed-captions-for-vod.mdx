...
Explore our [API documentation](/docs/api-reference/streaming/subtitles) which describes working with subtitles and captions. Here are some methods for the most helpful actions.

#### Add subtitles or captions

The [API method](/docs/api-reference/streaming/subtitles/add-subtitle) lets you add subtitles attached to a video.
...
The [API method](/docs/api-reference/streaming/subtitles/get-subtitle) lets you attach subtitles or captions to a video.
...
The [API method](/docs/api-reference/streaming/subtitles/change-subtitle) lets you modify any field of the subtitle or caption entity: to update vtt subtitles or just update the entity's name.
...
The [API method](/docs/api-reference/streaming/subtitles/delete-subtitle) allows you to delete the subtitle or caption entity.
...
If you have a custom player, you must get subtitles or captions from the API response or the HLS manifest (.m3u8 file.) Use this [API method](/docs/api-reference/streaming/subtitles/get-subtitle) to get the list of subtitles for the video. 
