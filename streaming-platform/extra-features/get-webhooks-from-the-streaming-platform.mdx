...
See the statuses of VOD processing in API docs:
  - Video status processing – [status](/docs/api-reference/streaming/videos/get-video#response-status)
  - Rendition status processing – [converted_videos/status](/docs/api-reference/streaming/videos/get-video#response-converted-videos)
