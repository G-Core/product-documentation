...
sidebarTitle: Player API tutorial
---

<Info>
**Deprecation Notice**  
This documentation refers to the current version of the Gcore Video Player based on Iframe.

A new version of the player is under development and will be released soon. New player is based on native javascript, and supports all modern browsers and OS. 

Once the new player is available, this documentation will be deprecated and replaced with updated guidelines.
</Info>
