...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Check the protocol in your encoder. Follow <a href="/streaming-platform/live-streaming/create-a-live-stream#step-3-configure-your-stream-for-push%2C-pull%2C-or-webrtc-to-hls" target="_blank">step 3 of the guide</a>.</td>
    </tr>
