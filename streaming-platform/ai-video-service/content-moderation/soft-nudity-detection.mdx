...
It's often used to determine whether videos can be published to all users or the publication should be prohibited due to offensive and inappropriate content. For a full list of objects that can be detected with the soft nudity check, read our [API documentation](/docs/api-reference/streaming/ai/create-ai-cm:soft_nudity-task). 
