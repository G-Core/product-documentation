...
<Info>
  RTMP is limited to the H264 codec only. If you want to use other codecs, please [use SRT](https://gcore.com/docs/streaming-platform/live-streaming/protocols/srt) instead.
