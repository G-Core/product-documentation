...
For detailed information, refer to our [API documentation](/docs/api-reference/streaming/overlays/get-all-overlays).

### Get all overlays

The [API method](/docs/api-reference/streaming/overlays/get-all-overlays) returns a list of HTML overlay widgets attached to a live stream.
...
The [API method](/docs/api-reference/streaming/overlays/create-overlays) lets you insert overlays into your live stream. Please review the requirements for overlays to work correctly in the [API documentation](/docs/api-reference/streaming/overlays/create-overlays).
...
After creating the overlay, you can request it with the [API method](/docs/api-reference/streaming/overlays/get-an-overlay) by specifying its ID.

### Change overlays

The [API method](/docs/api-reference/streaming/overlays/change-overlays) updates settings for a set of overlays. This method allows changing the settings of several overlays. If you have only one, try [this one](/docs/api-reference/streaming/overlays/change-overlays). 
...
The [API method](/docs/api-reference/streaming/overlays/delete-an-overlay) lets you delete the overlay.
