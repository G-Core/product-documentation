...
Details about additional recording options are available in the following guides:
  ...
  * [How to record an original or transcoded stream with overlays.](/docs/api-reference/streaming/streams/start-recording)
  * [How to create an instant clip from a currently running live stream.](/docs/api-reference/streaming/streams/create-clip)
