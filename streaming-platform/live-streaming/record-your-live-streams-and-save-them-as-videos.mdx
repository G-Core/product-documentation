...
Details about additional recording options are available in the following guides:
  ...
  * [How to record an original or transcoded stream with overlays.](https://api.preprod.world/docs/streaming#tag/Streams/operation/put_streams_id_start_recording)
  * [How to create an instant clip from a currently running live stream.](https://api.preprod.world/docs/streaming#tag/Streams/operation/put_streams_id_clip_recording)
