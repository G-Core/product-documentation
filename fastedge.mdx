...
[Local&nbsp;development](/fastedge/local-development/overview) covers building, testing, and deploying applications without touching the edge first — an AI plugin for Claude Code and Codex, a VS Code extension with a bundled debugger, and a headless test framework for CI.
