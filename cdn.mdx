---
title: CDN
ai-navigation: Configure Gcore CDN resources for content delivery including origin groups, caching rules, SSL certificates, HTTP headers, cache purge, logs, Grafana dashboards, and Terraform integration.
---
