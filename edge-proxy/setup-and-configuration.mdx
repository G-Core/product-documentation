...
Each card is a [supported&nbsp;application](/edge-proxy/supported-applications): a DDoS filtering profile such as Minecraft Protection, a Counter-Strike variant, FiveM, Generic TCP Server, or General UDP Countermeasure.
