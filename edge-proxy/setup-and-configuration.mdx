...
ai-navigation: Configure Edge Proxy DDoS protection using a four-step wizard - enter server details, select applications and a protection template, set ports, and deploy.
---
