...
ai-navigation: Configure Edge Proxy DDoS protection for TCP and UDP applications by assigning protected Anycast IP addresses, creating proxy rules with application type selection, and updating DNS A or AAAA records to route traffic through Gcore CDN edge network Points of Presence.
---
