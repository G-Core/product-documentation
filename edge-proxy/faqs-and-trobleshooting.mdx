...
ai-navigation: Resolve common Edge Proxy issues: DDoS protection setup, TCP/UDP application configuration, DNS updates, Anycast IP assignment, and connection troubleshooting.
ai-navigation: Diagnose Edge Proxy connectivity issues, application type configuration, DNS propagation, and origin IP reuse across multiple proxy rules.
---
...
2. Contact Gcore support  
   - Follow the instructions in the [Contact Gcore support](#contact-gcore-support) section  
