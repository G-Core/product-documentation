...
Any TCP or UDP application can be protected with a profile from [Supported&nbsp;applications](/edge-proxy/supported-applications). If the exact profile is not in that set, use **Generic TCP Server** or **General UDP Countermeasure**. An incorrect profile may cause legitimate traffic to be blocked during an attack.
</Accordion>
