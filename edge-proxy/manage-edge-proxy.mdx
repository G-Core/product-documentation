...
**Proxy protocol** is available in two versions: **V1** supports TCP connections and **V2** supports both TCP and UDP and can carry additional connection metadata. The origin application must support the selected version; otherwise, leave the setting **Off**.
