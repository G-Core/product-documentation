...
- **Server location**. Prices vary by data center. Contact [Gcore&nbsp;Sales](mailto:sales@gcore.com) for pricing on a specific location.

Always-on protection is available for L3-L7 protection layers. For custom configurations, contact Gcore Sales to request a tailored plan.
