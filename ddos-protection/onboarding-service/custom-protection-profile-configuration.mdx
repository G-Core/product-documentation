...
ai-navigation: Configure custom DDoS protection profiles with game-specific policies and default-udp for UDP games without a dedicated policy, including Arma 3 and DayZ.
---
...
- Next, [apply the custom profile to a protected network](/ddos-protection/onboarding-service/apply-a-custom-profile-to-a-protected-network)
