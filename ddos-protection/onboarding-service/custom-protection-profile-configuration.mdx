...
The new profile appears in the profile list from [Step 1](#step-1-open-protection-profiles), with its assigned template and name, confirming the save succeeded.
