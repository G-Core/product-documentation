...
To set up a GRE tunnel with the Gcore scrubbing center, please refer to [our step-by-step guide](/ddos-protection/gre-tunneling/set-a-gre-tunnel-with-gcore).