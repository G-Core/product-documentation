...
ai-navigation: Configure GRE tunnel endpoints on Cisco routers with tunnel ID, IP addressing, MTU/MSS limits, and BGP peering for traffic routing.
ai-navigation: Configure GRE tunnel with source/destination IP, tunnel ID, MTU 1476, MSS 1436, and BGP peering on Cisco routers.
---
