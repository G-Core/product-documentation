...
Automate DDoS Protection operations with the REST API, including protected networks, protection profiles, and event logs.
...
| --- | --- | --- |
| `date_from` | No | Start of the time window |
| `date_to` | No | End of the time window |
...
Request and response schemas for protected networks, BGP announces, protection profiles, and templates are in the DDoS Protection [API reference](/api-reference/ddos-protection).
