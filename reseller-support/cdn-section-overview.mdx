...
Click three-dot icon on the right to edit a customer's settings. For further details, refer to the dedicated guide: [Manage сlients](/reseller-support/manuals/manage-clients#edit-an-account). Click the arrow to log in to the Customer Portal as a customer.
...
- The CDN resource ID
- The CDN resource [custom domain (CNAME)](/cdn/cdn-resource-options/general/create-and-set-a-custom-domain-for-the-content-delivery-via-cdn)
- The customer's Account ID
...
This subsection provides information about [origin groups](/cdn/add-an-origin-group). Each entry includes:
