...
<Frame>
![Service management](https://assets.gcore.pro/docs/reseller-support/getting-started/vendor-settings-products.png)
</Frame>
...
<Frame>
![Products page](https://assets.gcore.pro/docs/reseller-support/getting-started/accounts-products.png)
</Frame>
...
<Frame>
![Log in as a user button](https://assets.gcore.pro/docs/reseller-support/getting-started/log-in-as-a-user.png)
</Frame>
