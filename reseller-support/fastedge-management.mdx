...
* **Group ID**. A unique identifier for the default group that’s associated with a single reseller and includes all customers created by that reseller. You can create and manage groups via <a href="/api-reference/fastedge-resellers/groups/list-groups" target="_blank">API</a>.
