...
ai-navigation: Configure Customer Portal product URLs with Base Customer Portal domain, SSL certificates, and CNAME DNS records.
---
...
- waap.gcore.com — Web Application Security product
