...
ai-navigation: Create Seller accounts with email invitations, manage activation status, resend invites, reset passwords, and delete Seller users in Admin Portal.
---
