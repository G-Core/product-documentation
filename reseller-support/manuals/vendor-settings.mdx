...
<Frame>
![Branding settings](https://assets.gcore.pro/docs/reseller-support/manuals/vendor-settings/vendor-settings.png)
</Frame>
...
For more details about the "Base Customer Portal domain" field, refer to [How to set up Customer Portal product URLs](/reseller-support/manuals/set-up-control-panel-services-urls).
...
<Frame>
![Show Create new account](https://assets.gcore.pro/docs/reseller-support/manuals/vendor-settings/create-new-acc-reseller.png)
</Frame>
...
**Email for deletion requests.** Here you can enter an email address to receive notifications about status updates of deletion requests. You will receive emails when a customer sends a deletion request and when the account is deleted. 
...
DNSaaS settings control the white-label name servers and SOA email a customer sees for a DNS zone, covered in [DNS service management](/reseller-support/dns-service-management).
...
In the [global visibility](/reseller-support/manuals/configure-global-visibility) settings, you can set the visibility of products for all your customers.
...
In the [personal visibility](/reseller-support/manuals/configure-personal-visibility) settings, you can enable or disable the visibility of products for a particular customer. The visibility statuses of personally configured products will not be available for changes from the global visibility settings. 
