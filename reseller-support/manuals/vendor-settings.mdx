...
For more details about the "Base Customer Portal domain" field, refer to <a href="/reseller-support/manuals/set-up-control-panel-services-urls" target="_blank">How to set up Customer Portal product URLs</a>.
...
In the <a href="/reseller-support/manuals/configure-global-visibility" target="_blank">global visibility</a> settings, you can set the visibility of products for all your customers.
