...
The Activity logs section displays changes that users have made. Users are all the [customers](/reseller-support/manuals/manage-clients) and [sellers](/reseller-support/manuals/manage-sellers) that you have added. Changes they can make include requests sent via the <a href="https://api.gcore.com/docs" target="_blank">API</a> and actions in the <a href="https://auth.gcore.com/login/signin?lang=en" target="_blank">Customer Portal</a>. 
...
<Frame>
![Activity logs](https://assets.gcore.pro/docs/reseller-support/manuals/view-the-history-of-users-requests-and-actions-via-activity-logs/activity-logs-platform.png)
</Frame>
...
<Frame>
![Manage Columns](https://assets.gcore.pro/docs/reseller-support/manuals/view-the-history-of-users-requests-and-actions-via-activity-logs/image3501-20.png)
</Frame>
...
<Frame>
![Use filters](https://assets.gcore.pro/docs/reseller-support/manuals/view-the-history-of-users-requests-and-actions-via-activity-logs/Group190991-30.png)
</Frame>
...
<Frame>
![Path filter](https://assets.gcore.pro/docs/reseller-support/manuals/view-the-history-of-users-requests-and-actions-via-activity-logs/image3503-40.png)
</Frame>
