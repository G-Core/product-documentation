...
In the field on the right, toggle on the products that you want to make available for the customer. By default, the <a href="/reseller-support/manuals/configure-global-visibility " target="_blank">global product visibility</a> settings are inherited.  
...
- <a href="/reseller-support/new-admin-panel-interface" target="_blank">New Admin Portal interface</a>
- <a href="/reseller-support/getting-started" target="_blank">Getting started</a>
- <a href="/reseller-support/cdn-service-management" target="_blank">CDN management</a>
- <a href="/reseller-support/storage-service-management" target="_blank">Storage management</a>
- <a href="/reseller-support/service-statuses" target="_blank">Product statuses</a>
- <a href="/reseller-support/api" target="_blank">API</a>
...
You can customize <a href="/reseller-support/manuals/configure-personal-visibility" target="_blank">product visibility</a> for a customer.

### Users tab

On this tab, you can edit personal data and manage user rights. You can <a href="/account-settings/users/manage-users" target="_blank">invite new users</a> only via the customer's Customer Portal.
...
<a href="/account-settings/users/about-users" target="_blank">About Users</a>
...
You can also receive emails about status updates of deletion requests. We describe how to do it in the "<a href="/reseller-support/manuals/vendor-settings" target="_blank">Vendor settings</a>" article.

<Warning>
Account deletion is permanent and cannot be undone. Once a deletion request is submitted, the account enters a Suspended state and cannot be recovered.
</Warning>

To process a deletion request, open the "Delete account" tab. You will see information about the current request status and the history of all the customer's deletion requests.

To finalize the deletion, click **Delete account**. A confirmation dialog will appear. Click **Yes, delete account** to permanently remove the account.

If a client has no outstanding debt, you can check the **No debt** option to skip the grace period and proceed with immediate deletion. Billing will still verify the debt status before processing.
