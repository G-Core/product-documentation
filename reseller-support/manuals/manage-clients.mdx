...
ai-navigation: Create customer accounts in Accounts section with email, name, password, seller assignment, and product visibility settings.
---
...
On this tab, you can edit personal data and manage user rights. You can <a href="https://gcore.com/docs/account-settings/users/manage-users" target="_blank">invite new users</a> only via the customer's Customer Portal.
