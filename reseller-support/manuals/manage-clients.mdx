...
In the field on the right, toggle on the products that you want to make available for the customer. By default, the [global product visibility](/reseller-support/manuals/configure-global-visibility) settings are inherited.  
...
You can customize [product visibility](/reseller-support/manuals/configure-personal-visibility) for a customer.

### Users tab

On this tab, you can edit personal data and manage user rights. You can [invite new users](/account-settings/users/manage-users) only via the customer's Customer Portal.
...
[About Users](/account-settings/users/about-users)
...
You can also receive emails about status updates of deletion requests. We describe how to do it in the "[Vendor settings](/reseller-support/manuals/vendor-settings)" article.
