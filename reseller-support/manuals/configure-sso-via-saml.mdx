...
<Frame>
![SSO in the Admin Portal](https://assets.gcore.pro/docs/reseller-support/manuals/configure-sso-via-saml/security-authorization-page.png)
</Frame>
...
<Frame>
![Sign in with SAML SSO](https://assets.gcore.pro/docs/reseller-support/manuals/configure-sso-via-saml/sign-in-with-sso-20.png)
</Frame>
...
<Frame>
![SSO authorization ](https://assets.gcore.pro/docs/reseller-support/manuals/configure-sso-via-saml/welcome-sso-page-30.png)
</Frame>

3\. Enter your username and password and log in.

<Frame>
![ log in](https://assets.gcore.pro/docs/reseller-support/manuals/configure-sso-via-saml/login-pass-40.png)
</Frame>
...
<Frame>
![Sign in with SAML SSO](https://assets.gcore.pro/docs/reseller-support/manuals/configure-sso-via-saml/reseller-sso-20.png)
</Frame>
...
<Frame>
![ SSO authorization](https://assets.gcore.pro/docs/reseller-support/manuals/configure-sso-via-saml/reseller-sso-30.png)
</Frame>
