...
<Frame>
![SSO in the Admin Portal](https://assets.gcore.pro/docs/reseller-support/manuals/configure-password-policy/authorization.png)
</Frame>
...
<Frame>
![SSO in the Admin Portal](https://assets.gcore.pro/docs/reseller-support/manuals/configure-password-policy/policy-enabled.png)
</Frame>

3\. Enable the **Frequency of password changing** toggle.

<Frame>
![SSO in the Admin Portal](https://assets.gcore.pro/docs/reseller-support/manuals/configure-password-policy/policy-disabled.png)
</Frame>
